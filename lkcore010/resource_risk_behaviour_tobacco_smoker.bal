...
public const string PROFILE_BASE_RISKBEHAVIOURTOBACCOSMOKER = "http://openhie.org/fhir/sri-lanka/StructureDefinition/risk-behaviour-tobacco-smoker";
public const RESOURCE_NAME_RISKBEHAVIOURTOBACCOSMOKER = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: RiskBehaviourTobaccoSmokerCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueCodeableConcept" : {
            ...
            valueSet: "http://openhie.org/fhir/sri-lanka/ValueSet/vs-risk-behaviour-tobacco-smoker"
        },
        "specimen" : {
            name: "specimen",
            dataType: r4:Reference,
        ...
        "component" : {
            name: "component",
            dataType: RiskBehaviourTobaccoSmokerComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: RiskBehaviourTobaccoSmokerReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: RiskBehaviourTobaccoSmokerStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type RiskBehaviourTobaccoSmoker record {|
    *r4:DomainResource;

    RESOURCE_NAME_RISKBEHAVIOURTOBACCOSMOKER resourceType = RESOURCE_NAME_RISKBEHAVIOURTOBACCOSMOKER;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    RiskBehaviourTobaccoSmokerCode code;
    ...
    RiskBehaviourTobaccoSmokerComponent[] component?;
    r4:Resource[] contained?;
    RiskBehaviourTobaccoSmokerReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    RiskBehaviourTobaccoSmokerStatus status;
    r4:Element ...;
|};

# RiskBehaviourTobaccoSmokerStatus enum
public enum RiskBehaviourTobaccoSmokerStatus {
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourTobaccoSmokerComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type RiskBehaviourTobaccoSmokerComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourTobaccoSmokerCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: RiskBehaviourTobaccoSmokerCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type RiskBehaviourTobaccoSmokerCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    RiskBehaviourTobaccoSmokerCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourTobaccoSmokerCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type RiskBehaviourTobaccoSmokerCodeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourTobaccoSmokerReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type RiskBehaviourTobaccoSmokerReferenceRange record {|
    *r4:BackboneElement;
