...
public const string PROFILE_BASE_INVESTIGATIONSTASK = "http://openhie.org/fhir/sri-lanka/StructureDefinition/investigations-task";
public const RESOURCE_NAME_INVESTIGATIONSTASK = "Task";
...
# + priority - reason(s) why this should be supported.
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/investigations-task",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "output" : {
            name: "output",
            dataType: InvestigationsTaskOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Task.output"
        ...
        "priority" : {
            name: "priority",
            dataType: InvestigationsTaskPriority,
            min: 0,
            max: 1,
            isArray: false,
            path: "Task.priority",
        ...
        "intent" : {
            name: "intent",
            dataType: InvestigationsTaskIntent,
            min: 1,
            max: 1,
            isArray: false,
            path: "Task.intent",
        ...
        "input" : {
            name: "input",
            dataType: InvestigationsTaskInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Task.input"
        ...
        "restriction" : {
            name: "restriction",
            dataType: InvestigationsTaskRestriction,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: InvestigationsTaskStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Task.status",
...
public type InvestigationsTask record {|
    *r4:DomainResource;

    RESOURCE_NAME_INVESTIGATIONSTASK resourceType = RESOURCE_NAME_INVESTIGATIONSTASK;
    ...
    InvestigationsTaskOutput[] output?;
    ...
    InvestigationsTaskPriority priority?;
    InvestigationsTaskIntent intent;
    r4:CodeableConcept[] performerType?;
    InvestigationsTaskInput[] input?;
    r4:Resource[] contained?;
    r4:Meta meta?;
    InvestigationsTaskRestriction restriction?;
    r4:uri implicitRules?;
    r4:Reference location;
    r4:dateTime lastModified?;
    r4:Identifier groupIdentifier?;
    InvestigationsTaskStatus status;
    r4:Element ...;
|};

# InvestigationsTaskStatus enum
public enum InvestigationsTaskStatus {
...
@r4:DataTypeDefinition {
    name: "InvestigationsTaskRestriction",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type InvestigationsTaskRestriction record {|
    *r4:BackboneElement;
...
public enum InvestigationsTaskPriority {
...
public type InvestigationsTaskInput record {|
    *r4:BackboneElement;
...
public type InvestigationsTaskOutput record {|
    *r4:BackboneElement;
...
public enum InvestigationsTaskIntent {
