...
public const string PROFILE_BASE_TOTALCHOLESTEROL = "http://openhie.org/fhir/sri-lanka/StructureDefinition/total-cholesterol";
public const RESOURCE_NAME_TOTALCHOLESTEROL = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: TotalCholesterolValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "component" : {
            name: "component",
            dataType: TotalCholesterolComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: TotalCholesterolReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: TotalCholesterolStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type TotalCholesterol record {|
    *r4:DomainResource;

    RESOURCE_NAME_TOTALCHOLESTEROL resourceType = RESOURCE_NAME_TOTALCHOLESTEROL;
    ...
    TotalCholesterolValue valueQuantity?;
    ...
    TotalCholesterolComponent[] component?;
    r4:Resource[] contained?;
    TotalCholesterolReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    name: "TotalCholesterolCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: TotalCholesterolCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type TotalCholesterolCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    TotalCholesterolCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "TotalCholesterolCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type TotalCholesterolCodeCoding record {|
    *r4:Coding;
...
public enum TotalCholesterolValueComparator {
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "TotalCholesterolComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type TotalCholesterolComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "TotalCholesterolReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type TotalCholesterolReferenceRange record {|
    *r4:BackboneElement;
...
public enum TotalCholesterolStatus {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "comparator": {
            name: "comparator",
            dataType: TotalCholesterolValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type TotalCholesterolValue record {|
    *r4:Quantity;

    TotalCholesterolValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
