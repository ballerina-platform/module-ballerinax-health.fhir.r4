...
public const string PROFILE_BASE_TARGETFACILITYENCOUNTER = "http://openhie.org/fhir/sri-lanka/StructureDefinition/target-facility-encounter";
public const RESOURCE_NAME_TARGETFACILITYENCOUNTER = "Encounter";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "participant" : {
            name: "participant",
            dataType: TargetFacilityEncounterParticipant,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "classHistory" : {
            name: "classHistory",
            dataType: TargetFacilityEncounterClassHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "hospitalization" : {
            ...
            dataType: TargetFacilityEncounterHospitalization,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "diagnosis" : {
            name: "diagnosis",
            dataType: TargetFacilityEncounterDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "statusHistory" : {
            name: "statusHistory",
            dataType: TargetFacilityEncounterStatusHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "location" : {
            name: "location",
            dataType: TargetFacilityEncounterLocation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: TargetFacilityEncounterStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type TargetFacilityEncounter record {|
    *r4:DomainResource;

    RESOURCE_NAME_TARGETFACILITYENCOUNTER resourceType = RESOURCE_NAME_TARGETFACILITYENCOUNTER;
    ...
    TargetFacilityEncounterParticipant[] participant;
    ...
    r4:Period period;
    TargetFacilityEncounterClassHistory[] classHistory?;
    TargetFacilityEncounterHospitalization hospitalization?;
    r4:Duration length?;
    TargetFacilityEncounterDiagnosis[] diagnosis?;
    r4:CodeableConcept priority?;
    r4:Resource[] contained?;
    TargetFacilityEncounterStatusHistory[] statusHistory?;
    r4:Meta meta?;
    r4:Reference serviceProvider?;
    r4:uri implicitRules?;
    TargetFacilityEncounterLocation[] location?;
    r4:Reference[] account?;
    TargetFacilityEncounterStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterLocation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "status": {
            name: "status",
            dataType: TargetFacilityEncounterLocationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type TargetFacilityEncounterLocation record {|
    *r4:BackboneElement;
    ...
    string id?;
    TargetFacilityEncounterLocationStatus status?;
|};

# TargetFacilityEncounterLocationStatus enum
public enum TargetFacilityEncounterLocationStatus {
...
public enum TargetFacilityEncounterStatus {
...
public enum TargetFacilityEncounterStatusHistoryStatus {
   CODE_STATUS_TRIAGED = "triaged",
   CODE_STATUS_ARRIVED = "arrived",
   CODE_STATUS_ONLEAVE = "onleave",
   CODE_STATUS_CANCELLED = "cancelled",
...
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterClassHistory",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type TargetFacilityEncounterClassHistory record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterDiagnosis",
    baseType: (),
    elements: {
        "condition": {
            name: "condition",
...
public type TargetFacilityEncounterDiagnosis record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterHospitalization",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type TargetFacilityEncounterHospitalization record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterParticipant",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type TargetFacilityEncounterParticipant record {|
    *r4:BackboneElement;
...
# + status - planned | arrived | triaged | in-progress | onleave | finished | cancelled +.
@r4:DataTypeDefinition {
    name: "TargetFacilityEncounterStatusHistory",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "status": {
            name: "status",
            dataType: TargetFacilityEncounterStatusHistoryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type TargetFacilityEncounterStatusHistory record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    TargetFacilityEncounterStatusHistoryStatus status;
|};
