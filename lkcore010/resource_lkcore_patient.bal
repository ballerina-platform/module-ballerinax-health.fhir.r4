...
public const string PROFILE_BASE_LKCOREPATIENT = "http://fhir.health.gov.lk/StructureDefinition/lk-core-patient-profile";
public const RESOURCE_NAME_LKCOREPATIENT = "Patient";
...
# * identifier Slicings
# 1) LKCorePatientIdentifierOther: Other Identifier Not Specified Above
#       - min = 0
#       - max = 1
#
# 2) LKCorePatientIdentifierDl: Driving License Number
#       - min = 0
#       - max = *
#
# 3) LKCorePatientIdentifierNic: National Identity Card Number
#       - min = 0
#       - max = *
#
# 4) LKCorePatientIdentifierScn: Senior Citizen Number
#       - min = 0
#       - max = *
#
# 5) LKCorePatientIdentifierPpn: Passport Number
#       - min = 0
#       - max = *
#
# 6) LKCorePatientIdentifierPhn: Personal Health Number
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://fhir.health.gov.lk/StructureDefinition/lk-core-patient-profile",
    elements: {
        "extension" : {
            name: "extension",
        ...
        "communication" : {
            name: "communication",
            dataType: LKCorePatientCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LKCorePatient record {|
    *r4:DomainResource;

    RESOURCE_NAME_LKCOREPATIENT resourceType = RESOURCE_NAME_LKCOREPATIENT;

    BaseLKCorePatientMeta meta = {
        profile : [PROFILE_BASE_LKCOREPATIENT]
    };
...
public type BaseLKCorePatientMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://fhir.health.gov.lk/StructureDefinition/lk-core-patient-profile"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
...
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierScn",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUseThree,
            min: 0,
            max: 1,
            isArray: false,
...
public type LKCorePatientIdentifierScn record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/scn";
    LKCorePatientIdentifierUseThree use?;
...
public enum LKCorePatientIdentifierUseFive {
...
public enum LKCorePatientIdentifierUseOne {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierOther",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type LKCorePatientIdentifierOther record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/other";
    LKCorePatientIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierPhn",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUseFive,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type LKCorePatientIdentifierPhn record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/phn";
    LKCorePatientIdentifierUseFive use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: LKCorePatientLinkType,
            min: 1,
            max: 1,
            isArray: false,
...
public type LKCorePatientLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    LKCorePatientLinkType 'type;
|};

# LKCorePatientContactGender enum
public enum LKCorePatientContactGender {
...
@r4:DataTypeDefinition {
    name: "LKCorePatientCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type LKCorePatientCommunication record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: LKCorePatientContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type LKCorePatientContact record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:Address address?;
    LKCorePatientContactGender gender?;
    r4:Extension[] modifierExtension?;
...
public enum LKCorePatientIdentifierUseThree {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierPpn",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUseFour,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type LKCorePatientIdentifierPpn record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/ppn";
    LKCorePatientIdentifierUseFour use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierNic",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUseTwo,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type LKCorePatientIdentifierNic record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/nic";
    LKCorePatientIdentifierUseTwo use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
public enum LKCorePatientGender {
   CODE_GENDER_OTHER = "other",
   CODE_GENDER_FEMALE = "female",
   CODE_GENDER_MALE = "male",
   CODE_GENDER_UNKNOWN = "unknown"
...
public enum LKCorePatientIdentifierUseFour {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
...
public enum LKCorePatientIdentifierUse {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "LKCorePatientIdentifierDl",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: LKCorePatientIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type LKCorePatientIdentifierDl record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "https://fhir.health.gov.lk/id/dl";
    LKCorePatientIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
public enum LKCorePatientLinkType {
...
public enum LKCorePatientIdentifierUseTwo {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
