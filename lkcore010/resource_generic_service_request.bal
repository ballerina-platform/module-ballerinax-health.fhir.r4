...
public const string PROFILE_BASE_GENERICSERVICEREQUEST = "http://openhie.org/fhir/sri-lanka/StructureDefinition/generic-service-request";
public const RESOURCE_NAME_GENERICSERVICEREQUEST = "ServiceRequest";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/generic-service-request",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "priority" : {
            name: "priority",
            dataType: GenericServiceRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: GenericServiceRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: GenericServiceRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type GenericServiceRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_GENERICSERVICEREQUEST resourceType = RESOURCE_NAME_GENERICSERVICEREQUEST;
    ...
    GenericServiceRequestPriority priority?;
    GenericServiceRequestIntent intent;
    ...
    GenericServiceRequestStatus status;
    r4:Element ...;
|};

# GenericServiceRequestPriority enum
public enum GenericServiceRequestPriority {
...
public enum GenericServiceRequestStatus {
...
public enum GenericServiceRequestIntent {
