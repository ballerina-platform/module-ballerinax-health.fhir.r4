...
public const string PROFILE_BASE_IMAGINGTASK = "http://openhie.org/fhir/sri-lanka/StructureDefinition/imaging-task";
public const RESOURCE_NAME_IMAGINGTASK = "Task";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/imaging-task",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "restriction" : {
            name: "restriction",
            dataType: ImagingTaskRestriction,
            min: 0,
            max: 1,
            isArray: false,
...
public type ImagingTask record {|
    *r4:DomainResource;

    RESOURCE_NAME_IMAGINGTASK resourceType = RESOURCE_NAME_IMAGINGTASK;
    ...
    ImagingTaskPriority priority?;
    ImagingTaskIntent intent;
    r4:CodeableConcept[] performerType?;
    ImagingTaskInput[] input?;
    r4:Resource[] contained?;
    r4:Meta meta?;
    ImagingTaskRestriction restriction?;
    r4:uri implicitRules?;
    r4:Reference location;
    r4:dateTime lastModified?;
    r4:Identifier groupIdentifier?;
    ImagingTaskStatus status;
    r4:Element ...;
|};

# ImagingTaskPriority enum
public enum ImagingTaskPriority {
...
public type ImagingTaskInput record {|
    *r4:BackboneElement;
...
public type ImagingTaskRestriction record {|
    *r4:BackboneElement;
...
public type ImagingTaskOutput record {|
    *r4:BackboneElement;
