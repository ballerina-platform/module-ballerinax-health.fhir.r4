...
public const string PROFILE_BASE_RISKBEHAVIOURPHYSICALACTIVITY = "http://openhie.org/fhir/sri-lanka/StructureDefinition/risk-behaviour-physical-activity";
public const RESOURCE_NAME_RISKBEHAVIOURPHYSICALACTIVITY = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: RiskBehaviourPhysicalActivityCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueCodeableConcept" : {
            ...
            valueSet: "http://openhie.org/fhir/sri-lanka/ValueSet/vs-risk-behaviour-physical-activity"
        },
        "specimen" : {
            name: "specimen",
            dataType: r4:Reference,
        ...
        "component" : {
            name: "component",
            dataType: RiskBehaviourPhysicalActivityComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: RiskBehaviourPhysicalActivityReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: RiskBehaviourPhysicalActivityStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type RiskBehaviourPhysicalActivity record {|
    *r4:DomainResource;

    RESOURCE_NAME_RISKBEHAVIOURPHYSICALACTIVITY resourceType = RESOURCE_NAME_RISKBEHAVIOURPHYSICALACTIVITY;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    RiskBehaviourPhysicalActivityCode code;
    ...
    RiskBehaviourPhysicalActivityComponent[] component?;
    r4:Resource[] contained?;
    RiskBehaviourPhysicalActivityReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    RiskBehaviourPhysicalActivityStatus status;
    r4:Element ...;
|};

# RiskBehaviourPhysicalActivityStatus enum
public enum RiskBehaviourPhysicalActivityStatus {
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourPhysicalActivityCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: RiskBehaviourPhysicalActivityCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type RiskBehaviourPhysicalActivityCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    RiskBehaviourPhysicalActivityCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourPhysicalActivityComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type RiskBehaviourPhysicalActivityComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourPhysicalActivityReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type RiskBehaviourPhysicalActivityReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "RiskBehaviourPhysicalActivityCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type RiskBehaviourPhysicalActivityCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "106020009";
|};
