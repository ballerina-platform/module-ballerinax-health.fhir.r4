...
public const string PROFILE_BASE_HIMSCOMPOSITION = "http://openhie.org/fhir/sri-lanka/StructureDefinition/hims-composition";
public const RESOURCE_NAME_HIMSCOMPOSITION = "Composition";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/hims-composition",
    elements: {
        "date" : {
            name: "date",
        ...
        "section" : {
            name: "section",
            dataType: HIMSCompositionSection,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "attester" : {
            name: "attester",
            dataType: HIMSCompositionAttester,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relatesTo" : {
            name: "relatesTo",
            dataType: HIMSCompositionRelatesTo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: HIMSCompositionStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type HIMSComposition record {|
    *r4:DomainResource;

    RESOURCE_NAME_HIMSCOMPOSITION resourceType = RESOURCE_NAME_HIMSCOMPOSITION;
    ...
    HIMSCompositionSection[] section;
    r4:Reference encounter;
    string title;
    r4:CodeableConcept 'type;
    HIMSCompositionAttester[] attester?;
    ...
    HIMSCompositionEvent[] event?;
    HIMSCompositionRelatesTo[] relatesTo?;
    HIMSCompositionStatus status;
    r4:Element ...;
|};

# HIMSCompositionAttesterMode enum
public enum HIMSCompositionAttesterMode {
...
public enum HIMSCompositionStatus {
...
@r4:DataTypeDefinition {
    name: "HIMSCompositionAttester",
    baseType: (),
    elements: {
        "mode": {
            name: "mode",
            dataType: HIMSCompositionAttesterMode,
            min: 1,
            max: 1,
            isArray: false,
...
public type HIMSCompositionAttester record {|
    *r4:BackboneElement;

    HIMSCompositionAttesterMode mode;
    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:dateTime time?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "code": {
            name: "code",
            dataType: HIMSCompositionRelatesToCode,
            min: 1,
            max: 1,
            isArray: false,
...
public type HIMSCompositionRelatesTo record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Identifier targetIdentifier;
    HIMSCompositionRelatesToCode code;
    r4:Extension[] modifierExtension?;
    string id?;
...
public enum HIMSCompositionSectionMode {
...
public type HIMSCompositionEvent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HIMSCompositionSection",
    baseType: (),
    elements: {
        "mode": {
            name: "mode",
            dataType: HIMSCompositionSectionMode,
            min: 0,
            max: 1,
            isArray: false,
...
public type HIMSCompositionSection record {|
    *r4:BackboneElement;

    HIMSCompositionSectionMode mode?;
    r4:Reference[] entry?;
    r4:Extension[] extension?;
    r4:CodeableConcept code?;
...
public enum HIMSCompositionRelatesToCode {
