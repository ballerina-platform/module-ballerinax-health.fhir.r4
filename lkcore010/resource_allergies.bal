...
public const string PROFILE_BASE_ALLERGIES = "http://openhie.org/fhir/sri-lanka/StructureDefinition/allergy-intolerance";
public const RESOURCE_NAME_ALLERGIES = "AllergyIntolerance";
...
# + code - reason(s) why this should be supported.
...
# + clinicalStatus - reason(s) why this should be supported.
# + onsetDateTime - reason(s) why this should be supported.
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/allergy-intolerance",
    elements: {
        "note" : {
            name: "note",
        ...
        "code" : {
            name: "code",
            dataType: AllergiesCode,
            min: 0,
            max: 1,
            isArray: false,
            path: "AllergyIntolerance.code",
            valueSet: "http://openhie.org/fhir/sri-lanka/ValueSet/vs-allergies"
        },
        "onsetRange" : {
            name: "onsetRange",
            dataType: r4:Range,
...
public type Allergies record {|
    *r4:DomainResource;

    RESOURCE_NAME_ALLERGIES resourceType = RESOURCE_NAME_ALLERGIES;
    ...
    AllergiesCriticality criticality?;
    r4:code language?;
...
public type AllergiesCode record {|
    *r4:CodeableConcept;
...
public enum AllergiesReactionSeverity {
...
public enum AllergiesCriticality {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "severity": {
            name: "severity",
            dataType: AllergiesReactionSeverity,
            min: 0,
            max: 1,
            isArray: false,
...
public type AllergiesReaction record {|
    *r4:BackboneElement;

    AllergiesReactionSeverity severity?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    @constraint:Array {
       minLength: 1
