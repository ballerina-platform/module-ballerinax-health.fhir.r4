...
public const string PROFILE_BASE_INVESTIGATIONSSERVICEREQUEST = "http://openhie.org/fhir/sri-lanka/StructureDefinition/investigations-request";
public const RESOURCE_NAME_INVESTIGATIONSSERVICEREQUEST = "ServiceRequest";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/investigations-request",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "code" : {
            ...
            valueSet: "http://openhie.org/fhir/sri-lanka/ValueSet/vs-investigation"
        },
        "requisition" : {
            name: "requisition",
        ...
        "priority" : {
            name: "priority",
            dataType: InvestigationsServiceRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: InvestigationsServiceRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: InvestigationsServiceRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type InvestigationsServiceRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_INVESTIGATIONSSERVICEREQUEST resourceType = RESOURCE_NAME_INVESTIGATIONSSERVICEREQUEST;
    ...
    InvestigationsServiceRequestPriority priority?;
    InvestigationsServiceRequestIntent intent;
    ...
    InvestigationsServiceRequestStatus status;
    r4:Element ...;
|};

# InvestigationsServiceRequestPriority enum
public enum InvestigationsServiceRequestPriority {
...
public enum InvestigationsServiceRequestIntent {
...
public enum InvestigationsServiceRequestStatus {
