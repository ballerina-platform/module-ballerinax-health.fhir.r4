...
public const string PROFILE_BASE_LKCOREALLERGYINTOLERANCE = "http://fhir.health.gov.lk/StructureDefinition/lk-core-allergy-intolerance";
public const RESOURCE_NAME_LKCOREALLERGYINTOLERANCE = "AllergyIntolerance";
...
@r4:ResourceDefinition {
    ...
    profile: "http://fhir.health.gov.lk/StructureDefinition/lk-core-allergy-intolerance",
    elements: {
        "note" : {
            name: "note",
        ...
        "code" : {
            ...
            valueSet: "http://fhir.health.gov.lk/ValueSet/lk-core-allergy-intolerance-code-vs"
        },
        "onsetRange" : {
            name: "onsetRange",
            dataType: r4:Range,
        ...
        "criticality" : {
            name: "criticality",
            dataType: LKCoreAllergyIntoleranceCriticality,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type" : {
            name: "type",
            dataType: LKCoreAllergyIntoleranceType,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "reaction" : {
            name: "reaction",
            dataType: LKCoreAllergyIntoleranceReaction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "category" : {
            name: "category",
            dataType: LKCoreAllergyIntoleranceCategory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LKCoreAllergyIntolerance record {|
    *r4:DomainResource;

    RESOURCE_NAME_LKCOREALLERGYINTOLERANCE resourceType = RESOURCE_NAME_LKCOREALLERGYINTOLERANCE;

    BaseLKCoreAllergyIntoleranceMeta meta = {
        profile : [PROFILE_BASE_LKCOREALLERGYINTOLERANCE]
    };
    r4:Annotation[] note?;
...
public type BaseLKCoreAllergyIntoleranceMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://fhir.health.gov.lk/StructureDefinition/lk-core-allergy-intolerance"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};

# LKCoreAllergyIntoleranceType enum
public enum LKCoreAllergyIntoleranceType {
   CODE_TYPE_INTOLERANCE = "intolerance",
   CODE_TYPE_ALLERGY = "allergy"
}

# LKCoreAllergyIntoleranceReactionSeverity enum
public enum LKCoreAllergyIntoleranceReactionSeverity {
...
public enum LKCoreAllergyIntoleranceCategory {
...
public enum LKCoreAllergyIntoleranceCriticality {
...
@r4:DataTypeDefinition {
    name: "LKCoreAllergyIntoleranceReaction",
    baseType: (),
    elements: {
        "severity": {
            name: "severity",
            dataType: LKCoreAllergyIntoleranceReactionSeverity,
            min: 0,
            max: 1,
            isArray: false,
...
public type LKCoreAllergyIntoleranceReaction record {|
    *r4:BackboneElement;

    LKCoreAllergyIntoleranceReactionSeverity severity?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    @constraint:Array {
       minLength: 1
