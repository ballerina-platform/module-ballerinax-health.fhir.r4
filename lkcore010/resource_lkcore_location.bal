...
public const string PROFILE_BASE_LKCORELOCATION = "http://fhir.health.gov.lk/StructureDefinition/lk-core-location";
public const RESOURCE_NAME_LKCORELOCATION = "Location";
...
@r4:ResourceDefinition {
    ...
    profile: "http://fhir.health.gov.lk/StructureDefinition/lk-core-location",
    elements: {
        "operationalStatus" : {
        ...
        "hoursOfOperation" : {
            ...
            dataType: LKCoreLocationHoursOfOperation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "position" : {
            name: "position",
            dataType: LKCoreLocationPosition,
            min: 0,
            max: 1,
            isArray: false,
...
public type LKCoreLocation record {|
    *r4:DomainResource;

    RESOURCE_NAME_LKCORELOCATION resourceType = RESOURCE_NAME_LKCORELOCATION;

    BaseLKCoreLocationMeta meta = {
        profile : [PROFILE_BASE_LKCORELOCATION]
    };
...
public type BaseLKCoreLocationMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://fhir.health.gov.lk/StructureDefinition/lk-core-location"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
...
@r4:DataTypeDefinition {
    name: "LKCoreLocationHoursOfOperation",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: LKCoreLocationHoursOfOperationDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LKCoreLocationHoursOfOperation record {|
    *r4:BackboneElement;
    ...
    r4:time openingTime?;
    string id?;
    LKCoreLocationHoursOfOperationDaysOfWeek[] daysOfWeek?;
|};

# LKCoreLocationMode enum
public enum LKCoreLocationMode {
...
public type LKCoreLocationPosition record {|
    *r4:BackboneElement;
...
public enum LKCoreLocationHoursOfOperationDaysOfWeek {
...
public enum LKCoreLocationStatus {
