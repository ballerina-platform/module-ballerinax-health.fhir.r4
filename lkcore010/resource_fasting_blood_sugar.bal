...
public const string PROFILE_BASE_FASTINGBLOODSUGAR = "http://openhie.org/fhir/sri-lanka/StructureDefinition/fasting-blood-sugar";
public const RESOURCE_NAME_FASTINGBLOODSUGAR = "Observation";
...
# + referenceRange - reason(s) why this should be supported.
...
# + interpretation - reason(s) why this should be supported.
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: FastingBloodSugarCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: FastingBloodSugarValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "component" : {
            name: "component",
            dataType: FastingBloodSugarComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: FastingBloodSugarReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: FastingBloodSugarStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type FastingBloodSugar record {|
    *r4:DomainResource;

    RESOURCE_NAME_FASTINGBLOODSUGAR resourceType = RESOURCE_NAME_FASTINGBLOODSUGAR;
    ...
    FastingBloodSugarValue valueQuantity?;
    ...
    FastingBloodSugarComponent[] component?;
    r4:Resource[] contained?;
    FastingBloodSugarReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    FastingBloodSugarStatus status;
    r4:Element ...;
|};

# FastingBloodSugarStatus enum
public enum FastingBloodSugarStatus {
...
@r4:DataTypeDefinition {
    name: "FastingBloodSugarValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: FastingBloodSugarValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type FastingBloodSugarValue record {|
    *r4:Quantity;

    FastingBloodSugarValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
@r4:DataTypeDefinition {
    name: "FastingBloodSugarCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type FastingBloodSugarCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "76629-5";
|};
...
@r4:DataTypeDefinition {
    name: "FastingBloodSugarCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: FastingBloodSugarCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FastingBloodSugarCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    FastingBloodSugarCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "FastingBloodSugarComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type FastingBloodSugarComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "FastingBloodSugarReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type FastingBloodSugarReferenceRange record {|
    *r4:BackboneElement;
...
public enum FastingBloodSugarValueComparator {
