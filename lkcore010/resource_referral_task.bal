...
public const string PROFILE_BASE_REFERRALTASK = "http://openhie.org/fhir/sri-lanka/StructureDefinition/referral-task";
public const RESOURCE_NAME_REFERRALTASK = "Task";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/referral-task",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "restriction" : {
            name: "restriction",
            dataType: ReferralTaskRestriction,
            min: 0,
            max: 1,
            isArray: false,
...
public type ReferralTask record {|
    *r4:DomainResource;

    RESOURCE_NAME_REFERRALTASK resourceType = RESOURCE_NAME_REFERRALTASK;
    ...
    ReferralTaskPriority priority?;
    ReferralTaskIntent intent;
    r4:CodeableConcept[] performerType?;
    ReferralTaskInput[] input?;
    r4:Resource[] contained?;
    r4:Meta meta?;
    ReferralTaskRestriction restriction?;
    r4:uri implicitRules?;
    r4:Reference location;
    r4:dateTime lastModified?;
    r4:Identifier groupIdentifier?;
    ReferralTaskStatus status;
    r4:Element ...;
|};
...
public type ReferralTaskInput record {|
    *r4:BackboneElement;
...
public enum ReferralTaskStatus {
...
public type ReferralTaskOutput record {|
    *r4:BackboneElement;
...
public type ReferralTaskRestriction record {|
    *r4:BackboneElement;
...
public enum ReferralTaskIntent {
...
public enum ReferralTaskPriority {
