...
public const string PROFILE_BASE_GENERALPRACTITIONER = "http://openhie.org/fhir/sri-lanka/StructureDefinition/practitioner";
public const RESOURCE_NAME_GENERALPRACTITIONER = "Practitioner";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "gender" : {
            name: "gender",
            dataType: GeneralPractitionerGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "qualification" : {
            name: "qualification",
            dataType: GeneralPractitionerQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "name" : {
            name: "name",
            dataType: GeneralPractitionerName,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type GeneralPractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_GENERALPRACTITIONER resourceType = RESOURCE_NAME_GENERALPRACTITIONER;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Address[] address?;
    GeneralPractitionerGender gender?;
    r4:Extension[] modifierExtension?;
    boolean active?;
    r4:Attachment[] photo?;
    r4:code language?;
    r4:date birthDate?;
    GeneralPractitionerQualification[] qualification?;
    r4:Resource[] contained?;
    r4:Meta meta?;
    @constraint:Array {
       minLength: 1
    }
    GeneralPractitionerName[] name;
...
public enum GeneralPractitionerGender {
...
@r4:DataTypeDefinition {
    name: "GeneralPractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type GeneralPractitionerQualification record {|
    *r4:BackboneElement;
...
public enum GeneralPractitionerNameUse {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: GeneralPractitionerNameUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type GeneralPractitionerName record {|
    *r4:HumanName;
    ...
    r4:Period period?;
    string[] prefix?;
    GeneralPractitionerNameUse use?;
    string id?;
    string text?;
    string family;
    string[] suffix?;
