...
public const string PROFILE_BASE_BLOODPRESSURE = "http://openhie.org/fhir/sri-lanka/StructureDefinition/blood-pressure";
public const RESOURCE_NAME_BLOODPRESSURE = "Observation";
...
# * component Slicings
# 1) BloodPressureComponentDiastolic: Component results
#       - min = 0
#       - max = 1
#
# 2) BloodPressureComponentSystolic: Component results
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: BloodPressureComponent,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: BloodPressureReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "category" : {
            name: "category",
            dataType: BloodPressureCategory,
            min: 1,
            max: 1,
            isArray: false,
...
public type BloodPressure record {|
    *r4:DomainResource;
    ...
    RESOURCE_NAME_BLOODPRESSURE resourceType = RESOURCE_NAME_BLOODPRESSURE;
    ...
    BloodPressureComponent[] component;
    r4:Resource[] contained?;
    BloodPressureReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "coding": {
            name: "coding",
            dataType: BloodPressureCategoryCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BloodPressureCategory record {|
    *r4:CodeableConcept;

    BloodPressureCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
#
@r4:DataTypeDefinition {
    name: "BloodPressureComponentValueValueValue",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type BloodPressureComponentValueValueValue record {|
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "BloodPressureComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BloodPressureComponentCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BloodPressureComponentCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    BloodPressureComponentCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "BloodPressureReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BloodPressureReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BloodPressureCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BloodPressureCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "BloodPressureComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: BloodPressureComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "value": {
            name: "value",
            dataType: BloodPressureComponentValueValueValue,
            min: 1,
            max: 1,
            isArray: false,
...
public type BloodPressureComponentValue record {|
    *r4:Quantity;

    BloodPressureComponentValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "BloodPressureComponentDiastolic",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: BloodPressureComponentCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: BloodPressureComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "The information determined as a result of making the observation, if the information has a simple value.",
...
public type BloodPressureComponentDiastolic record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] extension?;
    r4:time valueTime?;
    BloodPressureComponentCode code;
    r4:Range valueRange?;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept valueCodeableConcept?;
    r4:Ratio valueRatio?;
    ...
    string id?;
    r4:integer valueInteger?;
    BloodPressureComponentValue valueQuantity?;
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "BloodPressureComponentSystolic",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: BloodPressureComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type BloodPressureComponentSystolic record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] extension?;
    r4:time valueTime?;
    BloodPressureComponentCodeOne code;
    r4:Range valueRange?;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept valueCodeableConcept?;
    r4:Ratio valueRatio?;
...
public type BloodPressureCodeCoding record {|
    *r4:Coding;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "BloodPressureCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BloodPressureCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BloodPressureCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    BloodPressureCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "BloodPressureComponentCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type BloodPressureComponentCodeCoding record {|
    *r4:Coding;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "BloodPressureComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BloodPressureComponentCodeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BloodPressureComponentCodeOne record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    BloodPressureComponentCodeCodingOne[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public type BloodPressureComponent record {|
    *r4:BackboneElement;
...
public enum BloodPressureComponentValueComparator {
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "BloodPressureComponentCodeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type BloodPressureComponentCodeCodingOne record {|
    *r4:Coding;
