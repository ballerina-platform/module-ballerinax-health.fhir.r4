...
public const string PROFILE_BASE_GENERICOBSERVATION = "http://openhie.org/fhir/sri-lanka/StructureDefinition/generic-observation";
public const RESOURCE_NAME_GENERICOBSERVATION = "Observation";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/generic-observation",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "component" : {
            name: "component",
            dataType: GenericObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: GenericObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: GenericObservationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type GenericObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_GENERICOBSERVATION resourceType = RESOURCE_NAME_GENERICOBSERVATION;
    ...
    GenericObservationComponent[] component?;
    r4:Resource[] contained?;
    GenericObservationReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    GenericObservationStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "GenericObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type GenericObservationReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "GenericObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type GenericObservationComponent record {|
    *r4:BackboneElement;
...
public enum GenericObservationStatus {
