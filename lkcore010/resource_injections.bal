...
public const string PROFILE_BASE_INJECTIONS = "http://openhie.org/fhir/sri-lanka/StructureDefinition/injection";
public const RESOURCE_NAME_INJECTIONS = "MedicationAdministration";
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/injection",
    elements: {
        "dosage" : {
            name: "dosage",
            dataType: InjectionsDosage,
            min: 1,
            max: 1,
            isArray: false,
...
public type Injections record {|
    *r4:DomainResource;

    RESOURCE_NAME_INJECTIONS resourceType = RESOURCE_NAME_INJECTIONS;

    InjectionsDosage dosage;
    r4:uri[] instantiates?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
...
public type InjectionsPerformer record {|
    *r4:BackboneElement;
...
public type InjectionsDosage record {|
    *r4:BackboneElement;
