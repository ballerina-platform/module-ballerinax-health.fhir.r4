...
LK Core (0.1.0) FHIR R4 profile package for Sri Lanka-specific health interoperability use cases. It provides a broad set of typed records spanning patient, clinical, referral, and public health workflows.
...
- Comprehensive profile coverage aligned with LK and Sri Lanka implementation guides
- Typed models for clinical observations, requests, tasks, encounters, and organization data
- Supports national workflow scenarios such as referrals, imaging, and notifiable disease reporting
- StructureDefinition-linked records for safer profile-compliant payloads
- JSON-focused FHIR R4 interoperability for Sri Lankan healthcare ecosystems
