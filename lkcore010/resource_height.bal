...
public const string PROFILE_BASE_HEIGHT = "http://openhie.org/fhir/sri-lanka/StructureDefinition/height";
public const RESOURCE_NAME_HEIGHT = "Observation";
...
public type Height record {|
    *r4:DomainResource;

    RESOURCE_NAME_HEIGHT resourceType = RESOURCE_NAME_HEIGHT;
    ...
    HeightComponent[] component?;
    r4:Resource[] contained?;
    HeightReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "comparator": {
            name: "comparator",
            dataType: HeightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type HeightValue record {|
    *r4:Quantity;

    HeightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
public enum HeightValueComparator {
...
public type HeightComponent record {|
    *r4:BackboneElement;
...
public type HeightReferenceRange record {|
    *r4:BackboneElement;
...
public type HeightCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    HeightCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public type HeightCategoryCoding record {|
    *r4:Coding;
...
public type HeightCodeCoding record {|
    *r4:Coding;
...
public type HeightCategory record {|
    *r4:CodeableConcept;

    HeightCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
