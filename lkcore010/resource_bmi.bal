...
public const string PROFILE_BASE_BMI = "http://openhie.org/fhir/sri-lanka/StructureDefinition/bmi";
public const RESOURCE_NAME_BMI = "Observation";
...
public type BMI record {|
    *r4:DomainResource;

    RESOURCE_NAME_BMI resourceType = RESOURCE_NAME_BMI;
    ...
    BMIComponent[] component?;
    r4:Resource[] contained?;
    BMIReferenceRange[] referenceRange?;
    string valueString?;
...
public type BMICategoryCoding record {|
    *r4:Coding;
...
public type BMICategory record {|
    *r4:CodeableConcept;

    BMICategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public type BMIReferenceRange record {|
    *r4:BackboneElement;
...
public type BMIComponent record {|
    *r4:BackboneElement;
...
public type BMICodeCoding record {|
    *r4:Coding;
...
public type BMIValue record {|
    *r4:Quantity;

    BMIValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
public type BMICode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    BMICodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum BMIValueComparator {
