...
public const string PROFILE_BASE_LKCOREORGANIZATION = "http://fhir.health.gov.lk/StructureDefinition/lk-core-organization";
public const RESOURCE_NAME_LKCOREORGANIZATION = "Organization";
...
# * extension Slicings
# 1) Extension: LK Core Province Extension
#       - min = 0
#       - max = *
#
# 2) Extension: LK Core MOH Area Extension
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://fhir.health.gov.lk/StructureDefinition/lk-core-organization",
    elements: {
        "identifier" : {
            name: "identifier",
        ...
        "contact" : {
            name: "contact",
            dataType: LKCoreOrganizationContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LKCoreOrganization record {|
    *r4:DomainResource;

    RESOURCE_NAME_LKCOREORGANIZATION resourceType = RESOURCE_NAME_LKCOREORGANIZATION;

    BaseLKCoreOrganizationMeta meta = {
        profile : [PROFILE_BASE_LKCOREORGANIZATION]
    };
...
public type BaseLKCoreOrganizationMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://fhir.health.gov.lk/StructureDefinition/lk-core-organization"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
...
@r4:DataTypeDefinition {
    name: "LKCoreOrganizationContact",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type LKCoreOrganizationContact record {|
    *r4:BackboneElement;
