...
public const string PROFILE_BASE_PROVIDERSLOCATION = "http://openhie.org/fhir/sri-lanka/StructureDefinition/providers-location";
public const RESOURCE_NAME_PROVIDERSLOCATION = "Location";
...
# + identifier - reason(s) why this should be supported.
# * identifier Slicings
# 1) ProvidersLocationIdentifierLocationID: Unique code or number identifying the location to its users
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/providers-location",
    elements: {
        "operationalStatus" : {
        ...
        "hoursOfOperation" : {
            ...
            dataType: ProvidersLocationHoursOfOperation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "mode" : {
            name: "mode",
            dataType: ProvidersLocationMode,
            min: 0,
            max: 1,
            isArray: false,
            path: "Location.mode",
        ...
        "position" : {
            name: "position",
            dataType: ProvidersLocationPosition,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: ProvidersLocationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ProvidersLocation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PROVIDERSLOCATION resourceType = RESOURCE_NAME_PROVIDERSLOCATION;
    ...
    string description?;
    ProvidersLocationHoursOfOperation[] hoursOfOperation?;
    r4:code language?;
    r4:CodeableConcept[] 'type?;
    ProvidersLocationMode mode?;
    ...
    ProvidersLocationPosition position?;
    string availabilityExceptions?;
    ProvidersLocationStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ProvidersLocationIdentifierLocationID",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: ProvidersLocationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type ProvidersLocationIdentifierLocationID record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system;
    ProvidersLocationIdentifierUse use?;
...
@r4:DataTypeDefinition {
    name: "ProvidersLocationPosition",
    baseType: (),
    elements: {
        "altitude": {
            name: "altitude",
...
public type ProvidersLocationPosition record {|
    *r4:BackboneElement;
...
public enum ProvidersLocationIdentifierUse {
...
public enum ProvidersLocationStatus {
...
public enum ProvidersLocationMode {
   CODE_MODE_INSTANCE = "instance",
   CODE_MODE_KIND = "kind"
}

# ProvidersLocationHoursOfOperationDaysOfWeek enum
public enum ProvidersLocationHoursOfOperationDaysOfWeek {
...
@r4:DataTypeDefinition {
    name: "ProvidersLocationHoursOfOperation",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: ProvidersLocationHoursOfOperationDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ProvidersLocationHoursOfOperation record {|
    *r4:BackboneElement;
    ...
    r4:time openingTime?;
    string id?;
    ProvidersLocationHoursOfOperationDaysOfWeek[] daysOfWeek?;
|};
