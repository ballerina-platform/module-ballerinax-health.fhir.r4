...
public const string PROFILE_BASE_LKCOREPRACTITIONER = "http://fhir.health.gov.lk/StructureDefinition/lk-core-practitioner";
public const RESOURCE_NAME_LKCOREPRACTITIONER = "Practitioner";
...
@r4:ResourceDefinition {
    ...
    profile: "http://fhir.health.gov.lk/StructureDefinition/lk-core-practitioner",
    elements: {
        "identifier" : {
            name: "identifier",
        ...
        "gender" : {
            name: "gender",
            dataType: LKCorePractitionerGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "qualification" : {
            name: "qualification",
            dataType: LKCorePractitionerQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LKCorePractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_LKCOREPRACTITIONER resourceType = RESOURCE_NAME_LKCOREPRACTITIONER;

    BaseLKCorePractitionerMeta meta = {
        profile : [PROFILE_BASE_LKCOREPRACTITIONER]
    };
...
public type BaseLKCorePractitionerMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://fhir.health.gov.lk/StructureDefinition/lk-core-practitioner"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
...
@r4:DataTypeDefinition {
    name: "LKCorePractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type LKCorePractitionerQualification record {|
    *r4:BackboneElement;
...
public enum LKCorePractitionerGender {
