...
public const string PROFILE_BASE_RANDOMBLOODSUGAR = "http://openhie.org/fhir/sri-lanka/StructureDefinition/random-blood-sugar";
public const RESOURCE_NAME_RANDOMBLOODSUGAR = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: RandomBloodSugarValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "component" : {
            name: "component",
            dataType: RandomBloodSugarComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: RandomBloodSugarReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: RandomBloodSugarStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type RandomBloodSugar record {|
    *r4:DomainResource;

    RESOURCE_NAME_RANDOMBLOODSUGAR resourceType = RESOURCE_NAME_RANDOMBLOODSUGAR;
    ...
    RandomBloodSugarValue valueQuantity?;
    ...
    RandomBloodSugarComponent[] component?;
    r4:Resource[] contained?;
    RandomBloodSugarReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    name: "RandomBloodSugarValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: RandomBloodSugarValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type RandomBloodSugarValue record {|
    *r4:Quantity;

    RandomBloodSugarValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "RandomBloodSugarComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type RandomBloodSugarComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "RandomBloodSugarCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: RandomBloodSugarCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type RandomBloodSugarCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    RandomBloodSugarCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "RandomBloodSugarCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type RandomBloodSugarCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "15074-8";
|};
...
@r4:DataTypeDefinition {
    name: "RandomBloodSugarReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type RandomBloodSugarReferenceRange record {|
    *r4:BackboneElement;
...
public enum RandomBloodSugarValueComparator {
...
public enum RandomBloodSugarStatus {
