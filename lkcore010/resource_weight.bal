...
public const string PROFILE_BASE_WEIGHT = "http://openhie.org/fhir/sri-lanka/StructureDefinition/weight";
public const RESOURCE_NAME_WEIGHT = "Observation";
...
public type Weight record {|
    *r4:DomainResource;
    ...
    RESOURCE_NAME_WEIGHT resourceType = RESOURCE_NAME_WEIGHT;
    ...
    WeightReferenceRange[] referenceRange?;
    string valueString?;
...
public type WeightCategoryCoding record {|
    *r4:Coding;
...
public type WeightCodeCoding record {|
    *r4:Coding;
...
public type WeightCategory record {|
    *r4:CodeableConcept;

    WeightCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum WeightValueComparator {
...
public type WeightReferenceRange record {|
    *r4:BackboneElement;
...
public type WeightCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    WeightCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "comparator": {
            name: "comparator",
            dataType: WeightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type WeightValue record {|
    *r4:Quantity;

    WeightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
public type WeightComponent record {|
    *r4:BackboneElement;
