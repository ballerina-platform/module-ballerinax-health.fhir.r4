...
public const string PROFILE_BASE_PROCEDURES = "http://openhie.org/fhir/sri-lanka/StructureDefinition/procedure";
public const RESOURCE_NAME_PROCEDURES = "Procedure";
...
# + basedOn - reason(s) why this should be supported.
...
@r4:ResourceDefinition {
    ...
    profile: "http://openhie.org/fhir/sri-lanka/StructureDefinition/procedure",
    elements: {
        "note" : {
            name: "note",
        ...
        "code" : {
            ...
            isArray: false,
            path: "Procedure.code",
            valueSet: "http://openhie.org/fhir/sri-lanka/ValueSet/vs-procedure"
        },
        "subject" : {
            name: "subject",
            dataType: r4:Reference,
        ...
        "focalDevice" : {
            name: "focalDevice",
            dataType: ProceduresFocalDevice,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Procedures record {|
    *r4:DomainResource;

    RESOURCE_NAME_PROCEDURES resourceType = RESOURCE_NAME_PROCEDURES;
    ...
    ProceduresPerformer[] performer;
    r4:Reference[] usedReference?;
    ProceduresFocalDevice[] focalDevice?;
...
public type ProceduresPerformer record {|
    *r4:BackboneElement;
...
public type ProceduresFocalDevice record {|
    *r4:BackboneElement;
