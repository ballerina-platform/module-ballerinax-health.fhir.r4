...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-visionprescription",
    elements: {
    "prescriber" : {
            name: "prescriber",
    ...
    "lensSpecification" : {
            ...
            dataType: CRDVisionPrescriptionLensSpecification,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "status" : {
            name: "status",
            dataType: CRDVisionPrescriptionStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDVisionPrescription record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDVISIONPRESCRIPTION resourceType = RESOURCE_NAME_CRDVISIONPRESCRIPTION;
...
string id?;
r4:Narrative text?;
CRDVisionPrescriptionStatus status;
    r4:Element ...;
|};

# CRDVisionPrescriptionLensSpecificationEye enum
public enum CRDVisionPrescriptionLensSpecificationEye {
   CODE_EYE_LEFT = "left",
...
public enum CRDVisionPrescriptionLensSpecificationPrismBase {
   CODE_BASE_IN = "in",
...
@r4:DataTypeDefinition {
    name: "CRDVisionPrescriptionLensSpecification",
    baseType: (),
    elements: {
    "add": {
            name: "add",
    ...
    "eye": {
            name: "eye",
            dataType: CRDVisionPrescriptionLensSpecificationEye,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "prism": {
            name: "prism",
            dataType: CRDVisionPrescriptionLensSpecificationPrism,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDVisionPrescriptionLensSpecification record {|
    *r4:BackboneElement;
...
CRDVisionPrescriptionLensSpecificationEye eye;
decimal diameter?;
decimal sphere?;
decimal cylinder?;
string id?;
decimal power?;
string brand?;
CRDVisionPrescriptionLensSpecificationPrism   [] prism?;
|};

# CRDVisionPrescriptionStatus enum
public enum CRDVisionPrescriptionStatus {
...
@r4:DataTypeDefinition {
    name: "CRDVisionPrescriptionLensSpecificationPrism",
    baseType: (),
    elements: {
    "amount": {
            name: "amount",
    ...
    "base": {
            name: "base",
            dataType: CRDVisionPrescriptionLensSpecificationPrismBase,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDVisionPrescriptionLensSpecificationPrism record {|
    *r4:BackboneElement;
...
r4:Extension   [] modifierExtension?;
string id?;
CRDVisionPrescriptionLensSpecificationPrismBase base;
|};
