...
# * category Slicings
# 1) CRDServiceRequestCategoryUs_core: Classification of service
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    "priority" : {
            name: "priority",
            dataType: CRDServiceRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "intent" : {
            name: "intent",
            dataType: CRDServiceRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "status" : {
            name: "status",
            dataType: CRDServiceRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDServiceRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDSERVICEREQUEST resourceType = RESOURCE_NAME_CRDSERVICEREQUEST;
...
string id?;
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.ServiceRequest.locationReference constraint. This field must be an array containing at most one item."
        }
    }
...
CRDServiceRequestPriority priority?;
CRDServiceRequestIntent intent;
...
CRDServiceRequestStatus status;
    r4:Element ...;
|};

# CRDServiceRequestStatus enum
public enum CRDServiceRequestStatus {
...
@r4:DataTypeDefinition {
    name: "CRDServiceRequestCategoryUs_core",
    baseType: (),
    elements: {
},
    serializers: {
...
public type CRDServiceRequestCategoryUs_core record {|
    *r4:CodeableConcept;

|};

# CRDServiceRequestPriority enum
public enum CRDServiceRequestPriority {
...
public enum CRDServiceRequestIntent {
