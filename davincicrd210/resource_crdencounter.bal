...
@r4:ResourceDefinition {
    ...
    "participant" : {
            name: "participant",
            dataType: CRDEncounterParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "classHistory" : {
            name: "classHistory",
            dataType: CRDEncounterClassHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "hospitalization" : {
            ...
            dataType: CRDEncounterHospitalization,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "diagnosis" : {
            name: "diagnosis",
            dataType: CRDEncounterDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "statusHistory" : {
            name: "statusHistory",
            dataType: CRDEncounterStatusHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDEncounter record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDENCOUNTER resourceType = RESOURCE_NAME_CRDENCOUNTER;
...
CRDEncounterParticipant   [] participant?;
...
r4:Period period?;
CRDEncounterClassHistory   [] classHistory?;
CRDEncounterHospitalization hospitalization?;
r4:Duration length?;
CRDEncounterDiagnosis   [] diagnosis?;
r4:CodeableConcept priority?;
r4:Resource   [] contained?;
CRDEncounterStatusHistory   [] statusHistory?;
r4:Meta meta?;
r4:Reference serviceProvider?;
r4:uri implicitRules?;
CRDEncounterLocation   [] location?;
r4:Reference   [] account?;
CRDEncounterStatus status;
    r4:Element ...;
|};
...
public type CRDEncounterClassHistory record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "CRDEncounterHospitalization",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type CRDEncounterHospitalization record {|
    *r4:BackboneElement;
...
public enum CRDEncounterLocationStatus {
...
# + status - planned | arrived | triaged | in-progress | onleave | finished | cancelled +.
@r4:DataTypeDefinition {
    name: "CRDEncounterStatusHistory",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
    ...
    "status": {
            name: "status",
            dataType: CRDEncounterStatusHistoryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDEncounterStatusHistory record {|
    *r4:BackboneElement;
...
r4:Extension   [] modifierExtension?;
string id?;
CRDEncounterStatusHistoryStatus status;
|};

# CRDEncounterIdentifierUse enum
public enum CRDEncounterIdentifierUse {
...
public type CRDEncounterParticipant record {|
    *r4:BackboneElement;
...
public enum CRDEncounterStatusHistoryStatus {
...
public type CRDEncounterDiagnosis record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    "status": {
            name: "status",
            dataType: CRDEncounterLocationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type CRDEncounterLocation record {|
    *r4:BackboneElement;
...
string id?;
CRDEncounterLocationStatus status?;
|};

# CRDEncounterStatus enum
public enum CRDEncounterStatus {
   CODE_STATUS_TRIAGED = "triaged",
