...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-appointment-with-order",
    elements: {
    "serviceType" : {
            name: "serviceType",
    ...
    "participant" : {
            name: "participant",
            dataType: CRDAppointmentWithOrderParticipant,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDAppointmentWithOrder record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDAPPOINTMENTWITHORDER resourceType = RESOURCE_NAME_CRDAPPOINTMENTWITHORDER;
...
public enum CRDAppointmentWithOrderParticipantStatus {
...
public enum CRDAppointmentWithOrderParticipantRequired {
...
@r4:DataTypeDefinition {
    name: "CRDAppointmentWithOrderParticipant",
    baseType: (),
    elements: {
    "actor": {
            name: "actor",
    ...
    "required": {
            name: "required",
            dataType: CRDAppointmentWithOrderParticipantRequired,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "status": {
            name: "status",
            dataType: CRDAppointmentWithOrderParticipantStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDAppointmentWithOrderParticipant record {|
    *r4:BackboneElement;
...
CRDAppointmentWithOrderParticipantRequired required?;
CRDAppointmentWithOrderParticipantStatus status;
|};
