...
public const string PROFILE_BASE_CRDORGANIZATION = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-organization";
public const RESOURCE_NAME_CRDORGANIZATION = "Organization";
...
# * identifier Slicings
# 1) CRDOrganizationIdentifierNPI: National Provider Identifier (NPI)
#       - min = 0
#       - max = *
#
# 2) CRDOrganizationIdentifierNAIC: NAIC Code
#       - min = 0
#       - max = *
#
# 3) CRDOrganizationIdentifierTin: Identifies this organization across multiple systems
#       - min = 0
#       - max = 1
#
# 4) CRDOrganizationIdentifierCLIA: Clinical Laboratory Improvement Amendments (CLIA) Number for laboratories
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    "contact" : {
            name: "contact",
            dataType: CRDOrganizationContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDOrganization record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDORGANIZATION resourceType = RESOURCE_NAME_CRDORGANIZATION;
...
r4:Meta meta?;
CRDOrganizationContact   [] contact?;
string name;
string   [] alias?;
...
@r4:DataTypeDefinition {
    name: "CRDOrganizationIdentifierNAIC",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDOrganizationIdentifierNAIC record {|
    *r4:Identifier;
...
public enum CRDOrganizationAddressUse {
   CODE_USE_TEMP = "temp",
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "CRDOrganizationIdentifierNPI",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDOrganizationIdentifierNPI record {|
    *r4:Identifier;
...
public enum CRDOrganizationTelecomSystem {
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "CRDOrganizationIdentifierCLIA",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDOrganizationIdentifierCLIA record {|
    *r4:Identifier;
...
public type CRDOrganizationContact record {|
    *r4:BackboneElement;
...
public enum CRDOrganizationAddressType {
...
public enum CRDOrganizationTelecomUse {
   CODE_USE_TEMP = "temp",
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "CRDOrganizationIdentifierTin",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDOrganizationIdentifierTin record {|
    *r4:Identifier;
