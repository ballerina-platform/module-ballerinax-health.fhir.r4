...
public const string PROFILE_BASE_CRDTASKDISPATCH = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-task-dispatch";
public const RESOURCE_NAME_CRDTASKDISPATCH = "Task";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-task-dispatch",
    elements: {
    "insurance" : {
            name: "insurance",
    ...
    "output" : {
            name: "output",
            dataType: CRDTaskDispatchOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        path: "Task.output"
    ...
    "priority" : {
            name: "priority",
            dataType: CRDTaskDispatchPriority,
            min: 0,
            max: 1,
            isArray: false,
        path: "Task.priority",
    ...
    "intent" : {
            name: "intent",
            dataType: CRDTaskDispatchIntent,
            min: 1,
            max: 1,
            isArray: false,
        path: "Task.intent",
    ...
    "restriction" : {
            name: "restriction",
            dataType: CRDTaskDispatchRestriction,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "status" : {
            name: "status",
            dataType: CRDTaskDispatchStatus,
            min: 1,
            max: 1,
            isArray: false,
        path: "Task.status",
...
public type CRDTaskDispatch record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDTASKDISPATCH resourceType = RESOURCE_NAME_CRDTASKDISPATCH;

r4:Reference   [] insurance?;
r4:Annotation   [] note?;
r4:Reference   [] partOf?;
r4:Extension   [] extension?;
CRDTaskDispatchCode code?;
...
CRDTaskDispatchPriority priority?;
CRDTaskDispatchIntent intent;
r4:CodeableConcept   [] performerType?;
CRDTaskDispatchInput   [] input?;
r4:Resource   [] contained?;
r4:Meta meta?;
CRDTaskDispatchRestriction restriction?;
r4:uri implicitRules?;
r4:Reference location?;
r4:dateTime lastModified?;
r4:Identifier groupIdentifier?;
CRDTaskDispatchStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "CRDTaskDispatchCode",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDTaskDispatchCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDTaskDispatchCode record {|
    *r4:CodeableConcept;

    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Task.code.coding constraint. This field must be an array containing at least one item."
        },

        maxLength: {
            value: 1,
            message: "Validation failed for $.Task.code.coding constraint. This field must be an array containing at most one item."
        }
    }
CRDTaskDispatchCodeCoding   [] coding;
|};

# CRDTaskDispatchIntent enum
public enum CRDTaskDispatchIntent {
...
public enum CRDTaskDispatchPriority {
...
@r4:DataTypeDefinition {
    name: "CRDTaskDispatchRestriction",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type CRDTaskDispatchRestriction record {|
    *r4:BackboneElement;
...
public enum CRDTaskDispatchStatus {
...
@r4:DataTypeDefinition {
    name: "CRDTaskDispatchCodeCoding",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDTaskDispatchCodeCoding record {|
    *r4:Coding;

r4:uri system = "http://hl7.org/fhir/CodeSystem/task-code";
r4:code code = "fulfill";
|};
