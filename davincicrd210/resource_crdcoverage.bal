...
public const string PROFILE_BASE_CRDCOVERAGE = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-coverage";
public const RESOURCE_NAME_CRDCOVERAGE = "Coverage";
...
# * class Slicings
# 1) CRDCoverageClassPlan: Plan
#       - min = 0
#       - max = 1
#
# 2) CRDCoverageClassGroup: Group
#       - min = 0
#       - max = 1
#
...
# * identifier Slicings
# 1) CRDCoverageIdentifierMemberid: Member ID
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    "costToBeneficiary" : {
            ...
            dataType: CRDCoverageCostToBeneficiary,
            min: 0,
            max: 0,
            isArray: true,
...
public type CRDCoverage record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDCOVERAGE resourceType = RESOURCE_NAME_CRDCOVERAGE;
...
CRDCoverageClass   [] 'class?;
string dependent?;
r4:positiveInt 'order?;
r4:Identifier   [] identifier?;
CRDCoverageCostToBeneficiary   [] costToBeneficiary?;
r4:Period period?;
...
CRDCoverageStatus status;
    r4:Element ...;
|};

# CRDCoverageIdentifierUse enum
public enum CRDCoverageIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "CRDCoverageCostToBeneficiary",
    baseType: (),
    elements: {
    "exception": {
            name: "exception",
            dataType: CRDCoverageCostToBeneficiaryException,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDCoverageCostToBeneficiary record {|
    *r4:BackboneElement;
...
public type CRDCoverageClass record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "CRDCoverageClassTypeCoding",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDCoverageClassTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "CRDCoverageCostToBeneficiaryException",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type CRDCoverageCostToBeneficiaryException record {|
    *r4:BackboneElement;
...
public type CRDCoverageClassPlan record {|
    *CRDCoverageClass;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "CRDCoverageClassTypeCodingOne",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDCoverageClassTypeCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "CRDCoverageIdentifierMemberid",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
    ...
    "use": {
            name: "use",
            dataType: CRDCoverageIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "type": {
            name: "type",
            dataType: CRDCoverageIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDCoverageIdentifierMemberid record {|
    *r4:Identifier;

r4:Extension   [] extension?;
r4:Period period?;
r4:uri system?;
CRDCoverageIdentifierUse use?;
r4:Reference assigner?;
string id?;
CRDCoverageIdentifierType 'type;
string value?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "CRDCoverageIdentifierTypeCoding",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDCoverageIdentifierTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "CRDCoverageClassTypeOne",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDCoverageClassTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDCoverageClassTypeOne record {|
    *r4:CodeableConcept;
...
CRDCoverageClassTypeCodingOne   [] coding;
|};
...
@r4:DataTypeDefinition {
    ...
    "type": {
            name: "type",
            dataType: CRDCoverageClassTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of classification for which an insurer-specific class label or number and optional name is provided, for example may be used to identify a class of coverage or employer group, Policy, Plan.",
...
public type CRDCoverageClassGroup record {|
    *CRDCoverageClass;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "CRDCoverageIdentifierType",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDCoverageIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type CRDCoverageIdentifierType record {|
    *r4:CodeableConcept;
...
CRDCoverageIdentifierTypeCoding   [] coding;
|};

# CRDCoverageStatus enum
public enum CRDCoverageStatus {
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "CRDCoverageClassType",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDCoverageClassTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type CRDCoverageClassType record {|
    *r4:CodeableConcept;
...
CRDCoverageClassTypeCoding   [] coding;
|};
