...
public const string PROFILE_BASE_CRDDEVICE = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-device";
public const RESOURCE_NAME_CRDDEVICE = "Device";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-device",
    elements: {
    "note" : {
            name: "note",
    ...
    "specialization" : {
            name: "specialization",
            dataType: CRDDeviceSpecialization,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDDevice record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDDEVICE resourceType = RESOURCE_NAME_CRDDEVICE;
...
CRDDeviceUdiCarrier   [] udiCarrier?;
r4:Meta meta?;
r4:uri implicitRules?;
CRDDeviceSpecialization   [] specialization?;
r4:Reference location?;
string modelNumber?;
string partNumber?;
CRDDeviceStatus status?;
    r4:Element ...;
|};

# CRDDeviceUdiCarrierEntryType enum
public enum CRDDeviceUdiCarrierEntryType {
...
public type CRDDeviceSpecialization record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    "type": {
            name: "type",
            dataType: CRDDeviceDeviceNameType,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDDeviceDeviceName record {|
    *r4:BackboneElement;
...
string name;
string id?;
CRDDeviceDeviceNameType 'type;
|};

# CRDDeviceDeviceNameType enum
public enum CRDDeviceDeviceNameType {
...
public type CRDDeviceVersion record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "CRDDeviceUdiCarrier",
    baseType: (),
    elements: {
    "entryType": {
            name: "entryType",
            dataType: CRDDeviceUdiCarrierEntryType,
            min: 0,
            max: 1,
            isArray: false,
...
public type CRDDeviceUdiCarrier record {|
    *r4:BackboneElement;

CRDDeviceUdiCarrierEntryType entryType?;
r4:Extension   [] extension?;
...
public type CRDDeviceProperty record {|
    *r4:BackboneElement;
