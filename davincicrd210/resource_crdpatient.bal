...
public const string PROFILE_BASE_CRDPATIENT = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-patient";
public const RESOURCE_NAME_CRDPATIENT = "Patient";
...
# * identifier Slicings
# 1) CRDPatientIdentifierMRIdentifier: An identifier for this patient
# - min = 1
# - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "communication": {
            name: "communication",
            dataType: CRDPatientCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDPatient record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDPATIENT resourceType = RESOURCE_NAME_CRDPATIENT;

    r4:Extension[] extension?;
    CRDPatientGender gender;
    r4:Extension[] modifierExtension?;
    CRDPatientLink[] link?;
    r4:code language?;
    CRDPatientContact[] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference[] generalPractitioner?;
    r4:ContactPoint[] telecom?;
    string id?;
    r4:Narrative text?;
    CRDPatientCommunication[] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: CRDPatientContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type CRDPatientContact record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:Address address?;
    CRDPatientContactGender gender?;
    r4:Extension[] modifierExtension?;
...
public enum CRDPatientTelecomUse {
    CODE_USE_TEMP = "temp",
...
@r4:DataTypeDefinition {
    name: "CRDPatientIdentifierMRIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: CRDPatientIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: CRDPatientIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDPatientIdentifierMRIdentifier record {|
    *CRDPatientIdentifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system;
    CRDPatientIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    CRDPatientIdentifierType 'type;
    string value;
|};

# CRDPatientLinkType enum
public enum CRDPatientLinkType {
...
public type CRDPatientLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    CRDPatientLinkType 'type;
|};

# CRDPatientIdentifierUse enum
public enum CRDPatientIdentifierUse {
...
public enum CRDPatientTelecomSystem {
...
public enum CRDPatientIdentifierUseOne {
    CODE_USE_SECONDARY = "secondary",
...
public enum CRDPatientAddressType {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: CRDPatientAddressType,
            min: 0,
            max: 1,
            isArray: false,
...
public type CRDPatientAddress record {|
    *r4:Address;
    ...
    string city?;
    string[] line?;
    CRDPatientAddressUse use?;
    string district?;
    string postalCode?;
    string id?;
    string state?;
    string text?;
    CRDPatientAddressType 'type?;
|};
...
@r4:DataTypeDefinition {
    name: "CRDPatientIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: CRDPatientIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDPatientIdentifierType record {|
    *r4:CodeableConcept;
    ...
    CRDPatientIdentifierTypeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: CRDPatientIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type CRDPatientIdentifier record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system;
    CRDPatientIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
...
@r4:DataTypeDefinition {
    name: "CRDPatientIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type CRDPatientIdentifierTypeCoding record {|
    *r4:Coding;
...
public enum CRDPatientContactGender {
    CODE_GENDER_OTHER = "other",
...
public type CRDPatientCommunication record {|
    *r4:BackboneElement;
