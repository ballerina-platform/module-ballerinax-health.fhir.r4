...
public const string PROFILE_BASE_CRDNUTRITIONORDER = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-nutritionorder";
public const RESOURCE_NAME_CRDNUTRITIONORDER = "NutritionOrder";

public type CRDNutritionOrderExtensions (ExtCoverageInformation|r4:Extension);
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-nutritionorder",
    elements: {
    "dateTime" : {
            name: "dateTime",
    ...
    "enteralFormula" : {
            name: "enteralFormula",
            dataType: CRDNutritionOrderEnteralFormula,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "oralDiet" : {
            name: "oralDiet",
            dataType: CRDNutritionOrderOralDiet,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "intent" : {
            name: "intent",
            dataType: CRDNutritionOrderIntent,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "supplement" : {
            name: "supplement",
            dataType: CRDNutritionOrderSupplement,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "status" : {
            name: "status",
            dataType: CRDNutritionOrderStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDNutritionOrder record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDNUTRITIONORDER resourceType = RESOURCE_NAME_CRDNUTRITIONORDER;
...
CRDNutritionOrderEnteralFormula enteralFormula?;
CRDNutritionOrderOralDiet oralDiet?;
r4:CodeableConcept   [] excludeFoodModifier?;
r4:Reference encounter?;
r4:canonical   [] instantiatesCanonical?;
CRDNutritionOrderIntent intent;
r4:Resource   [] contained?;
r4:Meta meta?;
CRDNutritionOrderSupplement   [] supplement?;
r4:Reference orderer;
r4:uri implicitRules?;
r4:Reference   [] allergyIntolerance?;
CRDNutritionOrderStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderEnteralFormulaAdministration",
    baseType: (),
    elements: {
    "schedule": {
            name: "schedule",
...
public type CRDNutritionOrderEnteralFormulaAdministration record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderEnteralFormula",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
    ...
    "administration": {
            name: "administration",
            dataType: CRDNutritionOrderEnteralFormulaAdministration,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDNutritionOrderEnteralFormula record {|
    *r4:BackboneElement;
...
CRDNutritionOrderEnteralFormulaAdministration   [] administration?;
...
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderOralDiet",
    baseType: (),
    elements: {
    "schedule": {
            name: "schedule",
    ...
    "nutrient": {
            name: "nutrient",
            dataType: CRDNutritionOrderOralDietNutrient,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "texture": {
            name: "texture",
            dataType: CRDNutritionOrderOralDietTexture,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDNutritionOrderOralDiet record {|
    *r4:BackboneElement;

r4:Timing   [] schedule?;
r4:Extension   [] extension?;
CRDNutritionOrderOralDietNutrient   [] nutrient?;
string instruction?;
CRDNutritionOrderOralDietTexture   [] texture?;
r4:Extension   [] modifierExtension?;
...
public enum CRDNutritionOrderStatus {
...
public enum CRDNutritionOrderIntent {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderOralDietTexture",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type CRDNutritionOrderOralDietTexture record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderOralDietNutrient",
    baseType: (),
    elements: {
    "amount": {
            name: "amount",
...
public type CRDNutritionOrderOralDietNutrient record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "CRDNutritionOrderSupplement",
    baseType: (),
    elements: {
    "schedule": {
            name: "schedule",
...
public type CRDNutritionOrderSupplement record {|
    *r4:BackboneElement;
