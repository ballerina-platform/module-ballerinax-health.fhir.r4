...
public const string PROFILE_BASE_CRDTASKQUESTIONNAIRE = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-taskquestionnaire";
public const RESOURCE_NAME_CRDTASKQUESTIONNAIRE = "Task";
...
# * output Slicings
# 1) CRDTaskQuestionnaireOutputResponse: Information produced as part of task
#       - min = 0
#       - max = 1
#
...
# * input Slicings
# 1) CRDTaskQuestionnaireInputQuestionnaire: Information used to perform task
#       - min = 0
#       - max = 1
#
# 2) CRDTaskQuestionnaireInputAfterCompletion: Information used to perform task
#       - min = 1
#       - max = *
#
# 3) CRDTaskQuestionnaireInputResponseEndpoint: Information used to perform task
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    "code" : {
            ...
            isArray: false,
        path: "Task.code",
            valueSet: "http://hl7.org/fhir/uv/sdc/ValueSet/task-code"
    },
    ...
    "output" : {
            name: "output",
            dataType: CRDTaskQuestionnaireOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        path: "Task.output"
    ...
    "reasonCode" : {
        ...
        path: "Task.reasonCode",
            valueSet: "http://hl7.org/fhir/us/davinci-crd/ValueSet/taskReason"
    },
    ...
    "priority" : {
            name: "priority",
            dataType: CRDTaskQuestionnairePriority,
            min: 0,
            max: 1,
            isArray: false,
        path: "Task.priority",
    ...
    "intent" : {
            name: "intent",
            dataType: CRDTaskQuestionnaireIntent,
            min: 1,
            max: 1,
            isArray: false,
        path: "Task.intent",
    ...
    "input" : {
            name: "input",
            dataType: CRDTaskQuestionnaireInput,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        path: "Task.input"
    ...
    "restriction" : {
            name: "restriction",
            dataType: CRDTaskQuestionnaireRestriction,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "status" : {
            name: "status",
            dataType: CRDTaskQuestionnaireStatus,
            min: 1,
            max: 1,
            isArray: false,
        path: "Task.status",
...
public type CRDTaskQuestionnaire record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDTASKQUESTIONNAIRE resourceType = RESOURCE_NAME_CRDTASKQUESTIONNAIRE;
...
CRDTaskQuestionnaireOutput   [] output?;
...
CRDTaskQuestionnairePriority priority?;
CRDTaskQuestionnaireIntent intent;
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireOutputResponse",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
    ...
    "type": {
            name: "type",
            dataType: CRDTaskQuestionnaireOutputType,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDTaskQuestionnaireOutputResponse record {|
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputTypeOne",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDTaskQuestionnaireInputTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDTaskQuestionnaireInputTypeOne record {|
    *r4:CodeableConcept;
...
CRDTaskQuestionnaireInputTypeCodingOne   [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputTypeCoding",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDTaskQuestionnaireInputTypeCoding record {|
    *r4:Coding;

r4:uri system = "http://hl7.org/fhir/uv/sdc/CodeSystem/temp";
r4:code code = "questionnaire";
|};

# CRDTaskQuestionnaireStatus enum
public enum CRDTaskQuestionnaireStatus {
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputResponseEndpoint",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
    ...
    "type": {
            name: "type",
            dataType: CRDTaskQuestionnaireInputTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDTaskQuestionnaireInputResponseEndpoint record {|
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireOutputTypeCoding",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDTaskQuestionnaireOutputTypeCoding record {|
    *r4:Coding;

r4:uri system = "http://hl7.org/fhir/uv/sdc/CodeSystem/temp";
r4:code code = "questionnaire-response";
|};

# CRDTaskQuestionnaireIntent enum
public enum CRDTaskQuestionnaireIntent {
...
# + 'type - A code or description indicating how the input is intended to be used as part of the task execution.
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputQuestionnaire",
    baseType: (),
    elements: {
    "valueCanonical": {
            name: "valueCanonical",
    ...
    "type": {
            name: "type",
            dataType: CRDTaskQuestionnaireInputType,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code or description indicating how the input is intended to be used as part of the task execution.",
...
r4:Extension   [] modifierExtension?;
string id?;
CRDTaskQuestionnaireInputType 'type;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputType",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDTaskQuestionnaireInputTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type CRDTaskQuestionnaireInputType record {|
    *r4:CodeableConcept;
...
CRDTaskQuestionnaireInputTypeCoding   [] coding;
|};

# CRDTaskQuestionnairePriority enum
public enum CRDTaskQuestionnairePriority {
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInput",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputTypeCodingTwo",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDTaskQuestionnaireInputTypeCodingTwo record {|
    *r4:Coding;

r4:uri system = "http://hl7.org/fhir/uv/sdc/CodeSystem/temp";
r4:code code = "response-endpoint";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputTypeCodingOne",
    baseType: (),
    elements: {
    "system": {
            name: "system",
...
public type CRDTaskQuestionnaireInputTypeCodingOne record {|
    *r4:Coding;

r4:uri system = "http://hl7.org/fhir/us/davinci-crd/CodeSystem/temp";
r4:code code = "after-completion-action";
|};
...
# + valueAnnotation - The value of the input parameter as a basic type.
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputAfterCompletion",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
    ...
    "type": {
            name: "type",
            dataType: CRDTaskQuestionnaireInputTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code or description indicating how the input is intended to be used as part of the task execution.",
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireOutputType",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDTaskQuestionnaireOutputTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type CRDTaskQuestionnaireOutputType record {|
    *r4:CodeableConcept;

    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Task.output.type.coding constraint. This field must be an array containing at least one item."
        },

        maxLength: {
            value: 1,
            message: "Validation failed for $.Task.output.type.coding constraint. This field must be an array containing at most one item."
        }
    }
CRDTaskQuestionnaireOutputTypeCoding   [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireRestriction",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type CRDTaskQuestionnaireRestriction record {|
    *r4:BackboneElement;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireInputTypeTwo",
    baseType: (),
    elements: {
    "coding": {
            name: "coding",
            dataType: CRDTaskQuestionnaireInputTypeCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type CRDTaskQuestionnaireInputTypeTwo record {|
    *r4:CodeableConcept;
...
CRDTaskQuestionnaireInputTypeCodingTwo   [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "CRDTaskQuestionnaireOutput",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
