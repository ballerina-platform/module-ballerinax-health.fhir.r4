...
# * category Slicings
# 1) CRDMedicationRequestCategoryUs_core: Type of medication usage
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-medicationrequest",
    elements: {
    "insurance" : {
            name: "insurance",
    ...
    "substitution" : {
            name: "substitution",
            dataType: CRDMedicationRequestSubstitution,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "dispenseRequest" : {
            ...
            dataType: CRDMedicationRequestDispenseRequest,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "priority" : {
            name: "priority",
            dataType: CRDMedicationRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "intent" : {
            name: "intent",
            dataType: CRDMedicationRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "status" : {
            name: "status",
            dataType: CRDMedicationRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDMedicationRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDMEDICATIONREQUEST resourceType = RESOURCE_NAME_CRDMEDICATIONREQUEST;

r4:Reference   [] insurance?;
r4:Annotation   [] note?;
r4:Extension   [] extension?;
CRDMedicationRequestSubstitution substitution?;
...
CRDMedicationRequestStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "CRDMedicationRequestDispenseRequest",
    baseType: (),
    elements: {
    "validityPeriod": {
            name: "validityPeriod",
    ...
    "initialFill": {
            name: "initialFill",
            dataType: CRDMedicationRequestDispenseRequestInitialFill,
            min: 0,
            max: 1,
            isArray: false,
...
public type CRDMedicationRequestDispenseRequest record {|
    *r4:BackboneElement;
...
r4:Extension   [] modifierExtension?;
CRDMedicationRequestDispenseRequestInitialFill initialFill?;
string id?;
...
#
@r4:DataTypeDefinition {
    name: "CRDMedicationRequestCategoryUs_core",
    baseType: (),
    elements: {
},
    serializers: {
...
public type CRDMedicationRequestCategoryUs_core record {|
    *r4:CodeableConcept;

|};

# CRDMedicationRequestPriority enum
public enum CRDMedicationRequestPriority {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "CRDMedicationRequestSubstitution",
    baseType: (),
    elements: {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "CRDMedicationRequestDispenseRequestInitialFill",
    baseType: (),
    elements: {
    "duration": {
            name: "duration",
...
public type CRDMedicationRequestDispenseRequestInitialFill record {|
    *r4:BackboneElement;
...
public enum CRDMedicationRequestStatus {
...
public enum CRDMedicationRequestIntent {
