...
Da Vinci CRD (2.1.0) FHIR R4 profile package for Coverage Requirements Discovery workflows. It provides typed records for appointment, request, coverage, task, and communication artifacts used in CRD interactions.
...
- Comprehensive profile-based models for CRD clinical and administrative resources
- Support for appointment variants, requests, tasks, and communication resources
- Coverage and organization related profile typing for payer-provider exchanges
- Type-safe payload authoring for CRD-compliant integrations
- Designed for FHIR R4 JSON profile interoperability
