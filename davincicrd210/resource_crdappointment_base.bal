...
public const string PROFILE_BASE_CRDAPPOINTMENTBASE = "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-appointment-base";
public const RESOURCE_NAME_CRDAPPOINTMENTBASE = "Appointment";

public type CRDAppointmentBaseExtensions (ExtCoverageInformation|r4:Extension);
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-crd/StructureDefinition/profile-appointment-base",
    elements: {
    "serviceType" : {
            name: "serviceType",
    ...
    "participant" : {
            name: "participant",
            dataType: CRDAppointmentBaseParticipant,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CRDAppointmentBase record {|
    *r4:DomainResource;

    RESOURCE_NAME_CRDAPPOINTMENTBASE resourceType = RESOURCE_NAME_CRDAPPOINTMENTBASE;
...
CRDAppointmentBaseParticipant   [] participant;
...
public enum CRDAppointmentBaseParticipantStatus {
...
@r4:DataTypeDefinition {
    name: "CRDAppointmentBaseParticipant",
    baseType: (),
    elements: {
    "actor": {
            name: "actor",
    ...
    "required": {
            name: "required",
            dataType: CRDAppointmentBaseParticipantRequired,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "status": {
            name: "status",
            dataType: CRDAppointmentBaseParticipantStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CRDAppointmentBaseParticipant record {|
    *r4:BackboneElement;
...
CRDAppointmentBaseParticipantRequired required?;
CRDAppointmentBaseParticipantStatus status;
|};

# CRDAppointmentBaseParticipantRequired enum
public enum CRDAppointmentBaseParticipantRequired {
