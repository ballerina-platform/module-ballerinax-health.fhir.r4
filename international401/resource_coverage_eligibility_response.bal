...
public type CoverageEligibilityResponse record {|
    *r4:DomainResource;
    ...
    BaseCoverageEligibilityResponseMeta meta = {
        profile : [PROFILE_BASE_COVERAGEELIGIBILITYRESPONSE]
    };
...
@r4:DataTypeDefinition {
    name: "BaseCoverageEligibilityResponseMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
...
public type BaseCoverageEligibilityResponseMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/StructureDefinition/CoverageEligibilityResponse"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
