...
public const string PROFILE_BASE_CQL_LIBRARY = "http://hl7.org/fhir/StructureDefinition/cqllibrary";
public const RESOURCE_NAME_CQL_LIBRARY = "Library";
...
public type CQL_Library record {|
    *r4:DomainResource;

    RESOURCE_NAME_CQL_LIBRARY resourceType = RESOURCE_NAME_CQL_LIBRARY;
    ...
    CQL_LibraryStatus status;
    r4:Element ...;
|};

# CQL_LibraryStatus enum
public enum CQL_LibraryStatus {
