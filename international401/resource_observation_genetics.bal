...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: Observation_geneticsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_geneticsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type Observation_genetics record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_GENETICS resourceType = RESOURCE_NAME_OBSERVATION_GENETICS;
    ...
    Observation_geneticsComponent[] component?;
    ...
    Observation_geneticsStatus status;
    r4:Element ...;
|};

# Observation_geneticsStatus enum
public enum Observation_geneticsStatus {
...
# FHIR Observation_geneticsReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_geneticsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_geneticsReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_geneticsComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "Observation_geneticsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_geneticsComponent record {|
    *r4:BackboneElement;
