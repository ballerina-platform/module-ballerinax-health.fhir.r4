...
# * category Slicings
# 1) Observation_headcircumCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_headcircumCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_headcircumValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_headcircumComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_headcircumReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_headcircumStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_headcircum record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_HEADCIRCUM resourceType = RESOURCE_NAME_OBSERVATION_HEADCIRCUM;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_headcircumCode code;
    ...
    Observation_headcircumValue valueQuantity?;
    ...
    Observation_headcircumComponent[] component?;
    r4:Resource[] contained?;
    Observation_headcircumReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_headcircumStatus status;
    r4:Element ...;
|};

# Observation_headcircumValueComparator enum
public enum Observation_headcircumValueComparator {
...
# FHIR Observation_headcircumReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_headcircumReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_headcircumReferenceRange record {|
    *r4:BackboneElement;
...
public enum Observation_headcircumStatus {
...
# FHIR Observation_headcircumCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_headcircumCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_headcircumCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_headcircumCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_headcircumCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_headcircumCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_headcircumValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_headcircumValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_headcircumValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_headcircumValue record {|
    *r4:Quantity;

    Observation_headcircumValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
# FHIR Observation_headcircumCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_headcircumCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_headcircumCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type Observation_headcircumCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_headcircumCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR Observation_headcircumComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_headcircumComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_headcircumComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_headcircumCodeCodingHeadCircumCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_headcircumCodeCodingHeadCircumCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_headcircumCodeCodingHeadCircumCode record {|
    *r4:Coding;
