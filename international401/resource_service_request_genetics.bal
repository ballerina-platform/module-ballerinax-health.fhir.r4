...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "priority" : {
            name: "priority",
            dataType: ServiceRequest_GeneticsPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: ServiceRequest_GeneticsIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: ServiceRequest_GeneticsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ServiceRequest_Genetics record {|
    *r4:DomainResource;

    RESOURCE_NAME_SERVICEREQUEST_GENETICS resourceType = RESOURCE_NAME_SERVICEREQUEST_GENETICS;
    ...
    ServiceRequest_GeneticsPriority priority?;
    ServiceRequest_GeneticsIntent intent;
    ...
    ServiceRequest_GeneticsStatus status;
    r4:Element ...;
|};

# ServiceRequest_GeneticsIntent enum
public enum ServiceRequest_GeneticsIntent {
...
public enum ServiceRequest_GeneticsPriority {
...
public enum ServiceRequest_GeneticsStatus {
