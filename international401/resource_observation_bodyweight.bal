...
# * category Slicings
# 1) Observation_bodyweightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_bodyweightCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_bodyweightValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_bodyweightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_bodyweightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_bodyweightStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_bodyweight record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_BODYWEIGHT resourceType = RESOURCE_NAME_OBSERVATION_BODYWEIGHT;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_bodyweightCode code;
    ...
    Observation_bodyweightValue valueQuantity?;
    ...
    Observation_bodyweightComponent[] component?;
    r4:Resource[] contained?;
    Observation_bodyweightReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_bodyweightStatus status;
    r4:Element ...;
|};

# FHIR Observation_bodyweightCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyweightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyweightCategoryCoding record {|
    *r4:Coding;
...
public enum Observation_bodyweightStatus {
...
# FHIR Observation_bodyweightValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyweightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_bodyweightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_bodyweightValue record {|
    *r4:Quantity;

    Observation_bodyweightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
# FHIR Observation_bodyweightCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyweightCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_bodyweightCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_bodyweightCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_bodyweightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_bodyweightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type Observation_bodyweightCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_bodyweightCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum Observation_bodyweightValueComparator {
...
# FHIR Observation_bodyweightComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyweightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_bodyweightComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodyweightReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bodyweightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyweightReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodyweightCodeCodingBodyWeightCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_bodyweightCodeCodingBodyWeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyweightCodeCodingBodyWeightCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "29463-7";
