...
# * category Slicings
# 1) Observation_bodyheightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_bodyheightCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_bodyheightValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_bodyheightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_bodyheightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_bodyheightStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_bodyheight record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_BODYHEIGHT resourceType = RESOURCE_NAME_OBSERVATION_BODYHEIGHT;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_bodyheightCode code;
    ...
    Observation_bodyheightValue valueQuantity?;
    ...
    Observation_bodyheightComponent[] component?;
    r4:Resource[] contained?;
    Observation_bodyheightReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_bodyheightStatus status;
    r4:Element ...;
|};

# FHIR Observation_bodyheightComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyheightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_bodyheightComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodyheightCodeCodingBodyHeightCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bodyheightCodeCodingBodyHeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyheightCodeCodingBodyHeightCode record {|
    *r4:Coding;
...
# FHIR Observation_bodyheightCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyheightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_bodyheightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_bodyheightCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_bodyheightCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum Observation_bodyheightValueComparator {
...
# FHIR Observation_bodyheightReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bodyheightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyheightReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodyheightCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_bodyheightCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_bodyheightCode record {|
    *r4:CodeableConcept;
...
public enum Observation_bodyheightStatus {
...
# FHIR Observation_bodyheightValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodyheightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_bodyheightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_bodyheightValue record {|
    *r4:Quantity;

    Observation_bodyheightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
# FHIR Observation_bodyheightCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_bodyheightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodyheightCategoryCoding record {|
    *r4:Coding;
