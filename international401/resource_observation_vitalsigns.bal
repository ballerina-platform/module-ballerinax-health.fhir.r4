...
# * category Slicings
# 1) Observation_vitalsignsCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: Observation_vitalsignsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_vitalsignsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_vitalsignsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_vitalsigns record {|
    *r4:DomainResource;
    ...
    Observation_vitalsignsComponent[] component?;
    r4:Resource[] contained?;
    Observation_vitalsignsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    Observation_vitalsignsStatus status;
    r4:Element ...;
|};

# FHIR Observation_vitalsignsReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalsignsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_vitalsignsReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_vitalsignsComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalsignsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_vitalsignsComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_vitalsignsCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_vitalsignsCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_vitalsignsCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_vitalsignsCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalsignsCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_vitalsignsCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_vitalsignsCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_vitalsignsCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum Observation_vitalsignsStatus {
