...
# * category Slicings
# 1) Observation_bmiCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: Observation_bmiComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_bmiReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_bmiStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_bmi record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_BMI resourceType = RESOURCE_NAME_OBSERVATION_BMI;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_bmiCode code;
    ...
    Observation_bmiValue valueQuantity?;
    ...
    Observation_bmiComponent[] component?;
    r4:Resource[] contained?;
    Observation_bmiReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_bmiStatus status;
    r4:Element ...;
|};

# FHIR Observation_bmiComponent datatype record.
#
...
public type Observation_bmiComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_bmiReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bmiReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bmiReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_bmiCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bmiCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bmiCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_bmiValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bmiValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_bmiValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_bmiValue record {|
    *r4:Quantity;

    Observation_bmiValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "kg/m2";
...
# FHIR Observation_bmiCodeCodingBMICode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_bmiCodeCodingBMICode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bmiCodeCodingBMICode record {|
    *r4:Coding;
...
# FHIR Observation_bmiCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bmiCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_bmiCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_bmiCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_bmiCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum Observation_bmiValueComparator {
...
# FHIR Observation_bmiCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type Observation_bmiCode record {|
    *r4:CodeableConcept;
...
public enum Observation_bmiStatus {
