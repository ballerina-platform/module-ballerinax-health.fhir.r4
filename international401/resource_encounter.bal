...
public type EncounterExtensions (EncounterAssociatedEncounter|EncounterModeOfArrival|EncounterReasonCancelled|r4:Extension|PatientInterpreterRequired|PatientPreferredPharmacy|WorkflowAdheresTo|WorkflowFollowOnOf|WorkflowReleaseDate|WorkflowResearchStudy|WorkflowSupportingInfo|WorkflowTriggeredBy);
