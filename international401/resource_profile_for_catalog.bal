...
public const string PROFILE_BASE_PROFILE_FOR_CATALOG = "http://hl7.org/fhir/StructureDefinition/catalog";
public const RESOURCE_NAME_PROFILE_FOR_CATALOG = "Composition";

# FHIR Profile_for_Catalog resource record.
#
...
# * extension Slicings
# 1) Extension: The validity of the catalog
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "section" : {
            name: "section",
            dataType: Profile_for_CatalogSection,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "attester" : {
            name: "attester",
            dataType: Profile_for_CatalogAttester,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "event" : {
            name: "event",
            dataType: Profile_for_CatalogEvent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relatesTo" : {
            name: "relatesTo",
            dataType: Profile_for_CatalogRelatesTo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Profile_for_CatalogStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type Profile_for_Catalog record {|
    *r4:DomainResource;

    RESOURCE_NAME_PROFILE_FOR_CATALOG resourceType = RESOURCE_NAME_PROFILE_FOR_CATALOG;
    ...
    r4:code language?;
    Profile_for_CatalogSection[] section?;
    r4:Reference encounter?;
    string title;
    r4:CodeableConcept 'type;
    Profile_for_CatalogAttester[] attester?;
    ...
    Profile_for_CatalogEvent[] event?;
    Profile_for_CatalogRelatesTo[] relatesTo?;
    Profile_for_CatalogStatus status;
    r4:Element ...;
|};

# FHIR Profile_for_CatalogSection datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Profile_for_CatalogSection",
    baseType: (),
    elements: {
        "mode": {
            name: "mode",
            dataType: Profile_for_CatalogSectionMode,
            min: 0,
            max: 1,
            isArray: false,
...
public type Profile_for_CatalogSection record {|
    *r4:BackboneElement;

    Profile_for_CatalogSectionMode mode?;
    @constraint:Array {
       minLength: 1
    }
    r4:Reference[] entry;
...
# FHIR Profile_for_CatalogAttester datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Profile_for_CatalogAttester",
    baseType: (),
    elements: {
        "mode": {
            name: "mode",
            dataType: Profile_for_CatalogAttesterMode,
            min: 1,
            max: 1,
            isArray: false,
...
public type Profile_for_CatalogAttester record {|
    *r4:BackboneElement;

    Profile_for_CatalogAttesterMode mode;
    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:dateTime time?;
...
# FHIR Profile_for_CatalogRelatesTo datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Profile_for_CatalogRelatesTo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            name: "code",
            dataType: Profile_for_CatalogRelatesToCode,
            min: 1,
            max: 1,
            isArray: false,
...
public type Profile_for_CatalogRelatesTo record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Identifier targetIdentifier;
    Profile_for_CatalogRelatesToCode code;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:Reference targetReference;
|};

# FHIR Profile_for_CatalogDateIssueDate datatype record.
#
@r4:DataTypeDefinition {
    name: "Profile_for_CatalogDateIssueDate",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type Profile_for_CatalogDateIssueDate record {|

|};

# Profile_for_CatalogStatus enum
public enum Profile_for_CatalogStatus {
...
public enum Profile_for_CatalogSectionMode {
...
public enum Profile_for_CatalogAttesterMode {
...
# FHIR Profile_for_CatalogEvent datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
public type Profile_for_CatalogEvent record {|
    *r4:BackboneElement;
...
public enum Profile_for_CatalogRelatesToCode {
