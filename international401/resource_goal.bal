...
public type GoalExtensions (r4:Extension|GoalAcceptance|GoalReasonRejected|GoalRelationship|WorkflowBarrier|WorkflowEpisodeOfCare|WorkflowProtectiveFactor|WorkflowReleaseDate);
