...
public const string PROFILE_BASE_COMPUTABLE_PLANDEFINITION = "http://hl7.org/fhir/StructureDefinition/computableplandefinition";
public const RESOURCE_NAME_COMPUTABLE_PLANDEFINITION = "PlanDefinition";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "action" : {
            name: "action",
            dataType: Computable_PlanDefinitionAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "goal" : {
            name: "goal",
            dataType: Computable_PlanDefinitionGoal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Computable_PlanDefinitionStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type Computable_PlanDefinition record {|
    *r4:DomainResource;

    RESOURCE_NAME_COMPUTABLE_PLANDEFINITION resourceType = RESOURCE_NAME_COMPUTABLE_PLANDEFINITION;
    ...
    Computable_PlanDefinitionAction[] action?;
    string id?;
    r4:Narrative text?;
    r4:ContactDetail[] editor?;
    r4:Identifier[] identifier?;
    Computable_PlanDefinitionGoal[] goal?;
    ...
    Computable_PlanDefinitionStatus status;
    r4:Element ...;
|};

# Computable_PlanDefinitionActionConditionKind enum
public enum Computable_PlanDefinitionActionConditionKind {
   CODE_KIND_STOP = "stop",
...
public enum Computable_PlanDefinitionStatus {
...
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionActionRelatedAction",
    baseType: (),
    elements: {
        ...
        "relationship": {
            name: "relationship",
            dataType: Computable_PlanDefinitionActionRelatedActionRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type Computable_PlanDefinitionActionRelatedAction record {|
    *r4:BackboneElement;
    ...
    r4:id actionId;
    string id?;
    Computable_PlanDefinitionActionRelatedActionRelationship relationship;
|};

# Computable_PlanDefinitionActionSelectionBehavior enum
public enum Computable_PlanDefinitionActionSelectionBehavior {
...
public enum Computable_PlanDefinitionActionRelatedActionRelationship {
...
public enum Computable_PlanDefinitionActionCardinalityBehavior {
...
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionAction",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "cardinalityBehavior": {
            ...
            dataType: Computable_PlanDefinitionActionCardinalityBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "groupingBehavior": {
            ...
            dataType: Computable_PlanDefinitionActionGroupingBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "participant": {
            name: "participant",
            dataType: Computable_PlanDefinitionActionParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dynamicValue": {
            name: "dynamicValue",
            dataType: Computable_PlanDefinitionActionDynamicValue,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relatedAction": {
            name: "relatedAction",
            dataType: Computable_PlanDefinitionActionRelatedAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority": {
            name: "priority",
            dataType: Computable_PlanDefinitionActionPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "requiredBehavior": {
            ...
            dataType: Computable_PlanDefinitionActionRequiredBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "condition": {
            name: "condition",
            dataType: Computable_PlanDefinitionActionCondition,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "selectionBehavior": {
            ...
            dataType: Computable_PlanDefinitionActionSelectionBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "precheckBehavior": {
            ...
            dataType: Computable_PlanDefinitionActionPrecheckBehavior,
            min: 0,
            max: 1,
            isArray: false,
...
public type Computable_PlanDefinitionAction record {|
    *r4:BackboneElement;

    r4:CodeableConcept[] reason?;
    Computable_PlanDefinitionActionCardinalityBehavior cardinalityBehavior?;
    ...
    string title?;
    r4:CodeableConcept 'type?;
    Computable_PlanDefinitionActionGroupingBehavior groupingBehavior?;
    Computable_PlanDefinitionActionParticipant[] participant?;
    r4:DataRequirement[] output?;
    r4:canonical transform?;
    Computable_PlanDefinitionActionDynamicValue[] dynamicValue?;
    r4:Age timingAge?;
    string id?;
    Computable_PlanDefinitionActionRelatedAction[] relatedAction?;
    ...
    Computable_PlanDefinitionActionPriority priority?;
    r4:Reference subjectReference?;
    r4:DataRequirement[] input?;
    Computable_PlanDefinitionActionRequiredBehavior requiredBehavior?;
    Computable_PlanDefinitionActionCondition[] condition?;
    Computable_PlanDefinitionActionSelectionBehavior selectionBehavior?;
    r4:Range timingRange?;
    Computable_PlanDefinitionActionPrecheckBehavior precheckBehavior?;
    r4:dateTime timingDateTime?;
|};

# Computable_PlanDefinitionActionRequiredBehavior enum
public enum Computable_PlanDefinitionActionRequiredBehavior {
...
public enum Computable_PlanDefinitionActionParticipantType {
...
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionActionParticipant",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: Computable_PlanDefinitionActionParticipantType,
            min: 1,
            max: 1,
            isArray: false,
...
public type Computable_PlanDefinitionActionParticipant record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    Computable_PlanDefinitionActionParticipantType 'type;
|};
...
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionGoalTarget",
    baseType: (),
    elements: {
        "detailPlanDefinitionCodeableConcept": {
...
public type Computable_PlanDefinitionGoalTarget record {|
    *r4:BackboneElement;
...
public enum Computable_PlanDefinitionActionGroupingBehavior {
...
public enum Computable_PlanDefinitionActionPriority {
...
public enum Computable_PlanDefinitionActionPrecheckBehavior {
...
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionGoal",
    baseType: (),
    elements: {
        "addresses": {
            name: "addresses",
        ...
        "target": {
            name: "target",
            dataType: Computable_PlanDefinitionGoalTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Computable_PlanDefinitionGoal record {|
    *r4:BackboneElement;
    ...
    Computable_PlanDefinitionGoalTarget[] target?;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionActionDynamicValue",
    baseType: (),
    elements: {
        "path": {
            name: "path",
...
public type Computable_PlanDefinitionActionDynamicValue record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "Computable_PlanDefinitionActionCondition",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "kind": {
            name: "kind",
            dataType: Computable_PlanDefinitionActionConditionKind,
            min: 1,
            max: 1,
            isArray: false,
...
public type Computable_PlanDefinitionActionCondition record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Expression expression?;
    Computable_PlanDefinitionActionConditionKind kind;
    r4:Extension[] modifierExtension?;
    string id?;
|};
