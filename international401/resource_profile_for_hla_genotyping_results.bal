...
public const string PROFILE_BASE_PROFILE_FOR_HLA_GENOTYPING_RESULTS = "http://hl7.org/fhir/StructureDefinition/hlaresult";
public const RESOURCE_NAME_PROFILE_FOR_HLA_GENOTYPING_RESULTS = "DiagnosticReport";

# FHIR Profile_for_HLA_Genotyping_Results resource record.
#
# + resourceType - The type of the resource describes
# + extension - An Extension
# * extension Slicings
# 1) Extension: Allele Database
#       - min = 0
#       - max = 1
#
# 2) Extension: Haploid
...
#       - max = *
#
# 3) Extension: The platform, methodology and software applied at the time of the genotyping
#       - min = 0
#       - max = 1
#
# 4) Extension: Glstring
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "media" : {
            name: "media",
            dataType: Profile_for_HLA_Genotyping_ResultsMedia,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Profile_for_HLA_Genotyping_ResultsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type Profile_for_HLA_Genotyping_Results record {|
    *r4:DomainResource;

    RESOURCE_NAME_PROFILE_FOR_HLA_GENOTYPING_RESULTS resourceType = RESOURCE_NAME_PROFILE_FOR_HLA_GENOTYPING_RESULTS;
    ...
    r4:code language?;
    Profile_for_HLA_Genotyping_ResultsMedia[] media?;
    string conclusion?;
    r4:Reference[] result?;
    ...
    Profile_for_HLA_Genotyping_ResultsStatus status;
    r4:Element ...;
|};

# Profile_for_HLA_Genotyping_ResultsStatus enum
public enum Profile_for_HLA_Genotyping_ResultsStatus {
...
# FHIR Profile_for_HLA_Genotyping_ResultsMedia datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Profile_for_HLA_Genotyping_ResultsMedia",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Profile_for_HLA_Genotyping_ResultsMedia record {|
    *r4:BackboneElement;
