...
# * category Slicings
# 1) Observation_bodytempCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_bodytempCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_bodytempValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_bodytempComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_bodytempReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_bodytempStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_bodytemp record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_BODYTEMP resourceType = RESOURCE_NAME_OBSERVATION_BODYTEMP;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_bodytempCode code;
    ...
    Observation_bodytempValue valueQuantity?;
    ...
    Observation_bodytempComponent[] component?;
    r4:Resource[] contained?;
    Observation_bodytempReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_bodytempStatus status;
    r4:Element ...;
|};

# FHIR Observation_bodytempReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodytempReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodytempReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodytempCodeCodingBodyTempCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bodytempCodeCodingBodyTempCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodytempCodeCodingBodyTempCode record {|
    *r4:Coding;
...
# FHIR Observation_bodytempCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodytempCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_bodytempCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_bodytempCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_bodytempCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR Observation_bodytempValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodytempValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_bodytempValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_bodytempValue record {|
    *r4:Quantity;

    Observation_bodytempValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
# FHIR Observation_bodytempComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bodytempComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_bodytempComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_bodytempCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type Observation_bodytempCode record {|
    *r4:CodeableConcept;
...
public enum Observation_bodytempValueComparator {
...
public enum Observation_bodytempStatus {
...
# FHIR Observation_bodytempCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_bodytempCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bodytempCategoryCoding record {|
    *r4:Coding;
