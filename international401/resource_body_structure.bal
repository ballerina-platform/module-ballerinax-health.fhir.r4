...
public type BodyStructure record {|
    *r4:DomainResource;
    ...
    BaseBodyStructureMeta meta = {
        profile : [PROFILE_BASE_BODYSTRUCTURE]
    };
...
public type BaseBodyStructureMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/StructureDefinition/BodyStructure"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
