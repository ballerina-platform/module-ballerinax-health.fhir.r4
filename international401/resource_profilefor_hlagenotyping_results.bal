...
public const string PROFILE_BASE_PROFILEFORHLAGENOTYPINGRESULTS = "http://hl7.org/fhir/StructureDefinition/hlaresult";
public const RESOURCE_NAME_PROFILEFORHLAGENOTYPINGRESULTS = "DiagnosticReport";
...
# FHIR ProfileforHLAGenotypingResults resource record.
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "media": {
            name: "media",
            dataType: ProfileforHLAGenotypingResultsMedia,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status": {
            name: "status",
            dataType: ProfileforHLAGenotypingResultsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ProfileforHLAGenotypingResults record {|
    *r4:DomainResource;

    RESOURCE_NAME_PROFILEFORHLAGENOTYPINGRESULTS resourceType = RESOURCE_NAME_PROFILEFORHLAGENOTYPINGRESULTS;
    ...
    r4:code language?;
    ProfileforHLAGenotypingResultsMedia[] media?;
    string conclusion?;
    r4:Reference[] result?;
    ...
    ProfileforHLAGenotypingResultsStatus status;
    r4:Element...;
|};

# FHIR ProfileforHLAGenotypingResultsMedia datatype record.
#
...
@r4:DataTypeDefinition {
    name: "ProfileforHLAGenotypingResultsMedia",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ProfileforHLAGenotypingResultsMedia record {|
    *r4:BackboneElement;
...
# ProfileforHLAGenotypingResultsStatus enum
public enum ProfileforHLAGenotypingResultsStatus {
