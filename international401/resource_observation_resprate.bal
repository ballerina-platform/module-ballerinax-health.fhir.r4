...
# * category Slicings
# 1) Observation_resprateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_resprateCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_resprateValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_resprateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_resprateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_resprateStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_resprate record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_RESPRATE resourceType = RESOURCE_NAME_OBSERVATION_RESPRATE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_resprateCode code;
    ...
    Observation_resprateValue valueQuantity?;
    ...
    Observation_resprateComponent[] component?;
    r4:Resource[] contained?;
    Observation_resprateReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_resprateStatus status;
    r4:Element ...;
|};

# FHIR Observation_resprateCodeCodingRespRateCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_resprateCodeCodingRespRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_resprateCodeCodingRespRateCode record {|
    *r4:Coding;
...
# FHIR Observation_resprateValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_resprateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_resprateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_resprateValue record {|
    *r4:Quantity;

    Observation_resprateValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "/min";
...
public enum Observation_resprateStatus {
...
# FHIR Observation_resprateCode datatype record.
#
...
public type Observation_resprateCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_resprateComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_resprateComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_resprateComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_resprateCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_resprateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_resprateCategoryCoding record {|
    *r4:Coding;
...
public enum Observation_resprateValueComparator {
...
# FHIR Observation_resprateReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_resprateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_resprateReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_resprateCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_resprateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_resprateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type Observation_resprateCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_resprateCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
