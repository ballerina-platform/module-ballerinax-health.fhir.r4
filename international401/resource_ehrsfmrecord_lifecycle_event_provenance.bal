...
public const string PROFILE_BASE_EHRSFMRECORDLIFECYCLEEVENT_PROVENANCE = "http://hl7.org/fhir/StructureDefinition/ehrsrle-provenance";
public const RESOURCE_NAME_EHRSFMRECORDLIFECYCLEEVENT_PROVENANCE = "Provenance";

# FHIR EHRSFMRecordLifecycleEvent_Provenance resource record.
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "agent": {
            name: "agent",
            dataType: EHRSFMRecordLifecycleEvent_ProvenanceAgent,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "entity": {
            name: "entity",
            dataType: EHRSFMRecordLifecycleEvent_ProvenanceEntity,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type EHRSFMRecordLifecycleEvent_Provenance record {|
    *r4:DomainResource;
    ...
    EHRSFMRecordLifecycleEvent_ProvenanceAgent[] agent;
    ...
    string id?;
    r4:Narrative text?;
    EHRSFMRecordLifecycleEvent_ProvenanceEntity[] entity?;
    r4:dateTime occurredDateTime?;
    r4:uri[] policy?;
    r4:Element...;
|};

# EHRSFMRecordLifecycleEvent_ProvenanceEntityRole enum
public enum EHRSFMRecordLifecycleEvent_ProvenanceEntityRole {
...
# FHIR EHRSFMRecordLifecycleEvent_ProvenanceEntity datatype record.
#
...
@r4:DataTypeDefinition {
    name: "EHRSFMRecordLifecycleEvent_ProvenanceEntity",
    baseType: (),
    elements: {
        "agent": {
            name: "agent",
        ...
        "role": {
            name: "role",
            dataType: EHRSFMRecordLifecycleEvent_ProvenanceEntityRole,
            min: 1,
            max: 1,
            isArray: false,
...
public type EHRSFMRecordLifecycleEvent_ProvenanceEntity record {|
    *r4:BackboneElement;

    EHRSFMRecordLifecycleEvent_ProvenanceAgent[] agent?;
    r4:Extension[] extension?;
    EHRSFMRecordLifecycleEvent_ProvenanceEntityRole role;
    r4:Reference what;
    r4:Extension[] modifierExtension?;
    string id?;
|};

# FHIR EHRSFMRecordLifecycleEvent_ProvenanceAgent datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "EHRSFMRecordLifecycleEvent_ProvenanceAgent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type EHRSFMRecordLifecycleEvent_ProvenanceAgent record {|
    *r4:BackboneElement;
