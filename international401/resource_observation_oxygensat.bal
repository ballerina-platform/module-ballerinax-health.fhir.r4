...
# * category Slicings
# 1) Observation_oxygensatCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_oxygensatCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_oxygensatValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_oxygensatComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_oxygensatStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_oxygensat record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_OXYGENSAT resourceType = RESOURCE_NAME_OBSERVATION_OXYGENSAT;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_oxygensatCode code;
    ...
    r4:Reference device?;
    Observation_oxygensatStatus status;
    r4:Element ...;
|};

# FHIR Observation_oxygensatReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_oxygensatReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_oxygensatReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_oxygensatValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_oxygensatValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_oxygensatValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_oxygensatValue record {|
    *r4:Quantity;

    Observation_oxygensatValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "%";
...
# FHIR Observation_oxygensatCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_oxygensatCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_oxygensatCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_oxygensatCategoryVSCat record {|
    *r4:CodeableConcept;
...
# FHIR Observation_oxygensatCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_oxygensatCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_oxygensatCategoryCoding record {|
    *r4:Coding;
...
public enum Observation_oxygensatValueComparator {
...
public enum Observation_oxygensatStatus {
...
# FHIR Observation_oxygensatComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_oxygensatComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_oxygensatComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_oxygensatCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_oxygensatCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_oxygensatCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_oxygensatCodeCodingOxygenSatCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_oxygensatCodeCodingOxygenSatCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_oxygensatCodeCodingOxygenSatCode record {|
    *r4:Coding;
