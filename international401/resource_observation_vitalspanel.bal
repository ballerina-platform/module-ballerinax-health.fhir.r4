...
# * category Slicings
# 1) Observation_vitalspanelCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_vitalspanelCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_vitalspanelComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_vitalspanelReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_vitalspanelStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_vitalspanel record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_VITALSPANEL resourceType = RESOURCE_NAME_OBSERVATION_VITALSPANEL;
    ...
    r4:time valueTime?;
    Observation_vitalspanelCode code;
    ...
    Observation_vitalspanelComponent[] component?;
    r4:Resource[] contained?;
    Observation_vitalspanelReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    Observation_vitalspanelStatus status;
    r4:Element ...;
|};

# FHIR Observation_vitalspanelCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_vitalspanelCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_vitalspanelComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_vitalspanelComponent record {|
    *r4:BackboneElement;
...
# FHIR Observation_vitalspanelCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_vitalspanelCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_vitalspanelCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_vitalspanelCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR Observation_vitalspanelCodeCodingVitalsPanelCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelCodeCodingVitalsPanelCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_vitalspanelCodeCodingVitalsPanelCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "85353-1";
...
# FHIR Observation_vitalspanelCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_vitalspanelCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_vitalspanelReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_vitalspanelReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_vitalspanelReferenceRange record {|
    *r4:BackboneElement;
...
public enum Observation_vitalspanelStatus {
