...
public const string PROFILE_BASE_EHRS_FM_RECORD_LIFECYCLE_EVENT___PROVENANCE = "http://hl7.org/fhir/StructureDefinition/ehrsrle-provenance";
public const RESOURCE_NAME_EHRS_FM_RECORD_LIFECYCLE_EVENT___PROVENANCE = "Provenance";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "agent" : {
            name: "agent",
            dataType: EHRS_FM_Record_Lifecycle_Event___ProvenanceAgent,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "entity" : {
            name: "entity",
            dataType: EHRS_FM_Record_Lifecycle_Event___ProvenanceEntity,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type EHRS_FM_Record_Lifecycle_Event___Provenance record {|
    *r4:DomainResource;

    RESOURCE_NAME_EHRS_FM_RECORD_LIFECYCLE_EVENT___PROVENANCE resourceType = RESOURCE_NAME_EHRS_FM_RECORD_LIFECYCLE_EVENT___PROVENANCE;

    r4:CodeableConcept[] reason?;
    @constraint:Array {
       minLength: 1
    }
    EHRS_FM_Record_Lifecycle_Event___ProvenanceAgent[] agent;
    ...
    string id?;
    r4:Narrative text?;
    EHRS_FM_Record_Lifecycle_Event___ProvenanceEntity[] entity?;
...
public enum EHRS_FM_Record_Lifecycle_Event___ProvenanceEntityRole {
...
@r4:DataTypeDefinition {
    name: "EHRS_FM_Record_Lifecycle_Event___ProvenanceAgent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type EHRS_FM_Record_Lifecycle_Event___ProvenanceAgent record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "EHRS_FM_Record_Lifecycle_Event___ProvenanceEntity",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "role": {
            name: "role",
            dataType: EHRS_FM_Record_Lifecycle_Event___ProvenanceEntityRole,
            min: 1,
            max: 1,
            isArray: false,
...
public type EHRS_FM_Record_Lifecycle_Event___ProvenanceEntity record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    EHRS_FM_Record_Lifecycle_Event___ProvenanceEntityRole role;
    r4:Reference what;
    r4:Extension[] modifierExtension?;
    string id?;
|};
