...
public const string PROFILE_BASE_OBSERVATION_HEARTRATE = "http://hl7.org/fhir/StructureDefinition/heartrate";
public const RESOURCE_NAME_OBSERVATION_HEARTRATE = "Observation";
...
# FHIR observation_heartrate resource record.
#
...
# * category Slicings
# 1) Observation_heartrateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: Observation_heartrateCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: Observation_heartrateValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: Observation_heartrateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: Observation_heartrateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: Observation_heartrateStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type observation_heartrate record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_HEARTRATE resourceType = RESOURCE_NAME_OBSERVATION_HEARTRATE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_heartrateCode code;
    ...
    Observation_heartrateValue valueQuantity?;
    ...
    Observation_heartrateComponent[] component?;
    r4:Resource[] contained?;
    Observation_heartrateReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    Observation_heartrateStatus status;
    r4:Element ...;
|};

# FHIR Observation_heartrateReferenceRange datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_heartrateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_heartrateReferenceRange record {|
    *r4:BackboneElement;
...
public enum Observation_heartrateStatus {
...
# FHIR Observation_heartrateCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_heartrateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_heartrateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation_heartrateCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    Observation_heartrateCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR Observation_heartrateCodeCodingHeartRateCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_heartrateCodeCodingHeartRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_heartrateCodeCodingHeartRateCode record {|
    *r4:Coding;
...
# FHIR Observation_heartrateCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_heartrateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_heartrateCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_heartrateValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_heartrateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: Observation_heartrateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type Observation_heartrateValue record {|
    *r4:Quantity;

    Observation_heartrateValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "/min";
...
# FHIR Observation_heartrateComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_heartrateComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type Observation_heartrateComponent record {|
    *r4:BackboneElement;
...
public enum Observation_heartrateValueComparator {
...
# FHIR Observation_heartrateCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_heartrateCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_heartrateCode record {|
    *r4:CodeableConcept;
