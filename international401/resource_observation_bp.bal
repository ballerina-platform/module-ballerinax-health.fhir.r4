...
# * component Slicings
# 1) Observation_bpComponentSystolicBP: Used when reporting systolic and diastolic blood pressure.
#       - min = 1
#       - max = 1
#
# 2) Observation_bpComponentDiastolicBP: Used when reporting systolic and diastolic blood pressure.
#       - min = 1
#       - max = 1
#
...
# * category Slicings
# 1) Observation_bpCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: Observation_bpComponent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
...
public type observation_bp record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATION_BP resourceType = RESOURCE_NAME_OBSERVATION_BP;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    Observation_bpCode code;
...
public enum Observation_bpStatus {
...
# FHIR Observation_bpComponentDiastolicBP datatype record.
#
...
@r4:DataTypeDefinition {
    name: "Observation_bpComponentDiastolicBP",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
@r4:DataTypeDefinition {
    name: "Observation_bpCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bpCategoryCoding record {|
    *r4:Coding;
...
# FHIR Observation_bpComponent datatype record.
#
...
public type Observation_bpComponent record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_bpComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type Observation_bpComponentCode record {|
    *r4:CodeableConcept;
...
# FHIR Observation_bpReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "Observation_bpReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type Observation_bpReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR Observation_bpCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "Observation_bpCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: Observation_bpCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type Observation_bpCategoryVSCat record {|
    *r4:CodeableConcept;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "Observation_bpCodeCodingBPCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
