...
public const string PROFILE_BASE_CQF_QUESTIONNAIRE = "http://hl7.org/fhir/StructureDefinition/cqf-questionnaire";
public const RESOURCE_NAME_CQF_QUESTIONNAIRE = "Questionnaire";

public type CQF_QuestionnaireExtensions (CqfTargetInvariant|DesignNote|r4:Extension|PreferredTerminologyServer|QuestionnaireConstraint|QuestionnaireDefinitionBased|QuestionnaireSignatureRequired|Replaces|TargetConstraint|Variable);
...
public type CQF_Questionnaire record {|
    *r4:DomainResource;

    RESOURCE_NAME_CQF_QUESTIONNAIRE resourceType = RESOURCE_NAME_CQF_QUESTIONNAIRE;
...
@r4:DataTypeDefinition {
    name: "CQF_QuestionnaireItemAnswerOption",
    baseType: (),
    elements: {
        "valueCoding": {
            name: "valueCoding",
...
public type CQF_QuestionnaireItemAnswerOption record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "enableWhen": {
            name: "enableWhen",
            dataType: CQF_QuestionnaireItemEnableWhen,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "initial": {
            name: "initial",
            dataType: CQF_QuestionnaireItemInitial,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "type": {
            name: "type",
            dataType: CQF_QuestionnaireItemType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "definition": {
            ...
            max: 1,
            isArray: false,
            description: "This element is a URI that refers to an [ElementDefinition](http://hl7.org/fhir/elementdefinition.html) that provides information about this item, including information that might otherwise be included in the instance of the Questionnaire resource. A detailed description of the construction of the URI is shown in Comments, below. If this element is present then the following element values MAY be derived from the Element Definition if the corresponding elements of this Questionnaire resource instance have no value: * code (ElementDefinition.code) * type (ElementDefinition.type) * required (ElementDefinition.min) * repeats (ElementDefinition.max) * maxLength (ElementDefinition.maxLength) * answerValueSet (ElementDefinition.binding) * options (ElementDefinition.binding).",
            path: "Questionnaire.item.definition"
        },
        "enableBehavior": {
            name: "enableBehavior",
            dataType: CQF_QuestionnaireItemEnableBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "answerOption": {
            name: "answerOption",
            dataType: CQF_QuestionnaireItemAnswerOption,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CQF_QuestionnaireItem record {|
    *r4:BackboneElement;
    ...
    CQF_QuestionnaireItem[] item?;
    r4:Coding[] code?;
    CQF_QuestionnaireItemEnableWhen[] enableWhen?;
    CQF_QuestionnaireItemInitial[] initial?;
    string prefix?;
    r4:Extension[] modifierExtension?;
    boolean readOnly?;
    CQF_QuestionnaireItemType 'type;
    boolean required?;
    string linkId;
    r4:uri definition?;
    CQF_QuestionnaireItemEnableBehavior enableBehavior?;
    string id?;
    string text?;
    CQF_QuestionnaireItemAnswerOption[] answerOption?;
...
@r4:DataTypeDefinition {
    name: "CQF_QuestionnaireItemEnableWhen",
    baseType: (),
    elements: {
        "answerQuantity": {
            name: "answerQuantity",
        ...
        "operator": {
            name: "operator",
            dataType: CQF_QuestionnaireItemEnableWhenOperator,
            min: 1,
            max: 1,
            isArray: false,
...
public type CQF_QuestionnaireItemEnableWhen record {|
    *r4:BackboneElement;
    ...
    CQF_QuestionnaireItemEnableWhenOperator operator;
...
@r4:DataTypeDefinition {
    name: "CQF_QuestionnaireItemInitial",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type CQF_QuestionnaireItemInitial record {|
    *r4:BackboneElement;
