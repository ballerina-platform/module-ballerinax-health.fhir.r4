...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "media" : {
            name: "media",
            dataType: DiagnosticReport_GeneticsMedia,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: DiagnosticReport_GeneticsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type DiagnosticReport_Genetics record {|
    *r4:DomainResource;

    RESOURCE_NAME_DIAGNOSTICREPORT_GENETICS resourceType = RESOURCE_NAME_DIAGNOSTICREPORT_GENETICS;
    ...
    r4:code language?;
    DiagnosticReport_GeneticsMedia[] media?;
    string conclusion?;
    r4:Reference[] result?;
    ...
    DiagnosticReport_GeneticsStatus status;
    r4:Element ...;
|};

# DiagnosticReport_GeneticsStatus enum
public enum DiagnosticReport_GeneticsStatus {
...
@r4:DataTypeDefinition {
    name: "DiagnosticReport_GeneticsMedia",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DiagnosticReport_GeneticsMedia record {|
    *r4:BackboneElement;
