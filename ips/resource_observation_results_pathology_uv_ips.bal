...
public const string PROFILE_BASE_OBSERVATIONRESULTSPATHOLOGYUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-pathology-uv-ips";
public const RESOURCE_NAME_OBSERVATIONRESULTSPATHOLOGYUVIPS = "Observation";
...
# + hasMember - A reference to another Observation profiled by Observation-results-pathology-uv-ips. The target observation is considered as a sub-observation of the current one, which plays the role of a grouper
...
# * category Slicings
# 1) ObservationResultsPathologyUvIpsCategoryLaboratory: Concept - reference to a terminology or just text
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-pathology-uv-ips",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "valueCodeableConcept" : {
            ...
            isArray: false,
            path: "Observation.value[x]",
            valueSet: "http://hl7.org/fhir/uv/ips/ValueSet/result-coded-value-pathology-uv-ips"
        },
        "valueRatio" : {
            name: "valueRatio",
            dataType: r4:Ratio,
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: ObservationResultsPathologyUvIpsHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: ObservationResultsPathologyUvIpsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationResultsPathologyUvIpsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationResultsPathologyUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationResultsPathologyUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONRESULTSPATHOLOGYUVIPS resourceType = RESOURCE_NAME_OBSERVATIONRESULTSPATHOLOGYUVIPS;
    ...
    ObservationResultsPathologyUvIpsHasMember[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    ObservationResultsPathologyUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationResultsPathologyUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationResultsPathologyUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationResultsPathologyUvIpsHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationResultsPathologyUvIpsHasMember record {|
    *r4:Reference;
...
public enum ObservationResultsPathologyUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationResultsPathologyUvIpsCategoryLaboratory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationResultsPathologyUvIpsCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationResultsPathologyUvIpsCategoryLaboratory record {|
    *r4:CodeableConcept;
    ...
    ObservationResultsPathologyUvIpsCategoryCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationResultsPathologyUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationResultsPathologyUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsPathologyUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationResultsPathologyUvIpsComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsPathologyUvIpsCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ObservationResultsPathologyUvIpsCategoryCoding record {|
    *r4:Coding;
