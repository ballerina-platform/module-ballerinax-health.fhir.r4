...
public const string PROFILE_BASE_PRACTITIONERUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Practitioner-uv-ips";
public const RESOURCE_NAME_PRACTITIONERUVIPS = "Practitioner";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "gender" : {
            name: "gender",
            dataType: PractitionerUvIpsGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "qualification" : {
            name: "qualification",
            dataType: PractitionerUvIpsQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "name" : {
            name: "name",
            dataType: PractitionerUvIpsName,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PractitionerUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_PRACTITIONERUVIPS resourceType = RESOURCE_NAME_PRACTITIONERUVIPS;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Address[] address?;
    PractitionerUvIpsGender gender?;
    r4:Extension[] modifierExtension?;
    boolean active?;
    r4:Attachment[] photo?;
    r4:code language?;
    r4:date birthDate?;
    PractitionerUvIpsQualification[] qualification?;
...
public enum PractitionerUvIpsGender {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PractitionerUvIpsNameUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PractitionerUvIpsName record {|
    *r4:HumanName;
...
@r4:DataTypeDefinition {
    name: "PractitionerUvIpsQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type PractitionerUvIpsQualification record {|
    *r4:BackboneElement;
...
public enum PractitionerUvIpsNameUse {
