...
public const string PROFILE_BASE_DEVICEOBSERVERUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Device-observer-uv-ips";
public const RESOURCE_NAME_DEVICEOBSERVERUVIPS = "Device";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/uv/ips/StructureDefinition/Device-observer-uv-ips",
    elements: {
        "note" : {
            name: "note",
        ...
        "deviceName" : {
            name: "deviceName",
            dataType: DeviceObserverUvIpsDeviceName,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "property" : {
            name: "property",
            dataType: DeviceObserverUvIpsProperty,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "version" : {
            name: "version",
            dataType: DeviceObserverUvIpsVersion,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Device.version"
        ...
        "udiCarrier" : {
            name: "udiCarrier",
            dataType: DeviceObserverUvIpsUdiCarrier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "specialization" : {
            name: "specialization",
            dataType: DeviceObserverUvIpsSpecialization,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: DeviceObserverUvIpsStatus,
            min: 0,
            max: 1,
            isArray: false,
            path: "Device.status",
...
public type DeviceObserverUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_DEVICEOBSERVERUVIPS resourceType = RESOURCE_NAME_DEVICEOBSERVERUVIPS;
    ...
    string serialNumber?;
    string lotNumber?;
    DeviceObserverUvIpsVersion[] 'version?;
    r4:uri url?;
    r4:Resource[] contained?;
    DeviceObserverUvIpsUdiCarrier[] udiCarrier?;
    r4:Meta meta?;
    r4:uri implicitRules?;
    DeviceObserverUvIpsSpecialization[] specialization?;
    r4:Reference location?;
    string modelNumber?;
    string partNumber?;
    DeviceObserverUvIpsStatus status?;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "DeviceObserverUvIpsSpecialization",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DeviceObserverUvIpsSpecialization record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "DeviceObserverUvIpsProperty",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DeviceObserverUvIpsProperty record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "DeviceObserverUvIpsVersion",
    baseType: (),
    elements: {
        "component": {
            name: "component",
...
public type DeviceObserverUvIpsVersion record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "DeviceObserverUvIpsDeviceName",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: DeviceObserverUvIpsDeviceNameType,
            min: 1,
            max: 1,
            isArray: false,
...
public type DeviceObserverUvIpsDeviceName record {|
    *r4:BackboneElement;
    ...
    string name;
    string id?;
    DeviceObserverUvIpsDeviceNameType 'type;
|};

# DeviceObserverUvIpsUdiCarrierEntryType enum
public enum DeviceObserverUvIpsUdiCarrierEntryType {
...
public enum DeviceObserverUvIpsDeviceNameType {
...
@r4:DataTypeDefinition {
    name: "DeviceObserverUvIpsUdiCarrier",
    baseType: (),
    elements: {
        "entryType": {
            name: "entryType",
            dataType: DeviceObserverUvIpsUdiCarrierEntryType,
            min: 0,
            max: 1,
            isArray: false,
...
public type DeviceObserverUvIpsUdiCarrier record {|
    *r4:BackboneElement;

    DeviceObserverUvIpsUdiCarrierEntryType entryType?;
    r4:Extension[] extension?;
...
public enum DeviceObserverUvIpsStatus {
