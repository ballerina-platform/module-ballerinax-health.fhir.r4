...
public const string PROFILE_BASE_ORGANIZATIONUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Organization-uv-ips";
public const RESOURCE_NAME_ORGANIZATIONUVIPS = "Organization";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "contact" : {
            name: "contact",
            dataType: OrganizationUvIpsContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type OrganizationUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_ORGANIZATIONUVIPS resourceType = RESOURCE_NAME_ORGANIZATIONUVIPS;
    ...
    r4:Meta meta?;
    OrganizationUvIpsContact[] contact?;
    string name;
    string[] alias?;
...
public type OrganizationUvIpsContact record {|
    *r4:BackboneElement;
