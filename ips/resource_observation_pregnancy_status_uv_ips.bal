...
public const string PROFILE_BASE_OBSERVATIONPREGNANCYSTATUSUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-status-uv-ips";
public const RESOURCE_NAME_OBSERVATIONPREGNANCYSTATUSUVIPS = "Observation";
...
# + hasMember - A reference to the Expected Delivery Date Observation.
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: ObservationPregnancyStatusUvIpsCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "subject" : {
            name: "subject",
            dataType: ObservationPregnancyStatusUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: ObservationPregnancyStatusUvIpsHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: ObservationPregnancyStatusUvIpsComponent,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationPregnancyStatusUvIpsReferenceRange,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationPregnancyStatusUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationPregnancyStatusUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONPREGNANCYSTATUSUVIPS resourceType = RESOURCE_NAME_OBSERVATIONPREGNANCYSTATUSUVIPS;
    ...
    ObservationPregnancyStatusUvIpsSubject subject;
    r4:Range valueRange?;
    ...
    ObservationPregnancyStatusUvIpsHasMember[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    ObservationPregnancyStatusUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationPregnancyStatusUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationPregnancyStatusUvIpsStatus status;
    r4:Element ...;
|};

# ObservationPregnancyStatusUvIpsStatus enum
public enum ObservationPregnancyStatusUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationPregnancyStatusUvIpsSubject record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationPregnancyStatusUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationPregnancyStatusUvIpsComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationPregnancyStatusUvIpsCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationPregnancyStatusUvIpsCode record {|
    *r4:CodeableConcept;
    ...
    ObservationPregnancyStatusUvIpsCodeCoding[] coding;
|};
...
# + 'type - The expected type of the target of the reference. If both Reference.type and Reference.reference are populated and Reference.reference is a FHIR URL, both SHALL be consistent. The type is the Canonical URL of Resource Definition that is the type this reference refers to. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition/ e.g. 'Patient' is a reference to http://hl7.org/fhir/StructureDefinition/Patient. Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not resources).
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationPregnancyStatusUvIpsHasMember record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyStatusUvIpsCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ObservationPregnancyStatusUvIpsCodeCoding record {|
    *r4:Coding;
