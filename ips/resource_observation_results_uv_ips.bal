...
public const string PROFILE_BASE_OBSERVATIONRESULTSUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-uv-ips";
public const RESOURCE_NAME_OBSERVATIONRESULTSUVIPS = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "subject" : {
            name: "subject",
            dataType: ObservationResultsUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationResultsUvIpsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationResultsUvIpsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationResultsUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationResultsUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONRESULTSUVIPS resourceType = RESOURCE_NAME_OBSERVATIONRESULTSUVIPS;
    ...
    ObservationResultsUvIpsSubject subject;
    r4:Range valueRange?;
    ...
    ObservationResultsUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationResultsUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationResultsUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationResultsUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationResultsUvIpsSubject record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationResultsUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
public enum ObservationResultsUvIpsStatus {
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "ObservationResultsUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationResultsUvIpsComponent record {|
    *r4:BackboneElement;
