...
public const string PROFILE_BASE_OBSERVATIONALCOHOLUSEUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-alcoholuse-uv-ips";
public const RESOURCE_NAME_OBSERVATIONALCOHOLUSEUVIPS = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: ObservationAlcoholUseUvIpsCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "subject" : {
            name: "subject",
            dataType: ObservationAlcoholUseUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationAlcoholUseUvIpsComponent,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationAlcoholUseUvIpsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationAlcoholUseUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationAlcoholUseUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONALCOHOLUSEUVIPS resourceType = RESOURCE_NAME_OBSERVATIONALCOHOLUSEUVIPS;
    ...
    ObservationAlcoholUseUvIpsSubject subject;
    r4:Range valueRange?;
    ...
    ObservationAlcoholUseUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationAlcoholUseUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationAlcoholUseUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationAlcoholUseUvIpsCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationAlcoholUseUvIpsCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationAlcoholUseUvIpsCode record {|
    *r4:CodeableConcept;
    ...
    ObservationAlcoholUseUvIpsCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationAlcoholUseUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationAlcoholUseUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
public enum ObservationAlcoholUseUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationAlcoholUseUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationAlcoholUseUvIpsSubject record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationAlcoholUseUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationAlcoholUseUvIpsComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationAlcoholUseUvIpsCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ObservationAlcoholUseUvIpsCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "74013-4";
|};
