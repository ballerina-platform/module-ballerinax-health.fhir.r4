...
public const string PROFILE_BASE_OBSERVATIONPREGNANCYOUTCOMEUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-outcome-uv-ips";
public const RESOURCE_NAME_OBSERVATIONPREGNANCYOUTCOMEUVIPS = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "subject" : {
            name: "subject",
            dataType: ObservationPregnancyOutcomeUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationPregnancyOutcomeUvIpsComponent,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationPregnancyOutcomeUvIpsReferenceRange,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationPregnancyOutcomeUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationPregnancyOutcomeUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONPREGNANCYOUTCOMEUVIPS resourceType = RESOURCE_NAME_OBSERVATIONPREGNANCYOUTCOMEUVIPS;
    ...
    ObservationPregnancyOutcomeUvIpsSubject subject;
    r4:Range valueRange?;
    ...
    ObservationPregnancyOutcomeUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationPregnancyOutcomeUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationPregnancyOutcomeUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyOutcomeUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationPregnancyOutcomeUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "ObservationPregnancyOutcomeUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationPregnancyOutcomeUvIpsComponent record {|
    *r4:BackboneElement;
...
public enum ObservationPregnancyOutcomeUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyOutcomeUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationPregnancyOutcomeUvIpsSubject record {|
    *r4:Reference;
