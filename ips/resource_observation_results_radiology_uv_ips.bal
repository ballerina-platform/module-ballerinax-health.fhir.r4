...
public const string PROFILE_BASE_OBSERVATIONRESULTSRADIOLOGYUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips";
public const RESOURCE_NAME_OBSERVATIONRESULTSRADIOLOGYUVIPS = "Observation";
...
# + code - Describes what was observed. Sometimes this is called the observation 'name'. In this profile the code of the containing observation (the organizer result in the CDA implementation) may correspond to the procedure code (e.g. Chest X-Ray).
...
# * component Slicings
# 1) ObservationResultsRadiologyUvIpsComponentObservationCode: Observation Code
#       - min = 0
#       - max = *
#
# 2) ObservationResultsRadiologyUvIpsComponentNumericRatioMeasurement: Observation Measurement, including linear, area and volume ratio measurements
#       - min = 0
#       - max = *
#
# 3) ObservationResultsRadiologyUvIpsComponentNumericQuantityMeasurement: Observation Measurement, including linear, area and volume quantity measurements
#       - min = 0
#       - max = *
#
# 4) ObservationResultsRadiologyUvIpsComponentObservationText: Observation Text
#       - min = 0
#       - max = *
#
# 5) ObservationResultsRadiologyUvIpsComponentNumericRangeMeasurement: Observation Measurement, including linear, area and volume range measurements
#       - min = 0
#       - max = *
#
# 6) ObservationResultsRadiologyUvIpsComponentNumericSampledDataMeasurement: Observation Measurement, including linear, area and volume sampled data measurements
#       - min = 0
#       - max = *
#
...
# + category - A code that classifies the general type of observation being made. In this profile, fixed to 'imaging'.
# * category Slicings
# 1) ObservationResultsRadiologyUvIpsCategoryRadiology: Concept - reference to a terminology or just text
#       - min = 1
#       - max = 1
#
# + device - The device used to generate the observation data.
# + status - The status of the result value. Only final results feed patient summaries.
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: ObservationResultsRadiologyUvIpsHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationResultsRadiologyUvIpsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: ObservationResultsRadiologyUvIpsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationResultsRadiologyUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationResultsRadiologyUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONRESULTSRADIOLOGYUVIPS resourceType = RESOURCE_NAME_OBSERVATIONRESULTSRADIOLOGYUVIPS;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Observation.performer constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.Observation.performer constraint. This field must be an array containing at most one item."
        }
    }
    r4:Reference[] performer;
    r4:Period effectivePeriod;
    r4:CodeableConcept method?;
    ObservationResultsRadiologyUvIpsHasMember[] hasMember?;
    r4:Reference encounter?;
    ObservationResultsRadiologyUvIpsReferenceRange[] referenceRange?;
    CodeableConceptUvIps bodySite?;
    ObservationResultsRadiologyUvIpsComponent[] component?;
    ...
    r4:Reference device?;
    ObservationResultsRadiologyUvIpsStatus status;
    r4:Element ...;
|};

# FHIR ObservationResultsRadiologyUvIpsComponentObservationCode datatype record.
#
# + valueCodeableConcept - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
...
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentObservationCode",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
...
public type ObservationResultsRadiologyUvIpsComponentObservationCode record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + valueRatio - A relationship of two Quantity values - expressed as a numerator and a denominator.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
# + interpretation - A categorical assessment of an observation value. For example, high, low, normal.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentNumericRatioMeasurement",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type ObservationResultsRadiologyUvIpsComponentNumericRatioMeasurement record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + valueQuantity - A measured amount (or an amount that can potentially be measured). Note that measured amounts include amounts that are not precisely quantified, including amounts involving arbitrary units and floating currencies. This profile imposes that the code system for units be UCUM.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentNumericQuantityMeasurement",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type ObservationResultsRadiologyUvIpsComponentNumericQuantityMeasurement record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentNumericSampledDataMeasurement",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type ObservationResultsRadiologyUvIpsComponentNumericSampledDataMeasurement record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsCategoryRadiology",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationResultsRadiologyUvIpsCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationResultsRadiologyUvIpsCategoryRadiology record {|
    *r4:CodeableConcept;
    ...
    ObservationResultsRadiologyUvIpsCategoryCoding[] coding;
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationResultsRadiologyUvIpsComponent record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentObservationText",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type ObservationResultsRadiologyUvIpsComponentObservationText record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
# + code - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
# + interpretation - A categorical assessment of an observation value. For example, high, low, normal.
# + valueRange - A set of ordered Quantities defined by a low and high limit.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsComponentNumericRangeMeasurement",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type ObservationResultsRadiologyUvIpsComponentNumericRangeMeasurement record {|
    *ObservationResultsRadiologyUvIpsComponent;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationResultsRadiologyUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationResultsRadiologyUvIpsHasMember record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsRadiologyUvIpsCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ObservationResultsRadiologyUvIpsCategoryCoding record {|
    *r4:Coding;

    r4:uri system = "http://terminology.hl7.org/CodeSystem/observation-category";
    r4:code code = "imaging";
|};

# ObservationResultsRadiologyUvIpsStatus enum
public enum ObservationResultsRadiologyUvIpsStatus {
