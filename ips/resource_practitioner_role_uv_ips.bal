...
public const string PROFILE_BASE_PRACTITIONERROLEUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/PractitionerRole-uv-ips";
public const RESOURCE_NAME_PRACTITIONERROLEUVIPS = "PractitionerRole";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "notAvailable" : {
            name: "notAvailable",
            dataType: PractitionerRoleUvIpsNotAvailable,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "availableTime" : {
            name: "availableTime",
            dataType: PractitionerRoleUvIpsAvailableTime,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PractitionerRoleUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_PRACTITIONERROLEUVIPS resourceType = RESOURCE_NAME_PRACTITIONERROLEUVIPS;
    ...
    boolean active?;
    r4:code language?;
    PractitionerRoleUvIpsNotAvailable[] notAvailable?;
    PractitionerRoleUvIpsAvailableTime[] availableTime?;
...
@r4:DataTypeDefinition {
    name: "PractitionerRoleUvIpsNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PractitionerRoleUvIpsNotAvailable record {|
    *r4:BackboneElement;
...
public enum PractitionerRoleUvIpsAvailableTimeDaysOfWeek {
...
@r4:DataTypeDefinition {
    name: "PractitionerRoleUvIpsAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: PractitionerRoleUvIpsAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PractitionerRoleUvIpsAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    PractitionerRoleUvIpsAvailableTimeDaysOfWeek[] daysOfWeek?;
