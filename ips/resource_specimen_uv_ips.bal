...
public const string PROFILE_BASE_SPECIMENUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Specimen-uv-ips";
public const RESOURCE_NAME_SPECIMENUVIPS = "Specimen";
...
@r4:ResourceDefinition {
    ...
    elements: {
        "container" : {
            name: "container",
            dataType: SpecimenUvIpsContainer,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "collection" : {
            name: "collection",
            dataType: SpecimenUvIpsCollection,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "processing" : {
            name: "processing",
            dataType: SpecimenUvIpsProcessing,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type SpecimenUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_SPECIMENUVIPS resourceType = RESOURCE_NAME_SPECIMENUVIPS;

    SpecimenUvIpsContainer[] container?;
    ...
    SpecimenUvIpsSubject subject?;
    r4:Extension[] modifierExtension?;
    r4:code language?;
    SpecimenUvIpsCollection collection?;
    ...
    SpecimenUvIpsProcessing[] processing?;
    string id?;
    r4:Narrative text?;
    SpecimenUvIpsStatus status?;
    r4:Element ...;
|};
...
# + method - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
...
public type SpecimenUvIpsCollection record {|
    *r4:BackboneElement;
...
public enum SpecimenUvIpsStatus {
...
public type SpecimenUvIpsSubject record {|
    *r4:Reference;
...
public type SpecimenUvIpsContainer record {|
    *r4:BackboneElement;
...
public type SpecimenUvIpsProcessing record {|
    *r4:BackboneElement;
