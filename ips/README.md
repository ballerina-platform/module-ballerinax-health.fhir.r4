...
International Patient Summary (IPS) FHIR R4 package for constructing and handling IPS-compliant bundles and profile resources. It supports IPS resource modeling and customizable IPS bundle generation logic.
...
- Extensive typed models aligned with IPS profile definitions
- Utility APIs to construct IPS bundles from compatible inputs
- Supports customization via pluggable IPS generation implementations
- Broad IPS profile coverage across medications, conditions, observations, and more
- FHIR R4 JSON-oriented interoperability for cross-border summary exchange
