...
public const string PROFILE_BASE_DEVICEUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Device-uv-ips";
public const RESOURCE_NAME_DEVICEUVIPS = "Device";
...
# + 'type - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "type" : {
            ...
            isArray: false,
            path: "Device.type",
            valueSet: "http://hl7.org/fhir/uv/ips/ValueSet/medical-devices-snomed-absent-unknown-uv-ips"
        },
        "deviceName" : {
            name: "deviceName",
            dataType: DeviceUvIpsDeviceName,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "udiCarrier" : {
            name: "udiCarrier",
            dataType: DeviceUvIpsUdiCarrier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "specialization" : {
            name: "specialization",
            dataType: DeviceUvIpsSpecialization,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DeviceUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_DEVICEUVIPS resourceType = RESOURCE_NAME_DEVICEUVIPS;
    ...
    DeviceUvIpsDeviceName[] deviceName?;
    string manufacturer?;
    r4:CodeableConcept[] statusReason?;
    DeviceUvIpsPatient patient;
    r4:CodeableConcept[] safety?;
    r4:ContactPoint[] contact?;
    DeviceUvIpsProperty[] property?;
    ...
    string serialNumber?;
    string lotNumber?;
    DeviceUvIpsVersion[] 'version?;
    r4:uri url?;
    r4:Resource[] contained?;
    DeviceUvIpsUdiCarrier[] udiCarrier?;
    r4:Meta meta?;
    r4:uri implicitRules?;
    DeviceUvIpsSpecialization[] specialization?;
    r4:Reference location?;
    string modelNumber?;
    string partNumber?;
    DeviceUvIpsStatus status?;
    r4:Element ...;
|};
...
public type DeviceUvIpsVersion record {|
    *r4:BackboneElement;
...
public type DeviceUvIpsPatient record {|
    *r4:Reference;
...
public enum DeviceUvIpsUdiCarrierEntryType {
...
@r4:DataTypeDefinition {
    name: "DeviceUvIpsSpecialization",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DeviceUvIpsSpecialization record {|
    *r4:BackboneElement;
...
public type DeviceUvIpsProperty record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "DeviceUvIpsUdiCarrier",
    baseType: (),
    elements: {
        "entryType": {
            name: "entryType",
            dataType: DeviceUvIpsUdiCarrierEntryType,
            min: 0,
            max: 1,
            isArray: false,
...
public type DeviceUvIpsUdiCarrier record {|
    *r4:BackboneElement;

    DeviceUvIpsUdiCarrierEntryType entryType?;
    r4:Extension[] extension?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: DeviceUvIpsDeviceNameType,
            min: 1,
            max: 1,
            isArray: false,
...
public type DeviceUvIpsDeviceName record {|
    *r4:BackboneElement;
    ...
    string name;
    string id?;
    DeviceUvIpsDeviceNameType 'type;
|};

# DeviceUvIpsDeviceNameType enum
public enum DeviceUvIpsDeviceNameType {
