...
public const string PROFILE_BASE_OBSERVATIONRESULTSLABORATORYUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-uv-ips";
public const RESOURCE_NAME_OBSERVATIONRESULTSLABORATORYUVIPS = "Observation";
...
# + code - Describes what was observed. Sometimes this is called the observation 'name'. In this profile this code represents either a simple laboratory test or a laboratory study with multiple child observations
...
# + hasMember - A reference to another Observation profiled by Observation-results-laboratory-uv-ips. The target observation (for instance an individual test member of a panel) is considered as a sub-observation of the current one, which plays the role of a grouper.
...
# + interpretation - A concept that may be defined by a formal reference to a terminology or ontology or may be provided by text.
...
# + category - A code that classifies the general type of observation being made. In this profile, fixed to 'laboratory'.
# * category Slicings
# 1) ObservationResultsLaboratoryUvIpsCategoryLaboratory: Concept - reference to a terminology or just text
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: ObservationResultsLaboratoryUvIpsHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: ObservationResultsLaboratoryUvIpsComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationResultsLaboratoryUvIpsReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationResultsLaboratoryUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationResultsLaboratoryUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONRESULTSLABORATORYUVIPS resourceType = RESOURCE_NAME_OBSERVATIONRESULTSLABORATORYUVIPS;
    ...
    RangeUvIps valueRange?;
    r4:Extension[] modifierExtension?;
    r4:Reference[] focus?;
    r4:code language?;
    CodeableConceptUvIps valueCodeableConcept?;
    RatioUvIps valueRatio?;
    ...
    ObservationResultsLaboratoryUvIpsHasMember[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    ObservationResultsLaboratoryUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationResultsLaboratoryUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    r4:dateTime effectiveDateTime;
    CodeableConceptUvIps[] interpretation?;
    r4:Meta meta?;
    ...
    r4:Reference device?;
    ObservationResultsLaboratoryUvIpsStatus status;
    r4:Element ...;
|};

# ObservationResultsLaboratoryUvIpsStatus enum
public enum ObservationResultsLaboratoryUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationResultsLaboratoryUvIpsCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ObservationResultsLaboratoryUvIpsCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsLaboratoryUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationResultsLaboratoryUvIpsComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsLaboratoryUvIpsHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationResultsLaboratoryUvIpsHasMember record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsLaboratoryUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationResultsLaboratoryUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "ObservationResultsLaboratoryUvIpsCategoryLaboratory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationResultsLaboratoryUvIpsCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationResultsLaboratoryUvIpsCategoryLaboratory record {|
    *r4:CodeableConcept;
    ...
    ObservationResultsLaboratoryUvIpsCategoryCoding[] coding;
|};
