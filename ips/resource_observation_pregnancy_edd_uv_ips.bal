...
public const string PROFILE_BASE_OBSERVATIONPREGNANCYEDDUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-pregnancy-edd-uv-ips";
public const RESOURCE_NAME_OBSERVATIONPREGNANCYEDDUVIPS = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "subject" : {
            name: "subject",
            dataType: ObservationPregnancyEddUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationPregnancyEddUvIpsComponent,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationPregnancyEddUvIpsReferenceRange,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationPregnancyEddUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationPregnancyEddUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_OBSERVATIONPREGNANCYEDDUVIPS resourceType = RESOURCE_NAME_OBSERVATIONPREGNANCYEDDUVIPS;
    ...
    ObservationPregnancyEddUvIpsSubject subject;
    r4:Range valueRange?;
    ...
    ObservationPregnancyEddUvIpsComponent[] component?;
    r4:Resource[] contained?;
    ObservationPregnancyEddUvIpsReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    ObservationPregnancyEddUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyEddUvIpsReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationPregnancyEddUvIpsReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "ObservationPregnancyEddUvIpsComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationPregnancyEddUvIpsComponent record {|
    *r4:BackboneElement;
...
public enum ObservationPregnancyEddUvIpsStatus {
...
@r4:DataTypeDefinition {
    name: "ObservationPregnancyEddUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type ObservationPregnancyEddUvIpsSubject record {|
    *r4:Reference;
