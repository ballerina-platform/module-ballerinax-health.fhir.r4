...
public const string PROFILE_BASE_MEDIAOBSERVATIONUVIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/Media-observation-uv-ips";
public const RESOURCE_NAME_MEDIAOBSERVATIONUVIPS = "Media";
...
# + status - The status of the result value. Only final observations are eligible to be included in the international patient summary.
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "subject" : {
            name: "subject",
            dataType: MediaObservationUvIpsSubject,
            min: 1,
            max: 1,
            isArray: false,
            path: "Media.subject"
        ...
        "status" : {
            name: "status",
            dataType: MediaObservationUvIpsStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Media.status",
...
public type MediaObservationUvIps record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDIAOBSERVATIONUVIPS resourceType = RESOURCE_NAME_MEDIAOBSERVATIONUVIPS;

    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    r4:CodeableConcept modality?;
    MediaObservationUvIpsSubject subject;
    ...
    r4:Reference device?;
    MediaObservationUvIpsStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "MediaObservationUvIpsSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type MediaObservationUvIpsSubject record {|
    *r4:Reference;
...
public enum MediaObservationUvIpsStatus {
