...
public const string PROFILE_BASE_MEDICATIONREQUESTIPS = "http://hl7.org/fhir/uv/ips/StructureDefinition/MedicationRequest-uv-ips";
public const RESOURCE_NAME_MEDICATIONREQUESTIPS = "MedicationRequest";
...
# + medicationCodeableConcept - Identifies the medication being administered. This is either a link to a resource representing the details of the medication or a simple attribute carrying a code. To improve global interoperability is strongly encouraged that the reference to a medication resource is used, limiting the usage of the medicationCodeableConcept only to the cases in which no other information than a simple code is available.
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "substitution" : {
            name: "substitution",
            dataType: MedicationRequestIPSSubstitution,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "subject" : {
            name: "subject",
            dataType: MedicationRequestIPSSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "dispenseRequest" : {
            ...
            dataType: MedicationRequestIPSDispenseRequest,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "priority" : {
            name: "priority",
            dataType: MedicationRequestIPSPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: MedicationRequestIPSIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "dosageInstruction" : {
            ...
            dataType: MedicationRequestIPSDosageInstruction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: MedicationRequestIPSStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type MedicationRequestIPS record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDICATIONREQUESTIPS resourceType = RESOURCE_NAME_MEDICATIONREQUESTIPS;

    r4:Reference[] insurance?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    MedicationRequestIPSSubstitution substitution?;
    r4:CodeableConcept courseOfTherapyType?;
    r4:Reference priorPrescription?;
    MedicationRequestIPSSubject subject;
    ...
    MedicationRequestIPSDispenseRequest dispenseRequest?;
    string id?;
    ...
    MedicationRequestIPSPriority priority?;
    MedicationRequestIPSIntent intent;
    r4:CodeableConcept performerType?;
    r4:Resource[] contained?;
    MedicationRequestIPSDosageInstruction[] dosageInstruction?;
    r4:Meta meta?;
    r4:Reference[] eventHistory?;
    r4:uri implicitRules?;
    r4:CodeableConcept[] category?;
    r4:Identifier groupIdentifier?;
    MedicationRequestIPSStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "MedicationRequestIPSSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type MedicationRequestIPSSubject record {|
    *r4:Reference;
...
public enum MedicationRequestIPSIntent {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "MedicationRequestIPSSubstitution",
    baseType: (),
    elements: {
...
public type MedicationRequestIPSSubstitution record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "MedicationRequestIPSDispenseRequest",
    baseType: (),
    elements: {
        "validityPeriod": {
            name: "validityPeriod",
        ...
        "initialFill": {
            name: "initialFill",
            dataType: MedicationRequestIPSDispenseRequestInitialFill,
            min: 0,
            max: 1,
            isArray: false,
...
public type MedicationRequestIPSDispenseRequest record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    MedicationRequestIPSDispenseRequestInitialFill initialFill?;
    string id?;
    r4:Duration expectedSupplyDuration?;
|};

# MedicationRequestIPSStatus enum
public enum MedicationRequestIPSStatus {
...
@r4:DataTypeDefinition {
    name: "MedicationRequestIPSDosageInstruction",
    baseType: (),
    elements: {
        "maxDosePerLifetime": {
...
public type MedicationRequestIPSDosageInstruction record {|
    *r4:Dosage;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "MedicationRequestIPSDispenseRequestInitialFill",
    baseType: (),
    elements: {
        "duration": {
            name: "duration",
...
public type MedicationRequestIPSDispenseRequestInitialFill record {|
    *r4:BackboneElement;
...
public enum MedicationRequestIPSPriority {
