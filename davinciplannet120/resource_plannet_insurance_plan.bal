...
public const string PROFILE_BASE_PLANNETINSURANCEPLAN = "http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/plannet-InsurancePlan";
public const RESOURCE_NAME_PLANNETINSURANCEPLAN = "InsurancePlan";
...
@r4:ResourceDefinition {
    ...
    elements: {
        "coverage" : {
            name: "coverage",
            dataType: PlannetInsurancePlanCoverage,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "identifier" : {
            name: "identifier",
            dataType: PlannetInsurancePlanIdentifier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "contact" : {
            name: "contact",
            dataType: PlannetInsurancePlanContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "plan" : {
            name: "plan",
            dataType: PlannetInsurancePlanPlan,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PlannetInsurancePlanStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PlannetInsurancePlan record {|
    *r4:DomainResource;

    RESOURCE_NAME_PLANNETINSURANCEPLAN resourceType = RESOURCE_NAME_PLANNETINSURANCEPLAN;

    PlannetInsurancePlanCoverage[] coverage?;
    PlannetInsurancePlanIdentifier[] identifier?;
    ...
    r4:Meta meta?;
    PlannetInsurancePlanContact[] contact?;
    string name?;
    string[] alias?;
    ...
    PlannetInsurancePlanPlan[] plan?;
    r4:Reference[] coverageArea?;
    PlannetInsurancePlanStatus status;
    r4:Element ...;
|};

# PlannetInsurancePlanIdentifierUse enum
public enum PlannetInsurancePlanIdentifierUse {
...
public enum PlannetInsurancePlanContactTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanPlanSpecificCostBenefit",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "cost": {
            name: "cost",
            dataType: PlannetInsurancePlanPlanSpecificCostBenefitCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetInsurancePlanPlanSpecificCostBenefit record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    PlannetInsurancePlanPlanSpecificCostBenefitCost[] cost?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:CodeableConcept 'type;
|};
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanPlanSpecificCost",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "benefit": {
            name: "benefit",
            dataType: PlannetInsurancePlanPlanSpecificCostBenefit,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetInsurancePlanPlanSpecificCost record {|
    *r4:BackboneElement;
    ...
    PlannetInsurancePlanPlanSpecificCostBenefit[] benefit?;
|};

# PlannetInsurancePlanContactNameUse enum
public enum PlannetInsurancePlanContactNameUse {
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanCoverageBenefitLimit",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PlannetInsurancePlanCoverageBenefitLimit record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanCoverage",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "benefit": {
            name: "benefit",
            dataType: PlannetInsurancePlanCoverageBenefit,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetInsurancePlanCoverage record {|
    *r4:BackboneElement;
    ...
    PlannetInsurancePlanCoverageBenefit[] benefit;
    r4:Reference[] network?;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanContact",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PlannetInsurancePlanContact record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanCoverageBenefit",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "limit": {
            name: "limit",
            dataType: PlannetInsurancePlanCoverageBenefitLimit,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetInsurancePlanCoverageBenefit record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    PlannetInsurancePlanCoverageBenefitLimit[] 'limit?;
    string id?;
    string requirement?;
    r4:CodeableConcept 'type;
|};
...
public enum PlannetInsurancePlanStatus {
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanPlanSpecificCostBenefitCost",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PlannetInsurancePlanPlanSpecificCostBenefitCost record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PlannetInsurancePlanIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetInsurancePlanIdentifier record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PlannetInsurancePlanIdentifierUse use?;
...
public enum PlannetInsurancePlanContactTelecomSystem {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "specificCost": {
            name: "specificCost",
            dataType: PlannetInsurancePlanPlanSpecificCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "generalCost": {
            name: "generalCost",
            dataType: PlannetInsurancePlanPlanGeneralCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetInsurancePlanPlan record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PlannetInsurancePlanPlanSpecificCost[] specificCost?;
    r4:CodeableConcept 'type?;
    r4:Reference[] coverageArea?;
    PlannetInsurancePlanPlanGeneralCost[] generalCost?;
    r4:Reference[] network?;
|};
...
# + 'type - Type of cost.
@r4:DataTypeDefinition {
    name: "PlannetInsurancePlanPlanGeneralCost",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PlannetInsurancePlanPlanGeneralCost record {|
    *r4:BackboneElement;
