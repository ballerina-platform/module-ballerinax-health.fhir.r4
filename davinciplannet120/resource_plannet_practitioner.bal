...
public const string PROFILE_BASE_PLANNETPRACTITIONER = "http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/plannet-Practitioner";
public const RESOURCE_NAME_PLANNETPRACTITIONER = "Practitioner";
...
# * identifier Slicings
# 1) PlannetPractitionerIdentifierNPI: An identifier for the person as this agent
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        "identifier" : {
            name: "identifier",
            dataType: PlannetPractitionerIdentifier,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "address" : {
            name: "address",
            dataType: PlannetPractitionerAddress,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "gender" : {
            name: "gender",
            dataType: PlannetPractitionerGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "qualification" : {
            name: "qualification",
            dataType: PlannetPractitionerQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "name" : {
            name: "name",
            dataType: PlannetPractitionerName,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "telecom" : {
            name: "telecom",
            dataType: PlannetPractitionerTelecom,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "communication" : {
            name: "communication",
            dataType: PlannetPractitionerCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetPractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_PLANNETPRACTITIONER resourceType = RESOURCE_NAME_PLANNETPRACTITIONER;
    ...
    PlannetPractitionerIdentifier[] identifier;
    r4:Extension[] extension?;
    PlannetPractitionerAddress[] address?;
    PlannetPractitionerGender gender?;
    r4:Extension[] modifierExtension?;
    boolean active;
    r4:Attachment[] photo?;
    r4:code language?;
    r4:date birthDate?;
    PlannetPractitionerQualification[] qualification?;
    ...
    PlannetPractitionerName[] name;
    r4:uri implicitRules?;
    PlannetPractitionerTelecom[] telecom?;
    string id?;
    r4:Narrative text?;
    PlannetPractitionerCommunication[] communication?;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerCommunication",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PlannetPractitionerCommunication record {|
    *r4:CodeableConcept;
...
public enum PlannetPractitionerIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerIdentifierNPI",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PlannetPractitionerIdentifierNPI record {|
    *PlannetPractitionerIdentifier;
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PlannetPractitionerIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetPractitionerIdentifier record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system;
    PlannetPractitionerIdentifierUse use?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PlannetPractitionerNameUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetPractitionerName record {|
    *r4:HumanName;
    ...
    r4:Period period?;
    string[] prefix?;
    PlannetPractitionerNameUse use?;
    string id?;
    string text?;
    string family;
    string[] suffix?;
...
public enum PlannetPractitionerNameUse {
...
public enum PlannetPractitionerTelecomSystem {
...
public enum PlannetPractitionerAddressType {
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerAddress",
    baseType: (),
    elements: {
        "country": {
            name: "country",
        ...
        "use": {
            name: "use",
            dataType: PlannetPractitionerAddressUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: PlannetPractitionerAddressType,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetPractitionerAddress record {|
    *r4:Address;
    ...
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.Practitioner.address.line constraint. This field must be an array containing at most one item."
        }
    }
    string[] line?;
    PlannetPractitionerAddressUse use?;
    string district?;
    string postalCode?;
    string id?;
    string state?;
    string text?;
    PlannetPractitionerAddressType 'type?;
|};

# PlannetPractitionerAddressUse enum
public enum PlannetPractitionerAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
public enum PlannetPractitionerGender {
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type PlannetPractitionerQualification record {|
    *r4:BackboneElement;
...
public enum PlannetPractitionerTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
...
@r4:DataTypeDefinition {
    name: "PlannetPractitionerTelecom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "system": {
            name: "system",
            dataType: PlannetPractitionerTelecomSystem,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "use": {
            name: "use",
            dataType: PlannetPractitionerTelecomUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetPractitionerTelecom record {|
    *r4:ContactPoint;

    r4:Extension[] extension?;
    r4:Period period?;
    PlannetPractitionerTelecomSystem system?;
    PlannetPractitionerTelecomUse use?;
    r4:positiveInt rank?;
    string id?;
    string value?;
|};
