...
public const string PROFILE_BASE_PLANNETNETWORK = "http://hl7.org/fhir/us/davinci-pdex-plan-net/StructureDefinition/plannet-Network";
public const RESOURCE_NAME_PLANNETNETWORK = "Organization";
...
# * identifier Slicings
# 1) PlannetNetworkIdentifierNPI: National Provider Identifier (NPI)
#       - min = 0
#       - max = *
#
# 2) PlannetNetworkIdentifierNAIC: NAIC Code
#       - min = 0
#       - max = *
#
# 3) PlannetNetworkIdentifierCLIA: Clinical Laboratory Improvement Amendments (CLIA) Number for laboratories
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        "identifier" : {
            name: "identifier",
            dataType: PlannetNetworkIdentifier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "contact" : {
            name: "contact",
            dataType: PlannetNetworkContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlannetNetwork record {|
    *r4:DomainResource;

    RESOURCE_NAME_PLANNETNETWORK resourceType = RESOURCE_NAME_PLANNETNETWORK;

    PlannetNetworkIdentifier[] identifier?;
    r4:Reference partOf;
...
public enum PlannetNetworkIdentifierUse {
...
public enum PlannetNetworkContactTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
...
@r4:DataTypeDefinition {
    name: "PlannetNetworkIdentifierCLIA",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PlannetNetworkIdentifierCLIA record {|
    *PlannetNetworkIdentifier;

    r4:uri system = "urn:oid:2.16.840.1.113883.4.7";
|};

# PlannetNetworkContactTelecomSystem enum
public enum PlannetNetworkContactTelecomSystem {
...
public enum PlannetNetworkTelecomSystem {
   CODE_SYSTEM_OTHER = "other",
   CODE_SYSTEM_PAGER = "pager",
   CODE_SYSTEM_PHONE = "phone",
   CODE_SYSTEM_SMS = "sms",
...
public enum PlannetNetworkTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_MOBILE = "mobile",
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "PlannetNetworkIdentifierNPI",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PlannetNetworkIdentifierNPI record {|
    *PlannetNetworkIdentifier;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PlannetNetworkIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlannetNetworkIdentifier record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PlannetNetworkIdentifierUse use?;
...
public enum PlannetNetworkAddressType {
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "PlannetNetworkIdentifierNAIC",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PlannetNetworkIdentifierNAIC record {|
    *PlannetNetworkIdentifier;
...
public enum PlannetNetworkAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
public type PlannetNetworkContact record {|
    *r4:BackboneElement;
