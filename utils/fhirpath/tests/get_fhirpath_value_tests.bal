...
public function testgetFhirPathResult() returns error? {
    FhirPathResult fhirPathResult = getFhirPathResult(samplePatient1, "Patient.address.mor");
    ...
    FhirPathResult fhirPathResultTwo = getFhirPathResult(samplePatient1, "Patient.id");
