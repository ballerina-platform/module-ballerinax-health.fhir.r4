...
function testModificationFunctionOnSimpleStringField() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.gender", toUpperCaseFunction);
...
function testModificationFunctionOnNestedStringField() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.managingOrganization.display", toLowerCaseFunction);
...
function testModificationFunctionOnArrayElementField() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.name[0].family", addPrefixFunction);
...
function testModificationFunctionOnMultipleArrayElements() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.address.city", toUpperCaseFunction);
...
function testModificationFunctionWithHashFunction() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.gender", hashFunction);
...
function testModificationFunctionWithEmptyStringResult() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.gender", emptyStringFunction);
...
function testModificationFunctionWithReverseString() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.name[0].family", reverseStringFunction);
...
function testModificationFunctionError() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.gender", errorFunction);
...
function testModificationFunctionOnNonStringValue() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.active", toUpperCaseFunction);
...
function testModificationFunctionOnDeeplyNestedField() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.contact[0].name.family", addPrefixFunction);
...
function testModificationFunctionOnComplexArrayStructure() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.identifier.value", hashFunction);
...
function testModificationFunctionOnSpecificArrayIndex() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.telecom[1].value", toUpperCaseFunction);
...
function testModificationFunctionChaining() {
    ...
    json|FHIRPathError result1 = setFhirPathValues(testResource, "Patient.name[0].family", toUpperCaseFunction);
    test:assertTrue(result1 is json, "First modification should succeed");

    if result1 is json {
        // Then apply prefix to the result
        json|FHIRPathError result2 = setFhirPathValues(result1, "Patient.name[0].family", addPrefixFunction);
...
function testModificationFunctionWithEmptyArray() {
    ...
    json|FHIRPathError result = setFhirPathValues(testResource, "Patient.name.family", toUpperCaseFunction);
