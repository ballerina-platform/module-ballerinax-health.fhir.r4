...
public const string PROFILE_BASE_HREXPROVENANCE = "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-provenance";
public const RESOURCE_NAME_HREXPROVENANCE = "Provenance";
...
# * agent Slicings
# 1) HRexProvenanceAgentProvenanceAuthor: Actor involved
#       - min = 0
#       - max = *
#
# 2) HRexProvenanceAgentProvenanceTransmitter: Actor involved
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-provenance",
    elements: {
        "reason" : {
            name: "reason",
...
public type HRexProvenance record {|
    *r4:DomainResource;

    RESOURCE_NAME_HREXPROVENANCE resourceType = RESOURCE_NAME_HREXPROVENANCE;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "role": {
            name: "role",
            dataType: HRexProvenanceEntityRole,
            min: 1,
            max: 1,
            isArray: false,
...
public type HRexProvenanceEntity record {|
    *r4:BackboneElement;

    international401:ProvenanceAgent [] agent?;
    r4:Extension[] extension?;
    HRexProvenanceEntityRole role;
    r4:Reference what;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexProvenanceAgentTypeCoding record {|
    *r4:Coding;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexProvenanceAgentTypeCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentProvenanceTransmitter",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: HRexProvenanceAgentTypeOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type HRexProvenanceAgentProvenanceTransmitter record {|
    *HRexProvenanceAgent;
    ...
    string id?;
    HRexProvenanceAgentTypeOne 'type;
    r4:Reference who;
|};
...
# + who - The individual, device or organization that participated in the event.
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentProvenanceAuthor",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: HRexProvenanceAgentType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The participation the agent had with respect to the activity.",
...
public type HRexProvenanceAgentProvenanceAuthor record {|
    *HRexProvenanceAgent;
...
public type HRexProvenanceAgent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexProvenanceAgentTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexProvenanceAgentType record {|
    *r4:CodeableConcept;
    ...
    HRexProvenanceAgentTypeCoding[] coding;
|};

# HRexProvenanceEntityRole enum
public enum HRexProvenanceEntityRole {
...
public type HRexProvenanceTarget record {|
    *r4:Reference;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "HRexProvenanceAgentTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexProvenanceAgentTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type HRexProvenanceAgentTypeOne record {|
    *r4:CodeableConcept;
    ...
    HRexProvenanceAgentTypeCodingOne[] coding;
|};
