...
public const string PROFILE_BASE_HREXCOVERAGE = "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-coverage";
public const RESOURCE_NAME_HREXCOVERAGE = "Coverage";
...
# * class Slicings
# 1) HRexCoverageClassGroup: Additional coverage classifications
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "costToBeneficiary" : {
            ...
            dataType: HRexCoverageCostToBeneficiary,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexCoverage record {|
    *r4:DomainResource;

    RESOURCE_NAME_HREXCOVERAGE resourceType = RESOURCE_NAME_HREXCOVERAGE;
    ...
    @constraint:Array {
        maxLength: {
            value: 1,
            message: "Validation failed for $.Coverage.identifier constraint. This field must be an array containing at most one item."
        }
    }
    ...
    HRexCoverageStatus status;
    r4:Element ...;
|};

# HRexCoverageIdentifierUse enum
public enum HRexCoverageIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "HRexCoverageClassTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexCoverageClassTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: HRexCoverageIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type HRexCoverageIdentifier record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    HRexCoverageIdentifierUse use?;
...
public enum HRexCoverageStatus {
...
public type HRexCoverageClass record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HRexCoverageCostToBeneficiaryException",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type HRexCoverageCostToBeneficiaryException record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HRexCoverageCostToBeneficiary",
    baseType: (),
    elements: {
        "exception": {
            name: "exception",
            dataType: HRexCoverageCostToBeneficiaryException,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexCoverageCostToBeneficiary record {|
    *r4:BackboneElement;

    HRexCoverageCostToBeneficiaryException[] exception?;
    r4:Extension[] extension?;
    r4:Money valueMoney?;
    r4:Extension[] modifierExtension?;
    string id?;
...
@r4:DataTypeDefinition {
    name: "HRexCoverageClassType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexCoverageClassTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexCoverageClassType record {|
    *r4:CodeableConcept;
    ...
    HRexCoverageClassTypeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: HRexCoverageClassType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of classification for which an insurer-specific class label or number and optional name is provided, for example may be used to identify a class of coverage or employer group, Policy, Plan.",
...
public type HRexCoverageClassGroup record {|
    *HRexCoverageClass;
