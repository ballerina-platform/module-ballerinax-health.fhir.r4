...
public const string PROFILE_BASE_HREXMEMBERMATCHREQUESTPARAMETERS = "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-parameters-member-match-in";
public const RESOURCE_NAME_HREXMEMBERMATCHREQUESTPARAMETERS = "Parameters";
...
# * parameter Slicings
# 1) HRexMemberMatchRequestParametersParameterMemberPatient: Operation Parameter
#       - min = 1
#       - max = 1
#
# 2) HRexMemberMatchRequestParametersParameterConsent: Operation Parameter
#       - min = 1
#       - max = 1
#
# 3) HRexMemberMatchRequestParametersParameterCoverageToLink: Operation Parameter
#       - min = 0
#       - max = 1
#
# 4) HRexMemberMatchRequestParametersParameterCoverageToMatch: Operation Parameter
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-parameters-member-match-in",
    elements: {
        "meta" : {
            name: "meta",
            dataType: r4:Meta,
        ...
        "parameter" : {
            name: "parameter",
            dataType: HRexMemberMatchRequestParametersParameter,
            min: 3,
            max: 4,
            isArray: true,
...
public type HRexMemberMatchRequestParameters record {|
    *r4:DomainResource;

    RESOURCE_NAME_HREXMEMBERMATCHREQUESTPARAMETERS resourceType = RESOURCE_NAME_HREXMEMBERMATCHREQUESTPARAMETERS;
    ...
    HRexMemberMatchRequestParametersParameter[] 'parameter;
...
# + 'resource - This is the Coverage profile which is used to provide insurance information for scheduling an appointment and/or registering a patient.
...
@r4:DataTypeDefinition {
    name: "HRexMemberMatchRequestParametersParameterCoverageToLink",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
        ...
        "resource": {
            ...
            max: 1,
            isArray: false,
            description: "This is the Coverage profile which is used to provide insurance information for scheduling an appointment and/or registering a patient.",
...
public type HRexMemberMatchRequestParametersParameterCoverageToLink record {|
    *HRexMemberMatchRequestParametersParameter;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "HRexMemberMatchRequestParametersParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type HRexMemberMatchRequestParametersParameter record {|
    *r4:BackboneElement;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "HRexMemberMatchRequestParametersParameterConsent",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
        ...
        "resource": {
            ...
            max: 1,
            isArray: false,
            description: "This Consent profile conveys high-level computable information about a member's consent for information sharing, along with information that allows a party depending on the consent to follow up with the consent holder to access the 'original' consent, be it in paper form, audio recording or electronic for audit purposes.",
            path: "Parameters.parameter.resource"
        },
        "valueCode": {
            name: "valueCode",
...
public type HRexMemberMatchRequestParametersParameterConsent record {|
    *HRexMemberMatchRequestParametersParameter;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "HRexMemberMatchRequestParametersParameterCoverageToMatch",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type HRexMemberMatchRequestParametersParameterCoverageToMatch record {|
    *HRexMemberMatchRequestParametersParameter;
...
# + valueCount - If the parameter is a data type.
# + valueId - If the parameter is a data type.
# + 'resource - The US Core Patient Profile is based upon the core FHIR Patient Resource and designed to meet the applicable patient demographic data elements from the 2015 Edition Common Clinical Data Set.
# + valueCode - If the parameter is a data type.
# + valueAddress - If the parameter is a data type.
# + valueContactPoint - If the parameter is a data type.
# + valuePeriod - If the parameter is a data type.
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "HRexMemberMatchRequestParametersParameterMemberPatient",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
        ...
        "resource": {
            ...
            max: 1,
            isArray: false,
            description: "The US Core Patient Profile is based upon the core FHIR Patient Resource and designed to meet the applicable patient demographic data elements from the 2015 Edition Common Clinical Data Set.",
            path: "Parameters.parameter.resource"
        },
        "valueCode": {
            name: "valueCode",
...
public type HRexMemberMatchRequestParametersParameterMemberPatient record {|
    *HRexMemberMatchRequestParametersParameter;
