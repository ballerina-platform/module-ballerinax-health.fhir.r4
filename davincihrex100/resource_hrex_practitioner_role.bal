...
public const string PROFILE_BASE_HREXPRACTITIONERROLE = "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-practitionerrole";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-practitionerrole",
    elements: {
        "identifier" : {
            name: "identifier",
        ...
        "specialty" : {
            ...
            valueSet: "http://hl7.org/fhir/us/core/ValueSet/us-core-provider-specialty"
        },
        "code" : {
            name: "code",
            dataType: r4:CodeableConcept,
        ...
        "notAvailable" : {
            name: "notAvailable",
            dataType: HRexPractitionerRoleNotAvailable,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "availableTime" : {
            name: "availableTime",
            dataType: HRexPractitionerRoleAvailableTime,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexPractitionerRole record {|
    *r4:DomainResource;

    RESOURCE_NAME_HREXPRACTITIONERROLE resourceType = RESOURCE_NAME_HREXPRACTITIONERROLE;
    ...
    boolean active?;
    r4:code language?;
    HRexPractitionerRoleNotAvailable[] notAvailable?;
    HRexPractitionerRoleAvailableTime[] availableTime?;
...
@r4:DataTypeDefinition {
    name: "HRexPractitionerRoleNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type HRexPractitionerRoleNotAvailable record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HRexPractitionerRoleAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: HRexPractitionerRoleAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type HRexPractitionerRoleAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    HRexPractitionerRoleAvailableTimeDaysOfWeek[] daysOfWeek?;
    r4:time availableStartTime?;
|};

# HRexPractitionerRoleAvailableTimeDaysOfWeek enum
public enum HRexPractitionerRoleAvailableTimeDaysOfWeek {
...
public enum HRexPractitionerRoleTelecomSystem {
...
public enum HRexPractitionerRoleTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
