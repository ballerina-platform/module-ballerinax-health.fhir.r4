...
public enum HRexMemberMatchResponseParametersParameterValueUse {
...
@r4:DataTypeDefinition {
    name: "HRexMemberMatchResponseParametersParameterValueTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
            ...
            path: "Parameters.parameter.value[x].type.coding.system"
        },
        "code": {
            name: "code",
            dataType: r4:code,
            ...
            path: "Parameters.parameter.value[x].type.coding.code"
        }
    },
    serializers: {
        'xml: r4:complexDataTypeXMLSerializer,
...
public type HRexMemberMatchResponseParametersParameterValueTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "HRexMemberMatchResponseParametersParameterValue",
    baseType: (),
    elements: {
        "period": {
            name: "period",
        ...
        "use": {
            name: "use",
            dataType: HRexMemberMatchResponseParametersParameterValueUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: HRexMemberMatchResponseParametersParameterValueType,
            min: 1,
            max: 1,
            isArray: false,
...
public type HRexMemberMatchResponseParametersParameterValue record {|
    *r4:Identifier;

    r4:Period period?;
    r4:uri system?;
    HRexMemberMatchResponseParametersParameterValueUse use?;
    r4:Reference assigner?;
    HRexMemberMatchResponseParametersParameterValueType 'type;
    string value;
|};
...
@r4:DataTypeDefinition {
    name: "HRexMemberMatchResponseParametersParameterValueType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexMemberMatchResponseParametersParameterValueTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
            path: "Parameters.parameter.value[x].type.coding"
        }
    },
    serializers: {
        'xml: r4:complexDataTypeXMLSerializer,
...
public type HRexMemberMatchResponseParametersParameterValueType record {|
    *r4:CodeableConcept;

    @constraint:Array {
       minLength: 1
    }
    HRexMemberMatchResponseParametersParameterValueTypeCoding[] coding;
|};
...
public type HRexMemberMatchResponseParametersParameterMemberIdentifier record {|
    *HRexMemberMatchResponseParametersParameter;
    ...
    r4:Extension[] extension?;
    HRexMemberMatchResponseParametersParameterValue valueIdentifier;
    r4:Resource 'resource?;
    r4:Extension[] modifierExtension?;
