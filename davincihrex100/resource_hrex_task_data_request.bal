...
public const string PROFILE_BASE_HREXTASKDATAREQUEST = "http://hl7.org/fhir/us/davinci-hrex/StructureDefinition/hrex-task-data-request";
public const RESOURCE_NAME_HREXTASKDATAREQUEST = "Task";
...
# * output Slicings
# 1) HRexTaskDataRequestOutputData: Requested data
#       - min = 0
#       - max = *
#
...
# * input Slicings
# 1) HRexTaskDataRequestInputCode: Requested data code
#       - min = 0
#       - max = 1
#
# 2) HRexTaskDataRequestInputQuery: Requested query
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "output" : {
            name: "output",
            dataType: HRexTaskDataRequestOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Task.output"
        ...
        "statusReason" : {
            name: "statusReason",
            dataType: HRexTaskDataRequestStatusReason,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "reasonCode" : {
            name: "reasonCode",
            dataType: HRexTaskDataRequestReasonCode,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "businessStatus" : {
            name: "businessStatus",
            dataType: HRexTaskDataRequestBusinessStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "priority" : {
            name: "priority",
            dataType: HRexTaskDataRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
            path: "Task.priority",
        ...
        "intent" : {
            name: "intent",
            dataType: HRexTaskDataRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
            path: "Task.intent",
        ...
        "input" : {
            name: "input",
            dataType: HRexTaskDataRequestInput,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Task.input"
        ...
        "restriction" : {
            name: "restriction",
            dataType: HRexTaskDataRequestRestriction,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: HRexTaskDataRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Task.status",
...
public type HRexTaskDataRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_HREXTASKDATAREQUEST resourceType = RESOURCE_NAME_HREXTASKDATAREQUEST;
    ...
    HRexTaskDataRequestOutput[] output?;
    HRexTaskDataRequestStatusReason statusReason?;
    r4:Period executionPeriod?;
    string id?;
    HRexTaskDataRequestReasonCode reasonCode?;
    r4:Narrative text?;
    ...
    HRexTaskDataRequestBusinessStatus businessStatus?;
    r4:Reference encounter?;
    r4:canonical instantiatesCanonical?;
    HRexTaskDataRequestPriority priority?;
    HRexTaskDataRequestIntent intent;
    ...
    HRexTaskDataRequestInput[] input;
    r4:Resource[] contained?;
    r4:Meta meta?;
    HRexTaskDataRequestRestriction restriction?;
    r4:uri implicitRules?;
    r4:Reference location?;
    r4:dateTime lastModified?;
    r4:Identifier groupIdentifier?;
    HRexTaskDataRequestStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestBusinessStatus",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type HRexTaskDataRequestBusinessStatus record {|
    *r4:CodeableConcept;
...
public enum HRexTaskDataRequestStatus {
...
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestRestriction",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type HRexTaskDataRequestRestriction record {|
    *r4:BackboneElement;
...
public type HRexTaskDataRequestInput record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexTaskDataRequestInputTypeCoding record {|
    *r4:Coding;

    r4:uri system = "http://hl7.org/fhir/us/davinci-hrex/CodeSystem/hrex-temp";
    r4:code code = "data-code";
|};

# HRexTaskDataRequestIntent enum
public enum HRexTaskDataRequestIntent {
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexTaskDataRequestInputTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type HRexTaskDataRequestInputTypeOne record {|
    *r4:CodeableConcept;
    ...
    HRexTaskDataRequestInputTypeCodingOne[] coding;
|};
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestReasonCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "extension": {
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "Task.reasonCode.extension"
        },
        "id": {
            name: "id",
            dataType: string,
...
public type HRexTaskDataRequestReasonCode record {|
    *r4:CodeableConcept;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestStatusReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type HRexTaskDataRequestStatusReason record {|
    *r4:CodeableConcept;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexTaskDataRequestInputTypeCodingOne record {|
    *r4:Coding;

    r4:uri system = "http://hl7.org/fhir/us/davinci-hrex/CodeSystem/hrex-temp";
    r4:code code = "data-query";
|};
...
# + 'type - A code or description indicating how the input is intended to be used as part of the task execution.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputQuery",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: HRexTaskDataRequestInputTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code or description indicating how the input is intended to be used as part of the task execution.",
...
public type HRexTaskDataRequestInputQuery record {|
    *HRexTaskDataRequestInput;

    r4:Extension[] extension?;
    string valueString?;
    r4:Extension[] modifierExtension?;
    string id?;
    HRexTaskDataRequestInputTypeOne 'type;
|};
...
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestOutputData",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: HRexTaskDataRequestOutputType,
            min: 1,
            max: 1,
            isArray: false,
...
public type HRexTaskDataRequestOutputData record {|
    *HRexTaskDataRequestOutput;

    r4:Extension[] extension?;
    r4:Reference valueReference?;
    r4:Extension[] modifierExtension?;
    string id?;
    HRexTaskDataRequestOutputType 'type;
|};
...
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestOutput",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type HRexTaskDataRequestOutput record {|
    *r4:BackboneElement;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexTaskDataRequestInputTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type HRexTaskDataRequestInputType record {|
    *r4:CodeableConcept;
    ...
    HRexTaskDataRequestInputTypeCoding[] coding;
|};

# HRexTaskDataRequestPriority enum
public enum HRexTaskDataRequestPriority {
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestOutputTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type HRexTaskDataRequestOutputTypeCoding record {|
    *r4:Coding;

    r4:uri system = "http://hl7.org/fhir/us/davinci-hrex/CodeSystem/hrex-temp";
    r4:code code = "data-value";
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestOutputType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: HRexTaskDataRequestOutputTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type HRexTaskDataRequestOutputType record {|
    *r4:CodeableConcept;
    ...
    HRexTaskDataRequestOutputTypeCoding[] coding;
|};
...
# + 'type - A code or description indicating how the input is intended to be used as part of the task execution.
@r4:DataTypeDefinition {
    name: "HRexTaskDataRequestInputCode",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "type": {
            name: "type",
            dataType: HRexTaskDataRequestInputType,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code or description indicating how the input is intended to be used as part of the task execution.",
...
public type HRexTaskDataRequestInputCode record {|
    *HRexTaskDataRequestInput;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    HRexTaskDataRequestInputType 'type;
|};
