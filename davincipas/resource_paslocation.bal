...
public const string PROFILE_BASE_PASLOCATION = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-location";
public const RESOURCE_NAME_PASLOCATION = "Location";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-location",
    elements: {
        "operationalStatus" : {
        ...
        "hoursOfOperation" : {
            ...
            dataType: PASLocationHoursOfOperation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASLocation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASLOCATION resourceType = RESOURCE_NAME_PASLOCATION;
    ...
    string description?;
    PASLocationHoursOfOperation[] hoursOfOperation?;
    r4:code language?;
    r4:CodeableConcept[] 'type?;
    PASLocationMode mode?;
    ...
    PASLocationPosition position?;
    string availabilityExceptions?;
    PASLocationStatus status?;
    r4:Element ...;
|};
...
public type PASLocationPosition record {|
    *r4:BackboneElement;
...
public enum PASLocationMode {
   CODE_MODE_INSTANCE = "instance",
   CODE_MODE_KIND = "kind"
}

# PASLocationStatus enum
public enum PASLocationStatus {
...
public enum PASLocationAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
public enum PASLocationAddressType {
...
public enum PASLocationHoursOfOperationDaysOfWeek {
...
@r4:DataTypeDefinition {
    name: "PASLocationHoursOfOperation",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: PASLocationHoursOfOperationDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASLocationHoursOfOperation record {|
    *r4:BackboneElement;
    ...
    r4:time openingTime?;
    string id?;
    PASLocationHoursOfOperationDaysOfWeek[] daysOfWeek?;
|};
