...
public const string PROFILE_BASE_PASCOMMUNICATIONREQUEST = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-communicationrequest";
public const RESOURCE_NAME_PASCOMMUNICATIONREQUEST = "CommunicationRequest";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "medium" : {
            ...
            valueSet: "http://hl7.org/fhir/us/davinci-pas/ValueSet/PASCommunicationRequestMedium"
        },
        "statusReason" : {
            name: "statusReason",
            dataType: r4:CodeableConcept,
        ...
        "payload" : {
            name: "payload",
            dataType: PASCommunicationRequestPayload,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority" : {
            name: "priority",
            dataType: PASCommunicationRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "category" : {
            ...
            valueSet: "https://valueset.x12.org/x217/005010/response/2000D/PWK/1/01/00/755"
        },
        "groupIdentifier" : {
        ...
        "status" : {
            name: "status",
            dataType: PASCommunicationRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASCommunicationRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCOMMUNICATIONREQUEST resourceType = RESOURCE_NAME_PASCOMMUNICATIONREQUEST;
    ...
    PASCommunicationRequestPayload[] payload?;
    string id?;
    ...
    PASCommunicationRequestPriority priority?;
    ...
    PASCommunicationRequestStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "PASCommunicationRequestPayload",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASCommunicationRequestPayload record {|
    *r4:BackboneElement;
...
public enum PASCommunicationRequestStatus {
...
public enum PASCommunicationRequestPriority {
