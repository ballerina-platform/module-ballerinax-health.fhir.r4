...
public const string PROFILE_BASE_PASBENEFICIARY = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-beneficiary";
public const RESOURCE_NAME_PASBENEFICIARY = "Patient";

public type PASBeneficiaryExtensions (r4:Extension | ExtensionMilitaryStatus );
...
# + identifier - An identifier for this patient.
    # * identifier Slicings
        # 1) PASBeneficiaryIdentifierMemberIdentifier: An identifier for this patient
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "contact" : {
            name: "contact",
            dataType: PASBeneficiaryContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "communication" : {
            name: "communication",
            dataType: PASBeneficiaryCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "identifier" : {
            name: "identifier",
            dataType: PASBeneficiaryIdentifier,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "address" : {
            name: "address",
            dataType: PASBeneficiaryAddress,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASBeneficiary record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASBENEFICIARY resourceType = RESOURCE_NAME_PASBENEFICIARY;

    r4:Extension[] extension?;
    PASBeneficiaryGender gender;
    r4:Extension[] modifierExtension?;
    PASBeneficiaryLink[] link?;
    r4:code language?;
    PASBeneficiaryContact[] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference[] generalPractitioner?;
    r4:ContactPoint[] telecom?;
    string id?;
    r4:Narrative text?;
    PASBeneficiaryCommunication[] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PASBeneficiaryIdentifier [] identifier;
    PASBeneficiaryAddress[] address?;
...
public enum PASBeneficiaryTelecomSystem {
...
public enum PASBeneficiaryTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
...
# FHIR PASBeneficiaryIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASBeneficiaryIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASBeneficiaryIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASBeneficiaryIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASBeneficiaryIdentifierTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PASBeneficiaryLinkType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASBeneficiaryLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PASBeneficiaryLinkType 'type;
|};


# PASBeneficiaryIdentifierUseOne enum
public enum PASBeneficiaryIdentifierUseOne {
...
# FHIR PASBeneficiaryIdentifierTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASBeneficiaryIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASBeneficiaryIdentifierTypeCoding record {|
    *r4:Coding;
...
# FHIR PASBeneficiaryIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASBeneficiaryIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASBeneficiaryIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PASBeneficiaryIdentifierUse use?;
...
public enum PASBeneficiaryContactGender {
...
public enum PASBeneficiaryAddressType {
...
public enum PASBeneficiaryNameUse {
...
# FHIR PASBeneficiaryIdentifierMemberIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + period - Time period during which identifier is/was valid for use.
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
...
@r4:DataTypeDefinition {
    name: "PASBeneficiaryIdentifierMemberIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PASBeneficiaryIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
        ...
        "type": {
            name: "type",
            dataType: PASBeneficiaryIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
            description: "A coded type for the identifier that can be used to determine which identifier to use for a specific purpose.",
...
public type PASBeneficiaryIdentifierMemberIdentifier record {|
    *PASBeneficiaryIdentifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PASBeneficiaryIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    PASBeneficiaryIdentifierType 'type;
    string value;
|};


# PASBeneficiaryGender enum
public enum PASBeneficiaryGender {
   CODE_GENDER_OTHER = "other",
   CODE_GENDER_FEMALE = "female",
   CODE_GENDER_MALE = "male",
   CODE_GENDER_UNKNOWN = "unknown"
...
public enum PASBeneficiaryLinkType {
...
public enum PASBeneficiaryIdentifierUse {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
...
@r4:DataTypeDefinition {
    name: "PASBeneficiaryCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASBeneficiaryCommunication record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: PASBeneficiaryContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASBeneficiaryContact record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:Address address?;
    PASBeneficiaryContactGender gender?;
    r4:Extension[] modifierExtension?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASBeneficiaryNameUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASBeneficiaryName record {|
    *r4:HumanName;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASBeneficiaryAddressUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: PASBeneficiaryAddressType,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASBeneficiaryAddress record {|
    *r4:Address;
    ...
    string city?;
    string[] line?;
    PASBeneficiaryAddressUse use?;
    string district?;
    string postalCode?;
    string id?;
    string state?;
    string text?;
    PASBeneficiaryAddressType 'type?;
|};

# PASBeneficiaryAddressUse enum
public enum PASBeneficiaryAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
