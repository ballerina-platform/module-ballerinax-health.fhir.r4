...
public const string PROFILE_BASE_PASCOVERAGE = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-coverage";
public const RESOURCE_NAME_PASCOVERAGE = "Coverage";
...
# + 'class - A suite of underwriter specific classifiers.
    # * class Slicings
        # 1) PASCoverageClassPlan: Plan
        #       - min = 0
        #       - max = 1
        #
        # 2) PASCoverageClassGroup: Group
        #       - min = 0
        #       - max = 1
        #
...
# + identifier - A unique identifier assigned to this coverage.
    # * identifier Slicings
        # 1) PASCoverageIdentifierMemberid: Member ID
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "relationship" : {
            name: "relationship",
            dataType: PASCoverageRelationship,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "costToBeneficiary" : {
            ...
            dataType: PASCoverageCostToBeneficiary,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASCoverage record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCOVERAGE resourceType = RESOURCE_NAME_PASCOVERAGE;
    ...
    string id?;
    r4:Narrative text?;
    PASCoverageRelationship relationship;
    PASCoverageClass[] 'class?;
    string dependent?;
    r4:positiveInt 'order?;
    r4:Identifier[] identifier?;
    PASCoverageCostToBeneficiary[] costToBeneficiary?;
    r4:Period period?;
    ...
    PASCoverageStatus status;
    r4:Element ...;
|};

# PASCoverageStatus enum
public enum PASCoverageStatus {
...
# FHIR PASCoverageClassGroup datatype record.
#
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PASCoverageClassTypeOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASCoverageClassGroup record {|
    *PASCoverageClass;
    ...
    string name?;
    string id?;
    PASCoverageClassTypeOne 'type;
    string value;
|};


# FHIR PASCoverageClassPlan datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + name - A short description for the class.
...
public type PASCoverageClassPlan record {|
    *PASCoverageClass;
    ...
    string name?;
    string id?;
    PASCoverageClassType 'type;
    string value;
|};


# FHIR PASCoverageClassTypeCodingOne datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASCoverageClassTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASCoverageClassTypeCodingOne record {|
    *r4:Coding;
...
#
@r4:DataTypeDefinition {
    name: "PASCoverageRelationshipCodingX12Code",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PASCoverageRelationshipCodingX12Code record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "PASCoverageCostToBeneficiary",
    baseType: (),
    elements: {
        "exception": {
            name: "exception",
            dataType: PASCoverageCostToBeneficiaryException,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASCoverageCostToBeneficiary record {|
    *r4:BackboneElement;

    PASCoverageCostToBeneficiaryException[] exception?;
    r4:Extension[] extension?;
    r4:Money valueMoney?;
    r4:Extension[] modifierExtension?;
    string id?;
...
# FHIR PASCoverageIdentifierMemberid datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PASCoverageIdentifierMemberid",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PASCoverageIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: PASCoverageIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASCoverageIdentifierMemberid record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system?;
    PASCoverageIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    PASCoverageIdentifierType 'type;
    string value?;
|};


# FHIR PASCoverageClassTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "PASCoverageClassTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASCoverageClassTypeCoding record {|
    *r4:Coding;
...
# FHIR PASCoverageIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASCoverageIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASCoverageIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASCoverageIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASCoverageIdentifierTypeCoding [] coding;
|};


# FHIR PASCoverageIdentifierTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "PASCoverageIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASCoverageIdentifierTypeCoding record {|
    *r4:Coding;
...
# PASCoverageIdentifierUse enum
public enum PASCoverageIdentifierUse {
...
# FHIR PASCoverageClassType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASCoverageClassType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASCoverageClassTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASCoverageClassType record {|
    *r4:CodeableConcept;
    ...
    PASCoverageClassTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "PASCoverageCostToBeneficiaryException",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASCoverageCostToBeneficiaryException record {|
    *r4:BackboneElement;
...
public type PASCoverageClass record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "extension": {
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "Coverage.relationship.extension"
        },
...
public type PASCoverageRelationship record {|
    *r4:CodeableConcept;
...
# FHIR PASCoverageClassTypeOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASCoverageClassTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASCoverageClassTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASCoverageClassTypeOne record {|
    *r4:CodeableConcept;
    ...
    PASCoverageClassTypeCodingOne [] coding;
|};
