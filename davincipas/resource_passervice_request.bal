...
public const string PROFILE_BASE_PASSERVICEREQUEST = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-servicerequest";
public const RESOURCE_NAME_PASSERVICEREQUEST = "ServiceRequest";
...
# + quantityQuantity - The comparator is not used on a SimpleQuantity
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "priority" : {
            name: "priority",
            dataType: PASServiceRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: PASServiceRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: PASServiceRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASServiceRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASSERVICEREQUEST resourceType = RESOURCE_NAME_PASSERVICEREQUEST;
    ...
    ProfileQuantity quantityQuantity?;
    ...
    PASServiceRequestPriority priority?;
    PASServiceRequestIntent intent;
    ...
    PASServiceRequestStatus status;
    r4:Element ...;
|};

# PASServiceRequestPriority enum
public enum PASServiceRequestPriority {
...
public enum PASServiceRequestStatus {
...
public enum PASServiceRequestIntent {
