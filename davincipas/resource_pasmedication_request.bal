...
public const string PROFILE_BASE_PASMEDICATIONREQUEST = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-medicationrequest";
public const RESOURCE_NAME_PASMEDICATIONREQUEST = "MedicationRequest";
...
# + category - Indicates the type of medication request (for example, where the medication is expected to be consumed or administered (i.e. inpatient or outpatient)).
    # * category Slicings
        # 1) PASMedicationRequestCategoryUs_core: Type of medication usage
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-medicationrequest",
    elements: {
        "insurance" : {
            name: "insurance",
        ...
        "substitution" : {
            name: "substitution",
            dataType: PASMedicationRequestSubstitution,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "dispenseRequest" : {
            ...
            dataType: PASMedicationRequestDispenseRequest,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "priority" : {
            name: "priority",
            dataType: PASMedicationRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: PASMedicationRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "dosageInstruction" : {
            ...
            dataType: PASMedicationRequestDosageInstruction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PASMedicationRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASMedicationRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASMEDICATIONREQUEST resourceType = RESOURCE_NAME_PASMEDICATIONREQUEST;

    r4:Reference[] insurance?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    PASMedicationRequestSubstitution substitution?;
    ...
    PASMedicationRequestDispenseRequest dispenseRequest?;
    string id?;
    ...
    PASMedicationRequestPriority priority?;
    PASMedicationRequestIntent intent;
    r4:CodeableConcept performerType?;
    r4:Resource[] contained?;
    PASMedicationRequestDosageInstruction[] dosageInstruction?;
    r4:Meta meta?;
    r4:Reference[] eventHistory?;
    r4:uri implicitRules?;
    r4:CodeableConcept[] category?;
    r4:Identifier groupIdentifier?;
    PASMedicationRequestStatus status;
    r4:Element ...;
|};

# PASMedicationRequestStatus enum
public enum PASMedicationRequestStatus {
...
@r4:DataTypeDefinition {
    name: "PASMedicationRequestDosageInstruction",
    baseType: (),
    elements: {
        "maxDosePerLifetime": {
...
public type PASMedicationRequestDosageInstruction record {|
    *r4:Dosage;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASMedicationRequestSubstitution",
    baseType: (),
    elements: {
...
public type PASMedicationRequestSubstitution record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASMedicationRequestDispenseRequestInitialFill",
    baseType: (),
    elements: {
        "duration": {
            name: "duration",
...
public type PASMedicationRequestDispenseRequestInitialFill record {|
    *r4:BackboneElement;
...
# FHIR PASMedicationRequestCategoryUs_core datatype record.
#

@r4:DataTypeDefinition {
    name: "PASMedicationRequestCategoryUs_core",
    baseType: (),
    elements: {
    },
...
public type PASMedicationRequestCategoryUs_core record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "PASMedicationRequestDispenseRequest",
    baseType: (),
    elements: {
        "validityPeriod": {
            name: "validityPeriod",
        ...
        "initialFill": {
            name: "initialFill",
            dataType: PASMedicationRequestDispenseRequestInitialFill,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASMedicationRequestDispenseRequest record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    PASMedicationRequestDispenseRequestInitialFill initialFill?;
    string id?;
    r4:Duration expectedSupplyDuration?;
|};

# PASMedicationRequestIntent enum
public enum PASMedicationRequestIntent {
...
public enum PASMedicationRequestPriority {
