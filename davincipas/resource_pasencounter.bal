...
public const string PROFILE_BASE_PASENCOUNTER = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-encounter";
public const RESOURCE_NAME_PASENCOUNTER = "Encounter";

public type PASEncounterExtensions (r4:Extension | ExtensionNursingHomeResidentialStatus | ExtensionPatientStatus );
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "type" : {
            ...
            isArray: true,
            path: "Encounter.type",
            valueSet: "https://valueset.x12.org/x217/005010/request/2000E/CL1/1/01/00/1315"
        },
        "participant" : {
            name: "participant",
            dataType: PASEncounterParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "classHistory" : {
            name: "classHistory",
            dataType: PASEncounterClassHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "hospitalization" : {
            ...
            dataType: PASEncounterHospitalization,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "diagnosis" : {
            name: "diagnosis",
            dataType: PASEncounterDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "statusHistory" : {
            name: "statusHistory",
            dataType: PASEncounterStatusHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASEncounter record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASENCOUNTER resourceType = RESOURCE_NAME_PASENCOUNTER;
    ...
    PASEncounterParticipant[] participant?;
    ...
    r4:Period period?;
    PASEncounterClassHistory[] classHistory?;
    PASEncounterHospitalization hospitalization?;
    r4:Duration length?;
    PASEncounterDiagnosis[] diagnosis?;
    r4:CodeableConcept priority?;
    r4:Resource[] contained?;
    PASEncounterStatusHistory[] statusHistory?;
    r4:Meta meta?;
    r4:Reference serviceProvider?;
    r4:uri implicitRules?;
    PASEncounterLocation[] location?;
    r4:Reference[] account?;
    PASEncounterStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "PASEncounterStatusHistory",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "status": {
            name: "status",
            dataType: PASEncounterStatusHistoryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASEncounterStatusHistory record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PASEncounterStatusHistoryStatus status;
|};

# PASEncounterIdentifierUse enum
public enum PASEncounterIdentifierUse {
...
public type PASEncounterClassHistory record {|
    *r4:BackboneElement;
...
public enum PASEncounterStatusHistoryStatus {
...
public enum PASEncounterLocationStatus {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "status": {
            name: "status",
            dataType: PASEncounterLocationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASEncounterLocation record {|
    *r4:BackboneElement;
    ...
    string id?;
    PASEncounterLocationStatus status?;
|};

# PASEncounterStatus enum
public enum PASEncounterStatus {
   CODE_STATUS_TRIAGED = "triaged",
   CODE_STATUS_ARRIVED = "arrived",
   CODE_STATUS_ONLEAVE = "onleave",
   CODE_STATUS_CANCELLED = "cancelled",
...
public type PASEncounterParticipant record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASEncounterHospitalization",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASEncounterHospitalization record {|
    *r4:BackboneElement;
...
public type PASEncounterDiagnosis record {|
    *r4:BackboneElement;
