...
public const string PROFILE_BASE_PASCLAIMRESPONSE = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claimresponse";
public const RESOURCE_NAME_PASCLAIMRESPONSE = "ClaimResponse";

public type PASClaimResponseExtensions (r4:Extension | ExtensionEpsdtIndicator | ExtensionNursingHomeLevelOfCare | ExtensionProductOrServiceCodeEnd | ExtensionRevenueUnitRateLimit );
...
@r4:ResourceDefinition {
    ...
    elements: {
        "insurance" : {
            name: "insurance",
            dataType: PASClaimResponseInsurance,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "error" : {
            name: "error",
            dataType: PASClaimResponseError,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "processNote" : {
            name: "processNote",
            dataType: PASClaimResponseProcessNote,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "adjudication" : {
            name: "adjudication",
            dataType: PASClaimResponseAdjudication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "addItem" : {
            name: "addItem",
            dataType: PASClaimResponseAddItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "total" : {
            name: "total",
            dataType: PASClaimResponseTotal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payment" : {
            name: "payment",
            dataType: PASClaimResponsePayment,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "outcome" : {
            name: "outcome",
            dataType: PASClaimResponseOutcome,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: PASClaimResponseStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASClaimResponse record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCLAIMRESPONSE resourceType = RESOURCE_NAME_PASCLAIMRESPONSE;

    PASClaimResponseInsurance[] insurance?;
    r4:Reference request;
    r4:Extension[] extension?;
    PASClaimResponseUse use;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept payeeType?;
    string preAuthRef?;
    r4:code language?;
    PASClaimResponseError[] 'error?;
    r4:CodeableConcept 'type;
    PASClaimResponseProcessNote[] processNote?;
    PASClaimResponseAdjudication [] adjudication?;
    PASClaimResponseAddItem[] addItem?;
    PASClaimResponseTotal[] total?;
    r4:CodeableConcept fundsReserve?;
    r4:Reference insurer;
    r4:Reference patient;
    r4:Reference[] communicationRequest?;
    PASClaimResponsePayment payment?;
    string id?;
    r4:Narrative text?;
    PASClaimResponseOutcome outcome;
    ProfileIdentifier[] identifier?;
    PASClaimResponseItem[] item?;
...
public type PASClaimResponseError record {|
    *r4:BackboneElement;
...
# PASClaimResponseIdentifierUse enum
public enum PASClaimResponseIdentifierUse {
...
public enum PASClaimResponseUse {
   CODE_USE_PREDETERMINATION = "predetermination",
   CODE_USE_PREAUTHORIZATION = "preauthorization",
   CODE_USE_CLAIM = "claim"
}

# FHIR PASClaimResponseAddItemAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASClaimResponseAddItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimResponseAddItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimResponseAddItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimResponseAddItemAdjudicationCategoryCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimResponseItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimResponseItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimResponseItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:positiveInt detailSequence;
    r4:Extension [] modifierExtension?;
    PASClaimResponseItemDetailSubDetail [] subDetail?;
    string id?;
...
@r4:DataTypeDefinition {
    name: "PASClaimResponseItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimResponseItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASClaimResponseItemAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PASClaimResponseItemAdjudicationCategory category;
    decimal value?;
|};


# PASClaimResponseProcessNoteType enum
public enum PASClaimResponseProcessNoteType {
    CODE_TYPE_PRINT = "print",
    CODE_TYPE_DISPLAY = "display",
    CODE_TYPE_PRINTOPER = "printoper"
}

# FHIR PASClaimResponseAddItemAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - An Extension
...
@r4:DataTypeDefinition {
    name: "PASClaimResponseAddItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimResponseAddItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include the value submitted, maximum values or percentages allowed or payable under the plan, amounts that: the patient is responsible for in aggregate or pertaining to this item; amounts paid by other coverages; and, the benefit payable for this item.",
...
public type PASClaimResponseAddItemAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PASClaimResponseAddItemAdjudicationCategory category;
    decimal value?;
|};


# PASClaimResponseOutcome enum
public enum PASClaimResponseOutcome {
...
# FHIR PASClaimResponseAddItemAdjudicationCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASClaimResponseAddItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimResponseAddItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
public type PASClaimResponseTotal record {|
    *r4:BackboneElement;
...
# FHIR PASClaimResponseAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASClaimResponseAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimResponseAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimResponseAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimResponseAdjudicationCategoryCoding [] coding;
|};


# FHIR PASClaimResponseAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "PASClaimResponseAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimResponseAdjudicationCategoryCoding record {|
    *r4:Coding;
...
public type PASClaimResponsePayment record {|
    *r4:BackboneElement;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "PASClaimResponseItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimResponseItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "adjudication": {
            name: "adjudication",
            dataType: PASClaimResponseAddItemAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "The adjudication results.",
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimResponseAddItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimResponseAddItem record {|
    *r4:BackboneElement;
    ...
    PASClaimResponseAddItemAdjudication [] adjudication;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PASClaimResponseAddItemDetail[] detail?;
    string id?;
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimResponseAddItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimResponseAddItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimResponseAddItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    PASClaimResponseAddItemDetailSubDetail[] subDetail?;
    string id?;
    r4:CodeableConcept productOrService;
    decimal factor?;
    r4:Money net?;
...
@r4:DataTypeDefinition {
    name: "PASClaimResponseProcessNote",
    baseType: (),
    elements: {
        "number": {
            name: "number",
        ...
        "type": {
            name: "type",
            dataType: PASClaimResponseProcessNoteType,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASClaimResponseProcessNote record {|
    *r4:BackboneElement;
    ...
    string id?;
    string text;
    PASClaimResponseProcessNoteType 'type?;
|};
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimResponseAddItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type PASClaimResponseAddItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimResponseItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type PASClaimResponseItemDetailSubDetail record {|
    *r4:BackboneElement;
...
public enum PASClaimResponseStatus {
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimResponseItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimResponseItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimResponseItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimResponseItemAdjudicationCategoryCoding[] coding;
|};


# FHIR PASClaimResponseAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - An Extension
...
# + value - A non-monetary value associated with the category. Mutually exclusive to the amount element above.
@r4:DataTypeDefinition {
    name: "PASClaimResponseAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimResponseAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include the value submitted, maximum values or percentages allowed or payable under the plan, amounts that: the patient is responsible for in aggregate or pertaining to this item; amounts paid by other coverages; and, the benefit payable for this item.",
...
public type PASClaimResponseAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PASClaimResponseAdjudicationCategory category;
    decimal value?;
|};
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimResponseItem",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
            dataType: PASClaimResponseItemAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimResponseItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimResponseItem record {|
    *r4:BackboneElement;
    ...
    PASClaimResponseItemAdjudication[] adjudication;
    r4:positiveInt itemSequence;
    r4:Extension [] extension?;
    r4:Extension [] modifierExtension?;
    PASClaimResponseItemDetail[] detail?;
    string id?;
    r4:positiveInt [] noteNumber?;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimResponseInsurance",
    baseType: (),
    elements: {
        "coverage": {
            name: "coverage",
...
public type PASClaimResponseInsurance record {|
    *r4:BackboneElement;
