...
public const string PROFILE_BASE_PASPRACTITIONERROLE = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-practitionerrole";
public const RESOURCE_NAME_PASPRACTITIONERROLE = "PractitionerRole";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "notAvailable" : {
            name: "notAvailable",
            dataType: PASPractitionerRoleNotAvailable,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "availableTime" : {
            name: "availableTime",
            dataType: PASPractitionerRoleAvailableTime,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASPractitionerRole record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASPRACTITIONERROLE resourceType = RESOURCE_NAME_PASPRACTITIONERROLE;
    ...
    boolean active?;
    r4:code language?;
    PASPractitionerRoleNotAvailable[] notAvailable?;
    PASPractitionerRoleAvailableTime[] availableTime?;
...
@r4:DataTypeDefinition {
    name: "PASPractitionerRoleNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASPractitionerRoleNotAvailable record {|
    *r4:BackboneElement;
...
public enum PASPractitionerRoleAvailableTimeDaysOfWeek {
...
@r4:DataTypeDefinition {
    name: "PASPractitionerRoleAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: PASPractitionerRoleAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASPractitionerRoleAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    PASPractitionerRoleAvailableTimeDaysOfWeek[] daysOfWeek?;
