...
public const string PROFILE_BASE_PASCLAIMBASE = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claim-base";
public const RESOURCE_NAME_PASCLAIMBASE = "Claim";

public type PASClaimBaseExtensions (r4:Extension | ExtensionCertificationType | ExtensionConditionCode | ExtensionHomeHealthCareInformation | ExtensionItemCertificationEffectiveDate | ExtensionItemCertificationExpirationDate | ExtensionItemCertificationIssueDate | ExtensionLevelOfServiceCode );
...
# 1) PASClaimBaseSupportingInfoPatientEvent: Information about the dates of the event that are being requested.
#       - min = 0
#       - max = 1
#
# 2) PASClaimBaseSupportingInfoDischargeDates: Information about the discharge dates of a hospital admission being requested.
#       - min = 0
#       - max = 1
#
# 3) PASClaimBaseSupportingInfoAdmissionDates: Information about the admission dates of a hospital admission being requested.
#       - min = 0
#       - max = 1
#
...
# * careTeam Slicings
# 1) PASClaimBaseCareTeamOverallClaimMember: Care Team Providers that are applicable to all services being requested. NOTE: Only the first 14 can be sent in the X12 Request.
#       - min = 0
#       - max = *
#
# 2) PASClaimBaseCareTeamItemClaimMember: Care Team Providers that are applicable to a specific item (as referenced by that item). NOTE: Only the first 10 can be sent in the X12 Request.
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claim-base",
    elements: {
        "insurance" : {
            name: "insurance",
            dataType: PASClaimBaseInsurance,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "supportingInfo" : {
            name: "supportingInfo",
            dataType: PASClaimBaseSupportingInfo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "identifier" : {
            name: "identifier",
            dataType: PASClaimBaseIdentifier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "diagnosis" : {
            name: "diagnosis",
            dataType: PASClaimBaseDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "procedure" : {
            name: "procedure",
            dataType: PASClaimBaseProcedure,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimBase record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCLAIMBASE resourceType = RESOURCE_NAME_PASCLAIMBASE;
    ...
    PASClaimBaseInsurance[] insurance;
    r4:Extension[] extension?;
    PASClaimBaseUse use;
    r4:Extension[] modifierExtension?;
    r4:code language?;
    r4:CodeableConcept 'type;
    PASClaimBaseAccident accident?;
    PASClaimBasePayee payee?;
    r4:Money total?;
    PASClaimBaseRelated[] related?;
    PASClaimBaseSupportingInfo[] supportingInfo?;
    ...
    string id?;
    r4:Narrative text?;
    PASClaimBaseCareTeam[] careTeam?;
    ProfileIdentifier [] identifier?;
    PASClaimBaseItem [] item?;
    r4:dateTime created;
    PASClaimBaseDiagnosis[] diagnosis?;
    r4:Reference originalPrescription?;
    PASClaimBaseProcedure[] procedure?;
...
public type PASClaimBaseInsurance record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimBaseCareTeamOverallClaimMember",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type PASClaimBaseCareTeamOverallClaimMember record {|
    *PASClaimBaseCareTeam;
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimBaseSupportingInfoCategoryCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimBaseSupportingInfoCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimBaseSupportingInfoCategoryOne record {|
    *r4:CodeableConcept;
    ...
    PASClaimBaseSupportingInfoCategoryCodingOne[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoAdmissionDates",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimBaseSupportingInfoCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASClaimBaseSupportingInfoAdmissionDates record {|
    *PASClaimBaseSupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimBaseSupportingInfoCategoryTwo category;
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfo",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PASClaimBaseSupportingInfo record {|
    *r4:BackboneElement;
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoPatientEvent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimBaseSupportingInfoCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type PASClaimBaseSupportingInfoPatientEvent record {|
    *PASClaimBaseSupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimBaseSupportingInfoCategory category;
    r4:Quantity valueQuantity?;
|};
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoDischargeDates",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimBaseSupportingInfoCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type PASClaimBaseSupportingInfoDischargeDates record {|
    *PASClaimBaseSupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimBaseSupportingInfoCategoryOne category;
    r4:Quantity valueQuantity?;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimBaseSupportingInfoCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimBaseSupportingInfoCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    PASClaimBaseSupportingInfoCategoryCodingTwo[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimBaseSupportingInfoCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimBaseSupportingInfoCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimBaseSupportingInfoCategoryCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseItemDetailSubDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
...
public type PASClaimBaseItemDetailSubDetail record {|
    *r4:BackboneElement;
...
public type PASClaimBaseCareTeam record {|
    *r4:BackboneElement;
...
# FHIR PASClaimBaseIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "extension": {
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "Claim.identifier.extension"
        },
        ...
        "use": {
            name: "use",
            dataType: PASClaimBaseIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASClaimBaseIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PASClaimBaseIdentifierUse use?;
...
public type PASClaimBaseDiagnosis record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimBaseSupportingInfoCategoryCodingTwo record {|
    *r4:Coding;
...
public type PASClaimBaseAccident record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimBaseItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimBaseItem record {|
    *r4:BackboneElement;
...
public type PASClaimBaseProcedure record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASClaimBaseSupportingInfoCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimBaseSupportingInfoCategoryCoding record {|
    *r4:Coding;
...
# PASClaimBaseIdentifierUse enum
public enum PASClaimBaseIdentifierUse {
...
public enum PASClaimBaseStatus {
...
public type PASClaimBasePayee record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimBaseItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.",
...
public type PASClaimBaseItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    PASClaimBaseItemDetailSubDetail[] subDetail?;
    r4:CodeableConcept productOrService;
    r4:positiveInt sequence;
    r4:CodeableConcept revenue?;
    string id?;
...
public type PASClaimBaseRelated record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimBaseCareTeamItemClaimMember",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type PASClaimBaseCareTeamItemClaimMember record {|
    *PASClaimBaseCareTeam;
