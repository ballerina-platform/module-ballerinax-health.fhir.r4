...
public const string PROFILE_BASE_PASCLAIMINQUIRYRESPONSE = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claiminquiryresponse";
public const RESOURCE_NAME_PASCLAIMINQUIRYRESPONSE = "ClaimResponse";

public type PASClaimInquiryResponseExtensions (r4:Extension | ExtensionEpsdtIndicator | ExtensionNursingHomeLevelOfCare | ExtensionProductOrServiceCodeEnd | ExtensionRevenueUnitRateLimit );
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claiminquiryresponse",
    elements: {
        "insurance" : {
            name: "insurance",
            dataType: PASClaimInquiryResponseInsurance,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "use" : {
            name: "use",
            dataType: PASClaimInquiryResponseUse,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "error" : {
            name: "error",
            dataType: PASClaimInquiryResponseError,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "processNote" : {
            name: "processNote",
            dataType: PASClaimInquiryResponseProcessNote,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "adjudication" : {
            name: "adjudication",
            dataType: PASClaimInquiryResponseAdjudication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "addItem" : {
            name: "addItem",
            dataType: PASClaimInquiryResponseAddItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "total" : {
            name: "total",
            dataType: PASClaimInquiryResponseTotal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payment" : {
            name: "payment",
            dataType: PASClaimInquiryResponsePayment,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "outcome" : {
            name: "outcome",
            dataType: PASClaimInquiryResponseOutcome,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "item" : {
            name: "item",
            dataType: PASClaimInquiryResponseItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PASClaimInquiryResponseStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASClaimInquiryResponse record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCLAIMINQUIRYRESPONSE resourceType = RESOURCE_NAME_PASCLAIMINQUIRYRESPONSE;

    PASClaimInquiryResponseInsurance[] insurance?;
    r4:Reference request;
    r4:Extension[] extension?;
    PASClaimInquiryResponseUse use;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept payeeType?;
    string preAuthRef?;
    r4:code language?;
    PASClaimInquiryResponseError[] 'error?;
    r4:CodeableConcept 'type;
    PASClaimInquiryResponseProcessNote[] processNote?;
    PASClaimInquiryResponseAdjudication [] adjudication?;
    PASClaimInquiryResponseAddItem[] addItem?;
    PASClaimInquiryResponseTotal[] total?;
    r4:CodeableConcept fundsReserve?;
    r4:Reference insurer;
    r4:Reference patient;
    r4:Reference[] communicationRequest?;
    PASClaimInquiryResponsePayment payment?;
    string id?;
    r4:Narrative text?;
    PASClaimInquiryResponseOutcome outcome;
    ProfileIdentifier[] identifier?;
    PASClaimInquiryResponseItem[] item?;
    ...
    PASClaimInquiryResponseStatus status;
    r4:Element ...;
|};

# FHIR PASClaimInquiryResponseAdjudicationCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquiryResponseAdjudicationCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseInsurance",
    baseType: (),
    elements: {
        "coverage": {
            name: "coverage",
...
public type PASClaimInquiryResponseInsurance record {|
    *r4:BackboneElement;
...
# FHIR PASClaimInquiryResponseAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquiryResponseAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryResponseAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquiryResponseAdjudicationCategoryCoding [] coding;
|};


# PASClaimInquiryResponseIdentifierUse enum
public enum PASClaimInquiryResponseIdentifierUse {
...
# FHIR PASClaimInquiryResponseAddItemAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquiryResponseAddItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimInquiryResponseAddItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquiryResponseAddItemAdjudicationCategoryCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseTotal",
    baseType: (),
    elements: {
        "amount": {
            name: "amount",
...
public type PASClaimInquiryResponseTotal record {|
    *r4:BackboneElement;
...
public enum PASClaimInquiryResponseStatus {
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItem",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
            dataType: PASClaimInquiryResponseItemAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimInquiryResponseItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryResponseItem record {|
    *r4:BackboneElement;
    ...
    PASClaimInquiryResponseItemAdjudication [] adjudication;
    r4:positiveInt itemSequence;
    r4:Extension [] extension?;
    r4:Extension [] modifierExtension?;
    PASClaimInquiryResponseItemDetail [] detail?;
    string id?;
    r4:positiveInt [] noteNumber?;
|};


# FHIR PASClaimInquiryResponseAddItemAdjudication datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquiryResponseAddItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include the value submitted, maximum values or percentages allowed or payable under the plan, amounts that: the patient is responsible for in aggregate or pertaining to this item; amounts paid by other coverages; and, the benefit payable for this item.",
...
public type PASClaimInquiryResponseAddItemAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PASClaimInquiryResponseAddItemAdjudicationCategory category;
    decimal value?;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type PASClaimInquiryResponseAddItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# + value - A non-monetary value associated with the category. Mutually exclusive to the amount element above.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquiryResponseItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include the value submitted, maximum values or percentages allowed or payable under the plan, amounts that: the patient is responsible for in aggregate or pertaining to this item; amounts paid by other coverages; and, the benefit payable for this item.",
...
public type PASClaimInquiryResponseItemAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PASClaimInquiryResponseItemAdjudicationCategory category;
    decimal value?;
|};
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimInquiryResponseItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryResponseItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    PASClaimInquiryResponseItemDetailSubDetail[] subDetail?;
    string id?;
    r4:positiveInt[] noteNumber?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquiryResponseItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquiryResponseItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimInquiryResponseItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquiryResponseItemAdjudicationCategoryCoding[] coding;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseError",
    baseType: (),
    elements: {
        "subDetailSequence": {
...
public type PASClaimInquiryResponseError record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquiryResponseAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include the value submitted, maximum values or percentages allowed or payable under the plan, amounts that: the patient is responsible for in aggregate or pertaining to this item; amounts paid by other coverages; and, the benefit payable for this item.",
...
public type PASClaimInquiryResponseAdjudication record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PASClaimInquiryResponseAdjudicationCategory category;
    decimal value?;
|};
...
# + net - The quantity times the unit price for an additional service or product or charge.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItem",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "adjudication": {
            name: "adjudication",
            dataType: PASClaimInquiryResponseAddItemAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "The adjudication results.",
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimInquiryResponseAddItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryResponseAddItem record {|
    *r4:BackboneElement;
    ...
    PASClaimInquiryResponseAddItemAdjudication [] adjudication;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PASClaimInquiryResponseAddItemDetail[] detail?;
    string id?;
...
# FHIR PASClaimInquiryResponseAddItemAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquiryResponseAddItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponsePayment",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type PASClaimInquiryResponsePayment record {|
    *r4:BackboneElement;
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type PASClaimInquiryResponseItemDetailSubDetail record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseProcessNote",
    baseType: (),
    elements: {
        "number": {
            name: "number",
        ...
        "type": {
            name: "type",
            dataType: PASClaimInquiryResponseProcessNoteType,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASClaimInquiryResponseProcessNote record {|
    *r4:BackboneElement;
    ...
    string id?;
    string text;
    PASClaimInquiryResponseProcessNoteType 'type?;
|};
...
# + noteNumber - The numbers associated with notes below which apply to the adjudication of this item.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryResponseAddItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimInquiryResponseAddItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryResponseAddItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    PASClaimInquiryResponseAddItemDetailSubDetail[] subDetail?;
    string id?;
    r4:CodeableConcept productOrService;
    decimal factor?;
    r4:Money net?;
...
public enum PASClaimInquiryResponseOutcome {
...
public enum PASClaimInquiryResponseProcessNoteType {
