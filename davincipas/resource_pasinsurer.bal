...
#       - max = 1
#
# 2) PASInsurerIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
# 3) PASInsurerIdentifierCLIA: An identifier intended for computation
#       - min = 0
#       - max = 1
#
...
public enum PASInsurerIdentifierUse {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASInsurerIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
