...
public const string PROFILE_BASE_PASINSURER = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-insurer";
public const RESOURCE_NAME_PASINSURER = "Organization";
...
# * identifier Slicings
# 1) PASInsurerIdentifierNPI: An identifier intended for computation
#       - min = 0
        #       - max = *
#
        # 2) PASInsurerIdentifierNAIC: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
        # 3) PASInsurerIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
        # 4) PASInsurerIdentifierPI: The Payer Identification Number (PI)
#       - min = 0
#       - max = 1
#
        # 5) PASInsurerIdentifierCLIA: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "type" : {
            ...
            valueSet: "https://valueset.x12.org/x217/005010/request/2010A/NM1/1/01/00/98"
        },
        "contained" : {
            name: "contained",
...
public type PASInsurer record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASINSURER resourceType = RESOURCE_NAME_PASINSURER;
...
public type PASInsurerContact record {|
    *r4:BackboneElement;
...
public enum PASInsurerAddressType {
   CODE_TYPE_POSTAL = "postal",
   CODE_TYPE_PHYSICAL = "physical",
   CODE_TYPE_BOTH = "both"
}

# PASInsurerTelecomUse enum
public enum PASInsurerTelecomUse {
    CODE_USE_TEMP = "temp",
    CODE_USE_WORK = "work",
    CODE_USE_OLD = "old",
...
# PASInsurerTelecomSystem enum
public enum PASInsurerTelecomSystem {
...
public type PASInsurerIdentifierNPI record {|
    *r4:Identifier;
...
public type PASInsurerIdentifierPI record {|
    *r4:Identifier;

    PASInsurerIdentifierType 'type;
|};
...
public type PASInsurerIdentifierTIN record {|
    *r4:Identifier;
...
public type PASInsurerIdentifierCLIA record {|
    *r4:Identifier;
...
# FHIR PASInsurerIdentifierNAIC datatype record.
#
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.

@r4:DataTypeDefinition {
    name: "PASInsurerIdentifierNAIC",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASInsurerIdentifierNAIC record {|
    *r4:Identifier;
...
public enum PASInsurerAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
# FHIR PASInsurerIdentifierTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASInsurerIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASInsurerIdentifierTypeCoding record {|
    *r4:Coding;
...
# FHIR PASInsurerIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASInsurerIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASInsurerIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASInsurerIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASInsurerIdentifierTypeCoding [] coding;
|};
