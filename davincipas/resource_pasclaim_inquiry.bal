...
public const string PROFILE_BASE_PASCLAIMINQUIRY = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-claim-inquiry";
public const RESOURCE_NAME_PASCLAIMINQUIRY = "Claim";

public type PASClaimInquiryExtensions (r4:Extension | ExtensionCertificationType | ExtensionConditionCode | ExtensionHomeHealthCareInformation | ExtensionItemCertificationEffectiveDate | ExtensionItemCertificationExpirationDate | ExtensionItemCertificationIssueDate | ExtensionLevelOfServiceCode );
...
# 1) PASClaimInquirySupportingInfoPatientEvent: Information about the dates of the event that are being requested.
#       - min = 0
#       - max = 1
#
# 2) PASClaimInquirySupportingInfoDischargeDates: Information about the discharge dates of a hospital admission being requested.
#       - min = 0
#       - max = 1
#
# 3) PASClaimInquirySupportingInfoAdmissionDates: Information about the admission dates of a hospital admission being requested.
#       - min = 0
#       - max = 1
#
...
# * careTeam Slicings
# 1) PASClaimInquiryCareTeamOverallClaimMember: Care Team Providers that are applicable to all services being requested. NOTE: Only the first 14 can be sent in the X12 Request.
#       - min = 0
#       - max = *
#
# 2) PASClaimInquiryCareTeamItemClaimMember: Care Team Providers that are applicable to a specific item (as referenced by that item). NOTE: Only the first 10 can be sent in the X12 Request.
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        "insurance" : {
            name: "insurance",
            dataType: PASClaimInquiryInsurance,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "accident" : {
            name: "accident",
            dataType: PASClaimInquiryAccident,
            min: 0,
            max: 1,
            isArray: false,
            path: "Claim.accident"
        ...
        "related" : {
            name: "related",
            dataType: PASClaimInquiryRelated,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Claim.related"
        ...
        "supportingInfo" : {
            name: "supportingInfo",
            dataType: PASClaimInquirySupportingInfo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "careTeam" : {
            name: "careTeam",
            dataType: PASClaimInquiryCareTeam,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Claim.careTeam"
        ...
        "diagnosis" : {
            name: "diagnosis",
            dataType: PASClaimInquiryDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "procedure" : {
            name: "procedure",
            dataType: PASClaimInquiryProcedure,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PASClaimInquiryStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Claim.status",
...
public type PASClaimInquiry record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASCLAIMINQUIRY resourceType = RESOURCE_NAME_PASCLAIMINQUIRY;
    ...
    PASClaimInquiryInsurance[] insurance;
    r4:Extension[] extension?;
    PASClaimInquiryUse use;
    r4:Extension[] modifierExtension?;
    r4:code language?;
    r4:CodeableConcept 'type;
    PASClaimInquiryAccident accident?;
    PASClaimInquiryPayee payee?;
    r4:Money total?;
    PASClaimInquiryRelated[] related?;
    PASClaimInquirySupportingInfo[] supportingInfo?;
    ...
    string id?;
    r4:Narrative text?;
    PASClaimInquiryCareTeam[] careTeam?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PASClaimInquiryItem [] item?;
    r4:dateTime created;
    PASClaimInquiryDiagnosis[] diagnosis?;
    r4:Reference originalPrescription?;
    PASClaimInquiryProcedure[] procedure?;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfo",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PASClaimInquirySupportingInfo record {|
    *r4:BackboneElement;
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoAdmissionDates",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquirySupportingInfoCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type PASClaimInquirySupportingInfoAdmissionDates record {|
    *PASClaimInquirySupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimInquirySupportingInfoCategoryTwo category;
    r4:Quantity valueQuantity?;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryCareTeamOverallClaimMember",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type PASClaimInquiryCareTeamOverallClaimMember record {|
    *PASClaimInquiryCareTeam;
...
public type PASClaimInquiryCareTeam record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquirySupportingInfoCategoryCodingTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryItemDetailSubDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
...
public type PASClaimInquiryItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoPatientEvent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquirySupportingInfoCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type PASClaimInquirySupportingInfoPatientEvent record {|
    *PASClaimInquirySupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimInquirySupportingInfoCategory category;
    r4:Quantity valueQuantity?;
|};
...
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquirySupportingInfoCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquirySupportingInfoCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquirySupportingInfoCategoryCodingTwo[] coding;
|};
...
public type PASClaimInquiryAccident record {|
    *r4:BackboneElement;
...
public type PASClaimInquiryRelated record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PASClaimInquiryCareTeamItemClaimMember",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type PASClaimInquiryCareTeamItemClaimMember record {|
    *PASClaimInquiryCareTeam;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquirySupportingInfoCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimInquirySupportingInfoCategoryOne record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquirySupportingInfoCategoryCodingOne[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASClaimInquirySupportingInfoCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type PASClaimInquirySupportingInfoCategory record {|
    *r4:CodeableConcept;
    ...
    PASClaimInquirySupportingInfoCategoryCoding[] coding;
|};


# PASClaimInquiryIdentifierUse enum
public enum PASClaimInquiryIdentifierUse {
...
# + valueQuantity - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoDischargeDates",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: PASClaimInquirySupportingInfoCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type PASClaimInquirySupportingInfoDischargeDates record {|
    *PASClaimInquirySupportingInfo;
    ...
    string valueString?;
    string id?;
    PASClaimInquirySupportingInfoCategoryOne category;
    r4:Quantity valueQuantity?;
|};
...
public type PASClaimInquiryInsurance record {|
    *r4:BackboneElement;
...
public enum PASClaimInquiryStatus {
...
@r4:DataTypeDefinition {
    name: "PASClaimInquiryItemDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: PASClaimInquiryItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASClaimInquiryItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept [] modifier?;
    r4:Extension [] modifierExtension?;
    PASClaimInquiryItemDetailSubDetail [] subDetail?;
    r4:CodeableConcept productOrService;
    r4:positiveInt sequence;
    r4:CodeableConcept revenue?;
    string id?;
...
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquirySupportingInfoCategoryCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "detail": {
            name: "detail",
            dataType: PASClaimInquiryItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.",
...
public type PASClaimInquiryItem record {|
    *r4:BackboneElement;
    ...
    PASClaimInquiryItemDetail [] detail?;
...
public type PASClaimInquiryPayee record {|
    *r4:BackboneElement;
...
public type PASClaimInquiryDiagnosis record {|
    *r4:BackboneElement;
...
public type PASClaimInquiryProcedure record {|
    *r4:BackboneElement;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "PASClaimInquirySupportingInfoCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASClaimInquirySupportingInfoCategoryCoding record {|
    *r4:Coding;
...
public enum PASClaimInquiryUse {
