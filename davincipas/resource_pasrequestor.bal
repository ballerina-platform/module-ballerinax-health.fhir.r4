...
#       - max = 1
#
# 2) PASRequestorIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
# 3) PASRequestorIdentifierCLIA: An identifier intended for computation
#       - min = 0
#       - max = 1
#
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASRequestorIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public enum PASRequestorIdentifierUse {
