...
public const string PROFILE_BASE_PASREQUESTOR = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-requestor";
public const RESOURCE_NAME_PASREQUESTOR = "Organization";
...
# * identifier Slicings
# 1) PASRequestorIdentifierNPI: An identifier intended for computation
#       - min = 0
        #       - max = *
#
        # 2) PASRequestorIdentifierNAIC: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
        # 3) PASRequestorIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
        # 4) PASRequestorIdentifierPI: The Payer Identification Number (PI)
#       - min = 0
#       - max = 1
#
        # 5) PASRequestorIdentifierCLIA: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "type" : {
            ...
            valueSet: "https://valueset.x12.org/x217/005010/response/2010B/NM1/1/01/00/98"
        },
        "contained" : {
            name: "contained",
...
public type PASRequestor record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASREQUESTOR resourceType = RESOURCE_NAME_PASREQUESTOR;
...
# PASRequestorTelecomSystem enum
public enum PASRequestorTelecomSystem {
...
@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierTIN",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASRequestorIdentifierTIN record {|
    *r4:Identifier;
...
public type PASRequestorIdentifierPI record {|
    *r4:Identifier;

    PASRequestorIdentifierType 'type;
|};


# PASRequestorAddressUse enum
public enum PASRequestorAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
public type PASRequestorContact record {|
    *r4:BackboneElement;
...
# FHIR PASRequestorIdentifierTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASRequestorIdentifierTypeCoding record {|
    *r4:Coding;
...
# PASRequestorTelecomUse enum
public enum PASRequestorTelecomUse {
    CODE_USE_TEMP = "temp",
    CODE_USE_WORK = "work",
    CODE_USE_OLD = "old",
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierNPI",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASRequestorIdentifierNPI record {|
    *r4:Identifier;
...
# FHIR PASRequestorIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASRequestorIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASRequestorIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASRequestorIdentifierTypeCoding [] coding;
|};
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierCLIA",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASRequestorIdentifierCLIA record {|
    *r4:Identifier;
...
# FHIR PASRequestorIdentifierNAIC datatype record.
#
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.

@r4:DataTypeDefinition {
    name: "PASRequestorIdentifierNAIC",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASRequestorIdentifierNAIC record {|
    *r4:Identifier;
