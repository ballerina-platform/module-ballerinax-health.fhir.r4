...
public const string PROFILE_BASE_PASSUBSCRIBER = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-subscriber";
public const RESOURCE_NAME_PASSUBSCRIBER = "Patient";

public type PASSubscriberExtensions (r4:Extension | ExtensionMilitaryStatus );
...
# + identifier - An identifier for this patient.
    # * identifier Slicings
        # 1) PASSubscriberIdentifierMemberIdentifier: An identifier for this patient
        #       - min = 1
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "communication" : {
            name: "communication",
            dataType: PASSubscriberCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "identifier" : {
            name: "identifier",
            dataType: PASSubscriberIdentifier,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASSubscriber record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASSUBSCRIBER resourceType = RESOURCE_NAME_PASSUBSCRIBER;

    r4:Extension[] extension?;
    PASSubscriberGender gender;
    r4:Extension[] modifierExtension?;
    PASSubscriberLink[] link?;
    r4:code language?;
    PASSubscriberContact[] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference[] generalPractitioner?;
    r4:ContactPoint[] telecom?;
    string id?;
    r4:Narrative text?;
    PASSubscriberCommunication[] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PASSubscriberIdentifier [] identifier;
    PASSubscriberAddress[] address?;
...
public enum PASSubscriberNameUse {
...
# FHIR PASSubscriberIdentifierMemberIdentifier datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASSubscriberIdentifierMemberIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PASSubscriberIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: PASSubscriberIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASSubscriberIdentifierMemberIdentifier record {|
    *PASSubscriberIdentifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PASSubscriberIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    PASSubscriberIdentifierType 'type;
    string value;
|};


# FHIR PASSubscriberIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + period - Time period during which identifier is/was valid for use.
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASSubscriberIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type PASSubscriberIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PASSubscriberIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
...
public enum PASSubscriberLinkType {
...
public enum PASSubscriberContactGender {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PASSubscriberLinkType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASSubscriberLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    PASSubscriberLinkType 'type;
|};

# PASSubscriberAddressUse enum
public enum PASSubscriberAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASSubscriberAddressUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: PASSubscriberAddressType,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASSubscriberAddress record {|
    *r4:Address;
    ...
    string city?;
    string[] line?;
    PASSubscriberAddressUse use?;
    string district?;
    string postalCode?;
    string id?;
    string state?;
    string text?;
    PASSubscriberAddressType 'type?;
|};


# FHIR PASSubscriberIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASSubscriberIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASSubscriberIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASSubscriberIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASSubscriberIdentifierTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: PASSubscriberContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASSubscriberContact record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:Address address?;
    PASSubscriberContactGender gender?;
    r4:Extension[] modifierExtension?;
...
@r4:DataTypeDefinition {
    name: "PASSubscriberCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PASSubscriberCommunication record {|
    *r4:BackboneElement;
...
# PASSubscriberIdentifierUseOne enum
public enum PASSubscriberIdentifierUseOne {
...
public enum PASSubscriberTelecomUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
...
public type PASSubscriberName record {|
    *r4:HumanName;
...
public enum PASSubscriberTelecomSystem {
...
# FHIR PASSubscriberIdentifierTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASSubscriberIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASSubscriberIdentifierTypeCoding record {|
    *r4:Coding;
...
public enum PASSubscriberGender {
   CODE_GENDER_OTHER = "other",
   CODE_GENDER_FEMALE = "female",
   CODE_GENDER_MALE = "male",
   CODE_GENDER_UNKNOWN = "unknown"
...
public enum PASSubscriberIdentifierUse {
   CODE_USE_SECONDARY = "secondary",
   CODE_USE_TEMP = "temp",
   CODE_USE_USUAL = "usual",
   CODE_USE_OLD = "old",
