...
public const string PROFILE_BASE_PASORGANIZATION = "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-organization";
public const RESOURCE_NAME_PASORGANIZATION = "Organization";
...
# * identifier Slicings
# 1) PASOrganizationIdentifierNPI: An identifier intended for computation
#       - min = 0
        #       - max = *
#
        # 2) PASOrganizationIdentifierNAIC: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
        # 3) PASOrganizationIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
        # 4) PASOrganizationIdentifierPI: The Payer Identification Number (PI)
#       - min = 0
#       - max = 1
#
        # 5) PASOrganizationIdentifierCLIA: An identifier intended for computation
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-pas/StructureDefinition/profile-organization",
    elements: {
        "identifier" : {
            name: "identifier",
        ...
        "contact" : {
            name: "contact",
            dataType: PASOrganizationContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASOrganization record {|
    *r4:DomainResource;

    RESOURCE_NAME_PASORGANIZATION resourceType = RESOURCE_NAME_PASORGANIZATION;
    ...
    r4:Meta meta?;
    PASOrganizationContact[] contact?;
    string name;
    string[] alias?;
...
# PASOrganizationTelecomUse enum
public enum PASOrganizationTelecomUse {
    CODE_USE_TEMP = "temp",
    CODE_USE_WORK = "work",
    CODE_USE_OLD = "old",
...
public enum PASOrganizationAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
# PASOrganizationTelecomSystem enum
public enum PASOrganizationTelecomSystem {
...
public type PASOrganizationContact record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierNPI",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASOrganizationIdentifierNPI record {|
    *r4:Identifier;
...
# FHIR PASOrganizationIdentifierTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASOrganizationIdentifierTypeCoding record {|
    *r4:Coding;
...
# FHIR PASOrganizationIdentifierNAIC datatype record.
#
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.

@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierNAIC",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASOrganizationIdentifierNAIC record {|
    *r4:Identifier;
...
@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierTIN",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASOrganizationIdentifierTIN record {|
    *r4:Identifier;

    r4:uri system = "http://terminology.hl7.org/NamingSystem/USEIN";
|};


# FHIR PASOrganizationIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PASOrganizationIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PASOrganizationIdentifierType record {|
    *r4:CodeableConcept;
    ...
    PASOrganizationIdentifierTypeCoding [] coding;
|};
...
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierCLIA",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type PASOrganizationIdentifierCLIA record {|
    *r4:Identifier;
...
# FHIR PASOrganizationIdentifierPI datatype record.
#
# + 'type - A coded type for the identifier that can be used to determine which identifier to use for a specific purpose.

@r4:DataTypeDefinition {
    name: "PASOrganizationIdentifierPI",
    baseType: (),
    elements: {
        "type": {
            name: "type",
            dataType: PASOrganizationIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PASOrganizationIdentifierPI record {|
    *r4:Identifier;

    PASOrganizationIdentifierType 'type;
|};


# PASOrganizationAddressType enum
public enum PASOrganizationAddressType {
