...
#       - max = 1
#
# 2) PASOrganizationIdentifierTIN: The US Employer Identification Number (EIN) or Tax Identification Number (TIN).
#       - min = 0
#       - max = 1
#
# 3) PASOrganizationIdentifierCLIA: An identifier intended for computation
#       - min = 0
#       - max = 1
#
...
public enum PASOrganizationIdentifierUse {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PASOrganizationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PASOrganizationIdentifierTIN record {|
    *r4:Identifier;
    ...
    PASOrganizationIdentifierUse use?;
