...
# + value - An assertion that a procedure did not occur or that there are no items of specific interest (e.g. allergies, no current medications) for a patient or patient group.
...
public type AUAssertionNoRelevantFinding record {|
    *r4:DomainResource;
    ...
    BaseAUAssertionNoRelevantFindingMeta meta = {
        profile : [PROFILE_BASE_AUASSERTIONNORELEVANTFINDING]
    };
...
public type BaseAUAssertionNoRelevantFindingMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org.au/fhir/StructureDefinition/au-norelevantfinding"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
