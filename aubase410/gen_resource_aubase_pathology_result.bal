...
public type AUBasePathologyResult record {|
    *r4:DomainResource;
    ...
    BaseAUBasePathologyResultMeta meta = {
        profile : [PROFILE_BASE_AUBASEPATHOLOGYRESULT]
    };
...
public type BaseAUBasePathologyResultMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org.au/fhir/StructureDefinition/au-pathologyresult"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
