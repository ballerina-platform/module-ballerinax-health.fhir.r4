...
public const string PROFILE_BASE_AUBASECONDITION = "http://hl7.org.au/fhir/StructureDefinition/au-condition";
public const RESOURCE_NAME_AUBASECONDITION = "Condition";
...
public type AUBaseCondition record {|
    *r4:DomainResource;
