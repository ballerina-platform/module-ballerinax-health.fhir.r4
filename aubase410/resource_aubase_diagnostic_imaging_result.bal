...
public type AUBaseDiagnosticImagingResult record {|
    *r4:DomainResource;
    ...
    BaseAUBaseDiagnosticImagingResultMeta meta = {
        profile : [PROFILE_BASE_AUBASEDIAGNOSTICIMAGINGRESULT]
    };
...
public type BaseAUBaseDiagnosticImagingResultMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org.au/fhir/StructureDefinition/au-imagingresult"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
