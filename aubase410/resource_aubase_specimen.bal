...
public const string PROFILE_BASE_AUBASESPECIMEN = "http://hl7.org.au/fhir/StructureDefinition/au-specimen";
public const RESOURCE_NAME_AUBASESPECIMEN = "Specimen";
...
public type AUBaseSpecimen record {|
    *r4:DomainResource;
