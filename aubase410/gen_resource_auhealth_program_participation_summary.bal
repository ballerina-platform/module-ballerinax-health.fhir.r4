...
# + nextAction - The next action expected or scheduled as part of the program, as at the time this observation is asserted.
# + hPCat - A code that classifies the general type of observation being made.
# + valueRatio - The information determined as a result of making the observation, if the information has a simple value.
# + lastAction - The last program participation action, as at the time this observation is asserted.
# + participationStatus - Represents the current state of an individual's participation in a program. This status is only representative at the time this observation is asserted and may also represent participation exception states including exclusion or ineligibility.
# + notParticipantStatusReason - The reason why an individual is not actively participating in a program. This may include the reason why an individual's participation is suspended or stopped participating prior to completion. This value is asserted as current at the time this observation is asserted.
...
# + effective - Date, and optionally time, this program participation information is asserted as 'true'.
# + valueRange - The information determined as a result of making the observation, if the information has a simple value.
# + nextActionDate - The time or time period of the next program participation action, as at the time this observation is asserted.
# + forecastStatus - The most clinically relevant state at the time of assertion of this observation for future program participation, e.g. overdue or eligible at 25, and may repeat exception states relevant to forecasting program participation. This may be used in conjunction with reporting against an immunisation program.
...
# + lastActionDate - The time or time period of the last program participation action, as at the time this observation is asserted.
...
# + forecastStatusPeriod - The time or time period associated with 'next status', as at the time this observation is asserted.
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "notParticipantStatusReason" : {
            name: "notParticipantStatusReason",
            dataType: r4:BackboneElement,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "participationStatusPeriod" : {
            name: "participationStatusPeriod",
            dataType: r4:BackboneElement,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUHealthProgramParticipationSummary record {|
    *r4:DomainResource;
    ...
    BaseAUHealthProgramParticipationSummaryMeta meta = {
        profile : [PROFILE_BASE_AUHEALTHPROGRAMPARTICIPATIONSUMMARY]
    };
    ...
    r4:Reference[] focus?;
    r4:code language?;
    r4:BackboneElement nextAction?;
    r4:CodeableConcept hPCat;
    r4:Ratio valueRatio?;
    r4:BackboneElement lastAction?;
    r4:BackboneElement participationStatus;
    r4:BackboneElement[] notParticipantStatusReason?;
    string id?;
    r4:Narrative text?;
    r4:instant issued?;
    ...
    r4:BackboneElement participationStatusPeriod?;
    r4:Reference device?;
    ...
    r4:dateTime effective;
    r4:Range valueRange?;
    r4:BackboneElement nextActionDate?;
    r4:BackboneElement forecastStatus?;
    ...
    r4:BackboneElement lastActionDate?;
    ...
    r4:BackboneElement forecastStatusPeriod?;
|};
...
public type BaseAUHealthProgramParticipationSummaryMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org.au/fhir/StructureDefinition/au-healthprogramparticipation"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
