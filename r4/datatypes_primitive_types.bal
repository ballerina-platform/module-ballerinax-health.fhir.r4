...
@constraint:String {
    pattern: {
        value: re `\S*`,
        message: "A Uniform Resource Identifier should align with the Reference (RFC 3986 ). Note: URIs are case sensitive. For UUID (urn:uuid:53fefa32-fcbb-4ff8-8a92-55ee120877b7), use all lowercase. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        ...
        message: "A base64Binary should be a stream of bytes, base64 encoded (RFC 4648). Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        ...
        message: "An instant in time should be in the format YYYY-MM-DDThh:mm:ss.sss+zz:zz (e.g. 2015-02-07T13:28:17.239+02:00 or 2017-01-01T00:00:00Z). Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
...
@constraint:String {
    pattern: {
        ...
        message: "It should be a date, or partial date (e.g. just year or year + month) as used in human communication. The format is YYYY, YYYY-MM, or YYYY-MM-DD, e.g. 2018, 1973-06, or 1905-08-23. There SHALL be no time zone. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        ...
        message: "It should be a time during the day, in the format hh:mm:ss. There is no date specified. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        value: re `[^\s]+(\s[^\s]+)*`,
        message: "A code should be a string with at least one character and no leading or trailing whitespace, and there is no whitespace other than single spaces in the contents. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        ...
        message: "An OID should align with the URI specified in (RFC 3001 ); e.g. urn:oid:1.2.3.4.5; Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        ...
        message: "An id should be in any combination of upper-case or lower-case ASCII letters ('A'..'Z', and 'a'..'z', numerals ('0'..'9'), '-' and '.', with a length limit of 64 characters. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:String {
    pattern: {
        value: re `\s*(\S|\s)*`,
        message: "A markdown should be an FHIR string that may contain markdown syntax for optional processing by a markdown presentation engine in the GFM extension of CommonMark format. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:Int {
    minValue: {
        value: 1,
        message: "It should be any positive integer. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
...
@constraint:Int {
    minValue: {
        value: 0,
        message: "It should be any non-negative integer. Refer: https://hl7.org/fhir/R4/datatypes.html"
    }
}
