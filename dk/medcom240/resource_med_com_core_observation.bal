...
public const string PROFILE_BASE_MEDCOMCOREOBSERVATION = "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-observation";
public const RESOURCE_NAME_MEDCOMCOREOBSERVATION = "Observation";

# FHIR MedComCoreObservation resource record.
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "status": {
            ...
            valueSet: "http://medcomfhir.dk/ig/terminology/ValueSet/medcom-core-observation-status"
        }
    },
    serializers: {
...
public type MedComCoreObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDCOMCOREOBSERVATION resourceType = RESOURCE_NAME_MEDCOMCOREOBSERVATION;
    ...
    r4:time valueTime?;
    MedComCoreObservationCode code;
    ...
    MedComCoreObservationValue valueQuantity?;
    r4:Identifier[] identifier?;
    r4:Reference[] performer?;
    r4:Period effectivePeriod?;
    r4:Timing effectiveTiming?;
    MedComCoreObservationMethod method?;
    r4:Reference[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    MedComCoreObservationComponent[] component?;
    r4:Resource[] contained?;
    MedComCoreObservationReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "NPU": {
            name: "NPU",
            dataType: MedComCoreObservationComponentCodeCodingNPU,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "MedCom": {
            name: "MedCom",
            dataType: MedComCoreObservationComponentCodeCodingMedCom,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "LOINC": {
            name: "LOINC",
            dataType: MedComCoreObservationComponentCodeCodingLOINC,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SNOMEDCT": {
            name: "SNOMEDCT",
            dataType: MedComCoreObservationComponentCodeCodingSNOMEDCT,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SKS": {
            name: "SKS",
            dataType: MedComCoreObservationComponentCodeCodingSKS,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "IEEE": {
            name: "IEEE",
            dataType: MedComCoreObservationComponentCodeCodingIEEE,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type MedComCoreObservationComponentCode record {|
    *r4:CodeableConcept;
    ...
    MedComCoreObservationComponentCodeCodingNPU[] NPU?;
    r4:Extension[] extension?;
    @constraint:Array {
    ...
    MedComCoreObservationComponentCodeCodingMedCom[] MedCom?;
    @constraint:Array {
    ...
    MedComCoreObservationComponentCodeCodingLOINC[] LOINC?;
    @constraint:Array {
    ...
    MedComCoreObservationComponentCodeCodingSNOMEDCT[] SNOMEDCT?;
    @constraint:Array {
    ...
    MedComCoreObservationComponentCodeCodingSKS[] SKS?;
    string id?;
    string text?;
    @constraint:Array {
    ...
    MedComCoreObservationComponentCodeCodingIEEE[] IEEE?;
|};

# FHIR MedComCoreObservationComponentCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingIEEE record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: MedComCoreObservationCodeCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type MedComCoreObservationCode record {|
    *r4:CodeableConcept;

    MedComCoreObservationCodeCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingSKS record {|
    *MedComCoreObservationCodeCoding;
...
# FHIR MedComCoreObservationCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingSNOMEDCT record {|
    *MedComCoreObservationCodeCoding;
...
# FHIR MedComCoreObservationCodeCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCoding record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "MedComCoreObservationValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: MedComCoreObservationValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type MedComCoreObservationValue record {|
    *r4:Quantity;

    MedComCoreObservationValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# FHIR MedComCoreObservationComponentValue datatype record.
#
# + comparator - How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is '<' , then the real value is < stated value.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + unit - A human-readable form of the unit.
...
# + value - The value of the measured amount. The value includes an implicit precision in the presentation of the value.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: MedComCoreObservationComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
            description: "How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is '<' , then the real value is < stated value.",
...
public type MedComCoreObservationComponentValue record {|
    *r4:Quantity;

    MedComCoreObservationComponentValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingMedCom record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationCodeCodingNPU datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingNPU record {|
    *MedComCoreObservationCodeCoding;
...
# FHIR MedComCoreObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "MedComCoreObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR MedComCoreObservationCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingIEEE record {|
    *MedComCoreObservationCodeCoding;
...
# FHIR MedComCoreObservationComponentCodeCodingNPU datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingNPU record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationComponentCodeCodingLOINC datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingLOINC record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationComponentCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingSNOMEDCT record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationCodeCodingMedCom datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingMedCom record {|
    *MedComCoreObservationCodeCoding;
...
# FHIR MedComCoreObservationMethodCodingSCTCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationMethodCodingSCTCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationMethodCodingSCTCode record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: MedComCoreObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: MedComCoreObservationComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "The information determined as a result of making the observation, if the information has a simple value.",
...
public type MedComCoreObservationComponent record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] extension?;
    r4:time valueTime?;
    MedComCoreObservationComponentCode code;
    r4:Range valueRange?;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept valueCodeableConcept?;
    r4:Ratio valueRatio?;
    ...
    string id?;
    r4:integer valueInteger?;
    MedComCoreObservationComponentValue valueQuantity?;
|};

# FHIR MedComCoreObservationComponentCodeCodingSKS datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationComponentCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationComponentCodeCodingSKS record {|
    *r4:Coding;
...
# FHIR MedComCoreObservationMethod datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationMethod",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type MedComCoreObservationMethod record {|
    *r4:CodeableConcept;
...
# FHIR MedComCoreObservationCodeCodingLOINC datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "MedComCoreObservationCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreObservationCodeCodingLOINC record {|
    *MedComCoreObservationCodeCoding;
