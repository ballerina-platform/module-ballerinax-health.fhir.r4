...
public const string PROFILE_BASE_MEDCOMCOREORGANIZATION = "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-organization";
public const RESOURCE_NAME_MEDCOMCOREORGANIZATION = "Organization";

# FHIR MedComCoreOrganization resource record.
#
...
# + name - Name of the organization. Shall be present if known by the sender.
...
public type MedComCoreOrganization record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDCOMCOREORGANIZATION resourceType = RESOURCE_NAME_MEDCOMCOREORGANIZATION;
    ...
    r4:Meta meta?;
    MedComCoreOrganizationContact[] contact?;
    string name?;
    string[] alias?;
...
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationContact",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreOrganizationContact record {|
    *r4:BackboneElement;
...
# FHIR MedComCoreOrganizationIdentifierProducentID datatype record.
#
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierProducentID",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type MedComCoreOrganizationIdentifierProducentID record {|
    *r4:Identifier;
...
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierYdernummer",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: MedComCoreOrganizationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type MedComCoreOrganizationIdentifierYdernummer record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "urn:oid:1.2.208.176.1.4";
    MedComCoreOrganizationIdentifierUse use?;
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierRegionskode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: MedComCoreOrganizationIdentifierUseTwo,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type MedComCoreOrganizationIdentifierRegionskode record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "http://hl7.dk/fhir/core/CodeSystem/dk-core-regional-subdivision-codes";
    MedComCoreOrganizationIdentifierUseTwo use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
# FHIR MedComCoreOrganizationIdentifierKOMBIT_ORG_ID datatype record.
#
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierKOMBIT_ORG_ID",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type MedComCoreOrganizationIdentifierKOMBIT_ORG_ID record {|
    *r4:Identifier;

|};

# FHIR MedComCoreOrganizationIdentifierSOR_ID datatype record.
#
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierSOR_ID",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type MedComCoreOrganizationIdentifierSOR_ID record {|
    *r4:Identifier;
...
#
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierCVR_ID",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type MedComCoreOrganizationIdentifierCVR_ID record {|
    *r4:Identifier;

|};

# FHIR MedComCoreOrganizationIdentifierKommunekode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + period - Time period during which identifier is/was valid for use.
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
...
# + value - The portion of the identifier typically relevant to the user and which is unique within the context of the system.
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierKommunekode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: MedComCoreOrganizationIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type MedComCoreOrganizationIdentifierKommunekode record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system = "http://hl7.dk/fhir/core/CodeSystem/dk-core-municipality-codes";
    MedComCoreOrganizationIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
# FHIR MedComCoreOrganizationIdentifierEAN_ID datatype record.
#
@r4:DataTypeDefinition {
    name: "MedComCoreOrganizationIdentifierEAN_ID",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type MedComCoreOrganizationIdentifierEAN_ID record {|
    *r4:Identifier;
