...
public const string PROFILE_BASE_MEDCOMCOREPRACTITIONERROLE = "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-practitionerrole";
public const RESOURCE_NAME_MEDCOMCOREPRACTITIONERROLE = "PractitionerRole";

# FHIR MedComCorePractitionerRole resource record.
#
...
public type MedComCorePractitionerRole record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDCOMCOREPRACTITIONERROLE resourceType = RESOURCE_NAME_MEDCOMCOREPRACTITIONERROLE;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Period period?;
    r4:CodeableConcept[] specialty?;
    MedComCorePractitionerRoleCode[] code?;
    r4:Reference practitioner?;
    r4:Extension[] modifierExtension?;
    boolean active?;
    r4:code language?;
    MedComCorePractitionerRoleNotAvailable[] notAvailable?;
    MedComCorePractitionerRoleAvailableTime[] availableTime?;
...
@r4:DataTypeDefinition {
    name: "MedComCorePractitionerRoleNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCorePractitionerRoleNotAvailable record {|
    *r4:BackboneElement;
...
# FHIR MedComCorePractitionerRoleAvailableTime datatype record.
#
...
@r4:DataTypeDefinition {
    name: "MedComCorePractitionerRoleAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: MedComCorePractitionerRoleAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type MedComCorePractitionerRoleAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    MedComCorePractitionerRoleAvailableTimeDaysOfWeek[] daysOfWeek?;
    r4:time availableStartTime?;
|};

# FHIR MedComCorePractitionerRoleCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "MedComCorePractitionerRoleCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type MedComCorePractitionerRoleCode record {|
    *r4:CodeableConcept;
