...
public const string PROFILE_BASE_MEDCOMCOREDIAGNOSTICREPORT = "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-diagnosticreport";
public const RESOURCE_NAME_MEDCOMCOREDIAGNOSTICREPORT = "DiagnosticReport";

# FHIR MedComCoreDiagnosticReport resource record.
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "status": {
            ...
            valueSet: "http://medcomfhir.dk/ig/terminology/ValueSet/medcom-corediagnosticreport-status"
        }
    },
    serializers: {
...
public type MedComCoreDiagnosticReport record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDCOMCOREDIAGNOSTICREPORT resourceType = RESOURCE_NAME_MEDCOMCOREDIAGNOSTICREPORT;
    ...
    r4:code language?;
    MedComCoreDiagnosticReportMedia[] media?;
    string conclusion?;
    r4:Reference[] result?;
...
@r4:DataTypeDefinition {
    name: "MedComCoreDiagnosticReportMedia",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MedComCoreDiagnosticReportMedia record {|
    *r4:BackboneElement;
