...
public const string PROFILE_BASE_MEDCOMCOREPRACTITIONER = "http://medcomfhir.dk/ig/core/StructureDefinition/medcom-core-practitioner";
public const RESOURCE_NAME_MEDCOMCOREPRACTITIONER = "Practitioner";

# FHIR MedComCorePractitioner resource record.
#
...
public type MedComCorePractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_MEDCOMCOREPRACTITIONER resourceType = RESOURCE_NAME_MEDCOMCOREPRACTITIONER;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Address[] address?;
    MedComCorePractitionerGender gender?;
...
@r4:DataTypeDefinition {
    name: "MedComCorePractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type MedComCorePractitionerQualification record {|
    *r4:BackboneElement;
...
# + issuer - Organization that regulates and issues the qualification.
@r4:DataTypeDefinition {
    name: "MedComCorePractitionerQualificationOfficialHealthAuthorization",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type MedComCorePractitionerQualificationOfficialHealthAuthorization record {|
    *MedComCorePractitionerQualification;
