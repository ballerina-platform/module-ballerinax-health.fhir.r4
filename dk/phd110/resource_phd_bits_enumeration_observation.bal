...
public const string PROFILE_BASE_PHDBITSENUMERATIONOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdBitsEnumerationObservation";
public const RESOURCE_NAME_PHDBITSENUMERATIONOBSERVATION = "Observation";

# FHIR PhdBitsEnumerationObservation resource record.
#
...
# + dataAbsentReason - Provides a reason why no measurement BITs Component elements are present. This situation only happens if the Measurement-Status attribute or Enum-Observed-Value status field indicates a generic error.
...
public type PhdBitsEnumerationObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDBITSENUMERATIONOBSERVATION resourceType = RESOURCE_NAME_PHDBITSENUMERATIONOBSERVATION;

    boolean valueBoolean?;
    PhdBitsEnumerationObservationDataAbsentReason dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    @constraint:Array {
    ...
    r4:time valueTime?;
    PhdBitsEnumerationObservationCode code;
    ...
    PhdBitsEnumerationObservationComponent[] component?;
    r4:Resource[] contained?;
    PhdBitsEnumerationObservationReferenceRange[] referenceRange?;
    string valueString?;
    r4:dateTime effectiveDateTime;
    PhdBitsEnumerationObservationInterpretation[] interpretation?;
    PhdBitsEnumerationObservationMeta meta;
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdBitsEnumerationObservationComponentSupplementalTypesComponent record {|
    *PhdBitsEnumerationObservationComponent;
...
# FHIR PhdBitsEnumerationObservationComponentCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PhdBitsEnumerationObservationComponentCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PhdBitsEnumerationObservationComponentCode record {|
    *r4:CodeableConcept;
    ...
    PhdBitsEnumerationObservationComponentCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR PhdBitsEnumerationObservationComponentBitsComponent datatype record.
#
# + valueCodeableConcept - The information determined as a result of making the observation, if the information has a simple value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing. In this profile for this component that happens if the PHD does not support this bit and the uploader wishes to report that situation.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
# + interpretation - A categorical assessment of an observation value. For example, high, low, normal.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentBitsComponent",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "dataAbsentReason": {
            name: "dataAbsentReason",
            dataType: PhdBitsEnumerationObservationComponentDataAbsentReason,
            min: 0,
            max: 1,
            isArray: false,
            description: "Provides a reason why the expected value in the element Observation.component.value[x] is missing. In this profile for this component that happens if the PHD does not support this bit and the uploader wishes to report that situation.",
            path: "Observation.component.dataAbsentReason"
        },
        "extension": {
            name: "extension",
        ...
        "code": {
            name: "code",
            dataType: PhdBitsEnumerationObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type PhdBitsEnumerationObservationComponentBitsComponent record {|
    *PhdBitsEnumerationObservationComponent;

    r4:CodeableConcept valueCodeableConcept?;
    PhdBitsEnumerationObservationComponentDataAbsentReason dataAbsentReason?;
    r4:Extension[] extension?;
    PhdBitsEnumerationObservationComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};

# FHIR PhdBitsEnumerationObservationComponentCodeCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the IEEE ASN1 system.
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentCodeCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            ...
            max: 1,
            isArray: false,
            description: "A symbol in syntax defined by the IEEE ASN1 system.",
...
public type PhdBitsEnumerationObservationComponentCodeCoding record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationDataAbsentReasonCodingFhirDefault datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationDataAbsentReasonCodingFhirDefault",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationDataAbsentReasonCodingFhirDefault record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationMeta datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationMeta",
    baseType: (),
    elements: {
        "lastUpdated": {
            name: "lastUpdated",
...
public type PhdBitsEnumerationObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdBitsEnumerationObservationComponentDataAbsentReason datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdBitsEnumerationObservationComponentDataAbsentReason record {|
    *r4:CodeableConcept;
...
# FHIR PhdBitsEnumerationObservationMetaSecurityPhdHtest datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationIdentifierConditionalCreate datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdBitsEnumerationObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdBitsEnumerationObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdBitsEnumerationObservationIdentifierUse use?;
...
# FHIR PhdBitsEnumerationObservationInterpretation datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdBitsEnumerationObservationInterpretation record {|
    *r4:CodeableConcept;
...
# FHIR PhdBitsEnumerationObservationMetaProfilePhdProfile datatype record.
#
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationMetaProfilePhdProfile",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PhdBitsEnumerationObservationMetaProfilePhdProfile record {|

|};

# FHIR PhdBitsEnumerationObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdBitsEnumerationObservationComponentHiresRelativeTimeComponent record {|
    *PhdBitsEnumerationObservationComponent;
...
# FHIR PhdBitsEnumerationObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdBitsEnumerationObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdBitsEnumerationObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdBitsEnumerationObservationDataAbsentReason datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdBitsEnumerationObservationDataAbsentReason record {|
    *r4:CodeableConcept;
...
# FHIR PhdBitsEnumerationObservationComponentRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdBitsEnumerationObservationComponentRelativeTimeComponent record {|
    *PhdBitsEnumerationObservationComponent;
...
# FHIR PhdBitsEnumerationObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationCodeCodingLoincCoding record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationCodeCodingMDCType datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBitsEnumerationObservationCodeCodingMDCType record {|
    *r4:Coding;
...
# FHIR PhdBitsEnumerationObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "PhdBitsEnumerationObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdBitsEnumerationObservationComponent record {|
    *r4:BackboneElement;
