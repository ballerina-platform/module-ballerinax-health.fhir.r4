...
public const string PROFILE_BASE_PHDSTRINGENUMERATIONOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdStringEnumerationObservation";
public const RESOURCE_NAME_PHDSTRINGENUMERATIONOBSERVATION = "Observation";

# FHIR PhdStringEnumerationObservation resource record.
#
# + resourceType - The type of the resource describes
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.valueString is missing.
...
# * identifier Slicings
# 1) PhdStringEnumerationObservationIdentifierConditionalCreate: Unique identifier of this measurement for a given patient and device
#       - min = 0
#       - max = 1
#
...
# * component Slicings
# 1) PhdStringEnumerationObservationComponentRelativeTimeComponent: Relative time stamp of the measurement reported by the PHD.
#       - min = 0
#       - max = 1
#
# 2) PhdStringEnumerationObservationComponentHiresRelativeTimeComponent: Hi-Resolution Relative time stamp of the measurement reported by the PHD.
#       - min = 0
#       - max = 1
#
# 3) PhdStringEnumerationObservationComponentSupplementalTypesComponent: Supplemental Type: A further description of the measurement type.
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        "dataAbsentReason" : {
            ...
            dataType: PhdStringEnumerationObservationDataAbsentReason,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: PhdStringEnumerationObservationCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: PhdStringEnumerationObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: PhdStringEnumerationObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "interpretation" : {
            name: "interpretation",
            dataType: PhdStringEnumerationObservationInterpretation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "meta" : {
            name: "meta",
            dataType: PhdStringEnumerationObservationMeta,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: PhdStringEnumerationObservationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PhdStringEnumerationObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDSTRINGENUMERATIONOBSERVATION resourceType = RESOURCE_NAME_PHDSTRINGENUMERATIONOBSERVATION;

    PhdStringEnumerationObservationDataAbsentReason dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    @constraint:Array {
    ...
    PhdStringEnumerationObservationCode code;
    ...
    PhdStringEnumerationObservationComponent[] component?;
    r4:Resource[] contained?;
    PhdStringEnumerationObservationReferenceRange[] referenceRange?;
    string valueString;
    r4:dateTime effectiveDateTime;
    PhdStringEnumerationObservationInterpretation[] interpretation?;
    PhdStringEnumerationObservationMeta meta;
    r4:uri implicitRules?;
    r4:CodeableConcept[] category?;
    r4:Reference device;
    PhdStringEnumerationObservationStatus status;
    r4:Element ...;
|};

# FHIR PhdStringEnumerationObservationIdentifierConditionalCreate datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdStringEnumerationObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdStringEnumerationObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdStringEnumerationObservationIdentifierUse use?;
...
# FHIR PhdStringEnumerationObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# PhdStringEnumerationObservationIdentifierUse enum
public enum PhdStringEnumerationObservationIdentifierUse {
...
# FHIR PhdStringEnumerationObservationDataAbsentReason datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdStringEnumerationObservationDataAbsentReason record {|
    *r4:CodeableConcept;
...
# FHIR PhdStringEnumerationObservationComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdStringEnumerationObservationComponent record {|
    *r4:BackboneElement;
...
# FHIR PhdStringEnumerationObservationComponentRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdStringEnumerationObservationComponentRelativeTimeComponent record {|
    *PhdStringEnumerationObservationComponent;
...
# FHIR PhdStringEnumerationObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdStringEnumerationObservationComponentHiresRelativeTimeComponent record {|
    *PhdStringEnumerationObservationComponent;
...
# FHIR PhdStringEnumerationObservationMetaSecurityPhdHtest datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdStringEnumerationObservationDataAbsentReasonCodingFhirDefault datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationDataAbsentReasonCodingFhirDefault",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationDataAbsentReasonCodingFhirDefault record {|
    *r4:Coding;
...
# FHIR PhdStringEnumerationObservationCodeCodingMDCType datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationCodeCodingMDCType record {|
    *r4:Coding;
...
# PhdStringEnumerationObservationStatus enum
public enum PhdStringEnumerationObservationStatus {
...
# FHIR PhdStringEnumerationObservationMetaProfilePhdProfile datatype record.
#
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationMetaProfilePhdProfile",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PhdStringEnumerationObservationMetaProfilePhdProfile record {|

|};

# FHIR PhdStringEnumerationObservationInterpretation datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdStringEnumerationObservationInterpretation record {|
    *r4:CodeableConcept;
...
# FHIR PhdStringEnumerationObservationComponentSupplementalTypesComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdStringEnumerationObservationComponentSupplementalTypesComponent record {|
    *PhdStringEnumerationObservationComponent;
...
# FHIR PhdStringEnumerationObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdStringEnumerationObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdStringEnumerationObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdStringEnumerationObservationMeta datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationMeta",
    baseType: (),
    elements: {
        "lastUpdated": {
            name: "lastUpdated",
...
public type PhdStringEnumerationObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdStringEnumerationObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdStringEnumerationObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdStringEnumerationObservationCodeCodingLoincCoding record {|
    *r4:Coding;
