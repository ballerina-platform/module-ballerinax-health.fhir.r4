...
public const string PROFILE_BASE_PHDRTSAOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdRtsaObservation";
public const RESOURCE_NAME_PHDRTSAOBSERVATION = "Observation";

# FHIR PhdRtsaObservation resource record.
#
# + resourceType - The type of the resource describes
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.valueSampledData is missing.
...
# + valueSampledData - The information determined as a result of making the observation, when the observation consists of a periodic sample of numeric measurements.
...
public type PhdRtsaObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDRTSAOBSERVATION resourceType = RESOURCE_NAME_PHDRTSAOBSERVATION;

    PhdRtsaObservationDataAbsentReason dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    @constraint:Array {
    ...
    PhdRtsaObservationComponent[] component?;
    r4:Resource[] contained?;
    PhdRtsaObservationReferenceRange[] referenceRange?;
    r4:dateTime effectiveDateTime;
    PhdRtsaObservationInterpretation[] interpretation?;
    PhdRtsaObservationMeta meta;
    PhdRtsaObservationValue valueSampledData?;
...
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdRtsaObservationComponent record {|
    *r4:BackboneElement;
...
# FHIR PhdRtsaObservationValue datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + period - The length of time between sampling times, measured in milliseconds.
# + data - A series of data points which are decimal values separated by a single space (character u20). The special values 'E' (error), 'L' (below detection limit) and 'U' (above detection limit) are not used. The device does not provide such individual values.
# + origin - The 'origin' data type contains the 'y-intercept' for the equation that relates the scaled data to the actual data. If valueSampledData.data[i] is the array of sampled scaled data, the actual data is obtained by: x[i] =valueSampledData.data[i] * valueSampledData.factor + valueSampledData.origin.value
...
# + dimensions - The number of rtsa sample points at each time point. This value gives the number of data points in the valueSampledData.data[] array.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationValue",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "period": {
            ...
            path: "Observation.value[x].period"
        },
        "data": {
            name: "data",
            dataType: string,
            ...
            max: 1,
            isArray: false,
            description: "A series of data points which are decimal values separated by a single space (character u20). The special values 'E' (error), 'L' (below detection limit) and 'U' (above detection limit) are not used. The device does not provide such individual values.",
            path: "Observation.value[x].data"
        },
        "origin": {
            name: "origin",
            dataType: PhdRtsaObservationValueOrigin,
            min: 1,
            max: 1,
            isArray: false,
            description: "The 'origin' data type contains the 'y-intercept' for the equation that relates the scaled data to the actual data. If valueSampledData.data[i] is the array of sampled scaled data, the actual data is obtained by: x[i] =valueSampledData.data[i] * valueSampledData.factor + valueSampledData.origin.value",
        ...
        "dimensions": {
            ...
            max: 1,
            isArray: false,
            description: "The number of rtsa sample points at each time point. This value gives the number of data points in the valueSampledData.data[] array.",
            path: "Observation.value[x].dimensions"
        }
    },
    serializers: {
        'xml: r4:complexDataTypeXMLSerializer,
...
public type PhdRtsaObservationValue record {|
    *r4:SampledData;

    r4:Extension[] extension?;
    decimal period;
    string data?;
    PhdRtsaObservationValueOrigin origin;
    decimal upperLimit?;
    string id?;
    decimal lowerLimit?;
    decimal factor;
    r4:positiveInt dimensions;
|};

# FHIR PhdRtsaObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# FHIR PhdRtsaObservationComponentRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdRtsaObservationComponentRelativeTimeComponent record {|
    *PhdRtsaObservationComponent;
...
# FHIR PhdRtsaObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdRtsaObservationComponentHiresRelativeTimeComponent record {|
    *PhdRtsaObservationComponent;
...
# FHIR PhdRtsaObservationComponentSupplementalTypesComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdRtsaObservationComponentSupplementalTypesComponent record {|
    *PhdRtsaObservationComponent;
...
# FHIR PhdRtsaObservationMetaSecurityPhdHtest datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdRtsaObservationReferenceRangeLow datatype record.
#
# + comparator - Not allowed to be used in this context
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + unit - A human-readable form of the unit.
# + code - This unit code shall be the same as reported in the valueSampledData
# + system - This value identifies the MDC coding system
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + value - This is the value from the Scale-and-Range-SpecificationX.lower-absolute-value attribute where X is 8, 16, or 32. It is the minimum value that will be reported by the sensor. The attribute reports the value as an Mder FLOAT. Note that the word 'absolute' does not mean the mathematical absolute value!
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationReferenceRangeLow",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: PhdRtsaObservationReferenceRangeLowComparator,
            min: 0,
            max: 0,
            isArray: false,
        ...
        "code": {
            ...
            max: 1,
            isArray: false,
            description: "This unit code shall be the same as reported in the valueSampledData",
        ...
        "system": {
            ...
            max: 1,
            isArray: false,
            description: "This value identifies the MDC coding system",
...
public type PhdRtsaObservationReferenceRangeLow record {|
    *r4:Quantity;

    PhdRtsaObservationReferenceRangeLowComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code;
...
# FHIR PhdRtsaObservationMeta datatype record.
#
...
public type PhdRtsaObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdRtsaObservationValueOrigin datatype record.
#
# + comparator - Not allowed to be used in this context
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + unit - A human-readable form of the unit.
# + code - The unit code.
# + system - The identification of the UCUM coding system that provides the coded form of the unit.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + value - The intercept value with the indicated precision of the data as determined by the device.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationValueOrigin",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: PhdRtsaObservationValueOriginComparator,
            min: 0,
            max: 0,
            isArray: false,
            description: "Not allowed to be used in this context",
            path: "Observation.value[x].origin.comparator"
        },
        "extension": {
            name: "extension",
            dataType: r4:Extension,
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "Observation.value[x].origin.extension"
        },
        "unit": {
            name: "unit",
            dataType: string,
        ...
        "system": {
            ...
            max: 1,
            isArray: false,
            description: "The identification of the UCUM coding system that provides the coded form of the unit.",
        ...
        "id": {
            ...
            isArray: false,
            description: "Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
            path: "Observation.value[x].origin.id"
        },
        "value": {
            name: "value",
            dataType: decimal,
            ...
            max: 1,
            isArray: false,
            description: "The intercept value with the indicated precision of the data as determined by the device.",
            path: "Observation.value[x].origin.value"
        }
    },
    serializers: {
        'xml: r4:complexDataTypeXMLSerializer,
...
public type PhdRtsaObservationValueOrigin record {|
    *r4:Quantity;

    PhdRtsaObservationValueOriginComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code;
    r4:uri system = "http://unitsofmeasure.org";
...
# FHIR PhdRtsaObservationReferenceRangeScaleAndReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + low - The Scale-and-Range-SpecificationX.lower-absolute-value from the RTSA metric where X is one of 8, 16, or 32.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationReferenceRangeScaleAndReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "high": {
            name: "high",
            dataType: PhdRtsaObservationReferenceRangeHigh,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "low": {
            name: "low",
            dataType: PhdRtsaObservationReferenceRangeLow,
            min: 1,
            max: 1,
            isArray: false,
            description: "The Scale-and-Range-SpecificationX.lower-absolute-value from the RTSA metric where X is one of 8, 16, or 32.",
...
public type PhdRtsaObservationReferenceRangeScaleAndReferenceRange record {|
    *PhdRtsaObservationReferenceRange;

    r4:Extension[] extension?;
    PhdRtsaObservationReferenceRangeHigh high;
    PhdRtsaObservationReferenceRangeLow low;
    r4:Extension[] modifierExtension?;
...
# + unit - A human-readable form of the unit.
# + code - This unit code shall be the same as reported in the valueSampledData
# + system - This value identifies theUCUM coding system
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + value - This is the value from the Scale-and-Range-SpecificationX.upper-absolute-value attribute where X is 8, 16, or 32. It is the maximum value that will be reported by the sensor. The attribute reports the value as an Mder FLOAT. Note that the word 'absolute' does not mean the mathematical absolute value!
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationReferenceRangeHigh",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: PhdRtsaObservationReferenceRangeHighComparator,
            min: 0,
            max: 0,
            isArray: false,
            description: "Not allowed to be used in this context",
        ...
        "system": {
            ...
            max: 1,
            isArray: false,
            description: "This value identifies theUCUM coding system",
...
public type PhdRtsaObservationReferenceRangeHigh record {|
    *r4:Quantity;

    PhdRtsaObservationReferenceRangeHighComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code;
    r4:uri system = "http://unitsofmeasure.org";
...
# FHIR PhdRtsaObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationCodeCodingLoincCoding record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationCodeCodingMDCType record {|
    *r4:Coding;
...
# FHIR PhdRtsaObservationIdentifierConditionalCreate datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdRtsaObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdRtsaObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdRtsaObservationIdentifierUse use?;
...
# + age - The age at which this reference range is applicable. This is a neonatal age (e.g. number of weeks at term) if the meaning says so.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdRtsaObservationDataAbsentReason datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdRtsaObservationDataAbsentReason record {|
    *r4:CodeableConcept;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdRtsaObservationInterpretation record {|
    *r4:CodeableConcept;
...
public type PhdRtsaObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdRtsaObservationDataAbsentReasonCodingFhirDefault datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationDataAbsentReasonCodingFhirDefault",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdRtsaObservationDataAbsentReasonCodingFhirDefault record {|
    *r4:Coding;
...
# FHIR PhdRtsaObservationMetaProfilePhdProfile datatype record.
#
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationMetaProfilePhdProfile",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PhdRtsaObservationMetaProfilePhdProfile record {|

|};

# FHIR PhdRtsaObservationCategoryVitalSignsCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdRtsaObservationCategoryVitalSignsCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdRtsaObservationCategoryVitalSignsCategory record {|
    *r4:CodeableConcept;
