...
public const string PROFILE_BASE_PHDNUMERICOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdNumericObservation";
public const RESOURCE_NAME_PHDNUMERICOBSERVATION = "Observation";

# FHIR PhdNumericObservation resource record.
#
# + resourceType - The type of the resource describes
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.valueQuantity is missing. This could be a 'not-a-number', 'positive-infinity', 'negative-infinity' or an error condition indicated by the Measurement-Status attribute or the status field from a Nu-Observed-Value attribute.
...
# * identifier Slicings
# 1) PhdNumericObservationIdentifierConditionalCreate: Unique identifier of this measurement for a given patient and device
# - min = 0
# - max = 1
#
...
# * component Slicings
# 1) PhdNumericObservationComponentRelativeTimeComponent: Relative time stamp of the measurement reported by the PHD.
# - min = 0
# - max = 1
#
# 2) PhdNumericObservationComponentMeasurementConfidence95Component: The Measurement-Confidence-95 range
# - min = 0
# - max = 1
#
# 3) PhdNumericObservationComponentAlertOpTextStringComponent: The Alert-Op-Text human readable strings
# - min = 0
# - max = 1
#
# 4) PhdNumericObservationComponentAccuracyComponent: The accuracy of the measurement
# - min = 0
# - max = 1
#
# 5) PhdNumericObservationComponentHiresRelativeTimeComponent: Hi-Resolution Relative time stamp of the measurement reported by the PHD.
# - min = 0
# - max = 1
#
# 6) PhdNumericObservationComponentSupplementalTypesComponent: Supplemental Type: A further description of the measurement type.
# - min = 0
# - max = *
#
# 7) PhdNumericObservationComponentCurrentLimitsComponent: The Current-Limits values
# - min = 0
# - max = 1
#
# 8) PhdNumericObservationComponentThresholdNotificationTextStringComponent: The Threshold-Notification-Text-String attribute value entry
# - min = 0
# - max = 1
#
# 9) PhdNumericObservationComponentAlertOpStateComponent: The Alert Operations State component
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        "dataAbsentReason": {
            ...
            dataType: PhdNumericObservationDataAbsentReason,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "code": {
            name: "code",
            dataType: PhdNumericObservationCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: PhdNumericObservationValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component": {
            name: "component",
            dataType: PhdNumericObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange": {
            name: "referenceRange",
            dataType: PhdNumericObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "interpretation": {
            name: "interpretation",
            dataType: PhdNumericObservationInterpretation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "meta": {
            name: "meta",
            dataType: PhdNumericObservationMeta,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status": {
            name: "status",
            dataType: PhdNumericObservationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PhdNumericObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDNUMERICOBSERVATION resourceType = RESOURCE_NAME_PHDNUMERICOBSERVATION;

    PhdNumericObservationDataAbsentReason dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    @constraint:Array {
    ...
    PhdNumericObservationCode code;
    ...
    PhdNumericObservationValue valueQuantity?;
    ...
    PhdNumericObservationComponent[] component?;
    r4:Resource[] contained?;
    PhdNumericObservationReferenceRange[] referenceRange?;
    r4:dateTime effectiveDateTime;
    PhdNumericObservationInterpretation[] interpretation?;
    PhdNumericObservationMeta meta;
    r4:uri implicitRules?;
    r4:Reference device;
    PhdNumericObservationStatus status;
    r4:Element...;
|};

# FHIR PhdNumericObservationComponentAlertOpTextStringComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentAlertOpTextStringComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentAlertOpTextStringComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationComponentAccuracyComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentAccuracyComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentAccuracyComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# PhdNumericObservationStatus enum
public enum PhdNumericObservationStatus {
...
# FHIR PhdNumericObservationComponentAlertOpStateComponent datatype record.
#
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentAlertOpStateComponent",
    baseType: (),
    elements: {
        ...
        "code": {
            name: "code",
            dataType: PhdNumericObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type PhdNumericObservationComponentAlertOpStateComponent record {|
    *PhdNumericObservationComponent;

    r4:CodeableConcept valueCodeableConcept;
    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    PhdNumericObservationComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};

# FHIR PhdNumericObservationComponentCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: PhdNumericObservationComponentCodeCoding,
            min: 1,
            max: 1,
            isArray: true,
...
public type PhdNumericObservationComponentCode record {|
    *r4:CodeableConcept;
    ...
    PhdNumericObservationComponentCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR PhdNumericObservationCodeCodingMDCType datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationCodeCodingMDCType record {|
    *r4:Coding;
...
# FHIR PhdNumericObservationComponentRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentRelativeTimeComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdNumericObservationComponent datatype record.
#
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdNumericObservationComponent record {|
    *r4:BackboneElement;
...
# FHIR PhdNumericObservationComponentThresholdNotificationTextStringComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentThresholdNotificationTextStringComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentThresholdNotificationTextStringComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationValue datatype record.
#
...
# + value - The decoded Mder FLOAT or SFLOAT value from a PHD measurement containing either a Basic-Nu-Observed-Value Simple-Nu-Observed-Value or Nu_observed-Value attribute.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: PhdNumericObservationValueComparator,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "value": {
            ...
            max: 1,
            isArray: false,
            description: "The decoded Mder FLOAT or SFLOAT value from a PHD measurement containing either a Basic-Nu-Observed-Value Simple-Nu-Observed-Value or Nu_observed-Value attribute.",
...
public type PhdNumericObservationValue record {|
    *r4:Quantity;

    PhdNumericObservationValueComparator comparator?;
    string unit?;
    r4:code code;
...
# FHIR PhdNumericObservationDataAbsentReason datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdNumericObservationDataAbsentReason record {|
    *r4:CodeableConcept;
...
# FHIR PhdNumericObservationIdentifierConditionalCreate datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdNumericObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdNumericObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdNumericObservationIdentifierUse use?;
...
# FHIR PhdNumericObservationMeta datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdNumericObservationMeta",
    baseType: (),
    elements: {
        "lastUpdated": {
            name: "lastUpdated",
...
public type PhdNumericObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdNumericObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationCodeCodingLoincCoding record {|
    *r4:Coding;
...
# FHIR PhdNumericObservationComponentSupplementalTypesComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentSupplementalTypesComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationMetaProfilePhdProfile datatype record.
#
@r4:DataTypeDefinition {
    name: "PhdNumericObservationMetaProfilePhdProfile",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PhdNumericObservationMetaProfilePhdProfile record {|

|};

# FHIR PhdNumericObservationComponentMeasurementConfidence95Component datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentMeasurementConfidence95Component",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentMeasurementConfidence95Component record {|
    *PhdNumericObservationComponent;
...
# PhdNumericObservationIdentifierUse enum
public enum PhdNumericObservationIdentifierUse {
...
# FHIR PhdNumericObservationMetaSecurityPhdHtest datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdNumericObservationCategoryVitalSignsCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationCategoryVitalSignsCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdNumericObservationCategoryVitalSignsCategory record {|
    *r4:CodeableConcept;
...
# FHIR PhdNumericObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdNumericObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdNumericObservationComponentCurrentLimitsComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentCurrentLimitsComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentCurrentLimitsComponent record {|
    *PhdNumericObservationComponent;
...
# FHIR PhdNumericObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdNumericObservationComponentHiresRelativeTimeComponent record {|
    *PhdNumericObservationComponent;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationComponentCodeCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            ...
            max: 1,
            isArray: false,
            description: "This code, which is an alpha-numeric string, is generated by the attribute MDC code, which is 68746 for the Alert-Op-State, followed by a dot (.) followed by the MDER-bit that was set. Given that only three bits are defined in the Pulse Ox specialization that uses this attribute, the code will be one of 68746.0, 68746.1, or 68746.2",
...
public type PhdNumericObservationComponentCodeCoding record {|
    *r4:Coding;
...
# PhdNumericObservationValueComparator enum
public enum PhdNumericObservationValueComparator {
...
# FHIR PhdNumericObservationDataAbsentReasonCodingFhirDefault datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationDataAbsentReasonCodingFhirDefault",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdNumericObservationDataAbsentReasonCodingFhirDefault record {|
    *r4:Coding;
...
# FHIR PhdNumericObservationInterpretation datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdNumericObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdNumericObservationInterpretation record {|
    *r4:CodeableConcept;
