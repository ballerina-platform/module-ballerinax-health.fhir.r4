...
public const string PROFILE_BASE_PHDBASEOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdBaseObservation";
public const RESOURCE_NAME_PHDBASEOBSERVATION = "Observation";

# FHIR PhdBaseObservation resource record.
#
...
# * identifier Slicings
# 1) PhdBaseObservationIdentifierConditionalCreate: Unique identifier of this measurement for a given patient and device
# - min = 0
# - max = 1
#
...
# * component Slicings
# 1) PhdBaseObservationComponentRelativeTimeComponent: Relative time stamp of the measurement reported by the PHD.
# - min = 0
# - max = 1
#
# 2) PhdBaseObservationComponentHiresRelativeTimeComponent: Hi-Resolution Relative time stamp of the measurement reported by the PHD.
# - min = 0
# - max = 1
#
# 3) PhdBaseObservationComponentSupplementalTypesComponent: Supplemental Type: A further description of the measurement type.
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdBaseObservation",
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "code": {
            name: "code",
            dataType: PhdBaseObservationCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "subject": {
            name: "subject",
            dataType: PhdBaseObservationSubject,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component": {
            name: "component",
            dataType: PhdBaseObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange": {
            name: "referenceRange",
            dataType: PhdBaseObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "interpretation": {
            name: "interpretation",
            dataType: PhdBaseObservationInterpretation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "meta": {
            name: "meta",
            dataType: PhdBaseObservationMeta,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "device": {
            name: "device",
            dataType: PhdBaseObservationDevice,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status": {
            name: "status",
            dataType: PhdBaseObservationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PhdBaseObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDBASEOBSERVATION resourceType = RESOURCE_NAME_PHDBASEOBSERVATION;
    ...
    r4:time valueTime?;
    PhdBaseObservationCode code;
    PhdBaseObservationSubject subject;
    r4:Range valueRange?;
    ...
    PhdBaseObservationComponent[] component?;
    r4:Resource[] contained?;
    PhdBaseObservationReferenceRange[] referenceRange?;
    string valueString?;
    r4:dateTime effectiveDateTime;
    PhdBaseObservationInterpretation[] interpretation?;
    PhdBaseObservationMeta meta;
    r4:SampledData valueSampledData?;
    r4:Period valuePeriod?;
    r4:uri implicitRules?;
    r4:CodeableConcept[] category?;
    PhdBaseObservationDevice device;
    PhdBaseObservationStatus status;
    r4:Element...;
|};

# FHIR PhdBaseObservationComponentSupplementalTypesComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: PhdBaseObservationComponentCodeTwo,
            min: 1,
            max: 1,
            isArray: false,
...
public type PhdBaseObservationComponentSupplementalTypesComponent record {|
    *PhdBaseObservationComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    PhdBaseObservationComponentCodeTwo code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};

# FHIR PhdBaseObservationMeta datatype record.
#
...
public type PhdBaseObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdBaseObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdBaseObservationComponent record {|
    *r4:BackboneElement;
...
# FHIR PhdBaseObservationComponentRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: PhdBaseObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type PhdBaseObservationComponentRelativeTimeComponent record {|
    *PhdBaseObservationComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    PhdBaseObservationComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};

# FHIR PhdBaseObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdBaseObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBaseObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# FHIR PhdBaseObservationCodeCodingMDCType datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBaseObservationCodeCodingMDCType record {|
    *r4:Coding;
...
# FHIR PhdBaseObservationComponentCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - The reference identifier should be included in the description. For a Relative-Time-Stamp the ref id is MDC_ATTR_TIME_STAMP_REL
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "text": {
            ...
            max: 1,
            isArray: false,
            description: "The reference identifier should be included in the description. For a Relative-Time-Stamp the ref id is MDC_ATTR_TIME_STAMP_REL",
...
public type PhdBaseObservationComponentCode record {|
    *r4:CodeableConcept;
...
# PhdBaseObservationStatus enum
public enum PhdBaseObservationStatus {
...
# FHIR PhdBaseObservationMetaSecurityPhdHtest datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBaseObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdBaseObservationDevice datatype record.
#
# + reference - Reference to the device-related resources that describe the sensor device taking the measurement. This element will point to a Device resource following the Phd Device Profile.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        "reference": {
            ...
            max: 1,
            isArray: false,
            description: "Reference to the device-related resources that describe the sensor device taking the measurement. This element will point to a Device resource following the Phd Device Profile.",
...
public type PhdBaseObservationDevice record {|
    *r4:Reference;
...
# FHIR PhdBaseObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type PhdBaseObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdBaseObservationComponentCodeOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - The reference identifier should be included in the description. For a Hi-Res-Relative-Time-Stamp the ref id is MDC_ATTR_TIME_STAMP_REL_HI_RES
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "text": {
            ...
            max: 1,
            isArray: false,
            description: "The reference identifier should be included in the description. For a Hi-Res-Relative-Time-Stamp the ref id is MDC_ATTR_TIME_STAMP_REL_HI_RES",
            path: "Observation.component.code.text"
        }
    },
    serializers: {
...
public type PhdBaseObservationComponentCodeOne record {|
    *r4:CodeableConcept;
...
# FHIR PhdBaseObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdBaseObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBaseObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdBaseObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdBaseObservationCodeCodingLoincCoding record {|
    *r4:Coding;
...
# FHIR PhdBaseObservationComponentCodeTwo datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - It is recommended to display at least the reference identifier for the Supplemental-Types which is MDC_ATTR_SUPPLEMENTAL_TYPES
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentCodeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "text": {
            ...
            max: 1,
            isArray: false,
            description: "It is recommended to display at least the reference identifier for the Supplemental-Types which is MDC_ATTR_SUPPLEMENTAL_TYPES",
            path: "Observation.component.code.text"
        }
    },
    serializers: {
...
public type PhdBaseObservationComponentCodeTwo record {|
    *r4:CodeableConcept;
...
# PhdBaseObservationIdentifierUse enum
public enum PhdBaseObservationIdentifierUse {
...
# FHIR PhdBaseObservationInterpretation datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdBaseObservationInterpretation record {|
    *r4:CodeableConcept;
...
# FHIR PhdBaseObservationIdentifierConditionalCreate datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdBaseObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdBaseObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdBaseObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdBaseObservationIdentifierUse use?;
...
# FHIR PhdBaseObservationSubject datatype record.
#
...
# + 'type - The expected type of the target of the reference. If both Reference.type and Reference.reference are populated and Reference.reference is a FHIR URL, both SHALL be consistent. The type is the Canonical URL of Resource Definition that is the type this reference refers to. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition/ e.g. 'Patient' is a reference to http://hl7.org/fhir/StructureDefinition/Patient. Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not resources).
@r4:DataTypeDefinition {
    name: "PhdBaseObservationSubject",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type PhdBaseObservationSubject record {|
    *r4:Reference;
...
# FHIR PhdBaseObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdBaseObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: PhdBaseObservationComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type PhdBaseObservationComponentHiresRelativeTimeComponent record {|
    *PhdBaseObservationComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    PhdBaseObservationComponentCodeOne code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
