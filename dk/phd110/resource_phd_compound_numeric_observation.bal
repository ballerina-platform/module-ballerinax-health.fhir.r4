...
public const string PROFILE_BASE_PHDCOMPOUNDNUMERICOBSERVATION = "http://hl7.org/fhir/uv/phd/StructureDefinition/PhdCompoundNumericObservation";
public const RESOURCE_NAME_PHDCOMPOUNDNUMERICOBSERVATION = "Observation";

# FHIR PhdCompoundNumericObservation resource record.
#
...
# + dataAbsentReason - Provides a reason why no measurement compoundComponent elements are present. This situation only happens if the Measurement-Status attribute indicates a generic error.
...
public type PhdCompoundNumericObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_PHDCOMPOUNDNUMERICOBSERVATION resourceType = RESOURCE_NAME_PHDCOMPOUNDNUMERICOBSERVATION;

    boolean valueBoolean?;
    PhdCompoundNumericObservationDataAbsentReason dataAbsentReason?;
    r4:Reference[] partOf?;
    r4:Annotation[] note?;
    r4:time valueTime?;
    @constraint:Array {
    ...
    PhdCompoundNumericObservationCode code;
    ...
    PhdCompoundNumericObservationReferenceRange[] referenceRange?;
    r4:CodeableConcept bodySite?;
    PhdCompoundNumericObservationComponent[] component?;
    r4:Resource[] contained?;
    string valueString?;
    PhdCompoundNumericObservationInterpretation[] interpretation?;
    r4:dateTime effectiveDateTime;
    PhdCompoundNumericObservationMeta meta;
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdCompoundNumericObservationComponentRelativeTimeComponent record {|
    *PhdCompoundNumericObservationComponent;
...
# FHIR PhdCompoundNumericObservationComponentSupplementalTypesComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentSupplementalTypesComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdCompoundNumericObservationComponentSupplementalTypesComponent record {|
    *PhdCompoundNumericObservationComponent;
...
# FHIR PhdCompoundNumericObservationComponentValue datatype record.
#
...
# + code - The MDC code must be translated to the UCUM code.
# + system - The unit code shall use the UCUM system
# + value - The value of nth element of the compound attribute. The value element for the nth compoundComponent is missing if the attribute sends a special value or the Compound-Nu-Observed-Value status element indicates an error.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: PhdCompoundNumericObservationComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "code": {
            ...
            max: 1,
            isArray: false,
            description: "The MDC code must be translated to the UCUM code.",
        ...
        "value": {
            ...
            max: 1,
            isArray: false,
            description: "The value of nth element of the compound attribute. The value element for the nth compoundComponent is missing if the attribute sends a special value or the Compound-Nu-Observed-Value status element indicates an error.",
...
public type PhdCompoundNumericObservationComponentValue record {|
    *r4:Quantity;

    PhdCompoundNumericObservationComponentValueComparator comparator?;
    string unit?;
    r4:code code;
...
# FHIR PhdCompoundNumericObservationCategoryVitalSignsCategory datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationCategoryVitalSignsCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdCompoundNumericObservationCategoryVitalSignsCategory record {|
    *r4:CodeableConcept;
...
# FHIR PhdCompoundNumericObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdCompoundNumericObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR PhdCompoundNumericObservationInterpretationCodingMsmtStatusInterpretation datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationInterpretationCodingMsmtStatusInterpretation",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationInterpretationCodingMsmtStatusInterpretation record {|
    *r4:Coding;
...
# FHIR PhdCompoundNumericObservationDataAbsentReasonCodingFhirDefault datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationDataAbsentReasonCodingFhirDefault",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationDataAbsentReasonCodingFhirDefault record {|
    *r4:Coding;
...
# FHIR PhdCompoundNumericObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR PhdCompoundNumericObservationComponentHiresRelativeTimeComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentHiresRelativeTimeComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdCompoundNumericObservationComponentHiresRelativeTimeComponent record {|
    *PhdCompoundNumericObservationComponent;
...
# FHIR PhdCompoundNumericObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type PhdCompoundNumericObservationComponent record {|
    *r4:BackboneElement;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationMetaSecurityPhdHtest",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationMetaSecurityPhdHtest record {|
    *r4:Coding;
...
# FHIR PhdCompoundNumericObservationMeta datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationMeta",
    baseType: (),
    elements: {
        "lastUpdated": {
            name: "lastUpdated",
...
public type PhdCompoundNumericObservationMeta record {|
    *r4:Meta;
...
# FHIR PhdCompoundNumericObservationIdentifierConditionalCreate datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationIdentifierConditionalCreate",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: PhdCompoundNumericObservationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PhdCompoundNumericObservationIdentifierConditionalCreate record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    PhdCompoundNumericObservationIdentifierUse use?;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdCompoundNumericObservationDataAbsentReason record {|
    *r4:CodeableConcept;
...
# FHIR PhdCompoundNumericObservationMetaProfilePhdProfile datatype record.
#
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationMetaProfilePhdProfile",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type PhdCompoundNumericObservationMetaProfilePhdProfile record {|

|};

# FHIR PhdCompoundNumericObservationComponentDataAbsentReason datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentDataAbsentReason",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdCompoundNumericObservationComponentDataAbsentReason record {|
    *r4:CodeableConcept;

    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Observation.component.dataAbsentReason.coding constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.Observation.component.dataAbsentReason.coding constraint. This field must be an array containing at most one item."
        }
    }
    r4:Coding[] coding;
    r4:Extension[] extension?;
...
# FHIR PhdCompoundNumericObservationComponentAccuracyComponent datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentAccuracyComponent",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
...
public type PhdCompoundNumericObservationComponentAccuracyComponent record {|
    *PhdCompoundNumericObservationComponent;
...
# FHIR PhdCompoundNumericObservationComponentCompound datatype record.
#
# + dataAbsentReason - Provides a reason why the expected value in the nth element Observation.compoundComponent.valueQuantity is missing. This could be a NaN (Not a Number), PINF (Positive infinity), NINF (Negative infinity) or the reserved and not-at-this-resolution special values. It can also be indicated by the (measurement) status field of the Compound-Nu-Observed-Value. Note that the FHIR codes for NAN are no longer 'NAN' but 'not-a-number'. Similar changes have been made for NINF and PINF.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - Describes what was observed. Sometimes this is called the observation 'code'.
# + interpretation - A categorical assessment of an observation value. For example, high, low, normal.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationComponentCompound",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
            dataType: PhdCompoundNumericObservationComponentDataAbsentReason,
            min: 0,
            max: 1,
            isArray: false,
            description: "Provides a reason why the expected value in the nth element Observation.compoundComponent.valueQuantity is missing. This could be a NaN (Not a Number), PINF (Positive infinity), NINF (Negative infinity) or the reserved and not-at-this-resolution special values. It can also be indicated by the (measurement) status field of the Compound-Nu-Observed-Value. Note that the FHIR codes for NAN are no longer 'NAN' but 'not-a-number'. Similar changes have been made for NINF and PINF.",
            path: "Observation.component.dataAbsentReason"
        },
        "extension": {
            name: "extension",
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: PhdCompoundNumericObservationComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "The information determined as a result of making the observation, if the information has a simple value.",
...
public type PhdCompoundNumericObservationComponentCompound record {|
    *PhdCompoundNumericObservationComponent;

    PhdCompoundNumericObservationComponentDataAbsentReason dataAbsentReason?;
    r4:Extension[] extension?;
    r4:CodeableConcept code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
    PhdCompoundNumericObservationComponentValue valueQuantity?;
|};
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationInterpretation",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type PhdCompoundNumericObservationInterpretation record {|
    *r4:CodeableConcept;
...
# FHIR PhdCompoundNumericObservationCodeCodingLoincCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationCodeCodingLoincCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationCodeCodingLoincCoding record {|
    *r4:Coding;
...
# FHIR PhdCompoundNumericObservationCodeCodingMDCType datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "PhdCompoundNumericObservationCodeCodingMDCType",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PhdCompoundNumericObservationCodeCodingMDCType record {|
    *r4:Coding;
