...
public const string PROFILE_BASE_DKCOREOBSERVATION = "http://hl7.dk/fhir/core/StructureDefinition/dk-core-observation";
public const RESOURCE_NAME_DKCOREOBSERVATION = "Observation";

# FHIR DkCoreObservation resource record.
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code": {
            name: "code",
            dataType: DkCoreObservationCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: DkCoreObservationValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "method": {
            name: "method",
            dataType: DkCoreObservationMethod,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component": {
            name: "component",
            dataType: DkCoreObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange": {
            name: "referenceRange",
            dataType: DkCoreObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status": {
            name: "status",
            dataType: DkCoreObservationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type DkCoreObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_DKCOREOBSERVATION resourceType = RESOURCE_NAME_DKCOREOBSERVATION;
    ...
    DkCoreObservationValue valueQuantity?;
    r4:Identifier[] identifier?;
    r4:Reference[] performer?;
    r4:Period effectivePeriod?;
    r4:Timing effectiveTiming?;
    DkCoreObservationMethod method?;
    r4:Reference[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    DkCoreObservationComponent[] component?;
    r4:Resource[] contained?;
    DkCoreObservationReferenceRange[] referenceRange?;
    string valueString?;
    ...
    DkCoreObservationStatus status;
    r4:Element...;
|};

# FHIR DkCoreObservationCodeCodingLOINC datatype record.
#
...
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingLOINC record {|
    *r4:Coding;
...
# FHIR DkCoreObservationValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "DkCoreObservationValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: DkCoreObservationValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type DkCoreObservationValue record {|
    *r4:Quantity;

    DkCoreObservationValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# FHIR DkCoreObservationComponentCodeCodingMedCom datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingMedCom record {|
    *r4:Coding;
...
# FHIR DkCoreObservationCodeCodingSKS datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingSKS record {|
    *r4:Coding;
...
# FHIR DkCoreObservationComponentCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "NPU": {
            name: "NPU",
            dataType: DkCoreObservationComponentCodeCodingNPU,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "MedCom": {
            name: "MedCom",
            dataType: DkCoreObservationComponentCodeCodingMedCom,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "LOINC": {
            name: "LOINC",
            dataType: DkCoreObservationComponentCodeCodingLOINC,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SNOMEDCT": {
            name: "SNOMEDCT",
            dataType: DkCoreObservationComponentCodeCodingSNOMEDCT,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SKS": {
            name: "SKS",
            dataType: DkCoreObservationComponentCodeCodingSKS,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "IEEE": {
            name: "IEEE",
            dataType: DkCoreObservationComponentCodeCodingIEEE,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type DkCoreObservationComponentCode record {|
    *r4:CodeableConcept;
    ...
    DkCoreObservationComponentCodeCodingNPU[] NPU?;
    r4:Extension[] extension?;
    @constraint:Array {
    ...
    DkCoreObservationComponentCodeCodingMedCom[] MedCom?;
    @constraint:Array {
    ...
    DkCoreObservationComponentCodeCodingLOINC[] LOINC?;
    @constraint:Array {
    ...
    DkCoreObservationComponentCodeCodingSNOMEDCT[] SNOMEDCT?;
    @constraint:Array {
    ...
    DkCoreObservationComponentCodeCodingSKS[] SKS?;
    string id?;
    string text?;
    @constraint:Array {
    ...
    DkCoreObservationComponentCodeCodingIEEE[] IEEE?;
|};

# FHIR DkCoreObservationCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingSNOMEDCT record {|
    *r4:Coding;
...
# FHIR DkCoreObservationCodeCodingNPU datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingNPU record {|
    *r4:Coding;
...
# DkCoreObservationComponentValueComparator enum
public enum DkCoreObservationComponentValueComparator {
...
# FHIR DkCoreObservationComponentCodeCodingLOINC datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingLOINC record {|
    *r4:Coding;
...
# FHIR DkCoreObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "DkCoreObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR DkCoreObservationMethodCodingSCTCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationMethodCodingSCTCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationMethodCodingSCTCode record {|
    *r4:Coding;
...
# FHIR DkCoreObservationComponentCodeCodingNPU datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingNPU record {|
    *r4:Coding;
...
# FHIR DkCoreObservationComponentValue datatype record.
#
# + comparator - How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is '<' , then the real value is < stated value.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + unit - A human-readable form of the unit.
...
# + value - The value of the measured amount. The value includes an implicit precision in the presentation of the value.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: DkCoreObservationComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
            description: "How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is '<' , then the real value is < stated value.",
...
public type DkCoreObservationComponentValue record {|
    *r4:Quantity;

    DkCoreObservationComponentValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# FHIR DkCoreObservationMethod datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type DkCoreObservationMethod record {|
    *r4:CodeableConcept;
...
# FHIR DkCoreObservationComponentCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingSNOMEDCT record {|
    *r4:Coding;
...
# FHIR DkCoreObservationComponentCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingIEEE record {|
    *r4:Coding;
...
# FHIR DkCoreObservationCodeCodingMedCom datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingMedCom record {|
    *r4:Coding;
...
# DkCoreObservationStatus enum
public enum DkCoreObservationStatus {
...
# FHIR DkCoreObservationCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type DkCoreObservationCode record {|
    *r4:CodeableConcept;
...
# DkCoreObservationValueComparator enum
public enum DkCoreObservationValueComparator {
    CODE_COMPARATOR_LESS_THAN_OR_EQUAL = "<=",
    CODE_COMPARATOR_LESS_THAN = "<",
    CODE_COMPARATOR_GREATER_THAN = ">",
    CODE_COMPARATOR_GREATER_THAN_OR_EQUAL = ">="
...
# FHIR DkCoreObservationComponentCodeCodingSKS datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponentCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationComponentCodeCodingSKS record {|
    *r4:Coding;
...
# FHIR DkCoreObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "DkCoreObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: DkCoreObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: DkCoreObservationComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "The information determined as a result of making the observation, if the information has a simple value.",
...
public type DkCoreObservationComponent record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] extension?;
    r4:time valueTime?;
    DkCoreObservationComponentCode code;
    r4:Range valueRange?;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept valueCodeableConcept?;
    r4:Ratio valueRatio?;
    ...
    string id?;
    r4:integer valueInteger?;
    DkCoreObservationComponentValue valueQuantity?;
|};

# FHIR DkCoreObservationCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreObservationCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreObservationCodeCodingIEEE record {|
    *r4:Coding;
