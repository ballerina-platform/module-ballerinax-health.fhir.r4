...
public const string PROFILE_BASE_DKCORECONDITION = "http://hl7.dk/fhir/core/StructureDefinition/dk-core-condition";
public const RESOURCE_NAME_DKCORECONDITION = "Condition";

# FHIR DkCoreCondition resource record.
#
...
public type DkCoreCondition record {|
    *r4:DomainResource;

    RESOURCE_NAME_DKCORECONDITION resourceType = RESOURCE_NAME_DKCORECONDITION;

    r4:Annotation[] note?;
    r4:Extension[] extension?;
    DkCoreConditionCode code?;
    DkCoreConditionEvidence[] evidence?;
    r4:Range onsetRange?;
...
public type DkCoreConditionEvidence record {|
    *r4:BackboneElement;
...
# FHIR DkCoreConditionCodeCodingSCTConditionCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "DkCoreConditionCodeCodingSCTConditionCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreConditionCodeCodingSCTConditionCode record {|
    *r4:Coding;
...
# FHIR DkCoreConditionCodeCodingFSIIIConditionCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreConditionCodeCodingFSIIIConditionCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreConditionCodeCodingFSIIIConditionCode record {|
    *r4:Coding;
...
# FHIR DkCoreConditionCodeCodingSKS_D datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreConditionCodeCodingSKS_D",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreConditionCodeCodingSKS_D record {|
    *r4:Coding;
...
# FHIR DkCoreConditionCodeCodingICPC2code datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreConditionCodeCodingICPC2code",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreConditionCodeCodingICPC2code record {|
    *r4:Coding;
...
# FHIR DkCoreConditionStage datatype record.
#
...
public type DkCoreConditionStage record {|
    *r4:BackboneElement;
...
# FHIR DkCoreConditionCodeCodingFFBConditionCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreConditionCodeCodingFFBConditionCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreConditionCodeCodingFFBConditionCode record {|
    *r4:Coding;
...
# FHIR DkCoreConditionCode datatype record.
#
...
public type DkCoreConditionCode record {|
    *r4:CodeableConcept;
