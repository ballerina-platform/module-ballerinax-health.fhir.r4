...
public const string PROFILE_BASE_DKCOREBASICOBSERVATION = "http://hl7.dk/fhir/core/StructureDefinition/dk-core-basic-observation";
public const RESOURCE_NAME_DKCOREBASICOBSERVATION = "Observation";

# FHIR DkCoreBasicObservation resource record.
#
...
public type DkCoreBasicObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_DKCOREBASICOBSERVATION resourceType = RESOURCE_NAME_DKCOREBASICOBSERVATION;
    ...
    r4:time valueTime?;
    DkCoreBasicObservationCode code;
    ...
    DkCoreBasicObservationValue valueQuantity?;
    r4:Identifier[] identifier?;
    r4:Reference[] performer?;
    r4:Period effectivePeriod?;
    r4:Timing effectiveTiming?;
    DkCoreBasicObservationMethod method?;
    r4:Reference[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    DkCoreBasicObservationComponent[] component?;
    r4:Resource[] contained?;
    DkCoreBasicObservationReferenceRange[] referenceRange?;
    string valueString?;
    ...
    DkCoreBasicObservationCategory[] category;
    r4:Reference device?;
...
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingLOINC record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponentCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingSNOMEDCT record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR DkCoreBasicObservationCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingIEEE record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingNPU record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code;
    r4:uri system = "urn:oid:1.2.208.176.2.1";
    boolean userSelected?;
    string display?;
    string id?;
    string 'version?;
...
# FHIR DkCoreBasicObservationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type DkCoreBasicObservationCategoryCoding record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponentCodeCodingIEEE datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingIEEE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingIEEE record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationMethodCodingSCTCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationMethodCodingSCTCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationMethodCodingSCTCode record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: DkCoreBasicObservationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DkCoreBasicObservationCategory record {|
    *r4:CodeableConcept;
    ...
    DkCoreBasicObservationCategoryCoding[] coding;
|};

# FHIR DkCoreBasicObservationMethod datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationMethod",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type DkCoreBasicObservationMethod record {|
    *r4:CodeableConcept;
...
# FHIR DkCoreBasicObservationComponentCodeCodingLOINC datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingLOINC record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponentCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + NPU - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + MedCom - A reference to a code defined by a terminology system.
# + LOINC - A reference to a code defined by a terminology system.
# + SNOMEDCT - A reference to a code defined by a terminology system.
# + SKS - A reference to a code defined by a terminology system.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
# + IEEE - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
        ...
        "NPU": {
            name: "NPU",
            dataType: DkCoreBasicObservationComponentCodeCodingNPU,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "MedCom": {
            name: "MedCom",
            dataType: DkCoreBasicObservationComponentCodeCodingMedCom,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "LOINC": {
            name: "LOINC",
            dataType: DkCoreBasicObservationComponentCodeCodingLOINC,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SNOMEDCT": {
            name: "SNOMEDCT",
            dataType: DkCoreBasicObservationComponentCodeCodingSNOMEDCT,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "SKS": {
            name: "SKS",
            dataType: DkCoreBasicObservationComponentCodeCodingSKS,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
        ...
        "IEEE": {
            name: "IEEE",
            dataType: DkCoreBasicObservationComponentCodeCodingIEEE,
            min: 0,
            max: 1,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type DkCoreBasicObservationComponentCode record {|
    *r4:CodeableConcept;
    ...
    DkCoreBasicObservationComponentCodeCodingNPU[] NPU?;
    r4:Extension[] extension?;
    @constraint:Array {
    ...
    DkCoreBasicObservationComponentCodeCodingMedCom[] MedCom?;
    @constraint:Array {
    ...
    DkCoreBasicObservationComponentCodeCodingLOINC[] LOINC?;
    @constraint:Array {
    ...
    DkCoreBasicObservationComponentCodeCodingSNOMEDCT[] SNOMEDCT?;
    @constraint:Array {
    ...
    DkCoreBasicObservationComponentCodeCodingSKS[] SKS?;
    string id?;
    string text?;
    @constraint:Array {
    ...
    DkCoreBasicObservationComponentCodeCodingIEEE[] IEEE?;
|};

# FHIR DkCoreBasicObservationCodeCodingMedCom datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingMedCom record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code;
    r4:uri system = "http://medcomfhir.dk/ig/terminology/CodeSystem/medcom-observation-codes";
    boolean userSelected?;
    string display?;
    string id?;
    string 'version?;
...
# FHIR DkCoreBasicObservationComponentCodeCodingSKS datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingSKS record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code;
    r4:uri system = "urn:oid:1.2.208.176.2.4";
    boolean userSelected?;
    string display?;
    string id?;
    string 'version?;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type DkCoreBasicObservationCode record {|
    *r4:CodeableConcept;
...
# FHIR DkCoreBasicObservationCodeCodingNPU datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingNPU",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingNPU record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponentValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: DkCoreBasicObservationComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type DkCoreBasicObservationComponentValue record {|
    *r4:Quantity;

    DkCoreBasicObservationComponentValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# + value - The value of the measured amount. The value includes an implicit precision in the presentation of the value.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: DkCoreBasicObservationValueComparator,
            min: 0,
            max: 1,
            isArray: false,
            description: "How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is '<' , then the real value is < stated value.",
...
public type DkCoreBasicObservationValue record {|
    *r4:Quantity;

    DkCoreBasicObservationValueComparator comparator?;
    r4:Extension[] extension?;
    string unit?;
    r4:code code?;
    r4:uri system?;
...
# FHIR DkCoreBasicObservationCodeCodingSNOMEDCT datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingSNOMEDCT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingSNOMEDCT record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationCodeCodingSKS datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationCodeCodingSKS",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationCodeCodingSKS record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponentCodeCodingMedCom datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponentCodeCodingMedCom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DkCoreBasicObservationComponentCodeCodingMedCom record {|
    *r4:Coding;
...
# FHIR DkCoreBasicObservationComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "DkCoreBasicObservationComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: DkCoreBasicObservationComponentCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: DkCoreBasicObservationComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "The information determined as a result of making the observation, if the information has a simple value.",
...
public type DkCoreBasicObservationComponent record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] extension?;
    r4:time valueTime?;
    DkCoreBasicObservationComponentCode code;
    r4:Range valueRange?;
    r4:Extension[] modifierExtension?;
    r4:CodeableConcept valueCodeableConcept?;
    r4:Ratio valueRatio?;
    ...
    string id?;
    r4:integer valueInteger?;
    DkCoreBasicObservationComponentValue valueQuantity?;
|};
