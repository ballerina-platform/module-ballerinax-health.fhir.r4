...
public const string PROFILE_BASE_DKCOREPRACTITIONER = "http://hl7.dk/fhir/core/StructureDefinition/dk-core-practitioner";
public const RESOURCE_NAME_DKCOREPRACTITIONER = "Practitioner";

# FHIR DkCorePractitioner resource record.
#
...
# 1) DkCorePractitionerQualificationOfficialHealthAuthorization: Certification, licenses, or training pertaining to the provision of care
# - min = 0
# - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: DkCorePractitionerGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "qualification": {
            name: "qualification",
            dataType: DkCorePractitionerQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DkCorePractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_DKCOREPRACTITIONER resourceType = RESOURCE_NAME_DKCOREPRACTITIONER;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Address[] address?;
    DkCorePractitionerGender gender?;
    r4:Extension[] modifierExtension?;
    boolean active?;
    r4:Attachment[] photo?;
    r4:code language?;
    r4:date birthDate?;
    DkCorePractitionerQualification[] qualification?;
...
# FHIR DkCorePractitionerQualificationOfficialHealthAuthorization datatype record.
#
...
@r4:DataTypeDefinition {
    name: "DkCorePractitionerQualificationOfficialHealthAuthorization",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type DkCorePractitionerQualificationOfficialHealthAuthorization record {|
    *DkCorePractitionerQualification;
...
# DkCorePractitionerGender enum
public enum DkCorePractitionerGender {
...
# FHIR DkCorePractitionerQualification datatype record.
#
...
# + issuer - Organization that regulates and issues the qualification.
@r4:DataTypeDefinition {
    name: "DkCorePractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type DkCorePractitionerQualification record {|
    *r4:BackboneElement;
