...
public const string PROFILE_BASE_DTRQUESTIONNAIRENEXTQUESTIONNAIREOUTPUTPARAMETERS = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-next-question-output-parameters";
public const RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREOUTPUTPARAMETERS = "Parameters";
...
# * parameter Slicings
# 1) DTRQuestionnaireNextQuestionnaireOutputParametersParameterQuestionnaireResponse: Operation Parameter
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "parameter": {
            name: "parameter",
            dataType: DTRQuestionnaireNextQuestionnaireOutputParametersParameter,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRQuestionnaireNextQuestionnaireOutputParameters record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREOUTPUTPARAMETERS resourceType = RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREOUTPUTPARAMETERS;

    r4:Meta meta?;
    DTRQuestionnaireNextQuestionnaireOutputParametersParameter[] 'parameter?;
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireNextQuestionnaireOutputParametersParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnaireNextQuestionnaireOutputParametersParameter record {|
    *r4:BackboneElement;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireNextQuestionnaireOutputParametersParameterQuestionnaireResponse",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnaireNextQuestionnaireOutputParametersParameterQuestionnaireResponse record {|
    *DTRQuestionnaireNextQuestionnaireOutputParametersParameter;
