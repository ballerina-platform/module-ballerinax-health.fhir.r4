...
public const string PROFILE_BASE_DTRQUESTIONNAIRENEXTQUESTIONNAIREINPUTPARAMETERS = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-next-question-input-parameters";
public const RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREINPUTPARAMETERS = "Parameters";
...
# * parameter Slicings
# 1) DTRQuestionnaireNextQuestionnaireInputParametersParameterQuestionnaireResponse: Operation Parameter
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-next-question-input-parameters",
    elements: {
        "meta": {
            name: "meta",
            dataType: r4:Meta,
        ...
        "parameter": {
            name: "parameter",
            dataType: DTRQuestionnaireNextQuestionnaireInputParametersParameter,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRQuestionnaireNextQuestionnaireInputParameters record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREINPUTPARAMETERS resourceType = RESOURCE_NAME_DTRQUESTIONNAIRENEXTQUESTIONNAIREINPUTPARAMETERS;

    r4:Meta meta?;
    DTRQuestionnaireNextQuestionnaireInputParametersParameter[] 'parameter?;
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireNextQuestionnaireInputParametersParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnaireNextQuestionnaireInputParametersParameter record {|
    *r4:BackboneElement;
...
# + valueCount - If the parameter is a data type.
# + valueId - If the parameter is a data type.
# + 'resource - Sets expectations for supported capabilities for questionnaire responses for SDC-conformant systems.
# + valueCode - If the parameter is a data type.
# + valueAddress - If the parameter is a data type.
# + valueContactPoint - If the parameter is a data type.
# + valuePeriod - If the parameter is a data type.
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireNextQuestionnaireInputParametersParameterQuestionnaireResponse",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
        ...
        "resource": {
            name: "resource",
            dataType: DTRQuestionnaireResponse,
            min: 0,
            max: 1,
            isArray: false,
            description: "Sets expectations for supported capabilities for questionnaire responses for SDC-conformant systems.",
            path: "Parameters.parameter.resource"
        },
...
public type DTRQuestionnaireNextQuestionnaireInputParametersParameterQuestionnaireResponse record {|
    *DTRQuestionnaireNextQuestionnaireInputParametersParameter;
    ...
    r4:Count valueCount?;
    r4:id valueId?;
    DTRQuestionnaireResponse 'resource?;
    r4:code valueCode?;
    r4:Address valueAddress?;
    r4:ContactPoint valueContactPoint?;
    r4:Period valuePeriod?;
