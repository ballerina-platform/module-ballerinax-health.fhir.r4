...
public const string PROFILE_BASE_DTRSTDQUESTIONNAIRE = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-std-questionnaire";
public const RESOURCE_NAME_DTRSTDQUESTIONNAIRE = "Questionnaire";
...
@r4:ResourceDefinition {
    ...
    "title" : {
            name: "title",
            dataType: DTRStdQuestionnaireTitle,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "text" : {
            name: "text",
            dataType: DTRStdQuestionnaireText,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "item" : {
            name: "item",
            dataType: DTRStdQuestionnaireItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "status" : {
            name: "status",
            dataType: DTRStdQuestionnaireStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRStdQuestionnaire record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRSTDQUESTIONNAIRE resourceType = RESOURCE_NAME_DTRSTDQUESTIONNAIRE;
...
r4:code language?;
DTRStdQuestionnaireTitle title?;
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Questionnaire.subjectType constraint. This field must be an array containing at least one item."
        },

        maxLength: {
            value: 1,
            message: "Validation failed for $.Questionnaire.subjectType constraint. This field must be an array containing at most one item."
        }
    }
r4:code   [] subjectType;
...
string id?;
DTRStdQuestionnaireText text;
r4:Identifier   [] identifier?;
DTRStdQuestionnaireItem   [] item?;
...
DTRStdQuestionnaireStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    ...
    "status": {
            name: "status",
            dataType: DTRStdQuestionnaireTextStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRStdQuestionnaireText record {|
    *r4:Narrative;

r4:xhtml div;
r4:Extension   [] extension?;
string id?;
DTRStdQuestionnaireTextStatus status;
|};

# DTRStdQuestionnaireItemEnableWhenOperator enum
public enum DTRStdQuestionnaireItemEnableWhenOperator {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "DTRStdQuestionnaireItemEnableWhen",
    baseType: (),
    elements: {
    ...
    "operator": {
            name: "operator",
            dataType: DTRStdQuestionnaireItemEnableWhenOperator,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRStdQuestionnaireItemEnableWhen record {|
    *r4:BackboneElement;
...
DTRStdQuestionnaireItemEnableWhenOperator operator;
...
public enum DTRStdQuestionnaireItemType {
   CODE_TYPE_DATE = "date",
...
public enum DTRStdQuestionnaireTextStatus {
...
public enum DTRStdQuestionnaireStatus {
...
public enum DTRStdQuestionnaireItemEnableBehavior {
...
@r4:DataTypeDefinition {
    name: "DTRStdQuestionnaireItemText",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRStdQuestionnaireItemText record {|
...
public type DTRStdQuestionnaireTitle record {|
...
@r4:DataTypeDefinition {
    ...
    "enableWhen": {
            name: "enableWhen",
            dataType: DTRStdQuestionnaireItemEnableWhen,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "initial": {
            name: "initial",
            dataType: DTRStdQuestionnaireItemInitial,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "type": {
            name: "type",
            dataType: DTRStdQuestionnaireItemType,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "enableBehavior": {
            name: "enableBehavior",
            dataType: DTRStdQuestionnaireItemEnableBehavior,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "text": {
            name: "text",
            dataType: DTRStdQuestionnaireItemText,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "answerOption": {
            name: "answerOption",
            dataType: DTRStdQuestionnaireItemAnswerOption,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRStdQuestionnaireItem record {|
    *r4:BackboneElement;

boolean repeats?;
r4:Extension   [] extension?;
r4:Coding   [] code?;
DTRStdQuestionnaireItemEnableWhen   [] enableWhen?;
DTRStdQuestionnaireItemInitial   [] initial?;
string prefix?;
r4:Extension   [] modifierExtension?;
boolean readOnly?;
DTRStdQuestionnaireItemType 'type;
boolean required?;
string linkId;
r4:uri definition?;
DTRStdQuestionnaireItemEnableBehavior enableBehavior?;
string id?;
DTRStdQuestionnaireItemText text?;
DTRStdQuestionnaireItemAnswerOption   [] answerOption?;
...
@r4:DataTypeDefinition {
    name: "DTRStdQuestionnaireItemInitial",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRStdQuestionnaireItemInitial record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "DTRStdQuestionnaireItemAnswerOption",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRStdQuestionnaireItemAnswerOption record {|
    *r4:BackboneElement;
