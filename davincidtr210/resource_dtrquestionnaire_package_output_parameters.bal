...
public const string PROFILE_BASE_DTRQUESTIONNAIREPACKAGEOUTPUTPARAMETERS = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-qpackage-output-parameters";
public const RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEOUTPUTPARAMETERS = "Parameters";
...
# * parameter Slicings
# 1) DTRQuestionnairePackageOutputParametersParameterOutcome: Operation Outcome from this execution
#       - min = 0
#       - max = 1
#
# 2) DTRQuestionnairePackageOutputParametersParameterPackageBundle: The QuestionnairePackage bundle that was retrieved
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    "parameter" : {
            name: "parameter",
            dataType: DTRQuestionnairePackageOutputParametersParameter,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRQuestionnairePackageOutputParameters record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEOUTPUTPARAMETERS resourceType = RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEOUTPUTPARAMETERS;
...
DTRQuestionnairePackageOutputParametersParameter   [] 'parameter;
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageOutputParametersParameterOutcome",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnairePackageOutputParametersParameterOutcome record {|
    *DTRQuestionnairePackageOutputParametersParameter;
...
# + valueCount - If the parameter is a data type.
# + valueId - If the parameter is a data type.
# + 'resource - A container for a collection of resources.
# + valueCode - If the parameter is a data type.
# + valueAddress - If the parameter is a data type.
# + valueContactPoint - If the parameter is a data type.
# + valuePeriod - If the parameter is a data type.
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageOutputParametersParameterPackageBundle",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnairePackageOutputParametersParameterPackageBundle record {|
    *DTRQuestionnairePackageOutputParametersParameter;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageOutputParametersParameter",
    baseType: (),
    elements: {
    "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnairePackageOutputParametersParameter record {|
    *r4:BackboneElement;
