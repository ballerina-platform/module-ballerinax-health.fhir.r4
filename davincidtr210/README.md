...
Da Vinci DTR (2.1.0) FHIR R4 profile package for Documentation Templates and Rules workflows. It includes typed models for questionnaire adaptation, package input/output parameters, and response handling.
...
- Typed DTR models for questionnaire and parameter-based workflows
- Support for adapt/search operations and next-question flows
- Profile records for DTR package and logging interactions
- Improves reliability in documentation-rule exchange implementations
- FHIR R4 JSON support for DTR integration pipelines
