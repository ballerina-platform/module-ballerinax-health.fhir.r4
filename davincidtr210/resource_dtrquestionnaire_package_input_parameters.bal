...
public const string PROFILE_BASE_DTRQUESTIONNAIREPACKAGEINPUTPARAMETERS = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-qpackage-input-parameters";
public const RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEINPUTPARAMETERS = "Parameters";
...
# * parameter Slicings
# 1) DTRQuestionnairePackageInputParametersParameterCoverage: Operation Parameter
# - min = 1
# - max = *
#
# 2) DTRQuestionnairePackageInputParametersParameterQuestionnaire: Operation Parameter
# - min = 0
# - max = *
#
# 3) DTRQuestionnairePackageInputParametersParameterChangedsince: When the Questionnaire package was last retrieved
# - min = 0
# - max = 1
#
# 4) DTRQuestionnairePackageInputParametersParameterContext: CRD or CDex-provided context
# - min = 0
# - max = 1
#
# 5) DTRQuestionnairePackageInputParametersParameterOrder: Operation Parameter
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "parameter": {
            name: "parameter",
            dataType: DTRQuestionnairePackageInputParametersParameter,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRQuestionnairePackageInputParameters record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEINPUTPARAMETERS resourceType = RESOURCE_NAME_DTRQUESTIONNAIREPACKAGEINPUTPARAMETERS;
    ...
    DTRQuestionnairePackageInputParametersParameter[] 'parameter;
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameterQuestionnaire",
    baseType: (),
    elements: {
        "valueCanonical": {
            name: "valueCanonical",
...
public type DTRQuestionnairePackageInputParametersParameterQuestionnaire record {|
    *DTRQuestionnairePackageInputParametersParameter;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameterChangedsince",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DTRQuestionnairePackageInputParametersParameterChangedsince record {|
    *DTRQuestionnairePackageInputParametersParameter;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameterContext",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DTRQuestionnairePackageInputParametersParameterContext record {|
    *DTRQuestionnairePackageInputParametersParameter;
...
# + 'resource - This profile specifies constraints on the Coverage resource to support coverage requirements discovery.
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameterCoverage",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
        ...
        "resource": {
            name: "resource",
            dataType: davincicrd210:CRDCoverage,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRQuestionnairePackageInputParametersParameterCoverage record {|
    *DTRQuestionnairePackageInputParametersParameter;
    ...
    r4:Count valueCount?;
    r4:id valueId?;
    davincicrd210:CRDCoverage 'resource;
    r4:code valueCode?;
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnairePackageInputParametersParameter record {|
    *r4:BackboneElement;
...
#
# + valueTime - If the parameter is a data type.
# + 'resource - A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).
# + valueTriggerDefinition - If the parameter is a data type.
# + valueMoney - If the parameter is a data type.
# + valueSignature - If the parameter is a data type.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
# + valueAnnotation - If the parameter is a data type.
@r4:DataTypeDefinition {
    name: "DTRQuestionnairePackageInputParametersParameterOrder",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type DTRQuestionnairePackageInputParametersParameterOrder record {|
    *DTRQuestionnairePackageInputParametersParameter;
