...
public const string PROFILE_BASE_DTRQUESTIONNAIREADAPTSEARCH = "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-questionnaire-adapt-search";
public const RESOURCE_NAME_DTRQUESTIONNAIREADAPTSEARCH = "Questionnaire";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-dtr/StructureDefinition/dtr-questionnaire-adapt-search",
    elements: {
    "date" : {
            name: "date",
    ...
    "title" : {
            name: "title",
            dataType: DTRQuestionnaireAdaptSearchTitle,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "item" : {
            name: "item",
            dataType: DTRQuestionnaireAdaptSearchItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "status" : {
            name: "status",
            dataType: DTRQuestionnaireAdaptSearchStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRQuestionnaireAdaptSearch record {|
    *r4:DomainResource;

    RESOURCE_NAME_DTRQUESTIONNAIREADAPTSEARCH resourceType = RESOURCE_NAME_DTRQUESTIONNAIREADAPTSEARCH;
...
r4:code language?;
DTRQuestionnaireAdaptSearchTitle title?;
r4:code   [] subjectType?;
...
DTRQuestionnaireAdaptSearchItem   [] item?;
...
DTRQuestionnaireAdaptSearchStatus status;
    r4:Element ...;
|};

# DTRQuestionnaireAdaptSearchItemType enum
public enum DTRQuestionnaireAdaptSearchItemType {
   CODE_TYPE_DATE = "date",
...
public enum DTRQuestionnaireAdaptSearchItemEnableWhenOperator {
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireAdaptSearchItemInitial",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRQuestionnaireAdaptSearchItemInitial record {|
    *r4:BackboneElement;
...
public enum DTRQuestionnaireAdaptSearchItemEnableBehavior {
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireAdaptSearchItemAnswerOption",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRQuestionnaireAdaptSearchItemAnswerOption record {|
    *r4:BackboneElement;
...
public enum DTRQuestionnaireAdaptSearchStatus {
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireAdaptSearchTitle",
    baseType: (),
    elements: {
    "extension": {
            name: "extension",
...
public type DTRQuestionnaireAdaptSearchTitle record {|
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireAdaptSearchItemEnableWhen",
    baseType: (),
    elements: {
    ...
    "operator": {
            name: "operator",
            dataType: DTRQuestionnaireAdaptSearchItemEnableWhenOperator,
            min: 1,
            max: 1,
            isArray: false,
...
public type DTRQuestionnaireAdaptSearchItemEnableWhen record {|
    *r4:BackboneElement;
...
DTRQuestionnaireAdaptSearchItemEnableWhenOperator operator;
...
@r4:DataTypeDefinition {
    name: "DTRQuestionnaireAdaptSearchItem",
    baseType: (),
    elements: {
    "repeats": {
            name: "repeats",
    ...
    "enableWhen": {
            name: "enableWhen",
            dataType: DTRQuestionnaireAdaptSearchItemEnableWhen,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "initial": {
            name: "initial",
            dataType: DTRQuestionnaireAdaptSearchItemInitial,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
    ...
    "type": {
            name: "type",
            dataType: DTRQuestionnaireAdaptSearchItemType,
            min: 1,
            max: 1,
            isArray: false,
    ...
    "enableBehavior": {
            name: "enableBehavior",
            dataType: DTRQuestionnaireAdaptSearchItemEnableBehavior,
            min: 0,
            max: 1,
            isArray: false,
    ...
    "answerOption": {
            name: "answerOption",
            dataType: DTRQuestionnaireAdaptSearchItemAnswerOption,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DTRQuestionnaireAdaptSearchItem record {|
    *r4:BackboneElement;

boolean repeats?;
r4:Extension   [] extension?;
r4:Coding   [] code?;
DTRQuestionnaireAdaptSearchItemEnableWhen   [] enableWhen?;
DTRQuestionnaireAdaptSearchItemInitial   [] initial?;
string prefix?;
r4:Extension   [] modifierExtension?;
boolean readOnly?;
DTRQuestionnaireAdaptSearchItemType 'type;
boolean required?;
string linkId;
r4:uri definition?;
DTRQuestionnaireAdaptSearchItemEnableBehavior enableBehavior?;
string id?;
string text?;
DTRQuestionnaireAdaptSearchItemAnswerOption   [] answerOption?;
