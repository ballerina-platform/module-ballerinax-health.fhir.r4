...
public const string PROFILE_BASE_BEOBSERVATION = "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-observation";
public const RESOURCE_NAME_BEOBSERVATION = "Observation";
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-observation",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "component" : {
            name: "component",
            dataType: BeObservationComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: BeObservationReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BeObservation record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEOBSERVATION resourceType = RESOURCE_NAME_BEOBSERVATION;
    ...
    r4:time valueTime?;
    BeObservationcodeableconcept code;
    ...
    BeObservationComponent [] component?;
    r4:Resource [] contained?;
    BeObservationReferenceRange [] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    name: "BeObservationReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationReferenceRange record {|
    *r4:BackboneElement;
...
public type BeObservationComponent record {|
    *r4:BackboneElement;
...
public enum BeObservationStatus {
