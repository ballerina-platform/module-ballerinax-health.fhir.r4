...
const FHIR_IG = "belgium_federal_clinical_core100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "belgium_federal_clinical_core100",
        name: "belgium_federal_clinical_core100",
...
searchParameters: [TRANSVERSALCLINICALCORE_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 TransversalClinicalCore Module initialized.");
}
