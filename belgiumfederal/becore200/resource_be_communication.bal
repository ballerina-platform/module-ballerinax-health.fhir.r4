...
public const string PROFILE_BASE_BECOMMUNICATION = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-communication";
public const RESOURCE_NAME_BECOMMUNICATION = "Communication";
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-communication",
    elements: {
        "note" : {
            name: "note",
        ...
        "payload" : {
            name: "payload",
            dataType: BeCommunicationPayload,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority" : {
            name: "priority",
            dataType: BeCommunicationPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: BeCommunicationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeCommunication record {|
    *r4:DomainResource;

    RESOURCE_NAME_BECOMMUNICATION resourceType = RESOURCE_NAME_BECOMMUNICATION;
    ...
    BeCommunicationPayload [] payload?;
    ...
    BeCommunicationPriority priority?;
    r4:dateTime sent?;
    ...
    BeCommunicationStatus status;
    r4:Element ...;
|};

# BeCommunicationPriority enum
public enum BeCommunicationPriority {
...
public type BeCommunicationPayload record {|
    *r4:BackboneElement;
...
public enum BeCommunicationStatus {
