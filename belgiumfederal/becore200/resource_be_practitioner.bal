...
public const string PROFILE_BASE_BEPRACTITIONER = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-practitioner";
public const RESOURCE_NAME_BEPRACTITIONER = "Practitioner";

# FHIR BePractitioner resource record.
#
# + resourceType - The type of the resource describes
# + identifier - An identifier that applies to this person in this role. Typically, a NIHDI value and/or a SSIN value are given. Other systems remain allowed. Flows in organizations will most likely want to also include a local identifier, using its own system. A type can be added if needed. When it is given, a consumer SHALL NOT ignore it.
    # * identifier Slicings
        # 1) BePractitionerIdentifierSSIN: An identifier for the person as this agent
        #       - min = 0
        #       - max = *
        #
        # 2) BePractitionerIdentifierCBE: An identifier for the person as this agent
        #       - min = 0
        #       - max = *
        #
        # 3) BePractitionerIdentifierNIHDI: An identifier for the person as this agent
        #       - min = 0
        #       - max = *
        #
...
# + active - Whether this practitioner's record is in active use. It is RECOMMENDED to keep the value ‘true’ as long as the practitioner is still being treated by the provider of the data.
...
# + name - The name(s) associated with the practitioner. Typically RECOMMENDED to include one familyname and at least one given name and to define this use as ‘official’.
# + implicitRules - A reference to a set of rules that were followed when the resource was constructed, and which must be understood when processing the content. Often, this is a reference to an implementation guide that defines the special rules along with other profiles etc.
# + telecom - A contact detail for the practitioner, e.g. a telephone number or an email address. It is RECOMMENDED to at least add one phone or email address.
# + id - The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes.
# + text - A human-readable narrative that contains a summary of the resource and can be used to represent the content of the resource to a human. The narrative need not encode all the structured data, but is required to contain sufficient detail to make it 'clinically safe' for a human to just read the narrative. Resource definitions may define what content should be represented in the narrative to ensure clinical safety.
# + communication - A language the practitioner can use in patient communication. It is RECOMMENDED to include this when available
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "qualification" : {
            name: "qualification",
            dataType: BePractitionerQualification,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BePractitioner record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEPRACTITIONER resourceType = RESOURCE_NAME_BEPRACTITIONER;

    r4:Identifier [] identifier?;
    r4:Extension [] extension?;
    BeAddress [] address?;
    BePractitionerGender gender?;
    r4:Extension [] modifierExtension?;
    boolean active?;
    r4:Attachment [] photo?;
    r4:code language?;
    r4:date birthDate?;
    BePractitionerQualification [] qualification?;
...
@r4:DataTypeDefinition {
    name: "BePractitionerIdentifierSSIN",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: BePractitionerIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type BePractitionerIdentifierSSIN record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/ssin";
    BePractitionerIdentifierUse use?;
...
public enum BePractitionerIdentifierUseTwo {
...
public enum BePractitionerGender {
...
@r4:DataTypeDefinition {
    name: "BePractitionerQualification",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type BePractitionerQualification record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BePractitionerIdentifierCBE",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: BePractitionerIdentifierUseOne,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type BePractitionerIdentifierCBE record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/cbe";
    BePractitionerIdentifierUseOne use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
public enum BePractitionerIdentifierUse {
    CODE_USE_SECONDARY = "secondary",
    CODE_USE_TEMP = "temp",
    CODE_USE_USUAL = "usual",
    CODE_USE_OLD = "old",
...
@r4:DataTypeDefinition {
    name: "BePractitionerIdentifierNIHDI",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: BePractitionerIdentifierUseTwo,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
...
public type BePractitionerIdentifierNIHDI record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system = "https://www.ehealth.fgov.be/standards/fhir/core/NamingSystem/nihdi";
    BePractitionerIdentifierUseTwo use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value;
...
public enum BePractitionerIdentifierUseOne {
    CODE_USE_SECONDARY = "secondary",
    CODE_USE_TEMP = "temp",
    CODE_USE_USUAL = "usual",
    CODE_USE_OLD = "old",
