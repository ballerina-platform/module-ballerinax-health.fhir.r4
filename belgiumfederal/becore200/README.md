...
Belgium Federal Core (2.0.0) FHIR R4 profile package for foundational Belgian interoperability resources. It provides typed records for core patient, practitioner, organization, and provenance exchanges.
...
- Ballerina records mapped to Belgian core StructureDefinitions
- Core profile coverage for patient, practitioner, communication, and document reference
- Type-safe construction of Belgium core compliant payloads
- Useful base package for Belgium profile-specific integrations
- JSON payload support for FHIR R4 interoperability
