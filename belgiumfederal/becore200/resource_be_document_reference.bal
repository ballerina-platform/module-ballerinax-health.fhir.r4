...
public const string PROFILE_BASE_BEDOCUMENTREFERENCE = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-documentreference";
public const RESOURCE_NAME_BEDOCUMENTREFERENCE = "DocumentReference";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "content" : {
            name: "content",
            dataType: BeDocumentReferenceContent,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "docStatus" : {
            name: "docStatus",
            dataType: BeDocumentReferenceDocStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "context" : {
            name: "context",
            dataType: BeDocumentReferenceContext,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "relatesTo" : {
            name: "relatesTo",
            dataType: BeDocumentReferenceRelatesTo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: BeDocumentReferenceStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeDocumentReference record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEDOCUMENTREFERENCE resourceType = RESOURCE_NAME_BEDOCUMENTREFERENCE;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.DocumentReference.author constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.DocumentReference.author constraint. This field must be an array containing at most one item."
        }
    }
    r4:Reference [] author;
    ...
    BeDocumentReferenceContent [] content;
    r4:Resource [] contained?;
    BeDocumentReferenceDocStatus docStatus?;
    r4:Meta meta?;
    BeDocumentReferenceContext context?;
    r4:uri implicitRules?;
    string id?;
    r4:Narrative text?;
    r4:CodeableConcept [] category?;
    BeDocumentReferenceRelatesTo [] relatesTo?;
    r4:Reference authenticator?;
    BeDocumentReferenceStatus status;
    r4:Element ...;
|};

# BeDocumentReferenceRelatesToCode enum
public enum BeDocumentReferenceRelatesToCode {
...
@r4:DataTypeDefinition {
    name: "BeDocumentReferenceContext",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeDocumentReferenceContext record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeDocumentReferenceContent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeDocumentReferenceContent record {|
    *r4:BackboneElement;
...
public enum BeDocumentReferenceDocStatus {
...
@r4:DataTypeDefinition {
    name: "BeDocumentReferenceRelatesTo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            name: "code",
            dataType: BeDocumentReferenceRelatesToCode,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeDocumentReferenceRelatesTo record {|
    *r4:BackboneElement;

    r4:Extension [] extension?;
    BeDocumentReferenceRelatesToCode code;
    r4:Extension [] modifierExtension?;
    string id?;
    r4:Reference target;
|};
...
public enum BeDocumentReferenceStatus {
