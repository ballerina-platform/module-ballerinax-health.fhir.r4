...
public const string PROFILE_BASE_BEPRACTITIONERROLE = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-practitionerrole";
public const RESOURCE_NAME_BEPRACTITIONERROLE = "PractitionerRole";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "notAvailable" : {
            name: "notAvailable",
            dataType: BePractitionerRoleNotAvailable,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "availableTime" : {
            name: "availableTime",
            dataType: BePractitionerRoleAvailableTime,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BePractitionerRole record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEPRACTITIONERROLE resourceType = RESOURCE_NAME_BEPRACTITIONERROLE;
    ...
    boolean active?;
    r4:code language?;
    BePractitionerRoleNotAvailable [] notAvailable?;
    BePractitionerRoleAvailableTime [] availableTime?;
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: BePractitionerRoleAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BePractitionerRoleAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    BePractitionerRoleAvailableTimeDaysOfWeek [] daysOfWeek?;
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleCodeCD_HCPARTY",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BePractitionerRoleCodeCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BePractitionerRoleCodeCD_HCPARTY record {|
    *r4:CodeableConcept;

    BePractitionerRoleCodeCoding [] coding?;
    r4:Extension [] extension?;
    string id?;
    string text?;
|};
...
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination). If needed codes can be used from a different system, SNOMED-CT is preferred.
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleSpecialtyCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            ...
            max: 1,
            isArray: false,
            description: "A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination). If needed codes can be used from a different system, SNOMED-CT is preferred.",
...
public type BePractitionerRoleSpecialtyCoding record {|
    *r4:Coding;
...
public enum BePractitionerRoleAvailableTimeDaysOfWeek {
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BePractitionerRoleNotAvailable record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleSpecialtySNOMED_CT",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BePractitionerRoleSpecialtyCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BePractitionerRoleSpecialtySNOMED_CT record {|
    *r4:CodeableConcept;

    BePractitionerRoleSpecialtyCoding [] coding?;
    r4:Extension [] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "BePractitionerRoleCodeCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BePractitionerRoleCodeCoding record {|
    *r4:Coding;
