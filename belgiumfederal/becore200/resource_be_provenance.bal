...
public const string PROFILE_BASE_BEPROVENANCE = "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-provenance";
public const RESOURCE_NAME_BEPROVENANCE = "Provenance";
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/core/StructureDefinition/be-provenance",
    elements: {
        "reason" : {
            name: "reason",
...
public type BeProvenance record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEPROVENANCE resourceType = RESOURCE_NAME_BEPROVENANCE;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "role": {
            name: "role",
            dataType: BeProvenanceEntityRole,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeProvenanceEntity record {|
    *r4:BackboneElement;

    international401:ProvenanceAgent [] agent?;
    r4:Extension [] extension?;
    BeProvenanceEntityRole role;
    r4:Reference what;
    r4:Extension [] modifierExtension?;
    string id?;
|};
...
public enum BeProvenanceEntityRole {
...
public type BeProvenanceAgent record {|
    *r4:BackboneElement;
