...
Belgium Federal MyCareNet (2.0.0) FHIR R4 profile package for MyCareNet eAgreement workflows. It contains typed models for message headers, service requests, claims, and claim responses.
...
- Profile-based records for MyCareNet eAgreement interactions
- Support for message, request, claim, and response artifacts
- Includes binary request profile models used in workflow exchanges
- Type-safe payload authoring for payer/provider process integration
- FHIR R4 JSON profile support for Belgian MyCareNet
