...
public const string PROFILE_BASE_BEMEDICATIONDISPENSE = "https://www.ehealth.fgov.be/standards/fhir/medication/StructureDefinition/be-medicationdispense";
public const RESOURCE_NAME_BEMEDICATIONDISPENSE = "MedicationDispense";
...
# + identifier - Identifiers associated with this Medication Dispense that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate. They are business identifiers assigned to this resource by the performer or other systems and remain constant as the resource is updated and propagates from server to server.
    # * identifier Slicings
        # 1) BeMedicationDispenseIdentifierDGUID: External identifier
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "substitution" : {
            name: "substitution",
            dataType: BeMedicationDispenseSubstitution,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "context" : {
            name: "context",
            dataType: BeMedicationDispenseContext,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "authorizingPrescription" : {
            ...
            dataType: BeMedicationDispenseAuthorizingPrescription,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "performer" : {
            name: "performer",
            dataType: BeMedicationDispensePerformer,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dosageInstruction" : {
            ...
            dataType: BeMedicationDispenseDosageInstruction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: BeMedicationDispenseStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeMedicationDispense record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEMEDICATIONDISPENSE resourceType = RESOURCE_NAME_BEMEDICATIONDISPENSE;

    r4:Annotation [] note?;
    r4:Reference [] partOf?;
    r4:Extension [] extension?;
    BeMedicationDispenseSubstitution substitution?;
    ...
    BeMedicationDispenseContext context?;
    string id?;
    r4:Narrative text?;
    BeMedicationDispenseAuthorizingPrescription [] authorizingPrescription?;
    r4:Identifier [] identifier?;
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.MedicationDispense.performer constraint. This field must be an array containing at least one item."
        }
    }
    BeMedicationDispensePerformer [] performer;
    ...
    BeMedicationDispenseDosageInstruction [] dosageInstruction?;
    r4:Meta meta?;
    r4:Reference [] eventHistory?;
    r4:uri implicitRules?;
    r4:Reference location?;
    r4:CodeableConcept category?;
    BeMedicationDispenseStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseAuthorizingPrescription",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type BeMedicationDispenseAuthorizingPrescription record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseIdentifierDGUID",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: BeMedicationDispenseIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type BeMedicationDispenseIdentifierDGUID record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system = "https://www.gfd-dpp.be/fhir/reference/dguid";
    BeMedicationDispenseIdentifierUse use?;
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseDosageInstruction",
    baseType: (),
    elements: {
        "maxDosePerLifetime": {
...
public type BeMedicationDispenseDosageInstruction record {|
    *r4:Dosage;
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseSubstitution",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type BeMedicationDispenseSubstitution record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseContext",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
        ...
        "identifier": {
            name: "identifier",
            dataType: BeMedicationDispenseContextIdentifier,
            min: 0,
            max: 1,
            isArray: false,
            description: "An identifier for the target resource. This is used when there is no way to reference the other resource directly, either because the entity it represents is not available through a FHIR server, or because there is no way for the author of the resource to convert a known identifier to an actual location. There is no requirement that a Reference.identifier point to something that is actually exposed as a FHIR instance, but it SHALL point to a business concept that would be expected to be exposed as a FHIR instance, and that instance would need to be of a FHIR resource type allowed by the reference.",
        ...
        "extension": {
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "MedicationDispense.context.extension"
        },
...
public type BeMedicationDispenseContext record {|
    *r4:Reference;

    string reference?;
    BeMedicationDispenseContextIdentifier identifier?;
    r4:Extension [] extension?;
    string display?;
    string id?;
    r4:uri 'type?;
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispensePerformer",
    baseType: (),
    elements: {
        "actor": {
            name: "actor",
...
public type BeMedicationDispensePerformer record {|
    *r4:BackboneElement;
...
public enum BeMedicationDispenseIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "BeMedicationDispenseContextIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
            ...
            isArray: true,
            description: "May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.",
            path: "MedicationDispense.context.identifier.extension"
        },
        ...
        "use": {
            name: "use",
            dataType: BeMedicationDispenseContextIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
            description: "The purpose of this identifier.",
        ...
        "id": {
            ...
            isArray: false,
            description: "Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
            path: "MedicationDispense.context.identifier.id"
        },
...
public type BeMedicationDispenseContextIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system?;
    BeMedicationDispenseContextIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    r4:CodeableConcept 'type?;
    string value?;
...
public enum BeMedicationDispenseContextIdentifierUse {
    CODE_USE_SECONDARY = "secondary",
    CODE_USE_TEMP = "temp",
    CODE_USE_USUAL = "usual",
    CODE_USE_OLD = "old",
...
public enum BeMedicationDispenseStatus {
