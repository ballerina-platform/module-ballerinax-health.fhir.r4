...
const FHIR_IG = "health_fhir_r4_be_medication100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "health_fhir_r4_be_medication100",
        name: "health_fhir_r4_be_medication100",
        ...
        profiles: {
            "https://www.ehealth.fgov.be/standards/fhir/medication/StructureDefinition/be-medicationdispense": {
                ...
                modelType: BeMedicationDispense
            }

        },
searchParameters: [MEDICATION_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 Medication Module initialized.");
}
