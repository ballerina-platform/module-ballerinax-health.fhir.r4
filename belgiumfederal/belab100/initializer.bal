...
const FHIR_IG = "health_fhir_r4_be_lab100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "health_fhir_r4_be_lab100",
        name: "health_fhir_r4_be_lab100",
        ...
        profiles: {
            "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-laboratory-report": {
                ...
                modelType: BeLaboratoryReport
            },

            "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-laboratory-report-composition": {
                url: "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-laboratory-report-composition",
                resourceType: "Composition",
                modelType: BeLaboratoryReportComposition
            },
            ...
            "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-specimen-laboratory": {
                ...
                modelType: BeSpecimenLaboratory
            },
            ...
            "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-observation-laboratory": {
                ...
                modelType: BeObservationLaboratory
            }

        },
searchParameters: [LABORATORY_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 Laboratory Module initialized.");
}
