...
public const string PROFILE_BASE_BESPECIMENLABORATORY = "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-specimen-laboratory";
public const RESOURCE_NAME_BESPECIMENLABORATORY = "Specimen";
...
# + identifier - Business identifier for specimen is RECOMMENDED to include when available.
...
# + 'type - The kind of material that forms the specimen. RECOMMENDED to include.
...
@r4:ResourceDefinition {
    ...
    elements: {
        "container" : {
            name: "container",
            dataType: BeSpecimenLaboratoryContainer,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "collection" : {
            name: "collection",
            dataType: BeSpecimenLaboratoryCollection,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "processing" : {
            name: "processing",
            dataType: BeSpecimenLaboratoryProcessing,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "text" : {
            name: "text",
            dataType: BeSpecimenLaboratoryText,
            min: 0,
            max: 1,
            isArray: false,
            path: "Specimen.text"
        ...
        "status" : {
            name: "status",
            dataType: BeSpecimenLaboratoryStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type BeSpecimenLaboratory record {|
    *r4:DomainResource;

    RESOURCE_NAME_BESPECIMENLABORATORY resourceType = RESOURCE_NAME_BESPECIMENLABORATORY;

    BeSpecimenLaboratoryContainer [] container?;
    ...
    r4:code language?;
    BeSpecimenLaboratoryCollection collection?;
    ...
    BeSpecimenLaboratoryProcessing [] processing?;
    string id?;
    BeSpecimenLaboratoryText text?;
    BeSpecimenLaboratoryStatus status?;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "BeSpecimenLaboratoryProcessing",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeSpecimenLaboratoryProcessing record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeSpecimenLaboratoryCollection",
    baseType: (),
    elements: {
        "duration": {
            name: "duration",
...
public type BeSpecimenLaboratoryCollection record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "id": {
            ...
            isArray: false,
            description: "Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.",
            path: "Specimen.text.id"
        },

        "status": {
            name: "status",
            dataType: BeSpecimenLaboratoryTextStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeSpecimenLaboratoryText record {|
    *r4:Narrative;

    r4:xhtml div;
    r4:Extension [] extension?;
    string id?;
    BeSpecimenLaboratoryTextStatus status;
|};


# BeSpecimenLaboratoryStatus enum
public enum BeSpecimenLaboratoryStatus {
...
@r4:DataTypeDefinition {
    name: "BeSpecimenLaboratoryContainer",
    baseType: (),
    elements: {
        "identifier": {
            name: "identifier",
...
public type BeSpecimenLaboratoryContainer record {|
    *r4:BackboneElement;
...
public enum BeSpecimenLaboratoryTextStatus {
