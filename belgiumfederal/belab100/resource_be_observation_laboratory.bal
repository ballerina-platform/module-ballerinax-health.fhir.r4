...
public const string PROFILE_BASE_BEOBSERVATIONLABORATORY = "https://www.ehealth.fgov.be/standards/fhir/lab/StructureDefinition/be-observation-laboratory";
public const RESOURCE_NAME_BEOBSERVATIONLABORATORY = "Observation";
...
# + note - A text note which also contains information about who made the statement and when.
...
# + component - Some observations have multiple component observations. These component observations are expressed as separate code value pairs that share the same attributes. Examples include systolic and diastolic component observations for blood pressure measurement and multiple component observations for genetics observations.
    # * component Slicings
        # 1) BeObservationLaboratoryComponentProductNameQualifier: If a testing code does not include a product name but needs one to qualify the code
        #       - min = 0
        #       - max = 1
        #
        # 2) BeObservationLaboratoryComponentRelativeTimeQualifier: If a testing code does not include a time interval but needs one to qualify the code.
        #       - min = 0
        #       - max = 1
        #
        # 3) BeObservationLaboratoryComponentSubstanceAmountQualifier: If a testing code does not include a substance amount but needs one to qualify the code
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: BeObservationLaboratoryCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "text" : {
            name: "text",
            dataType: BeObservationLaboratoryText,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: BeObservationLaboratoryComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: BeObservationLaboratoryReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: BeObservationLaboratoryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeObservationLaboratory record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEOBSERVATIONLABORATORY resourceType = RESOURCE_NAME_BEOBSERVATIONLABORATORY;

    boolean valueBoolean?;
    r4:CodeableConcept dataAbsentReason?;
    CodedAnnotation [] note?;
    r4:Reference [] partOf?;
    ...
    string id?;
    BeObservationLaboratoryText text?;
    r4:instant issued?;
    ...
    BeObservationLaboratoryComponent [] component?;
    r4:Resource [] contained?;
    BeObservationLaboratoryReferenceRange [] referenceRange?;
    string valueString?;
    ...
    BeObservationLaboratoryStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentRelativeTimeQualifier",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: BeObservationLaboratoryComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeObservationLaboratoryComponentRelativeTimeQualifier record {|
    *BeObservationLaboratoryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension [] extension?;
    international401:ObservationReferenceRange [] referenceRange?;
    BeObservationLaboratoryComponentCodeOne code;
    r4:CodeableConcept [] interpretation?;
    r4:Extension [] modifierExtension?;
    string id?;
    r4:Quantity valueQuantity?;
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCodeCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryComponentCodeCoding record {|
    *r4:Coding;

    r4:Extension [] extension?;
    r4:code code = "774167006";
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCodeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BeObservationLaboratoryComponentCodeCodingTwo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BeObservationLaboratoryComponentCodeTwo record {|
    *r4:CodeableConcept;

    BeObservationLaboratoryComponentCodeCodingTwo [] coding?;
    r4:Extension [] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BeObservationLaboratoryComponentCodeCodingOne,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BeObservationLaboratoryComponentCodeOne record {|
    *r4:CodeableConcept;

    BeObservationLaboratoryComponentCodeCodingOne [] coding?;
    r4:Extension [] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryText",
    baseType: (),
    elements: {
        "div": {
            name: "div",
        ...
        "status": {
            name: "status",
            dataType: BeObservationLaboratoryTextStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeObservationLaboratoryText record {|
    *r4:Narrative;

    r4:xhtml div;
    r4:Extension [] extension?;
    string id?;
    BeObservationLaboratoryTextStatus status;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCodeCodingOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryComponentCodeCodingOne record {|
    *r4:Coding;

    r4:Extension [] extension?;
    r4:code code = "118578006";
    r4:uri system = "http://snomed.info/sct";
    boolean userSelected?;
    string display = "Relative time";
    string id?;
    string 'version?;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentSubstanceAmountQualifier",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: BeObservationLaboratoryComponentCodeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type BeObservationLaboratoryComponentSubstanceAmountQualifier record {|
    *BeObservationLaboratoryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension [] extension?;
    international401:ObservationReferenceRange [] referenceRange?;
    BeObservationLaboratoryComponentCodeTwo code;
    r4:CodeableConcept [] interpretation?;
    r4:Extension [] modifierExtension?;
    string id?;
    r4:Quantity valueQuantity?;
...
public enum BeObservationLaboratoryStatus {
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type BeObservationLaboratoryComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type BeObservationLaboratoryCode record {|
    *r4:CodeableConcept;
...
public enum BeObservationLaboratoryTextStatus {
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryCodeCodingLOINC",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryCodeCodingLOINC record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCodeCodingTwo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryComponentCodeCodingTwo record {|
    *r4:Coding;

    r4:Extension [] extension?;
    r4:code code = "118555000";
    r4:uri system = "http://snomed.info/sct";
    boolean userSelected?;
    string display = "Substance amount";
    string id?;
    string 'version?;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryCodeCodingSNOMED_CT",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeObservationLaboratoryCodeCodingSNOMED_CT record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: BeObservationLaboratoryComponentCodeCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type BeObservationLaboratoryComponentCode record {|
    *r4:CodeableConcept;

    BeObservationLaboratoryComponentCodeCoding [] coding?;
    r4:Extension [] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "BeObservationLaboratoryComponentProductNameQualifier",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: BeObservationLaboratoryComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type BeObservationLaboratoryComponentProductNameQualifier record {|
    *BeObservationLaboratoryComponent;
    ...
    r4:Extension [] extension?;
    international401:ObservationReferenceRange [] referenceRange?;
    BeObservationLaboratoryComponentCode code;
    string valueString?;
    r4:CodeableConcept [] interpretation?;
    r4:Extension [] modifierExtension?;
    string id?;
