...
const FHIR_IG = "health_fhir_r4_be_allergy100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "health_fhir_r4_be_allergy100",
        name: "health_fhir_r4_be_allergy100",
        ...
        profiles: {
            "https://www.ehealth.fgov.be/standards/fhir/allergy/StructureDefinition/be-allergyintolerance": {
                ...
                modelType: BeAllergyIntolerance
            }

        },
searchParameters: [ALLERGYPATIENTDOSSIER_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 AllergyPatientDossier Module initialized.");
}
