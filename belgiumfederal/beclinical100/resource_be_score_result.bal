...
public const string PROFILE_BASE_BESCORERESULT = "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-scoreresult";
public const RESOURCE_NAME_BESCORERESULT = "Observation";
...
# + referenceRange - The different ranges that the value can have, and corresponding evaluation (e.g. 0..10: normal; 11..20: elevated)
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-scoreresult",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "bodySite" : {
            name: "bodySite",
            dataType: BeScoreResultBodySite,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: BeScoreResultComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: BeScoreResultReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BeScoreResult record {|
    *r4:DomainResource;

    RESOURCE_NAME_BESCORERESULT resourceType = RESOURCE_NAME_BESCORERESULT;
    ...
    BeScoreResultBodySite bodySite?;
    BeScoreResultComponent [] component?;
    r4:Resource [] contained?;
    BeScoreResultReferenceRange [] referenceRange?;
    string valueString?;
...
public type BeScoreResultBodySite record {|
    *r4:CodeableConcept;
...
public enum BeScoreResultStatus {
...
@r4:DataTypeDefinition {
    name: "BeScoreResultReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type BeScoreResultReferenceRange record {|
    *r4:BackboneElement;
...
public type BeScoreResultComponent record {|
    *r4:BackboneElement;
