...
public const string PROFILE_BASE_BEPROBLEM = "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-problem";
public const RESOURCE_NAME_BEPROBLEM = "Condition";
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/core-clinical/StructureDefinition/be-problem",
    elements: {
        "note" : {
            name: "note",
...
public type BeProblem record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEPROBLEM resourceType = RESOURCE_NAME_BEPROBLEM;

    r4:Annotation [] note?;
    r4:Extension [] extension?;
    r4:CodeableConcept code;
    BeProblemEvidence [] evidence?;
    r4:Range onsetRange?;
    ...
    BeProblemBodySite [] bodySite?;
    r4:Resource [] contained?;
    r4:Reference asserter?;
    BeProblemStage [] stage?;
    r4:Meta meta?;
...
public type BeProblemStage record {|
    *r4:BackboneElement;
...
public type BeProblemEvidence record {|
    *r4:BackboneElement;
...
public type BeProblemBodySite record {|
    *r4:CodeableConcept;
