...
const FHIR_IG = "health_fhir_r4_be_vaccination100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "health_fhir_r4_be_vaccination100",
        name: "health_fhir_r4_be_vaccination100",
        terminology: terminology,
        profiles: {
            "https://www.ehealth.fgov.be/standards/fhir/vaccination/StructureDefinition/be-vaccination": {
                url: "https://www.ehealth.fgov.be/standards/fhir/vaccination/StructureDefinition/be-vaccination",
                resourceType: "Immunization",
                modelType: BeVaccination
            }

        },
searchParameters: [BEVACCINATION_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 BeVaccination Module initialized.");
}
