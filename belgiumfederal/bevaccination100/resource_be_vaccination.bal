...
public const string PROFILE_BASE_BEVACCINATION = "https://www.ehealth.fgov.be/standards/fhir/vaccination/StructureDefinition/be-vaccination";
public const RESOURCE_NAME_BEVACCINATION = "Immunization";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "education" : {
            name: "education",
            dataType: BeVaccinationEducation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "vaccineCode" : {
            ...
            valueSet: "https://www.ehealth.fgov.be/standards/fhir/vaccination/ValueSet/be-vs-vaccine-code"
        },
        ...
        "identifier" : {
            name: "identifier",
            dataType: BeVaccinationIdentifier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "performer" : {
            name: "performer",
            dataType: BeVaccinationPerformer,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "reaction" : {
            name: "reaction",
            dataType: BeVaccinationReaction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "site" : {
            name: "site",
            dataType: BeVaccinationSite,
            min: 0,
            max: 1,
            isArray: false,
            path: "Immunization.site",
            valueSet: "https://www.ehealth.fgov.be/standards/fhir/vaccination/ValueSet/be-vs-vaccination-bodysite"
        },
        ...
        "route" : {
            ...
            valueSet: "https://www.ehealth.fgov.be/standards/fhir/vaccination/ValueSet/be-vs-vaccination-administration-route"
        },
        ...
        "protocolApplied" : {
            ...
            dataType: BeVaccinationProtocolApplied,
            min: 0,
            max: 0,
            isArray: true,
...
public type BeVaccination record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEVACCINATION resourceType = RESOURCE_NAME_BEVACCINATION;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Immunization.extension constraint. This field must be an array containing at least one item."
        }
    }
    r4:Extension [] extension;
    BeVaccinationEducation [] education?;
    ...
    BeVaccinationIdentifier [] identifier?;
    BeVaccinationPerformer [] performer?;
    BeVaccinationReaction [] reaction?;
    r4:CodeableConcept [] subpotentReason?;
    r4:Reference encounter?;
    string lotNumber?;
    r4:dateTime recorded;
    r4:Resource [] contained?;
    BeVaccinationSite site?;
    r4:CodeableConcept route?;
    r4:Meta meta?;
    BeVaccinationProtocolApplied [] protocolApplied?;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: BeVaccinationIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type BeVaccinationIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    BeVaccinationIdentifierUse use?;
...
public type BeVaccinationEducation record {|
    *r4:BackboneElement;
...
public enum BeVaccinationIdentifierUse {
...
public type BeVaccinationPerformer record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "BeVaccinationProtocolApplied",
    baseType: (),
    elements: {
        "doseNumberString": {
...
public type BeVaccinationProtocolApplied record {|
    *r4:BackboneElement;
...
public type BeVaccinationReaction record {|
    *r4:BackboneElement;
...
public type BeVaccinationSite record {|
    *r4:CodeableConcept;
