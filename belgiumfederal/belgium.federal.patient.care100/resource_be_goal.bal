...
public const string PROFILE_BASE_BEGOAL = "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-goal";
public const RESOURCE_NAME_BEGOAL = "Goal";

# FHIR BeGoal resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-goal",
    elements: {
        "statusDate" : {
            name: "statusDate",
            dataType: r4:date,
        ...
        "lifecycleStatus" : {
            ...
            dataType: BeGoalLifecycleStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeGoal record {|
    *r4:DomainResource;

    RESOURCE_NAME_BEGOAL resourceType = RESOURCE_NAME_BEGOAL;

    r4:date statusDate?;
    r4:Annotation [] note?;
    r4:Reference [] addresses?;
    r4:Extension [] extension?;
    BeGoalLifecycleStatus lifecycleStatus;
...
# BeGoalLifecycleStatus enum
public enum BeGoalLifecycleStatus {
...
# FHIR BeGoalTarget datatype record.
#
...
public type BeGoalTarget record {|
    *r4:BackboneElement;
