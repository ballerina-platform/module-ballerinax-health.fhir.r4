...
public const string PROFILE_BASE_BETASK = "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-task";
public const RESOURCE_NAME_BETASK = "Task";

# FHIR BeTask resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-task",
    elements: {
        "insurance" : {
            name: "insurance",
...
public type BeTask record {|
    *r4:DomainResource;

    RESOURCE_NAME_BETASK resourceType = RESOURCE_NAME_BETASK;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Task.extension constraint. This field must be an array containing at least one item."
        }
    }
    ...
    BeTaskPriority priority?;
    BeTaskIntent intent;
    r4:CodeableConcept [] performerType?;
    BeTaskInput [] input?;
    r4:Resource [] contained?;
    r4:Meta meta?;
    BeTaskRestriction restriction?;
...
# FHIR BeTaskInput datatype record.
#
...
public type BeTaskInput record {|
    *r4:BackboneElement;
...
# FHIR BeTaskRestriction datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
public type BeTaskRestriction record {|
    *r4:BackboneElement;
...
# FHIR BeTaskOutput datatype record.
#
...
public type BeTaskOutput record {|
    *r4:BackboneElement;
