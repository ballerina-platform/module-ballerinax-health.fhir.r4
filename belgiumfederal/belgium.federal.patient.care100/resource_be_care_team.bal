...
public const string PROFILE_BASE_BECARETEAM = "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-careteam";
public const RESOURCE_NAME_BECARETEAM = "CareTeam";

# FHIR BeCareTeam resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-careteam",
    elements: {
        "identifier" : {
            name: "identifier",
        ...
        "participant" : {
            name: "participant",
            dataType: BeCareTeamParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type BeCareTeam record {|
    *r4:DomainResource;

    RESOURCE_NAME_BECARETEAM resourceType = RESOURCE_NAME_BECARETEAM;
    ...
    BeCareTeamParticipant [] participant?;
    ...
    BeCareTeamStatus status?;
    r4:Element ...;
|};

# FHIR BeCareTeamParticipant datatype record.
#
...
public type BeCareTeamParticipant record {|
    *r4:BackboneElement;
...
# BeCareTeamStatus enum
public enum BeCareTeamStatus {
