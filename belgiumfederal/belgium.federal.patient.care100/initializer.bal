...
const FHIR_IG = "belgium_federal_patient_care100";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "belgium_federal_patient_care100",
        name: "belgium_federal_patient_care100",
        ...
        profiles: {
            ...
            "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-care-plan": {
                ...
                modelType: BeCarePlan
            },

            "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-task": {
...
searchParameters: [BEPATIENTCARE_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 BePatientCare Module initialized.");
}
