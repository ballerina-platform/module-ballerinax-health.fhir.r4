...
public const string PROFILE_BASE_BECAREPLAN = "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-care-plan";
public const RESOURCE_NAME_BECAREPLAN = "CarePlan";

# FHIR BeCarePlan resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://www.ehealth.fgov.be/standards/fhir/patient-care/StructureDefinition/be-care-plan",
    elements: {
        "note" : {
            name: "note",
...
public type BeCarePlan record {|
    *r4:DomainResource;

    RESOURCE_NAME_BECAREPLAN resourceType = RESOURCE_NAME_BECAREPLAN;

    r4:Annotation [] note?;
    r4:Reference [] partOf?;
    r4:Reference [] addresses?;
    r4:Extension [] extension?;
    BeCarePlanActivity [] activity?;
    ...
    BeCarePlanIntent intent;
    r4:Resource [] contained?;
    r4:Meta meta?;
    r4:uri implicitRules?;
    r4:CodeableConcept [] category?;
    BeCarePlanStatus status;
    r4:Element ...;
|};

# BeCarePlanIntent enum
public enum BeCarePlanIntent {
...
# BeCarePlanActivityDetailKind enum
public enum BeCarePlanActivityDetailKind {
...
# BeCarePlanStatus enum
public enum BeCarePlanStatus {
...
# FHIR BeCarePlanActivity datatype record.
#
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "detail": {
            name: "detail",
            dataType: BeCarePlanActivityDetail,
            min: 0,
            max: 1,
            isArray: false,
...
public type BeCarePlanActivity record {|
    *r4:BackboneElement;
    ...
    BeCarePlanActivityDetail detail?;
    string id?;
|};


# FHIR BeCarePlanActivityDetail datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "kind": {
            name: "kind",
            dataType: BeCarePlanActivityDetailKind,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status": {
            name: "status",
            dataType: BeCarePlanActivityDetailStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type BeCarePlanActivityDetail record {|
    *r4:BackboneElement;
    ...
    BeCarePlanActivityDetailKind kind?;
    r4:Extension [] modifierExtension?;
    string description?;
    ...
    BeCarePlanActivityDetailStatus status;
|};


# BeCarePlanActivityDetailStatus enum
public enum BeCarePlanActivityDetailStatus {
