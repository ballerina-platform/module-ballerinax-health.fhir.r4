...
public const string PROFILE_BASE_USCOREOBSERVATIONPREGNANCYINTENTPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancyintent";
public const RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYINTENTPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreObservationPregnancyIntentProfileCategorySocialHistory: (USCDI) Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancyintent",
    elements: {
        "dataAbsentReason" : {
        ...
        "code" : {
            name: "code",
            dataType: USCoreObservationPregnancyIntentProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationPregnancyIntentProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationPregnancyIntentProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationPregnancyIntentProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationPregnancyIntentProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYINTENTPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYINTENTPROFILE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    USCoreObservationPregnancyIntentProfileCode code;
    ...
    USCoreObservationPregnancyIntentProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationPregnancyIntentProfileReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    USCoreObservationPregnancyIntentProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationPregnancyIntentProfileCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileCategorySocialHistory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationPregnancyIntentProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreObservationPregnancyIntentProfileCategorySocialHistory record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationPregnancyIntentProfileCategoryCoding[] coding;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationPregnancyIntentProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "86645-9";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationPregnancyIntentProfileReferenceRange record {|
    *r4:BackboneElement;
...
public enum USCoreObservationPregnancyIntentProfileStatus {
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationPregnancyIntentProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreObservationPregnancyIntentProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationPregnancyIntentProfileCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyIntentProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationPregnancyIntentProfileComponent record {|
    *r4:BackboneElement;
