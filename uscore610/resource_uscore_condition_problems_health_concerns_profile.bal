...
# * category Slicings
# 1) USCoreConditionProblemsHealthConcernsProfileCategoryScreening_assessment: (USCDI) USCDI Health Status/Assessments Data Class
#       - min = 0
#       - max = *
#
# 2) USCoreConditionProblemsHealthConcernsProfileCategoryUs_core: (USCDI) problem-list-item | health-concern
#       - min = 1
#       - max = *
#
