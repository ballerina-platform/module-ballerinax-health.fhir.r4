...
public const string PROFILE_BASE_USCORESIMPLEOBSERVATIONPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-simple-observation";
public const RESOURCE_NAME_USCORESIMPLEOBSERVATIONPROFILE = "Observation";
...
# + derivedFrom - US Core Observations, DocumentReference, QuestionnaireResponse or other resource from which this observation value is derived.
...
# * category Slicings
# 1) USCoreSimpleObservationProfileCategoryUs_core: (USCDI) Classification of type of observation
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: USCoreSimpleObservationProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreSimpleObservationProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreSimpleObservationProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreSimpleObservationProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORESIMPLEOBSERVATIONPROFILE resourceType = RESOURCE_NAME_USCORESIMPLEOBSERVATIONPROFILE;
    ...
    USCoreSimpleObservationProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreSimpleObservationProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreSimpleObservationProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreSimpleObservationProfileCategoryUs_core",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type USCoreSimpleObservationProfileCategoryUs_core record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "USCoreSimpleObservationProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreSimpleObservationProfileReferenceRange record {|
    *r4:BackboneElement;
...
public enum USCoreSimpleObservationProfileStatus {
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreSimpleObservationProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreSimpleObservationProfileComponent record {|
    *r4:BackboneElement;
