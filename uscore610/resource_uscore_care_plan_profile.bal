...
public const string PROFILE_BASE_USCORECAREPLANPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan";
public const RESOURCE_NAME_USCORECAREPLANPROFILE = "CarePlan";
...
# * category Slicings
# 1) USCoreCarePlanProfileCategoryAssessPlan: (USCDI) Type of plan
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "text" : {
            name: "text",
            dataType: USCoreCarePlanProfileText,
            min: 0,
            max: 1,
            isArray: false,
            path: "CarePlan.text"
...
public type USCoreCarePlanProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORECAREPLANPROFILE resourceType = RESOURCE_NAME_USCORECAREPLANPROFILE;
    ...
    string id?;
    USCoreCarePlanProfileText text?;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.CarePlan.category constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.CarePlan.category constraint. This field must be an array containing at most one item."
        }
    }
...
@r4:DataTypeDefinition {
    name: "USCoreCarePlanProfileText",
    baseType: (),
    elements: {
        "div": {
            name: "div",
        ...
        "status": {
            name: "status",
            dataType: USCoreCarePlanProfileTextStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreCarePlanProfileText record {|
    *r4:Narrative;

    r4:xhtml div;
    r4:Extension[] extension?;
    string id?;
    USCoreCarePlanProfileTextStatus status;
|};
...
public type USCoreCarePlanProfileCategoryAssessPlan record {|
    *r4:CodeableConcept;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.CarePlan.category.coding constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.CarePlan.category.coding constraint. This field must be an array containing at most one item."
        }
    }
