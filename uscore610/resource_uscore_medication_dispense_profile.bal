...
public const string PROFILE_BASE_USCOREMEDICATIONDISPENSEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationdispense";
public const RESOURCE_NAME_USCOREMEDICATIONDISPENSEPROFILE = "MedicationDispense";
...
# + whenHandedOver - When the product was given out. For mailed prescriptions, when the label was printed
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "substitution" : {
            name: "substitution",
            dataType: USCoreMedicationDispenseProfileSubstitution,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "performer" : {
            name: "performer",
            dataType: USCoreMedicationDispenseProfilePerformer,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dosageInstruction" : {
            ...
            dataType: USCoreMedicationDispenseProfileDosageInstruction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreMedicationDispenseProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreMedicationDispenseProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREMEDICATIONDISPENSEPROFILE resourceType = RESOURCE_NAME_USCOREMEDICATIONDISPENSEPROFILE;

    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    USCoreMedicationDispenseProfileSubstitution substitution?;
    ...
    USCoreMedicationDispenseProfilePerformer[] performer?;
    ...
    USCoreMedicationDispenseProfileDosageInstruction[] dosageInstruction?;
    r4:Meta meta?;
    r4:Reference[] eventHistory?;
    r4:uri implicitRules?;
    r4:Reference location?;
    r4:CodeableConcept category?;
    USCoreMedicationDispenseProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreMedicationDispenseProfileDosageInstruction",
    baseType: (),
    elements: {
        "maxDosePerLifetime": {
...
public type USCoreMedicationDispenseProfileDosageInstruction record {|
    *r4:Dosage;
...
@r4:DataTypeDefinition {
    name: "USCoreMedicationDispenseProfileSubstitution",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type USCoreMedicationDispenseProfileSubstitution record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "USCoreMedicationDispenseProfilePerformer",
    baseType: (),
    elements: {
        "actor": {
            name: "actor",
...
public type USCoreMedicationDispenseProfilePerformer record {|
    *r4:BackboneElement;
...
public enum USCoreMedicationDispenseProfileStatus {
