...
# * category Slicings
# 1) USCoreConditionEncounterDiagnosisProfileCategoryUs_core: (USCDI) encounter-diagnosis
#       - min = 1
#       - max = 1
#
...
public type USCoreConditionEncounterDiagnosisProfile record {|
    *r4:DomainResource;
    ...
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.Condition.category constraint. This field must be an array containing at most one item."
        }
    }
...
public type USCoreConditionEncounterDiagnosisProfileCategoryUs_core record {|
    *r4:CodeableConcept;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Condition.category.coding constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.Condition.category.coding constraint. This field must be an array containing at most one item."
        }
    }
