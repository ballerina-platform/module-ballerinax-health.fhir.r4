...
public type USCoreCareTeam record {|
    *r4:DomainResource;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.CareTeam.participant constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.CareTeam.participant constraint. This field must be an array containing at most one item."
        }
    }
...
public type USCoreCareTeamParticipant record {|
    *r4:BackboneElement;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.CareTeam.participant.role constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.CareTeam.participant.role constraint. This field must be an array containing at most one item."
        }
    }
