...
# * category Slicings
# 1) USCoreObservationScreeningAssessmentProfileCategoryScreening_assessment: (USCDI) Classification of type of observation
#       - min = 0
#       - max = *
#
# 2) USCoreObservationScreeningAssessmentProfileCategorySurvey: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
