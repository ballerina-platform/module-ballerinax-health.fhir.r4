...
public const string PROFILE_BASE_USCOREBODYTEMPERATUREPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-body-temperature";
public const RESOURCE_NAME_USCOREBODYTEMPERATUREPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreBodyTemperatureProfileCategoryVSCat: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: USCoreBodyTemperatureProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCoreBodyTemperatureProfileValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]",
        ...
        "component" : {
            name: "component",
            dataType: USCoreBodyTemperatureProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreBodyTemperatureProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreBodyTemperatureProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreBodyTemperatureProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREBODYTEMPERATUREPROFILE resourceType = RESOURCE_NAME_USCOREBODYTEMPERATUREPROFILE;
    ...
    r4:time valueTime?;
    USCoreBodyTemperatureProfileCode code;
    ...
    USCoreBodyTemperatureProfileValue valueQuantity?;
    ...
    USCoreBodyTemperatureProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreBodyTemperatureProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    USCoreBodyTemperatureProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBodyTemperatureProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreBodyTemperatureProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreBodyTemperatureProfileCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBodyTemperatureProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreBodyTemperatureProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCoreBodyTemperatureProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreBodyTemperatureProfileCodeCoding record {|
    *r4:Coding;
...
public enum USCoreBodyTemperatureProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreBodyTemperatureProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCoreBodyTemperatureProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreBodyTemperatureProfileValue record {|
    *r4:Quantity;

    USCoreBodyTemperatureProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBodyTemperatureProfileReferenceRange record {|
    *r4:BackboneElement;
...
public enum USCoreBodyTemperatureProfileValueComparator {
...
@r4:DataTypeDefinition {
    name: "USCoreBodyTemperatureProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBodyTemperatureProfileCategoryCoding record {|
    *r4:Coding;
