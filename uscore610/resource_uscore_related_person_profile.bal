...
public const string PROFILE_BASE_USCORERELATEDPERSONPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-relatedperson";
public const RESOURCE_NAME_USCORERELATEDPERSONPROFILE = "RelatedPerson";

public type USCoreRelatedPersonProfileExtensions (r4:Extension|UsCoreEthnicity|UsCoreGenderIdentity|UsCoreRace|UsCoreTribalAffiliation);
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "gender" : {
            name: "gender",
            dataType: USCoreRelatedPersonProfileGender,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "communication" : {
            name: "communication",
            dataType: USCoreRelatedPersonProfileCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreRelatedPersonProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORERELATEDPERSONPROFILE resourceType = RESOURCE_NAME_USCORERELATEDPERSONPROFILE;

    r4:Identifier[] identifier?;
    r4:Extension[] extension?;
    r4:Period period?;
    r4:Address[] address?;
    USCoreRelatedPersonProfileGender gender?;
    ...
    string id?;
    r4:Narrative text?;
    USCoreRelatedPersonProfileCommunication[] communication?;
...
@r4:DataTypeDefinition {
    name: "USCoreRelatedPersonProfileCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreRelatedPersonProfileCommunication record {|
    *r4:BackboneElement;
...
public enum USCoreRelatedPersonProfileGender {
