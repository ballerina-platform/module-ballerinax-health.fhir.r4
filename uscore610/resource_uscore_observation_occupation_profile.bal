...
public const string PROFILE_BASE_USCOREOBSERVATIONOCCUPATIONPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-occupation";
public const RESOURCE_NAME_USCOREOBSERVATIONOCCUPATIONPROFILE = "Observation";
...
# * component Slicings
# 1) USCoreObservationOccupationProfileComponentIndustry: (USCDI) Occupation industry
#       - min = 0
#       - max = 1
#
...
# * category Slicings
# 1) USCoreObservationOccupationProfileCategorySocialhistory: (USCDI) Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-occupation",
    elements: {
        "dataAbsentReason" : {
        ...
        "code" : {
            name: "code",
            dataType: USCoreObservationOccupationProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationOccupationProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationOccupationProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationOccupationProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationOccupationProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONOCCUPATIONPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONOCCUPATIONPROFILE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    USCoreObservationOccupationProfileCode code;
    ...
    USCoreObservationOccupationProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationOccupationProfileReferenceRange[] referenceRange?;
    ...
    USCoreObservationOccupationProfileStatus status;
    r4:Element ...;
|};

# USCoreObservationOccupationProfileStatus enum
public enum USCoreObservationOccupationProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileComponentCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationOccupationProfileComponentCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "86188-0";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileCategorySocialhistory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationOccupationProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreObservationOccupationProfileCategorySocialhistory record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationOccupationProfileCategoryCoding[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationOccupationProfileComponentCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreObservationOccupationProfileComponentCode record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationOccupationProfileComponentCodeCoding[] coding;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationOccupationProfileCategoryCoding record {|
    *r4:Coding;

    r4:uri system = "http://terminology.hl7.org/CodeSystem/observation-category";
    r4:code code = "social-history";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationOccupationProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationOccupationProfileReferenceRange record {|
    *r4:BackboneElement;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationOccupationProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "11341-5";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileComponentIndustry",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: USCoreObservationOccupationProfileComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type USCoreObservationOccupationProfileComponentIndustry record {|
    *USCoreObservationOccupationProfileComponent;

    r4:CodeableConcept valueCodeableConcept?;
    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    USCoreObservationOccupationProfileComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationOccupationProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationOccupationProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreObservationOccupationProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationOccupationProfileCodeCoding[] coding;
|};
