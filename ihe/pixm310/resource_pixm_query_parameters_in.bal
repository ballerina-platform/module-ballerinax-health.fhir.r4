...
public const string PROFILE_BASE_PIXMQUERYPARAMETERSIN = "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Query.Parameters.In";
public const RESOURCE_NAME_PIXMQUERYPARAMETERSIN = "Parameters";


# FHIR PIXmQueryParametersIn resource record.
#
# + resourceType - The type of the resource describes
# + meta - The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource.
# + 'parameter - A parameter passed to or received from the operation.
    # * parameter Slicings
        # 1) PIXmQueryParametersInParameterSourceIdentifier: sourceIdentifier
        #       - min = 1
        #       - max = 1
        #
        # 2) PIXmQueryParametersInParameter_format: _format
        #       - min = 0
        #       - max = 1
        #
        # 3) PIXmQueryParametersInParameterTargetSystem: targetSystem
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Query.Parameters.In",
    elements: {
        "meta" : {
            name: "meta",
            dataType: r4:Meta,
        ...
        "parameter" : {
            name: "parameter",
            dataType: PIXmQueryParametersInParameter,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PIXmQueryParametersIn record {|
    *r4:DomainResource;

    RESOURCE_NAME_PIXMQUERYPARAMETERSIN resourceType = RESOURCE_NAME_PIXMQUERYPARAMETERSIN;
    ...
    PIXmQueryParametersInParameter [] 'parameter;
...
# FHIR PIXmQueryParametersInParameterTargetSystem datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersInParameterTargetSystem",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmQueryParametersInParameterTargetSystem record {|
    *PIXmQueryParametersInParameter;
    ...
    string name = "targetSystem";
    string id?;
|};


# FHIR PIXmQueryParametersInParameterSourceIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + valueString - If the parameter is a data type.
# + 'resource - If the parameter is a whole resource.
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersInParameterSourceIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmQueryParametersInParameterSourceIdentifier record {|
    *PIXmQueryParametersInParameter;
...
# FHIR PIXmQueryParametersInParameter datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersInParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type PIXmQueryParametersInParameter record {|
    *r4:BackboneElement;
...
# FHIR PIXmQueryParametersInParameter_format datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + valueString - If the parameter is a data type.
# + 'resource - If the parameter is a whole resource.
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersInParameter_format",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmQueryParametersInParameter_format record {|
    *PIXmQueryParametersInParameter;
