...
public const string PROFILE_BASE_PIXMPATIENTBIRTHDATEREQUIRED = "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Patient.BirthDateRequired";
public const RESOURCE_NAME_PIXMPATIENTBIRTHDATEREQUIRED = "Patient";


# FHIR PIXmPatientBirthDateRequired resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Patient.BirthDateRequired",
    elements: {
        "extension" : {
            name: "extension",
        ...
        "gender" : {
            name: "gender",
            dataType: PIXmPatientBirthDateRequiredGender,
            min: 0,
            max: 1,
            isArray: false,
            path: "Patient.gender",
        ...
        "link" : {
            name: "link",
            dataType: PIXmPatientBirthDateRequiredLink,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Patient.link"
        ...
        "contact" : {
            name: "contact",
            dataType: PIXmPatientBirthDateRequiredContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "communication" : {
            name: "communication",
            dataType: PIXmPatientBirthDateRequiredCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PIXmPatientBirthDateRequired record {|
    *r4:DomainResource;

    RESOURCE_NAME_PIXMPATIENTBIRTHDATEREQUIRED resourceType = RESOURCE_NAME_PIXMPATIENTBIRTHDATEREQUIRED;

    r4:Extension [] extension?;
    PIXmPatientBirthDateRequiredGender gender?;
    r4:Extension [] modifierExtension?;
    PIXmPatientBirthDateRequiredLink [] link?;
    r4:code language?;
    PIXmPatientBirthDateRequiredContact [] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference [] generalPractitioner?;
    r4:ContactPoint [] telecom?;
    string id?;
    r4:Narrative text?;
    PIXmPatientBirthDateRequiredCommunication [] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
...
# PIXmPatientBirthDateRequiredGender enum
public enum PIXmPatientBirthDateRequiredGender {
...
# PIXmPatientBirthDateRequiredContactGender enum
public enum PIXmPatientBirthDateRequiredContactGender {
    CODE_GENDER_OTHER = "other",
    CODE_GENDER_FEMALE = "female",
    CODE_GENDER_MALE = "male",
    CODE_GENDER_UNKNOWN = "unknown"
...
# FHIR PIXmPatientBirthDateRequiredCommunication datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PIXmPatientBirthDateRequiredCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmPatientBirthDateRequiredCommunication record {|
    *r4:BackboneElement;
...
# PIXmPatientBirthDateRequiredIdentifierUse enum
public enum PIXmPatientBirthDateRequiredIdentifierUse {
...
# PIXmPatientBirthDateRequiredLinkType enum
public enum PIXmPatientBirthDateRequiredLinkType {
...
# FHIR PIXmPatientBirthDateRequiredContact datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PIXmPatientBirthDateRequiredContact",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "gender": {
            name: "gender",
            dataType: PIXmPatientBirthDateRequiredContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PIXmPatientBirthDateRequiredContact record {|
    *r4:BackboneElement;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:Address address?;
    PIXmPatientBirthDateRequiredContactGender gender?;
    r4:Extension [] modifierExtension?;
...
# FHIR PIXmPatientBirthDateRequiredLink datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "PIXmPatientBirthDateRequiredLink",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: PIXmPatientBirthDateRequiredLinkType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PIXmPatientBirthDateRequiredLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PIXmPatientBirthDateRequiredLinkType 'type;
|};
