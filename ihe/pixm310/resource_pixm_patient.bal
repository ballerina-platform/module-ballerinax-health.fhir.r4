...
public const string PROFILE_BASE_PIXMPATIENT = "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Patient";
public const RESOURCE_NAME_PIXMPATIENT = "Patient";


# FHIR PIXmPatient resource record.
#
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Patient",
    elements: {
        "extension" : {
            name: "extension",
        ...
        "communication" : {
            name: "communication",
            dataType: PIXmPatientCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PIXmPatient record {|
    *r4:DomainResource;

    RESOURCE_NAME_PIXMPATIENT resourceType = RESOURCE_NAME_PIXMPATIENT;

    r4:Extension [] extension?;
    PIXmPatientGender gender?;
    r4:Extension [] modifierExtension?;
    PIXmPatientLink [] link?;
    r4:code language?;
    PIXmPatientContact [] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference [] generalPractitioner?;
    r4:ContactPoint [] telecom?;
    string id?;
    r4:Narrative text?;
    PIXmPatientCommunication [] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
...
# PIXmPatientGender enum
public enum PIXmPatientGender {
...
# FHIR PIXmPatientContact datatype record.
#
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: PIXmPatientContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PIXmPatientContact record {|
    *r4:BackboneElement;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:Address address?;
    PIXmPatientContactGender gender?;
    r4:Extension [] modifierExtension?;
...
# PIXmPatientLinkType enum
public enum PIXmPatientLinkType {
...
# FHIR PIXmPatientLink datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
public type PIXmPatientLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PIXmPatientLinkType 'type;
|};


# PIXmPatientContactGender enum
public enum PIXmPatientContactGender {
    CODE_GENDER_OTHER = "other",
    CODE_GENDER_FEMALE = "female",
    CODE_GENDER_MALE = "male",
    CODE_GENDER_UNKNOWN = "unknown"
...
# PIXmPatientIdentifierUse enum
public enum PIXmPatientIdentifierUse {
...
# FHIR PIXmPatientCommunication datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
public type PIXmPatientCommunication record {|
    *r4:BackboneElement;
