...
public const string PROFILE_BASE_PIXMQUERYPARAMETERSOUT = "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Query.Parameters.Out";
public const RESOURCE_NAME_PIXMQUERYPARAMETERSOUT = "Parameters";


# FHIR PIXmQueryParametersOut resource record.
#
# + resourceType - The type of the resource describes
# + meta - The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource.
# + 'parameter - A parameter passed to or received from the operation.
    # * parameter Slicings
        # 1) PIXmQueryParametersOutParameterTargetIdentifier: targetIdentifier
        #       - min = 0
        #       - max = *
        #
        # 2) PIXmQueryParametersOutParameterTargetId: Operation Parameter
        #       - min = 0
        #       - max = *
        #
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Query.Parameters.Out",
    elements: {
        "meta" : {
            name: "meta",
            dataType: r4:Meta,
        ...
        "parameter" : {
            name: "parameter",
            dataType: PIXmQueryParametersOutParameter,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PIXmQueryParametersOut record {|
    *r4:DomainResource;

    RESOURCE_NAME_PIXMQUERYPARAMETERSOUT resourceType = RESOURCE_NAME_PIXMQUERYPARAMETERSOUT;

    r4:Meta meta?;
    PIXmQueryParametersOutParameter [] 'parameter?;
...
# FHIR PIXmQueryParametersOutParameter datatype record.
#
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersOutParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type PIXmQueryParametersOutParameter record {|
    *r4:BackboneElement;
...
# FHIR PIXmQueryParametersOutParameterTargetId datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + valueReference - If the parameter is a data type.
# + 'resource - If the parameter is a whole resource.
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersOutParameterTargetId",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmQueryParametersOutParameterTargetId record {|
    *PIXmQueryParametersOutParameter;
...
# FHIR PIXmQueryParametersOutParameterTargetIdentifier datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + valueIdentifier - If the parameter is a data type.
# + 'resource - If the parameter is a whole resource.
...
@r4:DataTypeDefinition {
    name: "PIXmQueryParametersOutParameterTargetIdentifier",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PIXmQueryParametersOutParameterTargetIdentifier record {|
    *PIXmQueryParametersOutParameter;
