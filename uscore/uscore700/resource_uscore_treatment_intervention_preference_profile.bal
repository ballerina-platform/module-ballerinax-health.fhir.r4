...
public const string PROFILE_BASE_USCORETREATMENTINTERVENTIONPREFERENCEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference";
public const RESOURCE_NAME_USCORETREATMENTINTERVENTIONPREFERENCEPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreTreatmentInterventionPreferenceProfileCategoryUs_core: Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-treatment-intervention-preference",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "code" : {
            name: "code",
            dataType: USCoreTreatmentInterventionPreferenceProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreTreatmentInterventionPreferenceProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreTreatmentInterventionPreferenceProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreTreatmentInterventionPreferenceProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreTreatmentInterventionPreferenceProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORETREATMENTINTERVENTIONPREFERENCEPROFILE resourceType = RESOURCE_NAME_USCORETREATMENTINTERVENTIONPREFERENCEPROFILE;
    ...
    r4:time valueTime?;
    USCoreTreatmentInterventionPreferenceProfileCode code;
    ...
    USCoreTreatmentInterventionPreferenceProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreTreatmentInterventionPreferenceProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreTreatmentInterventionPreferenceProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreTreatmentInterventionPreferenceProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileCategoryUs_core",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreTreatmentInterventionPreferenceProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreTreatmentInterventionPreferenceProfileCategoryUs_core record {|
    *r4:CodeableConcept;
    ...
    USCoreTreatmentInterventionPreferenceProfileCategoryCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreTreatmentInterventionPreferenceProfileReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreTreatmentInterventionPreferenceProfileCategoryCoding record {|
    *r4:Coding;

    r4:uri system = "http://hl7.org/fhir/us/core/CodeSystem/us-core-category";
    r4:code code = "treatment-intervention-preference";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreTreatmentInterventionPreferenceProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "75773-2";
|};

# USCoreTreatmentInterventionPreferenceProfileStatus enum
public enum USCoreTreatmentInterventionPreferenceProfileStatus {
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreTreatmentInterventionPreferenceProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreTreatmentInterventionPreferenceProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreTreatmentInterventionPreferenceProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreTreatmentInterventionPreferenceProfileCodeCoding[] coding;
|};
