...
public const string PROFILE_BASE_USCORECAREEXPERIENCEPREFERENCEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-care-experience-preference";
public const RESOURCE_NAME_USCORECAREEXPERIENCEPREFERENCEPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreCareExperiencePreferenceProfileCategoryUs_core: Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-care-experience-preference",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "code" : {
            name: "code",
            dataType: USCoreCareExperiencePreferenceProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreCareExperiencePreferenceProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreCareExperiencePreferenceProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreCareExperiencePreferenceProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreCareExperiencePreferenceProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORECAREEXPERIENCEPREFERENCEPROFILE resourceType = RESOURCE_NAME_USCORECAREEXPERIENCEPREFERENCEPROFILE;
    ...
    r4:time valueTime?;
    USCoreCareExperiencePreferenceProfileCode code;
    ...
    USCoreCareExperiencePreferenceProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreCareExperiencePreferenceProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreCareExperiencePreferenceProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreCareExperiencePreferenceProfileReferenceRange record {|
    *r4:BackboneElement;
...
public enum USCoreCareExperiencePreferenceProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreCareExperiencePreferenceProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "95541-9";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreCareExperiencePreferenceProfileCategoryCoding record {|
    *r4:Coding;

    r4:uri system = "http://hl7.org/fhir/us/core/CodeSystem/us-core-category";
    r4:code code = "care-experience-preference";
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreCareExperiencePreferenceProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileCategoryUs_core",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreCareExperiencePreferenceProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreCareExperiencePreferenceProfileCategoryUs_core record {|
    *r4:CodeableConcept;
    ...
    USCoreCareExperiencePreferenceProfileCategoryCoding[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreCareExperiencePreferenceProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreCareExperiencePreferenceProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreCareExperiencePreferenceProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreCareExperiencePreferenceProfileCodeCoding[] coding;
|};
