...
public const string PROFILE_BASE_USCOREPRACTITIONERROLEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitionerrole";
public const RESOURCE_NAME_USCOREPRACTITIONERROLEPROFILE = "PractitionerRole";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "telecom" : {
            name: "telecom",
            dataType: USCorePractitionerRoleProfileTelecom,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCorePractitionerRoleProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREPRACTITIONERROLEPROFILE resourceType = RESOURCE_NAME_USCOREPRACTITIONERROLEPROFILE;
    ...
    USCorePractitionerRoleProfileTelecom[] telecom?;
    string id?;
    r4:Narrative text?;
...
@r4:DataTypeDefinition {
    name: "USCorePractitionerRoleProfileTelecom",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "system": {
            name: "system",
            dataType: USCorePractitionerRoleProfileTelecomSystem,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "use": {
            name: "use",
            dataType: USCorePractitionerRoleProfileTelecomUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCorePractitionerRoleProfileTelecom record {|
    *r4:ContactPoint;

    r4:Extension[] extension?;
    r4:Period period?;
    USCorePractitionerRoleProfileTelecomSystem system;
    USCorePractitionerRoleProfileTelecomUse use?;
    r4:positiveInt rank?;
    string id?;
    string value;
|};
