...
public const string PROFILE_BASE_USCOREPEDIATRICHEADOCCIPITALFRONTALCIRCUMFERENCEPERCENTILEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/head-occipital-frontal-circumference-percentile";
public const RESOURCE_NAME_USCOREPEDIATRICHEADOCCIPITALFRONTALCIRCUMFERENCEPERCENTILEPROFILE = "Observation";
...
# * category Slicings
# 1) USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryVSCat: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]",
        ...
        "component" : {
            name: "component",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREPEDIATRICHEADOCCIPITALFRONTALCIRCUMFERENCEPERCENTILEPROFILE resourceType = RESOURCE_NAME_USCOREPEDIATRICHEADOCCIPITALFRONTALCIRCUMFERENCEPERCENTILEPROFILE;
    ...
    r4:time valueTime?;
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCode code;
    ...
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValue valueQuantity?;
    ...
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileComponent[] component?;
    r4:Resource[] contained?;
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValue record {|
    *r4:Quantity;

    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "%";
...
public enum USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileComponent record {|
    *r4:BackboneElement;
...
public enum USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileValueComparator {
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileCodeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCorePediatricHeadOccipitalFrontalCircumferencePercentileProfileReferenceRange record {|
    *r4:BackboneElement;
