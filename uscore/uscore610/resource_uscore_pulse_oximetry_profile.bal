...
# + valueQuantity - The oxygen saturation by pulse oximetry value is expressed as a percentage (0-100) of the total hemoglobin content of the blood.
...
# * component Slicings
# 1) USCorePulseOximetryProfileComponentFlowRate: (USCDI) Inhaled oxygen flow rate
#       - min = 0
#       - max = 1
#
# 2) USCorePulseOximetryProfileComponentConcentration: (USCDI) Inhaled oxygen concentration
#       - min = 0
#       - max = 1
#
...
# * category Slicings
# 1) USCorePulseOximetryProfileCategoryVSCat: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCorePulseOximetryProfileValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]",
...
public type USCorePulseOximetryProfile record {|
    *r4:DomainResource;
    ...
    USCorePulseOximetryProfileValue valueQuantity?;
...
public enum USCorePulseOximetryProfileValueComparator {
...
@r4:DataTypeDefinition {
    name: "USCorePulseOximetryProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCorePulseOximetryProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCorePulseOximetryProfileValue record {|
    *r4:Quantity;

    USCorePulseOximetryProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "%";
