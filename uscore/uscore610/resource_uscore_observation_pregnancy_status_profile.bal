...
public const string PROFILE_BASE_USCOREOBSERVATIONPREGNANCYSTATUSPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancystatus";
public const RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYSTATUSPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreObservationPregnancyStatusProfileCategorySocialHistory: (USCDI) Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-pregnancystatus",
    elements: {
        "dataAbsentReason" : {
        ...
        "code" : {
            name: "code",
            dataType: USCoreObservationPregnancyStatusProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationPregnancyStatusProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationPregnancyStatusProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationPregnancyStatusProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationPregnancyStatusProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYSTATUSPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONPREGNANCYSTATUSPROFILE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    USCoreObservationPregnancyStatusProfileCode code;
    ...
    USCoreObservationPregnancyStatusProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationPregnancyStatusProfileReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    USCoreObservationPregnancyStatusProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationPregnancyStatusProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "82810-3";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationPregnancyStatusProfileComponent record {|
    *r4:BackboneElement;
...
public enum USCoreObservationPregnancyStatusProfileStatus {
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationPregnancyStatusProfileCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationPregnancyStatusProfileReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationPregnancyStatusProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreObservationPregnancyStatusProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationPregnancyStatusProfileCodeCoding[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationPregnancyStatusProfileCategorySocialHistory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationPregnancyStatusProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreObservationPregnancyStatusProfileCategorySocialHistory record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationPregnancyStatusProfileCategoryCoding[] coding;
|};
