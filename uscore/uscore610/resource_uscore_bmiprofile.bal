...
public const string PROFILE_BASE_USCOREBMIPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi";
public const RESOURCE_NAME_USCOREBMIPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreBMIProfileCategoryVSCat: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCoreBMIProfileValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]",
        ...
        "component" : {
            name: "component",
            dataType: USCoreBMIProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreBMIProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreBMIProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreBMIProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREBMIPROFILE resourceType = RESOURCE_NAME_USCOREBMIPROFILE;
    ...
    USCoreBMIProfileValue valueQuantity?;
    ...
    USCoreBMIProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreBMIProfileReferenceRange[] referenceRange?;
    string valueString?;
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreBMIProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBMIProfileCategoryCoding record {|
    *r4:Coding;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreBMIProfileCodeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBMIProfileReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBMIProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreBMIProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreBMIProfileCodeCoding[] coding;
|};

# USCoreBMIProfileValueComparator enum
public enum USCoreBMIProfileValueComparator {
...
public enum USCoreBMIProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBMIProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreBMIProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCoreBMIProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCoreBMIProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreBMIProfileValue record {|
    *r4:Quantity;

    USCoreBMIProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "kg/m2";
