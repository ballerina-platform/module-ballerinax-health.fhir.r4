...
public const string PROFILE_BASE_USCOREHEARTRATEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-heart-rate";
public const RESOURCE_NAME_USCOREHEARTRATEPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreHeartRateProfileCategoryVSCat: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: USCoreHeartRateProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCoreHeartRateProfileValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]",
        ...
        "component" : {
            name: "component",
            dataType: USCoreHeartRateProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreHeartRateProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreHeartRateProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreHeartRateProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREHEARTRATEPROFILE resourceType = RESOURCE_NAME_USCOREHEARTRATEPROFILE;
    ...
    r4:time valueTime?;
    USCoreHeartRateProfileCode code;
    ...
    USCoreHeartRateProfileValue valueQuantity?;
    ...
    USCoreHeartRateProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreHeartRateProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    USCoreHeartRateProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreHeartRateProfileCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreHeartRateProfileReferenceRange record {|
    *r4:BackboneElement;
...
public enum USCoreHeartRateProfileStatus {
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreHeartRateProfileCodeCoding record {|
    *r4:Coding;
...
public enum USCoreHeartRateProfileValueComparator {
...
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreHeartRateProfileComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCoreHeartRateProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreHeartRateProfileValue record {|
    *r4:Quantity;

    USCoreHeartRateProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "/min";
...
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreHeartRateProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreHeartRateProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCoreHeartRateProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreHeartRateProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreHeartRateProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreHeartRateProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreHeartRateProfileCodeCoding[] coding;
|};
