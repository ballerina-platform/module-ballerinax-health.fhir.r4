...
public const string PROFILE_BASE_USCOREOBSERVATIONCLINICALRESULTPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-clinical-result";
public const RESOURCE_NAME_USCOREOBSERVATIONCLINICALRESULTPROFILE = "Observation";

# FHIR USCoreObservationClinicalResultProfile resource record.
#
# + resourceType - The type of the resource describes
# + valueBoolean - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueTime - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
# + code - The name of the clinical test or procedure performed on a patient. A LOINC **SHALL** be used if the concept is present in LOINC.
# + subject - The patient, or group of patients, location, or device this observation is about and into whose record the observation is placed. If the actual focus of the observation is different from the subject (or a sample of, part, or region of the subject), the `focus` element or the `code` itself specifies the actual focus of the observation.
# + valueRange - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueCodeableConcept - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
# + valueRatio - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueDateTime - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueInteger - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueQuantity - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueString - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# + valueSampledData - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
# + valuePeriod - The clinical test or procedure result value. If a numeric value, valueQuantity.code **SHALL** be selected from [UCUM](http://unitsofmeasure.org). A FHIR [UCUM Codes value set](http://hl7.org/fhir/STU3/valueset-ucum-units.html) that defines all UCUM codes is in the FHIR specification.
...
# * category Slicings
# 1) USCoreObservationClinicalResultProfileCategoryUs_core: (USCDI) Classification of type of observation
#       - min = 0
#       - max = *
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationClinicalResultProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationClinicalResultProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationClinicalResultProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationClinicalResultProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONCLINICALRESULTPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONCLINICALRESULTPROFILE;
    ...
    USCoreObservationClinicalResultProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationClinicalResultProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreObservationClinicalResultProfileStatus status;
    r4:Element ...;
|};

# USCoreObservationClinicalResultProfileStatus enum
public enum USCoreObservationClinicalResultProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreObservationClinicalResultProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationClinicalResultProfileComponent record {|
    *r4:BackboneElement;
...
#
@r4:DataTypeDefinition {
    name: "USCoreObservationClinicalResultProfileCategoryUs_core",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type USCoreObservationClinicalResultProfileCategoryUs_core record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "USCoreObservationClinicalResultProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationClinicalResultProfileReferenceRange record {|
    *r4:BackboneElement;
