...
public const string PROFILE_BASE_USCORESMOKINGSTATUSPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus";
public const RESOURCE_NAME_USCORESMOKINGSTATUSPROFILE = "Observation";
...
# * category Slicings
# 1) USCoreSmokingStatusProfileCategorySocialHistory: (USCDI) Classification of type of observation
#       - min = 1
#       - max = 1
#
...
public type USCoreSmokingStatusProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORESMOKINGSTATUSPROFILE resourceType = RESOURCE_NAME_USCORESMOKINGSTATUSPROFILE;
...
@r4:DataTypeDefinition {
    name: "USCoreSmokingStatusProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreSmokingStatusProfileCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "USCoreSmokingStatusProfileCategorySocialHistory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreSmokingStatusProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreSmokingStatusProfileCategorySocialHistory record {|
    *r4:CodeableConcept;
    ...
    USCoreSmokingStatusProfileCategoryCoding[] coding;
|};
