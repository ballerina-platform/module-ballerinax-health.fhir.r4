...
public const string PROFILE_BASE_USCOREOBSERVATIONSOCIALHISTORYPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-social-history";
public const RESOURCE_NAME_USCOREOBSERVATIONSOCIALHISTORYPROFILE = "Observation";

# FHIR USCoreObservationSocialHistoryProfile resource record.
#
...
# * category Slicings
# 1) USCoreObservationSocialHistoryProfileCategorySdoh: Classification of type of observation
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationSocialHistoryProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationSocialHistoryProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationSocialHistoryProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationSocialHistoryProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONSOCIALHISTORYPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONSOCIALHISTORYPROFILE;
    ...
    USCoreObservationSocialHistoryProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationSocialHistoryProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreObservationSocialHistoryProfileStatus status;
    r4:Element ...;
|};

# USCoreObservationSocialHistoryProfileStatus enum
public enum USCoreObservationSocialHistoryProfileStatus {
...
@r4:DataTypeDefinition {
    name: "USCoreObservationSocialHistoryProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationSocialHistoryProfileCategoryCoding record {|
    *r4:Coding;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreObservationSocialHistoryProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationSocialHistoryProfileComponent record {|
    *r4:BackboneElement;
...
# FHIR USCoreObservationSocialHistoryProfileCategorySdoh datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationSocialHistoryProfileCategorySdoh",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationSocialHistoryProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreObservationSocialHistoryProfileCategorySdoh record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationSocialHistoryProfileCategoryCoding[] coding;
|};

# FHIR USCoreObservationSocialHistoryProfileReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "USCoreObservationSocialHistoryProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationSocialHistoryProfileReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR USCoreObservationSocialHistoryProfileCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreObservationSocialHistoryProfileCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationSocialHistoryProfileCategoryCodingOne record {|
    *r4:Coding;
