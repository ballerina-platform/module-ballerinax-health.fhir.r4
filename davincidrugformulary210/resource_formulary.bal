...
public const string PROFILE_BASE_FORMULARY = "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-Formulary";
public const RESOURCE_NAME_FORMULARY = "InsurancePlan";
...
public type Formulary record {|
    *r4:DomainResource;

    RESOURCE_NAME_FORMULARY resourceType = RESOURCE_NAME_FORMULARY;

    FormularyCoverage[] coverage?;
    @constraint:Array {
        minLength: {
            value: 1,
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "limit": {
            name: "limit",
            dataType: FormularyCoverageBenefitLimit,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyCoverageBenefit record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    FormularyCoverageBenefitLimit[] 'limit?;
    string id?;
    string requirement?;
...
@r4:DataTypeDefinition {
    name: "FormularyPlanSpecificCost",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "benefit": {
            name: "benefit",
            dataType: FormularyPlanSpecificCostBenefit,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyPlanSpecificCost record {|
    *r4:BackboneElement;
    ...
    FormularyPlanSpecificCostBenefit[] benefit?;
|};
...
public type FormularyTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "specificCost": {
            name: "specificCost",
            dataType: FormularyPlanSpecificCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "generalCost": {
            name: "generalCost",
            dataType: FormularyPlanGeneralCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyPlan record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    FormularyPlanSpecificCost[] specificCost?;
    FormularyPlanType 'type;
    r4:Reference[] coverageArea?;
    FormularyPlanGeneralCost[] generalCost?;
    r4:Reference[] network?;
|};
...
@r4:DataTypeDefinition {
    name: "FormularyPlanType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: FormularyPlanTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyPlanType record {|
    *r4:CodeableConcept;
    ...
    FormularyPlanTypeCoding[] coding;
|};
...
public type FormularyPlanTypeCoding record {|
    *r4:Coding;
...
public type FormularyPlanGeneralCost record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "benefit": {
            name: "benefit",
            dataType: FormularyCoverageBenefit,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyCoverage record {|
    *r4:BackboneElement;
    ...
    FormularyCoverageBenefit[] benefit;
    r4:Reference[] network?;
|};
...
public type FormularyType record {|
    *r4:CodeableConcept;

    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.InsurancePlan.type.coding constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.InsurancePlan.type.coding constraint. This field must be an array containing at most one item."
        }
    }
    FormularyTypeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "FormularyCoverageBenefitLimit",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type FormularyCoverageBenefitLimit record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "FormularyPlanSpecificCostBenefitCost",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type FormularyPlanSpecificCostBenefitCost record {|
    *r4:BackboneElement;
...
public type FormularyContact record {|
    *r4:BackboneElement;
...
public type FormularyMeta record {|
    *r4:Meta;
...
@r4:DataTypeDefinition {
    name: "FormularyPlanSpecificCostBenefit",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "cost": {
            name: "cost",
            dataType: FormularyPlanSpecificCostBenefitCost,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyPlanSpecificCostBenefit record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    FormularyPlanSpecificCostBenefitCost[] cost?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:CodeableConcept 'type;
|};
