...
public const string PROFILE_BASE_INSURANCEPLANLOCATION = "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-InsurancePlanLocation";
public const RESOURCE_NAME_INSURANCEPLANLOCATION = "Location";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "hoursOfOperation" : {
            ...
            dataType: InsurancePlanLocationHoursOfOperation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "mode" : {
            name: "mode",
            dataType: InsurancePlanLocationMode,
            min: 0,
            max: 1,
            isArray: false,
            path: "Location.mode",
        ...
        "position" : {
            name: "position",
            dataType: InsurancePlanLocationPosition,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: InsurancePlanLocationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type InsurancePlanLocation record {|
    *r4:DomainResource;

    RESOURCE_NAME_INSURANCEPLANLOCATION resourceType = RESOURCE_NAME_INSURANCEPLANLOCATION;
    ...
    string description?;
    InsurancePlanLocationHoursOfOperation[] hoursOfOperation?;
    r4:code language?;
    r4:CodeableConcept[] 'type?;
    InsurancePlanLocationMode mode?;
    ...
    InsurancePlanLocationPosition position?;
    string availabilityExceptions?;
    InsurancePlanLocationStatus status?;
    r4:Element ...;
|};

# InsurancePlanLocationHoursOfOperationDaysOfWeek enum
public enum InsurancePlanLocationHoursOfOperationDaysOfWeek {
...
public enum InsurancePlanLocationAddressType {
...
@r4:DataTypeDefinition {
    name: "InsurancePlanLocationHoursOfOperation",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: InsurancePlanLocationHoursOfOperationDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type InsurancePlanLocationHoursOfOperation record {|
    *r4:BackboneElement;
    ...
    r4:time openingTime?;
    string id?;
    InsurancePlanLocationHoursOfOperationDaysOfWeek[] daysOfWeek?;
|};

# InsurancePlanLocationStatus enum
public enum InsurancePlanLocationStatus {
...
public enum InsurancePlanLocationAddressUse {
   CODE_USE_TEMP = "temp",
   CODE_USE_WORK = "work",
   CODE_USE_OLD = "old",
   CODE_USE_HOME = "home",
...
public enum InsurancePlanLocationMode {
...
@r4:DataTypeDefinition {
    name: "InsurancePlanLocationPosition",
    baseType: (),
    elements: {
        "altitude": {
            name: "altitude",
...
public type InsurancePlanLocationPosition record {|
    *r4:BackboneElement;
