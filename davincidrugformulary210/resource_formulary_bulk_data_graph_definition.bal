...
public const string PROFILE_BASE_FORMULARYBULKDATAGRAPHDEFINITION = "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyBulkDataGraphDefinition";
public const RESOURCE_NAME_FORMULARYBULKDATAGRAPHDEFINITION = "GraphDefinition";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyBulkDataGraphDefinition",
    elements: {
        "date" : {
            name: "date",
        ...
        "link" : {
            name: "link",
            dataType: FormularyBulkDataGraphDefinitionLink,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: FormularyBulkDataGraphDefinitionStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type FormularyBulkDataGraphDefinition record {|
    *r4:DomainResource;

    RESOURCE_NAME_FORMULARYBULKDATAGRAPHDEFINITION resourceType = RESOURCE_NAME_FORMULARYBULKDATAGRAPHDEFINITION;
    ...
    FormularyBulkDataGraphDefinitionLink[] link?;
    r4:code 'start;
    ...
    FormularyBulkDataGraphDefinitionStatus status;
    r4:Element ...;
|};

# FormularyBulkDataGraphDefinitionStatus enum
public enum FormularyBulkDataGraphDefinitionStatus {
...
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLink",
    baseType: (),
    elements: {
        "path": {
            name: "path",
        ...
        "target": {
            name: "target",
            dataType: FormularyBulkDataGraphDefinitionLinkTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyBulkDataGraphDefinitionLink record {|
    *r4:BackboneElement;
    ...
    string description?;
    string id?;
    FormularyBulkDataGraphDefinitionLinkTarget[] target?;
|};

# FormularyBulkDataGraphDefinitionLinkTargetCompartmentCode enum
public enum FormularyBulkDataGraphDefinitionLinkTargetCompartmentCode {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLinkTargetCompartment",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            name: "code",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetCompartmentCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "use": {
            name: "use",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetCompartmentUse,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "rule": {
            name: "rule",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetCompartmentRule,
            min: 1,
            max: 1,
            isArray: false,
...
public type FormularyBulkDataGraphDefinitionLinkTargetCompartment record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    FormularyBulkDataGraphDefinitionLinkTargetCompartmentCode code;
    string expression?;
    FormularyBulkDataGraphDefinitionLinkTargetCompartmentUse use;
    r4:Extension[] modifierExtension?;
    string description?;
    FormularyBulkDataGraphDefinitionLinkTargetCompartmentRule rule;
    string id?;
|};

# FormularyBulkDataGraphDefinitionLinkTargetCompartmentUse enum
public enum FormularyBulkDataGraphDefinitionLinkTargetCompartmentUse {
...
public enum FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentRule {
...
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLinkTarget",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "compartment": {
            name: "compartment",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetCompartment,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "link": {
            name: "link",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLink,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FormularyBulkDataGraphDefinitionLinkTarget record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    r4:canonical profile?;
    FormularyBulkDataGraphDefinitionLinkTargetCompartment[] compartment?;
    FormularyBulkDataGraphDefinitionLinkTargetLink[] link?;
    string id?;
    string params?;
    r4:code 'type;
|};
...
public enum FormularyBulkDataGraphDefinitionLinkTargetCompartmentRule {
   CODE_RULE_IDENTICAL = "identical",
   CODE_RULE_CUSTOM = "custom",
   CODE_RULE_DIFFERENT = "different",
   CODE_RULE_MATCHING = "matching"
...
public enum FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentUse {
   CODE_USE_CONDITION = "condition",
   CODE_USE_REQUIREMENT = "requirement"
}

# FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentCode enum
public enum FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentCode {
   CODE_CODE_PRACTITIONER = "Practitioner",
   CODE_CODE_DEVICE = "Device",
   CODE_CODE_PATIENT = "Patient",
   CODE_CODE_ENCOUNTER = "Encounter",
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartment",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "code": {
            name: "code",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Identifies the compartment.",
        ...
        "use": {
            name: "use",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentUse,
            min: 1,
            max: 1,
            isArray: false,
            description: "Defines how the compartment rule is used - whether it it is used to test whether resources are subject to the rule, or whether it is a rule that must be followed.",
        ...
        "rule": {
            name: "rule",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentRule,
            min: 1,
            max: 1,
            isArray: false,
            description: "identical | matching | different | no-rule | custom.",
...
public type FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartment record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentCode code;
    string expression?;
    FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentUse use;
    r4:Extension[] modifierExtension?;
    string description?;
    FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartmentRule rule;
    string id?;
|};
...
# + 'type - Type of resource this link refers to.
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLinkTargetLinkTarget",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "compartment": {
            name: "compartment",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartment,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Compartment Consistency Rules.",
...
public type FormularyBulkDataGraphDefinitionLinkTargetLinkTarget record {|
    *r4:BackboneElement;

    r4:Extension[] extension?;
    r4:Extension[] modifierExtension?;
    r4:canonical profile?;
    FormularyBulkDataGraphDefinitionLinkTargetLinkTargetCompartment[] compartment?;
    string id?;
    string params?;
    r4:code 'type;
|};
...
# + target - Potential target for the link.
@r4:DataTypeDefinition {
    name: "FormularyBulkDataGraphDefinitionLinkTargetLink",
    baseType: (),
    elements: {
        "path": {
            name: "path",
        ...
        "target": {
            name: "target",
            dataType: FormularyBulkDataGraphDefinitionLinkTargetLinkTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Potential target for the link.",
...
public type FormularyBulkDataGraphDefinitionLinkTargetLink record {|
    *r4:BackboneElement;
    ...
    string description?;
    string id?;
    FormularyBulkDataGraphDefinitionLinkTargetLinkTarget[] target?;
|};
