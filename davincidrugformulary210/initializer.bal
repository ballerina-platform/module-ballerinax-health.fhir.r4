...
const FHIR_IG = "health_fhir_r4_davincidrugformulary210";
...
function init() returns r4:FHIRError? {
    ...
    readonly & r4:IGInfoRecord baseIgRecord = {
        title: "health_fhir_r4_davincidrugformulary210",
        name: "health_fhir_r4_davincidrugformulary210",
        ...
        profiles: {
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-InsurancePlanLocation": {
                ...
                modelType: InsurancePlanLocation
            },
            ...
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-PayerInsurancePlan": {
                ...
                modelType: PayerInsurancePlan
            },
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-PayerInsurancePlanBulkDataGraphDefinition": {
                url: "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-PayerInsurancePlanBulkDataGraphDefinition",
                resourceType: "GraphDefinition",
                modelType: PayerInsurancePlanBulkDataGraphDefinition
            },
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyItem": {
                url: "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyItem",
                resourceType: "Basic",
            ...
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyBulkDataGraphDefinition": {
                url: "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/usdf-FormularyBulkDataGraphDefinition",
                resourceType: "GraphDefinition",
                modelType: FormularyBulkDataGraphDefinition
            },
            ...
            "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/insurance-plan-coverage": {
                url: "http://hl7.org/fhir/us/davinci-drug-formulary/StructureDefinition/insurance-plan-coverage",
                resourceType: "Coverage",
                modelType: InsurancePlanCoverage
            }
        },
        searchParameters: [FORMULARY_IG_SEARCH_PARAMS_1]
    };
    ...
    log:printDebug("FHIR R4 Formulary Module initialized.");
}
