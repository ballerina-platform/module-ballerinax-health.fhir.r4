...
# * category Slicings
# 1) USCoreDocumentReferenceProfileCategoryUscore: 𝗔𝗗𝗗𝗜𝗧𝗜𝗢𝗡𝗔𝗟 𝗨𝗦𝗖𝗗𝗜: Categorization of document
#       - min = 0
#       - max = *
#
...
public type USCoreDocumentReferenceProfile record {|
    *r4:DomainResource;
    ...
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.DocumentReference.category constraint. This field must be an array containing at most one item."
        }
    }
...
# + attachment - The document and format referenced.
