...
public const string PROFILE_BASE_USCOREAVERAGEBLOODPRESSUREPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-average-blood-pressure";
public const RESOURCE_NAME_USCOREAVERAGEBLOODPRESSUREPROFILE = "Observation";
...
# * component Slicings
# 1) USCoreAverageBloodPressureProfileComponentSystolic: Systolic Average Blood Pressure
#       - min = 1
#       - max = 1
#
# 2) USCoreAverageBloodPressureProfileComponentDiastolic: Diastolic Average Blood Pressure
#       - min = 1
#       - max = 1
#
...
# * category Slicings
# 1) USCoreAverageBloodPressureProfileCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-average-blood-pressure",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "code" : {
            name: "code",
            dataType: USCoreAverageBloodPressureProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreAverageBloodPressureProfileComponent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreAverageBloodPressureProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreAverageBloodPressureProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreAverageBloodPressureProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREAVERAGEBLOODPRESSUREPROFILE resourceType = RESOURCE_NAME_USCOREAVERAGEBLOODPRESSUREPROFILE;
    ...
    r4:time valueTime?;
    USCoreAverageBloodPressureProfileCode code;
    ...
    USCoreAverageBloodPressureProfileComponent[] component;
    r4:Resource[] contained?;
    USCoreAverageBloodPressureProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    USCoreAverageBloodPressureProfileStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreAverageBloodPressureProfileReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreAverageBloodPressureProfileComponentCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "96608-5";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreAverageBloodPressureProfileCategoryCoding record {|
    *r4:Coding;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentCodeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreAverageBloodPressureProfileComponentCodeCodingOne record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "96609-3";
|};

# USCoreAverageBloodPressureProfileComponentValueComparator enum
public enum USCoreAverageBloodPressureProfileComponentValueComparator {
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreAverageBloodPressureProfileComponentCodeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreAverageBloodPressureProfileComponentCodeOne record {|
    *r4:CodeableConcept;
    ...
    USCoreAverageBloodPressureProfileComponentCodeCodingOne[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreAverageBloodPressureProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreAverageBloodPressureProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreAverageBloodPressureProfileCodeCoding[] coding;
|};

# USCoreAverageBloodPressureProfileStatus enum
public enum USCoreAverageBloodPressureProfileStatus {
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreAverageBloodPressureProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "96607-7";
|};
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreAverageBloodPressureProfileComponent record {|
    *r4:BackboneElement;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreAverageBloodPressureProfileComponentCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreAverageBloodPressureProfileComponentCode record {|
    *r4:CodeableConcept;
    ...
    USCoreAverageBloodPressureProfileComponentCodeCoding[] coding;
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentDiastolic",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: USCoreAverageBloodPressureProfileComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: USCoreAverageBloodPressureProfileComponentValue,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreAverageBloodPressureProfileComponentDiastolic record {|
    *USCoreAverageBloodPressureProfileComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    USCoreAverageBloodPressureProfileComponentCodeOne code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
    USCoreAverageBloodPressureProfileComponentValue valueQuantity?;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreAverageBloodPressureProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreAverageBloodPressureProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCoreAverageBloodPressureProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCoreAverageBloodPressureProfileComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreAverageBloodPressureProfileComponentValue record {|
    *r4:Quantity;

    USCoreAverageBloodPressureProfileComponentValueComparator comparator?;
    string unit;
    r4:code code = "mm[Hg]";
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreAverageBloodPressureProfileComponentSystolic",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: USCoreAverageBloodPressureProfileComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type USCoreAverageBloodPressureProfileComponentSystolic record {|
    *USCoreAverageBloodPressureProfileComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    USCoreAverageBloodPressureProfileComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
    USCoreAverageBloodPressureProfileComponentValue valueQuantity?;
