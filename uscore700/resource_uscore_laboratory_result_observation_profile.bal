...
# * category Slicings
# 1) USCoreLaboratoryResultObservationProfileCategoryUs_core: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "meta" : {
            name: "meta",
            dataType: USCoreLaboratoryResultObservationProfileMeta,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreLaboratoryResultObservationProfile record {|
    *r4:DomainResource;
    ...
    USCoreLaboratoryResultObservationProfileMeta meta?;
...
@r4:DataTypeDefinition {
    name: "USCoreLaboratoryResultObservationProfileCategoryUs_core",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type USCoreLaboratoryResultObservationProfileCategoryUs_core record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "USCoreLaboratoryResultObservationProfileMeta",
    baseType: (),
    elements: {
        "lastUpdated": {
            name: "lastUpdated",
...
public type USCoreLaboratoryResultObservationProfileMeta record {|
    *r4:Meta;
