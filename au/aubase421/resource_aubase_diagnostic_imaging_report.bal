...
public const string PROFILE_BASE_AUBASEDIAGNOSTICIMAGINGREPORT = "http://hl7.org.au/fhir/StructureDefinition/au-imagingreport";
public const RESOURCE_NAME_AUBASEDIAGNOSTICIMAGINGREPORT = "DiagnosticReport";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org.au/fhir/StructureDefinition/au-imagingreport",
    elements: {
        "extension" : {
            name: "extension",
...
public type AUBaseDiagnosticImagingReport record {|
    *r4:DomainResource;
