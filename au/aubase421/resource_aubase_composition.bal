...
public const string PROFILE_BASE_AUBASECOMPOSITION = "http://hl7.org.au/fhir/StructureDefinition/au-composition";
public const RESOURCE_NAME_AUBASECOMPOSITION = "Composition";

public type AUBaseCompositionExtensions (r4:Extension|InformationRecipient);
...
public type AUBaseComposition record {|
    *r4:DomainResource;
