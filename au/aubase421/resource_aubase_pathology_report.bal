...
public const string PROFILE_BASE_AUBASEPATHOLOGYREPORT = "http://hl7.org.au/fhir/StructureDefinition/au-pathologyreport";
public const RESOURCE_NAME_AUBASEPATHOLOGYREPORT = "DiagnosticReport";
...
public type AUBasePathologyReport record {|
    *r4:DomainResource;
