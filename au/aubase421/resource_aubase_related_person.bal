...
public const string PROFILE_BASE_AUBASERELATEDPERSON = "http://hl7.org.au/fhir/StructureDefinition/au-relatedperson";
public const RESOURCE_NAME_AUBASERELATEDPERSON = "RelatedPerson";
...
public type AUBaseRelatedPerson record {|
    *r4:DomainResource;
...
# + language - A language which can be used to communicate with about the patient's health. The ISO-639-1 alpha 2 code in lower case for the language, optionally followed by a hyphen and the ISO-3166-1 alpha 2 code for the region in upper case; e.g. 'en' for English, or 'en-US' for American English versus 'en-EN' for England English.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "language": {
            ...
            max: 1,
            isArray: false,
            description: "A language which can be used to communicate with about the patient's health. The ISO-639-1 alpha 2 code in lower case for the language, optionally followed by a hyphen and the ISO-3166-1 alpha 2 code for the region in upper case; e.g. 'en' for English, or 'en-US' for American English versus 'en-EN' for England English.",
