...
public type AUBaseMedicationDispenseExtensions (DispenseNumber|r4:Extension|MedicationBrandName|MedicationGenericName|SubsidisedConcurrentSupply);
...
public type AUBaseMedicationDispenseSubstitution record {|
    *r4:BackboneElement;
    ...
    @constraint:Array {
        maxLength: {
            value: 1,
            message: "Validation failed for $.MedicationDispense.substitution.reason constraint. This field must be an array containing at most one item."
        }
    }
