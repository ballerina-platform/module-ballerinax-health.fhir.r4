...
public const string PROFILE_BASE_AUBASECOVERAGE = "http://hl7.org.au/fhir/StructureDefinition/au-coverage";
public const RESOURCE_NAME_AUBASECOVERAGE = "Coverage";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "type" : {
            ...
            isArray: false,
            path: "Coverage.type",
            valueSet: "http://terminology.hl7.org.au/ValueSet/coverage-type-extended"
        },
        "network" : {
            name: "network",
            dataType: string,
        ...
        "costToBeneficiary" : {
            ...
            dataType: AUBaseCoverageCostToBeneficiary,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUBaseCoverage record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUBASECOVERAGE resourceType = RESOURCE_NAME_AUBASECOVERAGE;
    ...
    AUBaseCoverageClass[] 'class?;
    string dependent?;
    r4:positiveInt 'order?;
    AuDvanumber[]|AuMedicarecardnumber[]|r4:Identifier[]|AuInsurancemembernumber[] identifier?;
    AUBaseCoverageCostToBeneficiary[] costToBeneficiary?;
    r4:Period period?;
...
@r4:DataTypeDefinition {
    name: "AUBaseCoverageCostToBeneficiaryException",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBaseCoverageCostToBeneficiaryException record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUBaseCoverageCostToBeneficiary",
    baseType: (),
    elements: {
        "exception": {
            name: "exception",
            dataType: AUBaseCoverageCostToBeneficiaryException,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUBaseCoverageCostToBeneficiary record {|
    *r4:BackboneElement;

    AUBaseCoverageCostToBeneficiaryException[] exception?;
    r4:Extension[] extension?;
    r4:Money valueMoney?;
    r4:Extension[] modifierExtension?;
    string id?;
...
public type AUBaseCoverageClass record {|
    *r4:BackboneElement;
...
public enum AUBaseCoverageStatus {
