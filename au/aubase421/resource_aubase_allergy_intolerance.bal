...
public const string PROFILE_BASE_AUBASEALLERGYINTOLERANCE = "http://hl7.org.au/fhir/StructureDefinition/au-allergyintolerance";
public const RESOURCE_NAME_AUBASEALLERGYINTOLERANCE = "AllergyIntolerance";
...
public type AUBaseAllergyIntolerance record {|
    *r4:DomainResource;
