...
public const string PROFILE_BASE_AUBASEDIAGNOSTICIMAGINGRESULT = "http://hl7.org.au/fhir/StructureDefinition/au-imagingresult";
public const RESOURCE_NAME_AUBASEDIAGNOSTICIMAGINGRESULT = "Observation";
...
# * category Slicings
# 1) AUBaseDiagnosticImagingResultCategoryAnatomicRegionOfInterest: Anatomic Region Of Interest
#       - min = 0
#       - max = *
#
# 2) AUBaseDiagnosticImagingResultCategoryDiagImg: Observation generated by imaging
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org.au/fhir/StructureDefinition/au-imagingresult",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "bodySite" : {
            name: "bodySite",
            dataType: AUBaseDiagnosticImagingResultBodySite,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUBaseDiagnosticImagingResultComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUBaseDiagnosticImagingResultReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUBaseDiagnosticImagingResultStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUBaseDiagnosticImagingResult record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUBASEDIAGNOSTICIMAGINGRESULT resourceType = RESOURCE_NAME_AUBASEDIAGNOSTICIMAGINGRESULT;
    ...
    AUBaseDiagnosticImagingResultBodySite bodySite?;
    AUBaseDiagnosticImagingResultComponent[] component?;
    r4:Resource[] contained?;
    AUBaseDiagnosticImagingResultReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    AUBaseDiagnosticImagingResultStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultCategoryDiagImg",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUBaseDiagnosticImagingResultCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUBaseDiagnosticImagingResultCategoryDiagImg record {|
    *r4:CodeableConcept;
    ...
    AUBaseDiagnosticImagingResultCategoryCodingOne[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBaseDiagnosticImagingResultReferenceRange record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultBodySite",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUBaseDiagnosticImagingResultBodySite record {|
    *r4:CodeableConcept;
...
public enum AUBaseDiagnosticImagingResultStatus {
...
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBaseDiagnosticImagingResultCategoryCoding record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultCategoryCodingOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBaseDiagnosticImagingResultCategoryCodingOne record {|
    *r4:Coding;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUBaseDiagnosticImagingResultComponent record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticImagingResultCategoryAnatomicRegionOfInterest",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUBaseDiagnosticImagingResultCategoryCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUBaseDiagnosticImagingResultCategoryAnatomicRegionOfInterest record {|
    *r4:CodeableConcept;

    AUBaseDiagnosticImagingResultCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
