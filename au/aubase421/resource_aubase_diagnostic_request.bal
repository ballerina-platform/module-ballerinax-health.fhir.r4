...
public const string PROFILE_BASE_AUBASEDIAGNOSTICREQUEST = "http://hl7.org.au/fhir/StructureDefinition/au-diagnosticrequest";
public const RESOURCE_NAME_AUBASEDIAGNOSTICREQUEST = "ServiceRequest";

public type AUBaseDiagnosticRequestExtensions (r4:Extension|ResultCopiesTo);
...
public type AUBaseDiagnosticRequest record {|
    *r4:DomainResource;
