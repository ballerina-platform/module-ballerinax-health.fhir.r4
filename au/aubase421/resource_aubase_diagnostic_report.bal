...
public const string PROFILE_BASE_AUBASEDIAGNOSTICREPORT = "http://hl7.org.au/fhir/StructureDefinition/au-diagnosticreport";
public const RESOURCE_NAME_AUBASEDIAGNOSTICREPORT = "DiagnosticReport";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "media" : {
            name: "media",
            dataType: AUBaseDiagnosticReportMedia,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUBaseDiagnosticReportStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUBaseDiagnosticReport record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUBASEDIAGNOSTICREPORT resourceType = RESOURCE_NAME_AUBASEDIAGNOSTICREPORT;
    ...
    r4:code language?;
    AUBaseDiagnosticReportMedia[] media?;
    string conclusion?;
    r4:Reference[] result?;
    ...
    AUBaseDiagnosticReportStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUBaseDiagnosticReportMedia",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBaseDiagnosticReportMedia record {|
    *r4:BackboneElement;
...
public enum AUBaseDiagnosticReportStatus {
