...
public const string PROFILE_BASE_AUASSERTIONNORELEVANTFINDING = "http://hl7.org.au/fhir/StructureDefinition/au-norelevantfinding";
public const RESOURCE_NAME_AUASSERTIONNORELEVANTFINDING = "Observation";
...
# + valueCodeableConcept - An assertion that a procedure did not occur or that there are no items of specific interest (e.g. allergies, no current medications) for a patient or patient group.
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUAssertionNoRelevantFindingCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUAssertionNoRelevantFindingComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUAssertionNoRelevantFindingReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUAssertionNoRelevantFindingStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUAssertionNoRelevantFinding record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUASSERTIONNORELEVANTFINDING resourceType = RESOURCE_NAME_AUASSERTIONNORELEVANTFINDING;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUAssertionNoRelevantFindingCode code;
    ...
    AUAssertionNoRelevantFindingComponent[] component?;
    r4:Resource[] contained?;
    AUAssertionNoRelevantFindingReferenceRange[] referenceRange?;
    ...
    AUAssertionNoRelevantFindingStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUAssertionNoRelevantFindingCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUAssertionNoRelevantFindingCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUAssertionNoRelevantFindingCode record {|
    *r4:CodeableConcept;
    ...
    AUAssertionNoRelevantFindingCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AUAssertionNoRelevantFindingComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUAssertionNoRelevantFindingComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUAssertionNoRelevantFindingCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUAssertionNoRelevantFindingCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://terminology.hl7.org/CodeSystem/v3-ActCode";
    r4:code code = "ASSERTION";
|};
...
@r4:DataTypeDefinition {
    name: "AUAssertionNoRelevantFindingReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUAssertionNoRelevantFindingReferenceRange record {|
    *r4:BackboneElement;
...
public enum AUAssertionNoRelevantFindingStatus {
