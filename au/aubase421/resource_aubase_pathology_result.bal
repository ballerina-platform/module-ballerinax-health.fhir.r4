...
public const string PROFILE_BASE_AUBASEPATHOLOGYRESULT = "http://hl7.org.au/fhir/StructureDefinition/au-pathologyresult";
public const RESOURCE_NAME_AUBASEPATHOLOGYRESULT = "Observation";
...
# * category Slicings
# 1) AUBasePathologyResultCategorySpecificDiscipline: Specific discipline of pathology
#       - min = 0
#       - max = *
#
# 2) AUBasePathologyResultCategoryLab: Observation generated by laboratories
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: AUBasePathologyResultComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUBasePathologyResultReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUBasePathologyResultStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUBasePathologyResult record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUBASEPATHOLOGYRESULT resourceType = RESOURCE_NAME_AUBASEPATHOLOGYRESULT;
    ...
    AUBasePathologyResultComponent[] component?;
    r4:Resource[] contained?;
    AUBasePathologyResultReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    AUBasePathologyResultStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBasePathologyResultCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBasePathologyResultReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultCategorySpecificDiscipline",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUBasePathologyResultCategoryCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUBasePathologyResultCategorySpecificDiscipline record {|
    *r4:CodeableConcept;

    AUBasePathologyResultCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultCategoryCodingOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUBasePathologyResultCategoryCodingOne record {|
    *r4:Coding;
...
public enum AUBasePathologyResultStatus {
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUBasePathologyResultComponent record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUBasePathologyResultCategoryLab",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUBasePathologyResultCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUBasePathologyResultCategoryLab record {|
    *r4:CodeableConcept;
    ...
    AUBasePathologyResultCategoryCodingOne[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
