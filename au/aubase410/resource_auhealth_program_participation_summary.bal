...
public const string PROFILE_BASE_AUHEALTHPROGRAMPARTICIPATIONSUMMARY = "http://hl7.org.au/fhir/StructureDefinition/au-healthprogramparticipation";
public const RESOURCE_NAME_AUHEALTHPROGRAMPARTICIPATIONSUMMARY = "Observation";
...
# + code - Describes the nature of the observation including specifying the type of program for which participation information for an individual is observed, e.g. national breast cancer screening, or a substance use therapy program such as a twelve step alcohol program.
...
# * component Slicings
# 1) AUHealthProgramParticipationSummaryComponentNextAction: Next program participation action
#       - min = 0
#       - max = 1
#
# 2) AUHealthProgramParticipationSummaryComponentLastAction: Last program participation action
#       - min = 0
#       - max = 1
#
# 3) AUHealthProgramParticipationSummaryComponentParticipationStatus: Current status of an individual's participation in a program
#       - min = 1
#       - max = 1
#
# 4) AUHealthProgramParticipationSummaryComponentNotParticipantStatusReason: Reason for not participating
#       - min = 0
#       - max = *
#
# 5) AUHealthProgramParticipationSummaryComponentParticipationStatusPeriod: Validity period for the program participation status
#       - min = 0
#       - max = 1
#
# 6) AUHealthProgramParticipationSummaryComponentNextActionDate: Next program participation action date
#       - min = 0
#       - max = 1
#
# 7) AUHealthProgramParticipationSummaryComponentForecastStatus: Forecast status with reference to program pathway, e.g. overdue, as at the time this observation is asserted
#       - min = 0
#       - max = 1
#
# 8) AUHealthProgramParticipationSummaryComponentLastActionDate: Last program participation action date
#       - min = 0
#       - max = 1
#
# 9) AUHealthProgramParticipationSummaryComponentForecastStatusPeriod: Validity period associated with forecast status
#       - min = 0
#       - max = 1
#
...
# + effectiveDateTime - Date, and optionally time, this program participation information is asserted as 'true'.
...
# * category Slicings
# 1) AUHealthProgramParticipationSummaryCategoryHPCat: Health program
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org.au/fhir/StructureDefinition/au-healthprogramparticipation",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "code" : {
            ...
            valueSet: "https://healthterminologies.gov.au/fhir/ValueSet/participation-in-health-program-1"
        },
        "subject" : {
            name: "subject",
            dataType: r4:Reference,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUHealthProgramParticipationSummaryReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: AUHealthProgramParticipationSummaryComponent,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUHealthProgramParticipationSummaryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUHealthProgramParticipationSummary record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUHEALTHPROGRAMPARTICIPATIONSUMMARY resourceType = RESOURCE_NAME_AUHEALTHPROGRAMPARTICIPATIONSUMMARY;
    ...
    AUHealthProgramParticipationSummaryReferenceRange[] referenceRange?;
    ...
    AUHealthProgramParticipationSummaryComponent[] component;
    ...
    r4:Reference device?;
    AUHealthProgramParticipationSummaryStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUHealthProgramParticipationSummaryComponentCodeOne record {|
    *r4:CodeableConcept;

    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Observation.component.code.coding constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.Observation.component.code.coding constraint. This field must be an array containing at most one item."
        }
    }
    AUHealthProgramParticipationSummaryComponentCodeCodingOne[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeSeven",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingSeven,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeSeven record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingSeven[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCode record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentParticipationStatusPeriod",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeFour,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUHealthProgramParticipationSummaryComponentParticipationStatusPeriod record {|
    *AUHealthProgramParticipationSummaryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeFour code;
    r4:CodeableConcept[] interpretation?;
    r4:Period valuePeriod?;
    r4:Extension[] modifierExtension?;
    r4:dateTime valueDateTime?;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeSix",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingSix,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeSix record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingSix[] coding;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentLastActionDate",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeSeven,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentLastActionDate record {|
    *AUHealthProgramParticipationSummaryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeSeven code;
    r4:CodeableConcept[] interpretation?;
    r4:Period valuePeriod?;
    r4:Extension[] modifierExtension?;
    r4:dateTime valueDateTime?;
...
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingTwo record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1603781000168102";
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeThree",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingThree,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeThree record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingThree[] coding;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeEight",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingEight,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeEight record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingEight[] coding;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryCategoryCoding record {|
    *r4:Coding;

    r4:uri system = "http://terminology.hl7.org.au/CodeSystem/observation-category";
    r4:code code = "program";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentForecastStatusPeriod",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeEight,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentForecastStatusPeriod record {|
    *AUHealthProgramParticipationSummaryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeEight code;
    r4:CodeableConcept[] interpretation?;
    r4:Period valuePeriod?;
    r4:Extension[] modifierExtension?;
    r4:dateTime valueDateTime?;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeFive",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingFive,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeFive record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingFive[] coding;
|};

# AUHealthProgramParticipationSummaryStatus enum
public enum AUHealthProgramParticipationSummaryStatus {
...
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUHealthProgramParticipationSummaryReferenceRange record {|
    *r4:BackboneElement;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingThree",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingThree record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1603991000168102";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604021000168101";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentNextActionDate",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeFive,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentNextActionDate record {|
    *AUHealthProgramParticipationSummaryComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeFive code;
    r4:CodeableConcept[] interpretation?;
    r4:Period valuePeriod?;
    r4:Extension[] modifierExtension?;
    r4:dateTime valueDateTime?;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingSeven",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingSeven record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604011000168108";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentNextAction",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCode,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentNextAction record {|
    *AUHealthProgramParticipationSummaryComponent;
    ...
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingFour",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingFour record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1603791000168104";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingFive",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingFive record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604031000168103";
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeTwo record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingTwo[] coding;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentLastAction",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentLastAction record {|
    *AUHealthProgramParticipationSummaryComponent;
    ...
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeOne code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentNotParticipantStatusReason",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeThree,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentNotParticipantStatusReason record {|
    *AUHealthProgramParticipationSummaryComponent;
    ...
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeThree code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeFour",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryComponentCodeCodingFour,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryComponentCodeFour record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryComponentCodeCodingFour[] coding;
|};
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUHealthProgramParticipationSummaryComponent record {|
    *r4:BackboneElement;
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryCategoryHPCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUHealthProgramParticipationSummaryCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUHealthProgramParticipationSummaryCategoryHPCat record {|
    *r4:CodeableConcept;
    ...
    AUHealthProgramParticipationSummaryCategoryCoding[] coding;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingOne record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604001000168105";
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingEight",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingEight record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604051000168109";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentParticipationStatus",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentParticipationStatus record {|
    *AUHealthProgramParticipationSummaryComponent;
    ...
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeTwo code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentCodeCodingSix",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUHealthProgramParticipationSummaryComponentCodeCodingSix record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1604041000168107";
|};
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUHealthProgramParticipationSummaryComponentForecastStatus",
    baseType: (),
    elements: {
        "valueCodeableConcept": {
            name: "valueCodeableConcept",
        ...
        "code": {
            name: "code",
            dataType: AUHealthProgramParticipationSummaryComponentCodeSix,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUHealthProgramParticipationSummaryComponentForecastStatus record {|
    *AUHealthProgramParticipationSummaryComponent;
    ...
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUHealthProgramParticipationSummaryComponentCodeSix code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
|};
