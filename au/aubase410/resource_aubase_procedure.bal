...
public const string PROFILE_BASE_AUBASEPROCEDURE = "http://hl7.org.au/fhir/StructureDefinition/au-procedure";
public const RESOURCE_NAME_AUBASEPROCEDURE = "Procedure";
...
public type AUBaseProcedure record {|
    *r4:DomainResource;
