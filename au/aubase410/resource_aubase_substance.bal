...
public const string PROFILE_BASE_AUBASESUBSTANCE = "http://hl7.org.au/fhir/StructureDefinition/au-substance";
public const RESOURCE_NAME_AUBASESUBSTANCE = "Substance";
...
public type AUBaseSubstance record {|
    *r4:DomainResource;
