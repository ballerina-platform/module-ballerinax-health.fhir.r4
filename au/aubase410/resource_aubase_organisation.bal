...
public const string PROFILE_BASE_AUBASEORGANISATION = "http://hl7.org.au/fhir/StructureDefinition/au-organization";
public const RESOURCE_NAME_AUBASEORGANISATION = "Organization";
...
public type AUBaseOrganisation record {|
    *r4:DomainResource;
