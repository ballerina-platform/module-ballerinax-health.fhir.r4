...
public const string PROFILE_BASE_AUBASEDIAGNOSTICRESULT = "http://hl7.org.au/fhir/StructureDefinition/au-diagnosticresult";
public const RESOURCE_NAME_AUBASEDIAGNOSTICRESULT = "Observation";
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org.au/fhir/StructureDefinition/au-diagnosticresult",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
...
public type AUBaseDiagnosticResult record {|
    *r4:DomainResource;
