...
public const string PROFILE_BASE_AUCOREALLERGYINTOLERANCE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-allergyintolerance";
public const RESOURCE_NAME_AUCOREALLERGYINTOLERANCE = "AllergyIntolerance";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "criticality" : {
            name: "criticality",
            dataType: AUCoreAllergyIntoleranceCriticality,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type" : {
            name: "type",
            dataType: AUCoreAllergyIntoleranceType,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "reaction" : {
            name: "reaction",
            dataType: AUCoreAllergyIntoleranceReaction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "category" : {
            name: "category",
            dataType: AUCoreAllergyIntoleranceCategory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreAllergyIntolerance record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREALLERGYINTOLERANCE resourceType = RESOURCE_NAME_AUCOREALLERGYINTOLERANCE;
    ...
    AUCoreAllergyIntoleranceCriticality criticality?;
    r4:code language?;
    r4:CodeableConcept clinicalStatus?;
    r4:dateTime onsetDateTime?;
    AUCoreAllergyIntoleranceType 'type?;
    r4:Age onsetAge?;
    ...
    AUCoreAllergyIntoleranceReaction[] reaction?;
    ...
    AUCoreAllergyIntoleranceCategory[] category?;
    r4:Element ...;
|};

# AUCoreAllergyIntoleranceCriticality enum
public enum AUCoreAllergyIntoleranceCriticality {
...
public enum AUCoreAllergyIntoleranceType {
...
@r4:DataTypeDefinition {
    name: "AUCoreAllergyIntoleranceReaction",
    baseType: (),
    elements: {
        "severity": {
            name: "severity",
            dataType: AUCoreAllergyIntoleranceReactionSeverity,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreAllergyIntoleranceReaction record {|
    *r4:BackboneElement;

    AUCoreAllergyIntoleranceReactionSeverity severity?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    @constraint:Array {
        minLength: {
...
public enum AUCoreAllergyIntoleranceCategory {
...
public enum AUCoreAllergyIntoleranceReactionSeverity {
