...
public const string PROFILE_BASE_AUCOREWAISTCIRCUMFERENCE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-waistcircum";
public const RESOURCE_NAME_AUCOREWAISTCIRCUMFERENCE = "Observation";

# FHIR AUCoreWaistCircumference resource record.
#
...
# + effectiveDateTime - Date, and optionally time, the observation was performed.
...
# * category Slicings
# 1) AUCoreWaistCircumferenceCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUCoreWaistCircumferenceCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: AUCoreWaistCircumferenceValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "component" : {
            name: "component",
            dataType: AUCoreWaistCircumferenceComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreWaistCircumferenceReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreWaistCircumferenceStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreWaistCircumference record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREWAISTCIRCUMFERENCE resourceType = RESOURCE_NAME_AUCOREWAISTCIRCUMFERENCE;
    ...
    r4:time valueTime?;
    AUCoreWaistCircumferenceCode code;
    ...
    AUCoreWaistCircumferenceValue valueQuantity?;
    ...
    AUCoreWaistCircumferenceComponent[] component?;
    r4:Resource[] contained?;
    AUCoreWaistCircumferenceReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    AUCoreWaistCircumferenceStatus status;
    r4:Element ...;
|};

# FHIR AUCoreWaistCircumferenceComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreWaistCircumferenceComponent record {|
    *r4:BackboneElement;
...
# FHIR AUCoreWaistCircumferenceCodeCodingLoincWaistCircumCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceCodeCodingLoincWaistCircumCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreWaistCircumferenceCodeCodingLoincWaistCircumCode record {|
    *r4:Coding;
...
# FHIR AUCoreWaistCircumferenceCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreWaistCircumferenceCode record {|
    *r4:CodeableConcept;
...
# FHIR AUCoreWaistCircumferenceCodeCodingSnomedWaistCircumCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceCodeCodingSnomedWaistCircumCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreWaistCircumferenceCodeCodingSnomedWaistCircumCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "276361009";
...
# FHIR AUCoreWaistCircumferenceCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreWaistCircumferenceCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreWaistCircumferenceCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreWaistCircumferenceCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR AUCoreWaistCircumferenceReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreWaistCircumferenceReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR AUCoreWaistCircumferenceCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreWaistCircumferenceCategoryCoding record {|
    *r4:Coding;
...
public enum AUCoreWaistCircumferenceStatus {
...
public enum AUCoreWaistCircumferenceValueComparator {
...
# FHIR AUCoreWaistCircumferenceValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreWaistCircumferenceValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreWaistCircumferenceValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreWaistCircumferenceValue record {|
    *r4:Quantity;

    AUCoreWaistCircumferenceValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
