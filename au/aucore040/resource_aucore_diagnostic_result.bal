...
public const string PROFILE_BASE_AUCOREDIAGNOSTICRESULT = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-diagnosticresult";
public const RESOURCE_NAME_AUCOREDIAGNOSTICRESULT = "Observation";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: AUCoreDiagnosticResultHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreDiagnosticResultComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreDiagnosticResultReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreDiagnosticResultStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreDiagnosticResult record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREDIAGNOSTICRESULT resourceType = RESOURCE_NAME_AUCOREDIAGNOSTICRESULT;
    ...
    AUCoreDiagnosticResultHasMember[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    AUCoreDiagnosticResultComponent[] component?;
    r4:Resource[] contained?;
    AUCoreDiagnosticResultReferenceRange[] referenceRange?;
    string valueString?;
    ...
    AUCoreDiagnosticResultStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreDiagnosticResultHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type AUCoreDiagnosticResultHasMember record {|
    *r4:Reference;
...
public enum AUCoreDiagnosticResultStatus {
...
@r4:DataTypeDefinition {
    name: "AUCoreDiagnosticResultReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreDiagnosticResultReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "AUCoreDiagnosticResultComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreDiagnosticResultComponent record {|
    *r4:BackboneElement;
