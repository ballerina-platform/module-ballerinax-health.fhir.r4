...
public const string PROFILE_BASE_AUCOREHEARTRATE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-heartrate";
public const RESOURCE_NAME_AUCOREHEARTRATE = "Observation";
...
# * category Slicings
# 1) AUCoreHeartRateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: AUCoreHeartRateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreHeartRateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreHeartRateStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreHeartRate record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREHEARTRATE resourceType = RESOURCE_NAME_AUCOREHEARTRATE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreHeartRateCode code;
    ...
    AUCoreHeartRateValue valueQuantity?;
    ...
    AUCoreHeartRateComponent[] component?;
    r4:Resource[] contained?;
    AUCoreHeartRateReferenceRange[] referenceRange?;
...
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreHeartRateCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreHeartRateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreHeartRateValue record {|
    *r4:Quantity;

    AUCoreHeartRateValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "/min";
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateCodeCodingSnomedHeartRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreHeartRateCodeCodingSnomedHeartRateCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "364075005";
...
public type AUCoreHeartRateCode record {|
    *r4:CodeableConcept;
...
public type AUCoreHeartRateComponent record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreHeartRateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreHeartRateCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreHeartRateCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum AUCoreHeartRateValueComparator {
...
public enum AUCoreHeartRateStatus {
...
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreHeartRateReferenceRange record {|
    *r4:BackboneElement;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreHeartRateCodeCodingHeartRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreHeartRateCodeCodingHeartRateCode record {|
    *r4:Coding;
