...
#       - max = 1
#
# 3) Extension: Veteran / Australian Defence Force (ADF) status
#       - min = 0
#       - max = *
#
# 4) Extension: Place of Birth for patient
#       - min = 0
#       - max = 1
#
# 5) Extension: Gender identity shall be a member of the Gender Identity Response value set if any codes within that value set can apply
#       - min = 0
#       - max = *
#
...
#       - max = *
#
# 7) Extension: Closing the Gap co-payment eligibility indicator
#       - min = 0
#       - max = 1
#
# 8) Extension: The date a person first arrived in Australia, from another country, with the intention of living in Australia for one year or more
#       - min = 0
#       - max = 1
#
# 9) Extension: Pronouns shall be a member of the Australian Pronouns value set if any codes within that value set can apply
#       - min = 0
#       - max = *
#
# 10) Extension: Whether the patient needs an interpreter
#       - min = 0
#       - max = 1
#
