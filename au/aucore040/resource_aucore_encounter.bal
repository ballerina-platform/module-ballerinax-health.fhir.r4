...
public const string PROFILE_BASE_AUCOREENCOUNTER = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-encounter";
public const RESOURCE_NAME_AUCOREENCOUNTER = "Encounter";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "participant" : {
            name: "participant",
            dataType: AUCoreEncounterParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "classHistory" : {
            name: "classHistory",
            dataType: AUCoreEncounterClassHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "hospitalization" : {
            ...
            dataType: AUCoreEncounterHospitalization,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "diagnosis" : {
            name: "diagnosis",
            dataType: AUCoreEncounterDiagnosis,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "statusHistory" : {
            name: "statusHistory",
            dataType: AUCoreEncounterStatusHistory,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "location" : {
            name: "location",
            dataType: AUCoreEncounterLocation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreEncounterStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreEncounter record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREENCOUNTER resourceType = RESOURCE_NAME_AUCOREENCOUNTER;
    ...
    AUCoreEncounterParticipant[] participant?;
    ...
    r4:Period period?;
    AUCoreEncounterClassHistory[] classHistory?;
    AUCoreEncounterHospitalization hospitalization?;
    r4:Duration length?;
    AUCoreEncounterDiagnosis[] diagnosis?;
    r4:CodeableConcept priority?;
    r4:Resource[] contained?;
    AUCoreEncounterStatusHistory[] statusHistory?;
    r4:Meta meta?;
    r4:Reference serviceProvider?;
    r4:uri implicitRules?;
    AUCoreEncounterLocation[] location?;
    r4:Reference[] account?;
    AUCoreEncounterStatus status;
    r4:Element ...;
|};

# AUCoreEncounterStatusHistoryStatus enum
public enum AUCoreEncounterStatusHistoryStatus {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "status": {
            name: "status",
            dataType: AUCoreEncounterLocationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreEncounterLocation record {|
    *r4:BackboneElement;
    ...
    string id?;
    AUCoreEncounterLocationStatus status?;
|};
...
public type AUCoreEncounterDiagnosis record {|
    *r4:BackboneElement;
...
# + status - planned | arrived | triaged | in-progress | onleave | finished | cancelled +.
@r4:DataTypeDefinition {
    name: "AUCoreEncounterStatusHistory",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "status": {
            name: "status",
            dataType: AUCoreEncounterStatusHistoryStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreEncounterStatusHistory record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    AUCoreEncounterStatusHistoryStatus status;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreEncounterParticipant",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreEncounterParticipant record {|
    *r4:BackboneElement;
...
public enum AUCoreEncounterLocationStatus {
...
public enum AUCoreEncounterStatus {
   CODE_STATUS_TRIAGED = "triaged",
   CODE_STATUS_ARRIVED = "arrived",
   CODE_STATUS_ONLEAVE = "onleave",
   CODE_STATUS_CANCELLED = "cancelled",
...
@r4:DataTypeDefinition {
    name: "AUCoreEncounterClassHistory",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreEncounterClassHistory record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreEncounterHospitalization",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreEncounterHospitalization record {|
    *r4:BackboneElement;
