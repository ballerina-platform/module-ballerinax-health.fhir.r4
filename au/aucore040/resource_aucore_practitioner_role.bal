...
public const string PROFILE_BASE_AUCOREPRACTITIONERROLE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-practitionerrole";
public const RESOURCE_NAME_AUCOREPRACTITIONERROLE = "PractitionerRole";

# FHIR AUCorePractitionerRole resource record.
#
# + resourceType - The type of the resource describes
# + identifier - Business Identifiers that are specific to a role/location.
# * identifier Slicings
# 1) AUCorePractitionerRoleIdentifierMedicareProvider: Medicare Provider Number
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "notAvailable" : {
            name: "notAvailable",
            dataType: AUCorePractitionerRoleNotAvailable,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "availableTime" : {
            name: "availableTime",
            dataType: AUCorePractitionerRoleAvailableTime,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCorePractitionerRole record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREPRACTITIONERROLE resourceType = RESOURCE_NAME_AUCOREPRACTITIONERROLE;

    aubase421:AuNationalprovideridentifieratorganisation[]|r4:Identifier[]|aubase421:AuEmployeenumber[]|aubase421:AuMedicareprovidernumber[] identifier?;
    ...
    boolean active?;
    r4:code language?;
    AUCorePractitionerRoleNotAvailable[] notAvailable?;
    AUCorePractitionerRoleAvailableTime[] availableTime?;
...
# FHIR AUCorePractitionerRoleAvailableTime datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCorePractitionerRoleAvailableTime",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: AUCorePractitionerRoleAvailableTimeDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCorePractitionerRoleAvailableTime record {|
    *r4:BackboneElement;
    ...
    string id?;
    AUCorePractitionerRoleAvailableTimeDaysOfWeek[] daysOfWeek?;
    r4:time availableStartTime?;
|};

# AUCorePractitionerRoleAvailableTimeDaysOfWeek enum
public enum AUCorePractitionerRoleAvailableTimeDaysOfWeek {
...
# FHIR AUCorePractitionerRoleNotAvailable datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCorePractitionerRoleNotAvailable",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCorePractitionerRoleNotAvailable record {|
    *r4:BackboneElement;
...
# FHIR AUCorePractitionerRoleIdentifierMedicareProvider datatype record.
#
@r4:DataTypeDefinition {
    name: "AUCorePractitionerRoleIdentifierMedicareProvider",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type AUCorePractitionerRoleIdentifierMedicareProvider record {|
    *r4:Identifier;
