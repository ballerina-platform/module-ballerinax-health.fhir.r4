...
public const string PROFILE_BASE_AUCORECONDITION = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-condition";
public const RESOURCE_NAME_AUCORECONDITION = "Condition";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "evidence" : {
            name: "evidence",
            dataType: AUCoreConditionEvidence,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreCondition record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCORECONDITION resourceType = RESOURCE_NAME_AUCORECONDITION;

    r4:Annotation[] note?;
    r4:Extension[] extension?;
    r4:CodeableConcept code;
    AUCoreConditionEvidence[] evidence?;
    r4:Range onsetRange?;
...
public type AUCoreConditionEvidence record {|
    *r4:BackboneElement;
...
public type AUCoreConditionStage record {|
    *r4:BackboneElement;
