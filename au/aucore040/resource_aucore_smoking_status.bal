...
public const string PROFILE_BASE_AUCORESMOKINGSTATUS = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-smokingstatus";
public const RESOURCE_NAME_AUCORESMOKINGSTATUS = "Observation";

# FHIR AUCoreSmokingStatus resource record.
#
...
# * category Slicings
# 1) AUCoreSmokingStatusCategorySocialHistory: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUCoreSmokingStatusCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueCodeableConcept" : {
            ...
            valueSet: "https://healthterminologies.gov.au/fhir/ValueSet/smoking-status-1"
        },
        "specimen" : {
            name: "specimen",
            dataType: r4:Reference,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreSmokingStatusComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreSmokingStatusReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreSmokingStatusStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreSmokingStatus record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCORESMOKINGSTATUS resourceType = RESOURCE_NAME_AUCORESMOKINGSTATUS;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreSmokingStatusCode code;
    ...
    AUCoreSmokingStatusComponent[] component?;
    r4:Resource[] contained?;
    AUCoreSmokingStatusReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    AUCoreSmokingStatusStatus status;
    r4:Element ...;
|};

# FHIR AUCoreSmokingStatusComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreSmokingStatusComponent record {|
    *r4:BackboneElement;
...
# FHIR AUCoreSmokingStatusCodeCodingLoincSmokingStatus datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusCodeCodingLoincSmokingStatus",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreSmokingStatusCodeCodingLoincSmokingStatus record {|
    *AUCoreSmokingStatusCodeCoding;

    r4:Extension[] extension?;
    r4:code code = "72166-2";
...
# FHIR AUCoreSmokingStatusCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUCoreSmokingStatusCategoryCoding record {|
    *r4:Coding;
...
# FHIR AUCoreSmokingStatusCodeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUCoreSmokingStatusCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://snomed.info/sct";
    r4:code code = "1747861000168109";
|};

# FHIR AUCoreSmokingStatusCode datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreSmokingStatusCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreSmokingStatusCode record {|
    *r4:CodeableConcept;
    ...
    AUCoreSmokingStatusCodeCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum AUCoreSmokingStatusStatus {
...
# FHIR AUCoreSmokingStatusCategorySocialHistory datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusCategorySocialHistory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreSmokingStatusCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreSmokingStatusCategorySocialHistory record {|
    *r4:CodeableConcept;
    ...
    AUCoreSmokingStatusCategoryCoding[] coding;
|};

# FHIR AUCoreSmokingStatusReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreSmokingStatusReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreSmokingStatusReferenceRange record {|
    *r4:BackboneElement;
