...
public const string PROFILE_BASE_AUCOREPATHOLOGYRESULT = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-diagnosticresult-path";
public const RESOURCE_NAME_AUCOREPATHOLOGYRESULT = "Observation";
...
# * category Slicings
# 1) AUCorePathologyResultCategorySpecificDiscipline: Specific discipline of pathology
#       - min = 0
#       - max = *
#
# 2) AUCorePathologyResultCategoryLab: Observation generated by laboratories
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "specimen" : {
            name: "specimen",
            dataType: AUCorePathologyResultSpecimen,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "hasMember" : {
            name: "hasMember",
            dataType: AUCorePathologyResultHasMember,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: AUCorePathologyResultComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCorePathologyResultReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCorePathologyResultStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCorePathologyResult record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREPATHOLOGYRESULT resourceType = RESOURCE_NAME_AUCOREPATHOLOGYRESULT;
    ...
    r4:Ratio valueRatio?;
    AUCorePathologyResultSpecimen specimen?;
    ...
    AUCorePathologyResultHasMember[] hasMember?;
    r4:Reference encounter?;
    r4:CodeableConcept bodySite?;
    AUCorePathologyResultComponent[] component?;
    r4:Resource[] contained?;
    AUCorePathologyResultReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r4:Reference device?;
    AUCorePathologyResultStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCorePathologyResultComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCorePathologyResultCategoryCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultHasMember",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type AUCorePathologyResultHasMember record {|
    *r4:Reference;
...
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCorePathologyResultReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultCategorySpecificDiscipline",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCorePathologyResultCategoryCoding,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCorePathologyResultCategorySpecificDiscipline record {|
    *r4:CodeableConcept;

    AUCorePathologyResultCategoryCoding[] coding?;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultCategoryLab",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCorePathologyResultCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCorePathologyResultCategoryLab record {|
    *r4:CodeableConcept;
    ...
    AUCorePathologyResultCategoryCodingOne[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + 'type - The expected type of the target of the reference. If both Reference.type and Reference.reference are populated and Reference.reference is a FHIR URL, both SHALL be consistent. The type is the Canonical URL of Resource Definition that is the type this reference refers to. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition/ e.g. 'Patient' is a reference to http://hl7.org/fhir/StructureDefinition/Patient. Absolute URLs are only allowed for logical models (and can only be used in references in logical models, not resources).
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultSpecimen",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type AUCorePathologyResultSpecimen record {|
    *r4:Reference;
...
public enum AUCorePathologyResultStatus {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCorePathologyResultCategoryCodingOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCorePathologyResultCategoryCodingOne record {|
    *r4:Coding;
