...
public const string PROFILE_BASE_AUCOREBODYWEIGHT = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-bodyweight";
public const RESOURCE_NAME_AUCOREBODYWEIGHT = "Observation";
...
# * category Slicings
# 1) AUCoreBodyWeightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: AUCoreBodyWeightValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreBodyWeightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreBodyWeightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreBodyWeightStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreBodyWeight record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREBODYWEIGHT resourceType = RESOURCE_NAME_AUCOREBODYWEIGHT;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreBodyWeightCode code;
    ...
    AUCoreBodyWeightValue valueQuantity?;
    ...
    AUCoreBodyWeightComponent[] component?;
    r4:Resource[] contained?;
    AUCoreBodyWeightReferenceRange[] referenceRange?;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreBodyWeightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreBodyWeightCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreBodyWeightCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyWeightReferenceRange record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyWeightCategoryCoding record {|
    *r4:Coding;
...
public type AUCoreBodyWeightCode record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreBodyWeightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreBodyWeightValue record {|
    *r4:Quantity;

    AUCoreBodyWeightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreBodyWeightComponent record {|
    *r4:BackboneElement;
...
public enum AUCoreBodyWeightStatus {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightCodeCodingBodyWeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyWeightCodeCodingBodyWeightCode record {|
    *r4:Coding;
...
public enum AUCoreBodyWeightValueComparator {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyWeightCodeCodingSnomedBodyWeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyWeightCodeCodingSnomedBodyWeightCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "27113001";
