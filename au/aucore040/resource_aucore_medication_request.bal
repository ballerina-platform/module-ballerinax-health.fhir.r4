...
public const string PROFILE_BASE_AUCOREMEDICATIONREQUEST = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-medicationrequest";
public const RESOURCE_NAME_AUCOREMEDICATIONREQUEST = "MedicationRequest";
...
# 1) AUCoreMedicationRequestSupportingInformationBodyHeight: Observation of Body Height
#       - min = 0
#       - max = 1
#
# 2) AUCoreMedicationRequestSupportingInformationBodyWeight: Observation of Body Weight
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "substitution" : {
            name: "substitution",
            dataType: AUCoreMedicationRequestSubstitution,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "dispenseRequest" : {
            ...
            dataType: AUCoreMedicationRequestDispenseRequest,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "priority" : {
            name: "priority",
            dataType: AUCoreMedicationRequestPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: AUCoreMedicationRequestIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreMedicationRequestStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreMedicationRequest record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREMEDICATIONREQUEST resourceType = RESOURCE_NAME_AUCOREMEDICATIONREQUEST;

    r4:Reference[] insurance?;
    r4:Annotation[] note?;
    r4:Extension[] extension?;
    AUCoreMedicationRequestSubstitution substitution?;
    ...
    AUCoreMedicationRequestDispenseRequest dispenseRequest?;
    string id?;
    ...
    r4:Identifier[]|aubase421:AuEtpprescriptionidentifier[]|aubase421:AuLocalprescriptionidentifier[] identifier?;
    ...
    AUCoreMedicationRequestPriority priority?;
    AUCoreMedicationRequestIntent intent;
    r4:CodeableConcept performerType?;
    r4:Resource[] contained?;
    aubase421:AuDosage[] dosageInstruction?;
    r4:Meta meta?;
    r4:Reference[] eventHistory?;
    r4:uri implicitRules?;
    r4:CodeableConcept[] category?;
    r4:Identifier groupIdentifier?;
    AUCoreMedicationRequestStatus status;
    r4:Element ...;
|};

# AUCoreMedicationRequestIntent enum
public enum AUCoreMedicationRequestIntent {
...
@r4:DataTypeDefinition {
    name: "AUCoreMedicationRequestSupportingInformationBodyWeight",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type AUCoreMedicationRequestSupportingInformationBodyWeight record {|
    *r4:Reference;

|};

# AUCoreMedicationRequestPriority enum
public enum AUCoreMedicationRequestPriority {
...
@r4:DataTypeDefinition {
    name: "AUCoreMedicationRequestDispenseRequest",
    baseType: (),
    elements: {
        "validityPeriod": {
            name: "validityPeriod",
        ...
        "initialFill": {
            name: "initialFill",
            dataType: AUCoreMedicationRequestDispenseRequestInitialFill,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreMedicationRequestDispenseRequest record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    AUCoreMedicationRequestDispenseRequestInitialFill initialFill?;
    string id?;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreMedicationRequestSubstitution",
    baseType: (),
    elements: {
...
public type AUCoreMedicationRequestSubstitution record {|
    *r4:BackboneElement;
...
public enum AUCoreMedicationRequestStatus {
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreMedicationRequestDispenseRequestInitialFill",
    baseType: (),
    elements: {
        "duration": {
            name: "duration",
...
public type AUCoreMedicationRequestDispenseRequestInitialFill record {|
    *r4:BackboneElement;
...
#
@r4:DataTypeDefinition {
    name: "AUCoreMedicationRequestSupportingInformationBodyHeight",
    baseType: (),
    elements: {
    },
    serializers: {
...
public type AUCoreMedicationRequestSupportingInformationBodyHeight record {|
    *r4:Reference;
