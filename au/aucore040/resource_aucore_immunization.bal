...
public const string PROFILE_BASE_AUCOREIMMUNIZATION = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-immunization";
public const RESOURCE_NAME_AUCOREIMMUNIZATION = "Immunization";
...
# * performer Slicings
# 1) AUCoreImmunizationPerformerApprovedBy: Immunisation Approved By
#       - min = 0
#       - max = 1
#
# 2) AUCoreImmunizationPerformerAdministeredBy: Immunisation Administered By
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "education" : {
            name: "education",
            dataType: AUCoreImmunizationEducation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "vaccineCode" : {
            name: "vaccineCode",
            dataType: AUCoreImmunizationVaccineCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "performer" : {
            name: "performer",
            dataType: AUCoreImmunizationPerformer,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "reaction" : {
            name: "reaction",
            dataType: AUCoreImmunizationReaction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "protocolApplied" : {
            ...
            dataType: AUCoreImmunizationProtocolApplied,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreImmunizationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreImmunization record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREIMMUNIZATION resourceType = RESOURCE_NAME_AUCOREIMMUNIZATION;

    r4:Annotation[] note?;
    boolean primarySource?;
    r4:Extension[] extension?;
    AUCoreImmunizationEducation[] education?;
    ...
    r4:Narrative text?;
    AUCoreImmunizationVaccineCode vaccineCode;
    r4:date expirationDate?;
    r4:Identifier[] identifier?;
    AUCoreImmunizationPerformer[] performer?;
    AUCoreImmunizationReaction[] reaction?;
    ...
    r4:Meta meta?;
    AUCoreImmunizationProtocolApplied[] protocolApplied?;
    ...
    AUCoreImmunizationStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerFunction",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreImmunizationPerformerFunctionCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreImmunizationPerformerFunction record {|
    *r4:CodeableConcept;
    ...
    AUCoreImmunizationPerformerFunctionCoding[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerAdministeredBy",
    baseType: (),
    elements: {
        "actor": {
            name: "actor",
        ...
        "function": {
            name: "function",
            dataType: AUCoreImmunizationPerformerFunctionOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreImmunizationPerformerAdministeredBy record {|
    *AUCoreImmunizationPerformer;

    r4:Reference actor;
    r4:Extension[] extension?;
    AUCoreImmunizationPerformerFunctionOne 'function;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerFunctionOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreImmunizationPerformerFunctionCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreImmunizationPerformerFunctionOne record {|
    *r4:CodeableConcept;
    ...
    AUCoreImmunizationPerformerFunctionCodingOne[] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerFunctionCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUCoreImmunizationPerformerFunctionCoding record {|
    *r4:Coding;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationProtocolApplied",
    baseType: (),
    elements: {
        "doseNumberString": {
...
public type AUCoreImmunizationProtocolApplied record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationVaccineCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreImmunizationVaccineCode record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationEducation",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type AUCoreImmunizationEducation record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationReaction",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type AUCoreImmunizationReaction record {|
    *r4:BackboneElement;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerApprovedBy",
    baseType: (),
    elements: {
        "actor": {
            name: "actor",
        ...
        "function": {
            name: "function",
            dataType: AUCoreImmunizationPerformerFunction,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes the type of performance (e.g. ordering provider, administering provider, etc.).",
...
public type AUCoreImmunizationPerformerApprovedBy record {|
    *AUCoreImmunizationPerformer;

    r4:Reference actor;
    r4:Extension[] extension?;
    AUCoreImmunizationPerformerFunction 'function;
    r4:Extension[] modifierExtension?;
    string id?;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationVaccineCodeCodingAmtVaccineCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreImmunizationVaccineCodeCodingAmtVaccineCode record {|
    *r4:Coding;
...
public enum AUCoreImmunizationStatus {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationVaccineCodeCodingAirVaccineCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreImmunizationVaccineCodeCodingAirVaccineCode record {|
    *r4:Coding;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformer",
    baseType: (),
    elements: {
        "actor": {
            name: "actor",
...
public type AUCoreImmunizationPerformer record {|
    *r4:BackboneElement;
...
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
@r4:DataTypeDefinition {
    name: "AUCoreImmunizationPerformerFunctionCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AUCoreImmunizationPerformerFunctionCodingOne record {|
    *r4:Coding;
