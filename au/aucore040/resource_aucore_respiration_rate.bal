...
public const string PROFILE_BASE_AUCORERESPIRATIONRATE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-resprate";
public const RESOURCE_NAME_AUCORERESPIRATIONRATE = "Observation";

# FHIR AUCoreRespirationRate resource record.
#
...
# * category Slicings
# 1) AUCoreRespirationRateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUCoreRespirationRateCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: AUCoreRespirationRateValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreRespirationRateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreRespirationRateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreRespirationRateStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreRespirationRate record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCORERESPIRATIONRATE resourceType = RESOURCE_NAME_AUCORERESPIRATIONRATE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreRespirationRateCode code;
    ...
    AUCoreRespirationRateValue valueQuantity?;
    ...
    AUCoreRespirationRateComponent[] component?;
    r4:Resource[] contained?;
    AUCoreRespirationRateReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    AUCoreRespirationRateStatus status;
    r4:Element ...;
|};

# FHIR AUCoreRespirationRateComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreRespirationRateComponent record {|
    *r4:BackboneElement;
...
# FHIR AUCoreRespirationRateCodeCodingSnomedRespRateCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateCodeCodingSnomedRespRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreRespirationRateCodeCodingSnomedRespRateCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "86290005";
...
# FHIR AUCoreRespirationRateValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreRespirationRateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreRespirationRateValue record {|
    *r4:Quantity;

    AUCoreRespirationRateValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "/min";
...
# FHIR AUCoreRespirationRateReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreRespirationRateReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR AUCoreRespirationRateCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreRespirationRateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreRespirationRateCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreRespirationRateCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum AUCoreRespirationRateValueComparator {
...
public enum AUCoreRespirationRateStatus {
...
# FHIR AUCoreRespirationRateCodeCodingRespRateCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateCodeCodingRespRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreRespirationRateCodeCodingRespRateCode record {|
    *r4:Coding;
...
# FHIR AUCoreRespirationRateCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreRespirationRateCategoryCoding record {|
    *r4:Coding;
...
# FHIR AUCoreRespirationRateCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreRespirationRateCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreRespirationRateCode record {|
    *r4:CodeableConcept;
