...
public enum AUCoreBloodPressureComponentValueComparator {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "valueQuantity": {
            name: "valueQuantity",
            dataType: AUCoreBloodPressureComponentValue,
            min: 0,
            max: 1,
            isArray: false,
            description: "Vital Sign Value recorded with UCUM.",
...
public type AUCoreBloodPressureComponentDiastolicBP record {|
    *AUCoreBloodPressureComponent;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    AUCoreBloodPressureComponentValue valueQuantity?;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponentValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreBloodPressureComponentValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreBloodPressureComponentValue record {|
    *r4:Quantity;

    AUCoreBloodPressureComponentValueComparator comparator?;
    string unit;
    r4:code code = "mm[Hg]";
