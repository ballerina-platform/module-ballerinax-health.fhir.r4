...
public const string PROFILE_BASE_AUCOREBLOODPRESSURE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-bloodpressure";
public const RESOURCE_NAME_AUCOREBLOODPRESSURE = "Observation";
...
# * component Slicings
# 1) AUCoreBloodPressureComponentSystolicBP: Systolic Blood Pressure
#       - min = 1
#       - max = 1
#
# 2) AUCoreBloodPressureComponentDiastolicBP: Diastolic Blood Pressure
#       - min = 1
#       - max = 1
#
...
# * category Slicings
# 1) AUCoreBloodPressureCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUCoreBloodPressureCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreBloodPressureComponent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreBloodPressureReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreBloodPressureStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreBloodPressure record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREBLOODPRESSURE resourceType = RESOURCE_NAME_AUCOREBLOODPRESSURE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreBloodPressureCode code;
    ...
    AUCoreBloodPressureComponent[] component;
    r4:Resource[] contained?;
    AUCoreBloodPressureReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    AUCoreBloodPressureStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureCodeCodingSnomedBPCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBloodPressureCodeCodingSnomedBPCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "75367002";
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreBloodPressureComponentCode record {|
    *r4:CodeableConcept;
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponentSystolicBP",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUCoreBloodPressureComponentCode,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreBloodPressureComponentSystolicBP record {|
    *AUCoreBloodPressureComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUCoreBloodPressureComponentCode code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:Quantity valueQuantity?;
...
public type AUCoreBloodPressureCode record {|
    *r4:CodeableConcept;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureCodeCodingBPCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBloodPressureCodeCodingBPCode record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBloodPressureReferenceRange record {|
    *r4:BackboneElement;
...
# + valueQuantity - Vital Sign Value recorded with UCUM.
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreBloodPressureComponent record {|
    *r4:BackboneElement;
...
public enum AUCoreBloodPressureStatus {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBloodPressureCategoryCoding record {|
    *r4:Coding;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreBloodPressureComponentCodeOne record {|
    *r4:CodeableConcept;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreBloodPressureCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreBloodPressureCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreBloodPressureCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBloodPressureComponentDiastolicBP",
    baseType: (),
    elements: {
        "dataAbsentReason": {
            name: "dataAbsentReason",
        ...
        "code": {
            name: "code",
            dataType: AUCoreBloodPressureComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type AUCoreBloodPressureComponentDiastolicBP record {|
    *AUCoreBloodPressureComponent;

    r4:CodeableConcept dataAbsentReason?;
    r4:Extension[] extension?;
    international401:ObservationReferenceRange[] referenceRange?;
    AUCoreBloodPressureComponentCodeOne code;
    r4:CodeableConcept[] interpretation?;
    r4:Extension[] modifierExtension?;
    string id?;
    r4:Quantity valueQuantity?;
