...
public const string PROFILE_BASE_AUCOREMEDICATION = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-medication";
public const RESOURCE_NAME_AUCOREMEDICATION = "Medication";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "ingredient" : {
            name: "ingredient",
            dataType: AUCoreMedicationIngredient,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "batch" : {
            name: "batch",
            dataType: AUCoreMedicationBatch,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreMedicationStatus,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreMedication record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREMEDICATION resourceType = RESOURCE_NAME_AUCOREMEDICATION;

    r4:Identifier[] identifier?;
    r4:Ratio amount?;
    r4:Extension[] extension?;
    AUCoreMedicationCode code;
    AUCoreMedicationIngredient[] ingredient?;
    r4:Extension[] modifierExtension?;
    AUCoreMedicationBatch batch?;
    r4:code language?;
...
@r4:DataTypeDefinition {
    name: "AUCoreMedicationCodeCodingGtin",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreMedicationCodeCodingGtin record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreMedicationCodeCodingAmt",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreMedicationCodeCodingAmt record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreMedicationCodeCodingPbs",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreMedicationCodeCodingPbs record {|
    *r4:Coding;
...
public type AUCoreMedicationBatch record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreMedicationIngredient",
    baseType: (),
    elements: {
        "itemReference": {
            name: "itemReference",
...
public type AUCoreMedicationIngredient record {|
    *r4:BackboneElement;
...
public type AUCoreMedicationCode record {|
    *r4:CodeableConcept;
...
public enum AUCoreMedicationStatus {
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreMedicationCodeCodingMimsPackage",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreMedicationCodeCodingMimsPackage record {|
    *r4:Coding;
