...
public const string PROFILE_BASE_AUCOREBODYTEMPERATURE = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-bodytemp";
public const RESOURCE_NAME_AUCOREBODYTEMPERATURE = "Observation";
...
# * category Slicings
# 1) AUCoreBodyTemperatureCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: AUCoreBodyTemperatureCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: AUCoreBodyTemperatureValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreBodyTemperatureComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreBodyTemperatureReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreBodyTemperatureStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreBodyTemperature record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREBODYTEMPERATURE resourceType = RESOURCE_NAME_AUCOREBODYTEMPERATURE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreBodyTemperatureCode code;
    ...
    AUCoreBodyTemperatureValue valueQuantity?;
    ...
    AUCoreBodyTemperatureComponent[] component?;
    r4:Resource[] contained?;
    AUCoreBodyTemperatureReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    AUCoreBodyTemperatureStatus status;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreBodyTemperatureComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureCodeCodingSnomedBodyTempCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyTemperatureCodeCodingSnomedBodyTempCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "386725007";
...
public enum AUCoreBodyTemperatureStatus {
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type AUCoreBodyTemperatureCode record {|
    *r4:CodeableConcept;
...
public enum AUCoreBodyTemperatureValueComparator {
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyTemperatureReferenceRange record {|
    *r4:BackboneElement;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreBodyTemperatureCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreBodyTemperatureCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreBodyTemperatureCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyTemperatureCategoryCoding record {|
    *r4:Coding;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureCodeCodingBodyTempCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyTemperatureCodeCodingBodyTempCode record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyTemperatureValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreBodyTemperatureValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreBodyTemperatureValue record {|
    *r4:Quantity;

    AUCoreBodyTemperatureValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
