...
public const string PROFILE_BASE_AUCOREBODYHEIGHT = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-bodyheight";
public const RESOURCE_NAME_AUCOREBODYHEIGHT = "Observation";
...
# * category Slicings
# 1) AUCoreBodyHeightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: AUCoreBodyHeightValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: AUCoreBodyHeightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: AUCoreBodyHeightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: AUCoreBodyHeightStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type AUCoreBodyHeight record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCOREBODYHEIGHT resourceType = RESOURCE_NAME_AUCOREBODYHEIGHT;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    AUCoreBodyHeightCode code;
    ...
    AUCoreBodyHeightValue valueQuantity?;
    ...
    AUCoreBodyHeightComponent[] component?;
    r4:Resource[] contained?;
    AUCoreBodyHeightReferenceRange[] referenceRange?;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyHeightCategoryCoding record {|
    *r4:Coding;
...
public enum AUCoreBodyHeightStatus {
...
public enum AUCoreBodyHeightValueComparator {
...
public type AUCoreBodyHeightCode record {|
    *r4:CodeableConcept;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightCodeCodingSnomedBodyHeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyHeightCodeCodingSnomedBodyHeightCode record {|
    *r4:Coding;

    r4:Extension[] extension?;
    r4:code code = "50373000";
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: AUCoreBodyHeightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreBodyHeightValue record {|
    *r4:Quantity;

    AUCoreBodyHeightValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code;
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightCodeCodingBodyHeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyHeightCodeCodingBodyHeightCode record {|
    *r4:Coding;
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AUCoreBodyHeightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AUCoreBodyHeightCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    AUCoreBodyHeightCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type AUCoreBodyHeightComponent record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AUCoreBodyHeightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AUCoreBodyHeightReferenceRange record {|
    *r4:BackboneElement;
