...
public const string PROFILE_BASE_AUCORELOCATION = "http://hl7.org.au/fhir/core/StructureDefinition/au-core-location";
public const RESOURCE_NAME_AUCORELOCATION = "Location";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "hoursOfOperation" : {
            ...
            dataType: AUCoreLocationHoursOfOperation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "position" : {
            name: "position",
            dataType: AUCoreLocationPosition,
            min: 0,
            max: 1,
            isArray: false,
...
public type AUCoreLocation record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUCORELOCATION resourceType = RESOURCE_NAME_AUCORELOCATION;
    ...
    string description?;
    AUCoreLocationHoursOfOperation[] hoursOfOperation?;
    r4:code language?;
    r4:CodeableConcept[] 'type?;
    AUCoreLocationMode mode?;
    r4:Reference[] endpoint?;
    string[] alias?;
    r4:ContactPoint[] telecom?;
    string id?;
    r4:Narrative text?;
    aubase421:AuLocationspecificpracticenumber[]|r4:Identifier[]|aubase421:AuNatasitenumber[] identifier?;
    ...
    AUCoreLocationPosition position?;
    string availabilityExceptions?;
    AUCoreLocationStatus status?;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AUCoreLocationHoursOfOperation",
    baseType: (),
    elements: {
        "allDay": {
            name: "allDay",
        ...
        "daysOfWeek": {
            name: "daysOfWeek",
            dataType: AUCoreLocationHoursOfOperationDaysOfWeek,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AUCoreLocationHoursOfOperation record {|
    *r4:BackboneElement;
    ...
    r4:time openingTime?;
    string id?;
    AUCoreLocationHoursOfOperationDaysOfWeek[] daysOfWeek?;
|};
...
public type AUCoreLocationPosition record {|
    *r4:BackboneElement;
...
public enum AUCoreLocationStatus {
...
public enum AUCoreLocationHoursOfOperationDaysOfWeek {
...
public enum AUCoreLocationMode {
