...
public const string PROFILE_BASE_C4BBEXPLANATIONOFBENEFITINPATIENTINSTITUTIONALBASIS = "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit-Inpatient-Institutional-Basis";
public const RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITINPATIENTINSTITUTIONALBASIS = "ExplanationOfBenefit";

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasis resource record.
#
...
# 1) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoMedicalrecordnumber: Medical record number
# - min = 0
# - max = 1
#
# 2) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoClmrecvddate: Claim received date
# - min = 0
# - max = 1
#
# 3) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDrg: Diagnosis Related Group
# - min = 0
# - max = 1
#
# 4) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPatientaccountnumber: Patient account number
# - min = 0
# - max = 1
#
# 5) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmissionperiod: Admission Period
# - min = 1
# - max = 1
#
# 6) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDischarge_status: Discharge status
# - min = 0
# - max = 1
#
# 7) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoTypeofbill: Type of bill
# - min = 0
# - max = 1
#
# 8) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPointoforigin: Point of origin for admission
# - min = 0
# - max = 1
#
# 9) C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmtype: Admission type
# - min = 0
# - max = 1
#
...
# * identifier Slicings
# 1) C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUniqueclaimid: Unique Claim Identifier
# - min = 1
# - max = 1
#
...
# 1) C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBillingnetworkstatus: Billing provider network status
# - min = 0
# - max = 1
#
# 2) C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBenefitpaymentstatus: Indicates the in network or out of network payment status of the claim. (142)
# - min = 1
# - max = 1
#
# 3) C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationAdjustmentreason: Reason codes used to interpret the Non-Covered Amount (92)
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit-Inpatient-Institutional-Basis",
    elements: {
        "benefitPeriod": {
            name: "benefitPeriod",
            dataType: r4:Period,
        ...
        "insurance": {
            name: "insurance",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisInsurance,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "use": {
            name: "use",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisUse,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "processNote": {
            name: "processNote",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNote,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payee": {
            name: "payee",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisPayee,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "supportingInfo": {
            name: "supportingInfo",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payment": {
            name: "payment",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisPayment,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "careTeam": {
            name: "careTeam",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisCareTeam,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "item": {
            name: "item",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItem,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "diagnosis": {
            name: "diagnosis",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisDiagnosis,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "billablePeriod": {
            name: "billablePeriod",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisBillablePeriod,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "subType": {
            name: "subType",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSubType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status": {
            name: "status",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "benefitBalance": {
            name: "benefitBalance",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalance,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "accident": {
            name: "accident",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAccident,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "adjudication": {
            name: "adjudication",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "addItem": {
            name: "addItem",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "total": {
            name: "total",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisTotal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "related": {
            name: "related",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisRelated,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "outcome": {
            name: "outcome",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisOutcome,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "procedure": {
            name: "procedure",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisProcedure,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasis record {|
    *r4:DomainResource;

    RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITINPATIENTINSTITUTIONALBASIS resourceType = RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITINPATIENTINSTITUTIONALBASIS;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisInsurance[] insurance;
    r4:Reference claimResponse?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisUse use;
    r4:Extension[] modifierExtension?;
    string[] preAuthRef?;
    r4:code language?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisType 'type;
    r4:positiveInt precedence?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNote[] processNote?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisPayee payee?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo[] supportingInfo;
    r4:Reference claim?;
    r4:Reference enterer?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisPayment payment?;
    string id?;
    r4:Narrative text?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisCareTeam[] careTeam?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItem[] item;
    r4:dateTime created;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisDiagnosis[] diagnosis;
    r4:CodeableConcept priority?;
    r4:Period[] preAuthRefPeriod?;
    r4:Meta meta;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisBillablePeriod billablePeriod;
    r4:uri implicitRules?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSubType subType;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisStatus status;
    r4:Extension[] extension?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalance[] benefitBalance?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAccident accident?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication[] adjudication;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItem[] addItem?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisTotal[] total?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisRelated[] related?;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisOutcome outcome;
    r4:CodeableConcept formCode?;
    r4:Reference originalPrescription?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisProcedure[] procedure?;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalanceFinancial datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalanceFinancial",
    baseType: (),
    elements: {
        "allowedMoney": {
            name: "allowedMoney",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalanceFinancial record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingOne datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmissionperiod datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmissionperiod",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFour,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmissionperiod record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFour category;
    r4:Quantity valueQuantity?;
|};

# C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUse enum
public enum C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUse {
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAllowedunits datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAllowedunits",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAllowedunits record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryOne category;
    decimal value;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetail datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:Extension[] modifierExtension?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetailSubDetail[] subDetail?;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSubTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSubTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSubTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySix datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySix",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSix,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySix record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSix[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUniqueclaimid datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUniqueclaimid",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUniqueclaimid record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierType 'type;
    string value;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetailSubDetail datatype record.
#
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + quantity - The number of repetitions of a service or product.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetailSubDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDischarge_status datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDischarge_status",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFive,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDischarge_status record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFive category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisCareTeam datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisCareTeam",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisCareTeam record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingEight datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingEight",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingEight record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalance datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalance",
    baseType: (),
    elements: {
        "excluded": {
            name: "excluded",
        ...
        "financial": {
            name: "financial",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalanceFinancial,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalance record {|
    *r4:BackboneElement;

    boolean excluded?;
    r4:Extension[] extension?;
    r4:CodeableConcept unit?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisBenefitBalanceFinancial[] financial?;
    r4:Extension[] modifierExtension?;
    string name?;
    string description?;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoMedicalrecordnumber datatype record.
#
# + timingDate - The date when or period to which this information refers.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + sequence - A number to uniquely identify supporting information entries.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoMedicalrecordnumber",
    baseType: (),
    elements: {
        "timingDate": {
            name: "timingDate",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoMedicalrecordnumber record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategory category;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBenefitpaymentstatus datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBenefitpaymentstatus",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBenefitpaymentstatus record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryOne category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisIdentifierTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryEight datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryEight",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingEight,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryEight record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingEight[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSubType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSubType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSubTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSubType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSubTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisRelated datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisRelated",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisRelated record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisTotal datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisTotal",
    baseType: (),
    elements: {
        "amount": {
            name: "amount",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisTotal record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetailSubDetail datatype record.
#
# + adjudication - The adjudication results.
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisPayment datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisPayment",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisPayment record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDrg datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDrg",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoDrg record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryTwo category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPatientaccountnumber datatype record.
#
# + timingDate - The date when or period to which this information refers.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + sequence - A number to uniquely identify supporting information entries.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPatientaccountnumber",
    baseType: (),
    elements: {
        "timingDate": {
            name: "timingDate",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryThree,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPatientaccountnumber record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryThree category;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFive datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFive",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFive record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationAdjustmentreason datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationAdjustmentreason",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationAdjustmentreason record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryTwo category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisProcedure datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisProcedure",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisProcedure record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFour datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFour",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFour record {|
    *r4:Coding;
...
# C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNoteType enum
public enum C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNoteType {
    CODE_TYPE_PRINT = "print",
    CODE_TYPE_DISPLAY = "display",
    CODE_TYPE_PRINTOPER = "printoper"
}

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisDiagnosis datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisDiagnosis",
    baseType: (),
    elements: {
        "sequence": {
            name: "sequence",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisDiagnosis record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryTwo datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingTwo[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBillingnetworkstatus datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBillingnetworkstatus",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationBillingnetworkstatus record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategory category;
    decimal value?;
|};

# C4BBExplanationOfBenefitInpatientInstitutionalBasisUse enum
public enum C4BBExplanationOfBenefitInpatientInstitutionalBasisUse {
    CODE_USE_PREDETERMINATION = "predetermination",
    CODE_USE_PREAUTHORIZATION = "preauthorization",
    CODE_USE_CLAIM = "claim"
}

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoTypeofbill datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoTypeofbill",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySix,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoTypeofbill record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySix category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisBillablePeriod datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisBillablePeriod",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisBillablePeriod record {|
    *r4:Period;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFour datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFour",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFour,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFour record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFour[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingTwo datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingTwo record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetail datatype record.
#
# + adjudication - The adjudication results.
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetailSubDetail[] subDetail?;
    string id?;
    r4:CodeableConcept productOrService;
    decimal factor?;
    r4:Money net?;
...
# C4BBExplanationOfBenefitInpatientInstitutionalBasisOutcome enum
public enum C4BBExplanationOfBenefitInpatientInstitutionalBasisOutcome {
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryTwo datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingTwo[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingThree datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingThree",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingThree record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSeven datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSeven",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSeven record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItem datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifier - Item typification or modifiers codes to convey additional context for the product or service.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItem",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "adjudication": {
            name: "adjudication",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "detail": {
            name: "detail",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItem record {|
    *r4:BackboneElement;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication[] adjudication?;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemDetail[] detail?;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryThree datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryThree",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingThree,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryThree record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingThree[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoClmrecvddate datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoClmrecvddate",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoClmrecvddate record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryOne category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySeven datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySeven",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSeven,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySeven record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSeven[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisInsurance datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisInsurance",
    baseType: (),
    elements: {
        "coverage": {
            name: "coverage",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisInsurance record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingTwo datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingTwo record {|
    *r4:Coding;
...
# C4BBExplanationOfBenefitInpatientInstitutionalBasisStatus enum
public enum C4BBExplanationOfBenefitInpatientInstitutionalBasisStatus {
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAccident datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAccident",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAccident record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisPayee datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisPayee",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisPayee record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItem datatype record.
#
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + quantity - The number of repetitions of a service or product.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItem",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "detail": {
            name: "detail",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItem record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] subSite?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisAddItemDetail[] detail?;
    string id?;
    r4:Reference locationReference?;
    r4:date servicedDate?;
    decimal factor?;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAdjustmentreason datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAdjustmentreason",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationAdjustmentreason record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategory category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSix datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSix",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingSix record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPointoforigin datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPointoforigin",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySeven,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoPointoforigin record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategorySeven category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudicationCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmtype datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmtype",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryEight,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoAdmtype record {|
    *C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryEight category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNote datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNote",
    baseType: (),
    elements: {
        "number": {
            name: "number",
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNoteType,
            min: 0,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNote record {|
    *r4:BackboneElement;
    ...
    string id?;
    string text?;
    C4BBExplanationOfBenefitInpatientInstitutionalBasisProcessNoteType 'type?;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFive datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFive",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFive,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryFive record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfoCategoryCodingFive[] coding;
|};

# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisSupportingInfo record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisItemAdjudication record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitInpatientInstitutionalBasisAdjudicationCategoryCoding record {|
    *r4:Coding;
