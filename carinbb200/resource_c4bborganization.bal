...
#       - max = *
#
# 3) C4BBOrganizationIdentifierTax: Tax ID Number
#       - min = 0
#       - max = *
#
# 4) C4BBOrganizationIdentifierNaiccode: NAIC Code
#       - min = 0
#       - max = *
#
...
# FHIR C4BBOrganizationIdentifierNaiccode datatype record.
#
# + system - Establishes the namespace for the value - that is, a URL that describes a set values that are unique.
# + 'type - A coded type for the identifier that can be used to determine which identifier to use for a specific purpose.
@r4:DataTypeDefinition {
    name: "C4BBOrganizationIdentifierNaiccode",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBOrganizationIdentifierNaiccode record {|
    *r4:Identifier;
