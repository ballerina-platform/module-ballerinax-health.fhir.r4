...
public const string PROFILE_BASE_C4BBEXPLANATIONOFBENEFITOUTPATIENTINSTITUTIONALBASIS = "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit-Outpatient-Institutional-Basis";
public const RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITOUTPATIENTINSTITUTIONALBASIS = "ExplanationOfBenefit";

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasis resource record.
#
...
# 1) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoMedicalrecordnumber: Medical record number
# - min = 0
# - max = 1
#
# 2) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoClmrecvddate: Claim received date
# - min = 0
# - max = 1
#
# 3) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPatientaccountnumber: Patient account number
# - min = 0
# - max = 1
#
# 4) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoDischarge_status: Discharge status
# - min = 0
# - max = 1
#
# 5) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoTypeofbill: Type of bill
# - min = 0
# - max = 1
#
# 6) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPointoforigin: Point of origin for admission or visit
# - min = 0
# - max = 1
#
# 7) C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoAdmtype: Admission type
# - min = 0
# - max = 1
#
...
# * identifier Slicings
# 1) C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUniqueclaimid: Unique Claim Identifier
# - min = 1
# - max = 1
#
...
# 1) C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBillingnetworkstatus: Billing provider networking status
# - min = 0
# - max = 1
#
# 2) C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBenefitpaymentstatus: Indicates the in network or out of network payment status of the claim. (142)
# - min = 1
# - max = 1
#
# 3) C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationAdjustmentreason: Reason codes used to interpret the Non-Covered Amount (92)
# - min = 0
# - max = *
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit-Outpatient-Institutional-Basis",
    elements: {
        "benefitPeriod": {
            name: "benefitPeriod",
            dataType: r4:Period,
        ...
        "insurance": {
            name: "insurance",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisInsurance,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "use": {
            name: "use",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisUse,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "processNote": {
            name: "processNote",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNote,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payee": {
            name: "payee",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayee,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "supportingInfo": {
            name: "supportingInfo",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "payment": {
            name: "payment",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayment,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "careTeam": {
            name: "careTeam",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisCareTeam,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "item": {
            name: "item",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItem,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "diagnosis": {
            name: "diagnosis",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisDiagnosis,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "subType": {
            name: "subType",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status": {
            name: "status",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "benefitBalance": {
            name: "benefitBalance",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalance,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "accident": {
            name: "accident",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAccident,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "adjudication": {
            name: "adjudication",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "addItem": {
            name: "addItem",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItem,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "total": {
            name: "total",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisTotal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "related": {
            name: "related",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisRelated,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "outcome": {
            name: "outcome",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisOutcome,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "procedure": {
            name: "procedure",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcedure,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasis record {|
    *r4:DomainResource;

    RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITOUTPATIENTINSTITUTIONALBASIS resourceType = RESOURCE_NAME_C4BBEXPLANATIONOFBENEFITOUTPATIENTINSTITUTIONALBASIS;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisInsurance[] insurance;
    r4:Reference claimResponse?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisUse use;
    r4:Extension[] modifierExtension?;
    string[] preAuthRef?;
    r4:code language?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisType 'type;
    r4:positiveInt precedence?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNote[] processNote?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayee payee?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo[] supportingInfo?;
    r4:Reference claim?;
    r4:Reference enterer?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayment payment?;
    string id?;
    r4:Narrative text?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisCareTeam[] careTeam?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItem[] item;
    r4:dateTime created;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisDiagnosis[] diagnosis;
    r4:CodeableConcept priority?;
    r4:Period[] preAuthRefPeriod?;
    r4:Meta meta;
    r4:Period billablePeriod;
    r4:uri implicitRules?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubType subType;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisStatus status;
    r4:Extension[] extension?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalance[] benefitBalance?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAccident accident?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication[] adjudication;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItem[] addItem?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisTotal[] total?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisRelated[] related?;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisOutcome outcome;
    r4:CodeableConcept formCode?;
    r4:Reference originalPrescription?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcedure[] procedure?;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFive datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFive",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFive record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisRelated datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisRelated",
    baseType: (),
    elements: {
        "reference": {
            name: "reference",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisRelated record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisCareTeam datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisCareTeam",
    baseType: (),
    elements: {
        "qualification": {
            name: "qualification",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisCareTeam record {|
    *r4:BackboneElement;
...
# C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNoteType enum
public enum C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNoteType {
    CODE_TYPE_PRINT = "print",
    CODE_TYPE_DISPLAY = "display",
    CODE_TYPE_PRINTOPER = "printoper"
}

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryThree datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryThree",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingThree,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryThree record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingThree[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFive datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFive",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFive,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFive record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFive[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoClmrecvddate datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoClmrecvddate",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoClmrecvddate record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryOne category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBillingnetworkstatus datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBillingnetworkstatus",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBillingnetworkstatus record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategory category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNote datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNote",
    baseType: (),
    elements: {
        "number": {
            name: "number",
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNoteType,
            min: 0,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNote record {|
    *r4:BackboneElement;
    ...
    string id?;
    string text?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcessNoteType 'type?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoDischarge_status datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoDischarge_status",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryThree,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoDischarge_status record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryThree category;
    r4:Quantity valueQuantity?;
|};

# C4BBExplanationOfBenefitOutpatientInstitutionalBasisStatus enum
public enum C4BBExplanationOfBenefitOutpatientInstitutionalBasisStatus {
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFour datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFour",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFour,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFour record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFour[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingTwo datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingTwo record {|
    *r4:Coding;
...
# C4BBExplanationOfBenefitOutpatientInstitutionalBasisUse enum
public enum C4BBExplanationOfBenefitOutpatientInstitutionalBasisUse {
    CODE_USE_PREDETERMINATION = "predetermination",
    CODE_USE_PREAUTHORIZATION = "preauthorization",
    CODE_USE_CLAIM = "claim"
}

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisTotal datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisTotal",
    baseType: (),
    elements: {
        "amount": {
            name: "amount",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisTotal record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingTwo datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingTwo record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAllowedunits datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAllowedunits",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAllowedunits record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryOne category;
    decimal value;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcedure datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcedure",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisProcedure record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetailSubDetail datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetailSubDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBenefitpaymentstatus datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBenefitpaymentstatus",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationBenefitpaymentstatus record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryOne category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalanceFinancial datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalanceFinancial",
    baseType: (),
    elements: {
        "allowedMoney": {
            name: "allowedMoney",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalanceFinancial record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingSix datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingSix",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingSix record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetail datatype record.
#
# + adjudication - The adjudication results.
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetail",
    baseType: (),
    elements: {
        "adjudication": {
            name: "adjudication",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetailSubDetail[] subDetail?;
    string id?;
    r4:CodeableConcept productOrService;
    decimal factor?;
    r4:Money net?;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayment datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayment",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayment record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategory datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategory",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategory record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUniqueclaimid datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUniqueclaimid",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUniqueclaimid record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierType 'type;
    string value;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayee datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayee",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisPayee record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalance datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalance",
    baseType: (),
    elements: {
        "excluded": {
            name: "excluded",
        ...
        "financial": {
            name: "financial",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalanceFinancial,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalance record {|
    *r4:BackboneElement;

    boolean excluded?;
    r4:Extension[] extension?;
    r4:CodeableConcept unit?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisBenefitBalanceFinancial[] financial?;
    r4:Extension[] modifierExtension?;
    string name?;
    string description?;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationAdjustmentreason datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationAdjustmentreason",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationAdjustmentreason record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryTwo category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetailSubDetail datatype record.
#
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + quantity - The number of repetitions of a service or product.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetailSubDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetailSubDetail record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubType record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubTypeCoding[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAccident datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAccident",
    baseType: (),
    elements: {
        "date": {
            name: "date",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAccident record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAdjustmentreason datatype record.
#
# + reason - A code supporting the understanding of the adjudication result and explaining variance from expected amount.
# + amount - Monetary amount associated with the category.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAdjustmentreason",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "A code to indicate the information type of this adjudication record. Information types may include: the value submitted, maximum values or percentages allowed or payable under the plan, amounts that the patient is responsible for in-aggregate or pertaining to this item, amounts paid by other coverages, and the benefit payable for this item.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationAdjustmentreason record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategory category;
    decimal value?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoMedicalrecordnumber datatype record.
#
# + timingDate - The date when or period to which this information refers.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + sequence - A number to uniquely identify supporting information entries.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoMedicalrecordnumber",
    baseType: (),
    elements: {
        "timingDate": {
            name: "timingDate",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategory,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoMedicalrecordnumber record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategory category;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPointoforigin datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPointoforigin",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFive,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPointoforigin record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFive category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryTwo datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingTwo[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisInsurance datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisInsurance",
    baseType: (),
    elements: {
        "coverage": {
            name: "coverage",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisInsurance record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItem datatype record.
#
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + quantity - The number of repetitions of a service or product.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItem",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "detail": {
            name: "detail",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItem record {|
    *r4:BackboneElement;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisAddItemDetail[] detail?;
    string id?;
    r4:Reference locationReference?;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingThree datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingThree",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingThree record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItem datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifier - Item typification or modifiers codes to convey additional context for the product or service.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItem",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "adjudication": {
            name: "adjudication",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "detail": {
            name: "detail",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItem record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept productOrService;
    r4:positiveInt[] noteNumber?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudication[] adjudication?;
    ...
    r4:CodeableConcept bodySite?;
    r4:CodeableConcept[] subSite?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetail[] detail?;
    r4:date servicedDate?;
    r4:Reference[] udi?;
    r4:CodeableConcept category?;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetail datatype record.
#
# + unitPrice - If the item is not a group then this is the fee for the product or service, otherwise this is the total of the fees for the details of the group.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + quantity - The number of repetitions of a service or product.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetail",
    baseType: (),
    elements: {
        "unitPrice": {
            name: "unitPrice",
        ...
        "subDetail": {
            name: "subDetail",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetailSubDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetail record {|
    *r4:BackboneElement;
    ...
    r4:CodeableConcept[] modifier?;
    r4:Extension[] modifierExtension?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemDetailSubDetail[] subDetail?;
    r4:CodeableConcept productOrService;
    r4:positiveInt[] noteNumber?;
    international401:ExplanationOfBenefitItemAdjudication[] adjudication?;
    r4:positiveInt sequence;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSubTypeCoding record {|
    *r4:Coding;
...
# C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUse enum
public enum C4BBExplanationOfBenefitOutpatientInstitutionalBasisIdentifierUse {
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPatientaccountnumber datatype record.
#
# + timingDate - The date when or period to which this information refers.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + sequence - A number to uniquely identify supporting information entries.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPatientaccountnumber",
    baseType: (),
    elements: {
        "timingDate": {
            name: "timingDate",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoPatientaccountnumber record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    r4:Extension[] modifierExtension?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryTwo category;
|};

# C4BBExplanationOfBenefitOutpatientInstitutionalBasisOutcome enum
public enum C4BBExplanationOfBenefitOutpatientInstitutionalBasisOutcome {
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCodingOne record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryTwo datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryTwo record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingTwo[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisDiagnosis datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisDiagnosis",
    baseType: (),
    elements: {
        "sequence": {
            name: "sequence",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisDiagnosis record {|
    *r4:BackboneElement;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoTypeofbill datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoTypeofbill",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFour,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoTypeofbill record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryFour category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategorySix datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategorySix",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingSix,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategorySix record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingSix[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisAdjudicationCategoryCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisItemAdjudicationCategoryCoding record {|
    *r4:Coding;
...
# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryOne record {|
    *r4:CodeableConcept;
    ...
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingOne[] coding;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoAdmtype datatype record.
#
# + valueBoolean - Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
# + reason - Provides the reason in the situation where a reason code is required in addition to the content.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoAdmtype",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "category": {
            name: "category",
            dataType: C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategorySix,
            min: 1,
            max: 1,
            isArray: false,
            description: "The general class of the information supplied: information; exception; accident, employment; onset, etc.",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoAdmtype record {|
    *C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfo;
    ...
    string valueString?;
    string id?;
    C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategorySix category;
    r4:Quantity valueQuantity?;
|};

# FHIR C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFour datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFour",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBExplanationOfBenefitOutpatientInstitutionalBasisSupportingInfoCategoryCodingFour record {|
    *r4:Coding;
