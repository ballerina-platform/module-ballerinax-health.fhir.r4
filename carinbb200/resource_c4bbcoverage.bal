...
public const string PROFILE_BASE_C4BBCOVERAGE = "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-Coverage";
public const RESOURCE_NAME_C4BBCOVERAGE = "Coverage";

# FHIR C4BBCoverage resource record.
#
...
# * class Slicings
# 1) C4BBCoverageClassPlan: (USCDI) Plan
#       - min = 0
#       - max = 1
#
# 2) C4BBCoverageClassGroup: (USCDI) Group
#       - min = 0
#       - max = 1
#
...
# * identifier Slicings
# 1) C4BBCoverageIdentifierMemberid: (USCDI) Member ID
# - min = 0
# - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "costToBeneficiary" : {
            ...
            dataType: C4BBCoverageCostToBeneficiary,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBCoverage record {|
    *r4:DomainResource;

    RESOURCE_NAME_C4BBCOVERAGE resourceType = RESOURCE_NAME_C4BBCOVERAGE;
    ...
    C4BBCoverageClass[] 'class?;
    string dependent?;
    r4:positiveInt 'order?;
    r4:Identifier[] identifier?;
    C4BBCoverageCostToBeneficiary[] costToBeneficiary?;
    r4:Period period?;
    ...
    C4BBCoverageMeta meta;
    r4:uri implicitRules?;
    r4:Reference policyHolder?;
    C4BBCoverageStatus status;
    r4:Element ...;
|};

# FHIR C4BBCoverageCostToBeneficiaryException datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBCoverageCostToBeneficiaryException",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type C4BBCoverageCostToBeneficiaryException record {|
    *r4:BackboneElement;
...
# FHIR C4BBCoverageClassPlan datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: C4BBCoverageClassType,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBCoverageClassPlan record {|
    *C4BBCoverageClass;
    ...
    string name?;
    string id?;
    C4BBCoverageClassType 'type;
    string value;
|};

# FHIR C4BBCoverageClassTypeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBCoverageClassTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBCoverageClassTypeCoding record {|
    *r4:Coding;
...
# FHIR C4BBCoverageClassGroup datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + name - A short description for the class.
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: C4BBCoverageClassTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of classification for which an insurer-specific class label or number and optional name is provided, for example may be used to identify a class of coverage or employer group, Policy, Plan.",
...
public type C4BBCoverageClassGroup record {|
    *C4BBCoverageClass;
    ...
    string name?;
    string id?;
    C4BBCoverageClassTypeOne 'type;
    string value;
|};

# FHIR C4BBCoverageClass datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + name - A short description for the class.
...
public type C4BBCoverageClass record {|
    *r4:BackboneElement;
...
# FHIR C4BBCoverageIdentifierMemberid datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "C4BBCoverageIdentifierMemberid",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "use": {
            name: "use",
            dataType: C4BBCoverageIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: C4BBCoverageIdentifierType,
            min: 1,
            max: 1,
            isArray: false,
...
public type C4BBCoverageIdentifierMemberid record {|
    *r4:Identifier;

    r4:Extension[] extension?;
    r4:Period period?;
    r4:uri system?;
    C4BBCoverageIdentifierUse use?;
    r4:Reference assigner?;
    string id?;
    C4BBCoverageIdentifierType 'type;
    string value?;
|};

# FHIR C4BBCoverageIdentifierTypeCoding datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBCoverageIdentifierTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBCoverageIdentifierTypeCoding record {|
    *r4:Coding;
...
# C4BBCoverageIdentifierUse enum
public enum C4BBCoverageIdentifierUse {
...
# FHIR C4BBCoverageCostToBeneficiary datatype record.
#
...
@r4:DataTypeDefinition {
    name: "C4BBCoverageCostToBeneficiary",
    baseType: (),
    elements: {
        "exception": {
            name: "exception",
            dataType: C4BBCoverageCostToBeneficiaryException,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBCoverageCostToBeneficiary record {|
    *r4:BackboneElement;

    C4BBCoverageCostToBeneficiaryException[] exception?;
    r4:Extension[] extension?;
    r4:Money valueMoney?;
    r4:Extension[] modifierExtension?;
    string id?;
...
# FHIR C4BBCoverageMeta datatype record.
#
...
public type C4BBCoverageMeta record {|
    *r4:Meta;
...
# FHIR C4BBCoverageIdentifierType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBCoverageIdentifierType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBCoverageIdentifierTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type C4BBCoverageIdentifierType record {|
    *r4:CodeableConcept;
    ...
    C4BBCoverageIdentifierTypeCoding[] coding;
|};

# FHIR C4BBCoverageClassType datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBCoverageClassType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBCoverageClassTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBCoverageClassType record {|
    *r4:CodeableConcept;
...
# FHIR C4BBCoverageClassTypeOne datatype record.
#
# + coding - A reference to a code defined by a terminology system.

@r4:DataTypeDefinition {
    name: "C4BBCoverageClassTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: C4BBCoverageClassTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type C4BBCoverageClassTypeOne record {|
    *r4:CodeableConcept;
...
# FHIR C4BBCoverageClassTypeCodingOne datatype record.
#
# + system - The identification of the code system that defines the meaning of the symbol in the code.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).

@r4:DataTypeDefinition {
    name: "C4BBCoverageClassTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type C4BBCoverageClassTypeCodingOne record {|
    *r4:Coding;
...
# C4BBCoverageStatus enum
public enum C4BBCoverageStatus {
