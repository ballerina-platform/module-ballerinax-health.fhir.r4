...
public const string PROFILE_BASE_USCOREOBSERVATIONSURVEYPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-survey";
public const RESOURCE_NAME_USCOREOBSERVATIONSURVEYPROFILE = "Observation";

# FHIR USCoreObservationSurveyProfile resource record.
#
...
# * category Slicings
# 1) USCoreObservationSurveyProfileCategorySurvey: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationSurveyProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationSurveyProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationSurveyProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationSurveyProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONSURVEYPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONSURVEYPROFILE;
    ...
    USCoreObservationSurveyProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationSurveyProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreObservationSurveyProfileStatus status;
    r4:Element ...;
|};

# FHIR USCoreObservationSurveyProfileCategorySurvey datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationSurveyProfileCategorySurvey",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationSurveyProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreObservationSurveyProfileCategorySurvey record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationSurveyProfileCategoryCoding[] coding;
|};

# FHIR USCoreObservationSurveyProfileComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreObservationSurveyProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationSurveyProfileComponent record {|
    *r4:BackboneElement;
...
public enum USCoreObservationSurveyProfileStatus {
...
# FHIR USCoreObservationSurveyProfileCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreObservationSurveyProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationSurveyProfileCategoryCoding record {|
    *r4:Coding;
...
# FHIR USCoreObservationSurveyProfileReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "USCoreObservationSurveyProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationSurveyProfileReferenceRange record {|
    *r4:BackboneElement;
