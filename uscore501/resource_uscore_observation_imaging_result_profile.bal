...
public const string PROFILE_BASE_USCOREOBSERVATIONIMAGINGRESULTPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-imaging";
public const RESOURCE_NAME_USCOREOBSERVATIONIMAGINGRESULTPROFILE = "Observation";

# FHIR USCoreObservationImagingResultProfile resource record.
#
...
# + code - The name of the imaging test performed on a patient. A LOINC **SHALL** be used if the concept is present in LOINC.
...
# * category Slicings
# 1) USCoreObservationImagingResultProfileCategoryImaging: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/us/core/StructureDefinition/us-core-observation-imaging",
    elements: {
        "valueBoolean" : {
            name: "valueBoolean",
            dataType: boolean,
        ...
        "component" : {
            name: "component",
            dataType: USCoreObservationImagingResultProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreObservationImagingResultProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreObservationImagingResultProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreObservationImagingResultProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREOBSERVATIONIMAGINGRESULTPROFILE resourceType = RESOURCE_NAME_USCOREOBSERVATIONIMAGINGRESULTPROFILE;
    ...
    USCoreObservationImagingResultProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreObservationImagingResultProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    USCoreObservationImagingResultProfileStatus status;
    r4:Element ...;
|};

# FHIR USCoreObservationImagingResultProfileCategoryCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreObservationImagingResultProfileCategoryCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreObservationImagingResultProfileCategoryCoding record {|
    *r4:Coding;
...
# FHIR USCoreObservationImagingResultProfileComponent datatype record.
#
# + valueBoolean - The information determined as a result of making the observation, if the information has a simple value.
...
# + valueQuantity - The information determined as a result of making the observation, if the information has a simple value.
@r4:DataTypeDefinition {
    name: "USCoreObservationImagingResultProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreObservationImagingResultProfileComponent record {|
    *r4:BackboneElement;
...
public enum USCoreObservationImagingResultProfileStatus {
...
# FHIR USCoreObservationImagingResultProfileReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "USCoreObservationImagingResultProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreObservationImagingResultProfileReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR USCoreObservationImagingResultProfileCategoryImaging datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreObservationImagingResultProfileCategoryImaging",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreObservationImagingResultProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreObservationImagingResultProfileCategoryImaging record {|
    *r4:CodeableConcept;
    ...
    USCoreObservationImagingResultProfileCategoryCoding[] coding;
|};
