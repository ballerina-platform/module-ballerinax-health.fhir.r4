...
public const string PROFILE_BASE_USCOREDIAGNOSTICREPORTPROFILELABORATORYREPORTING = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab";
public const RESOURCE_NAME_USCOREDIAGNOSTICREPORTPROFILELABORATORYREPORTING = "DiagnosticReport";
...
# + code - The test, panel or battery that was ordered.
...
# + LaboratorySlice - A code that classifies the clinical discipline, department or diagnostic service that created the report (e.g. cardiology, biochemistry, hematology, MRI). This is used for searching, sorting and display purposes.
...
# + effectivePeriod - This is the Specimen Collection Datetime or Period which is the physically relevent dateTime for laboratory tests.
...
# + effectiveDateTime - This is the Specimen Collection Datetime or Period which is the physically relevent dateTime for laboratory tests.
...
@r4:ResourceDefinition {
    resourceType: "USCoreDiagnosticReportProfileLaboratoryReporting",
...
public type USCoreDiagnosticReportProfileLaboratoryReporting record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREDIAGNOSTICREPORTPROFILELABORATORYREPORTING resourceType = RESOURCE_NAME_USCOREDIAGNOSTICREPORTPROFILELABORATORYREPORTING;

    BaseUSCoreDiagnosticReportProfileLaboratoryReportingMeta meta = {
        profile : [PROFILE_BASE_USCOREDIAGNOSTICREPORTPROFILELABORATORYREPORTING]
    };
    ...
    r4:CodeableConcept LaboratorySlice;
    string conclusion?;
    r4:Reference[] result?;
...
@r4:DataTypeDefinition {
    name: "BaseUSCoreDiagnosticReportProfileLaboratoryReportingMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
...
public type BaseUSCoreDiagnosticReportProfileLaboratoryReportingMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
