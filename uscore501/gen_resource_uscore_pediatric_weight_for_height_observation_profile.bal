...
@r4:ResourceDefinition {
    resourceType: "USCorePediatricWeightForHeightObservationProfile",
...
public type USCorePediatricWeightForHeightObservationProfile record {|
    *r4:DomainResource;
...
@r4:DataTypeDefinition {
    name: "BaseUSCorePediatricWeightForHeightObservationProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
...
# ObservationValue[x]Comparator enum
public enum ObservationValueComparator {
