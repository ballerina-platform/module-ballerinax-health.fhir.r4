...
public type USCoreSmokingStatusProfile record {|
    *r4:DomainResource;
    ...
    BaseUSCoreSmokingStatusProfileMeta meta = {
        profile : [PROFILE_BASE_USCORESMOKINGSTATUSPROFILE]
    };
...
public type BaseUSCoreSmokingStatusProfileMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-smokingstatus"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
