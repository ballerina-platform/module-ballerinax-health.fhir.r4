...
@r4:ResourceDefinition {
    resourceType: "USCorePediatricBMIforAgeObservationProfile",
...
public type USCorePediatricBMIforAgeObservationProfile record {|
    *r4:DomainResource;
    ...
    BaseUSCorePediatricBMIforAgeObservationProfileMeta meta = {
        profile : [PROFILE_BASE_USCOREPEDIATRICBMIFORAGEOBSERVATIONPROFILE]
    };
...
@r4:DataTypeDefinition {
    name: "BaseUSCorePediatricBMIforAgeObservationProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
...
public type BaseUSCorePediatricBMIforAgeObservationProfileMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/pediatric-bmi-for-age"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
...
# ObservationValue[x]ComparatorOne enum
public enum ObservationValueComparatorOne {
