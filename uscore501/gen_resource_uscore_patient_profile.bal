...
public const string PROFILE_BASE_USCOREPATIENTPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-patient";
public const RESOURCE_NAME_USCOREPATIENTPROFILE = "Patient";
...
# + birthsex - A code classifying the person's sex assigned at birth as specified by the [Office of the National Coordinator for Health IT (ONC)](https://www.healthit.gov/newsroom/about-onc).
# + maritalStatus - This field contains a patient's most recent marital (civil) status.
@r4:ResourceDefinition {
    resourceType: "USCorePatientProfile",
...
public type USCorePatientProfile record {|
    *r4:DomainResource;
    ...
    r4:Extension birthsex?;
    r4:CodeableConcept maritalStatus?;
|};

@r4:DataTypeDefinition {
    name: "BaseUSCorePatientProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
