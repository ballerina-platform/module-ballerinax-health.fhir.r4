...
# + FlowRate - Used when reporting component observation such as systolic and diastolic blood pressure.
...
# + Concentration - Used when reporting component observation such as systolic and diastolic blood pressure.
...
@r4:ResourceDefinition {
    resourceType: "USCorePulseOximetryProfile",
...
public type USCorePulseOximetryProfile record {|
    *r4:DomainResource;
    ...
    r4:BackboneElement Concentration?;
...
@r4:DataTypeDefinition {
    name: "BaseUSCorePulseOximetryProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
