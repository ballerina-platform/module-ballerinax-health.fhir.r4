...
public const string PROFILE_BASE_USCORESERVICEREQUESTPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-servicerequest";
public const RESOURCE_NAME_USCORESERVICEREQUESTPROFILE = "ServiceRequest";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "priority" : {
            name: "priority",
            dataType: USCoreServiceRequestProfilePriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: USCoreServiceRequestProfileIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: USCoreServiceRequestProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreServiceRequestProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCORESERVICEREQUESTPROFILE resourceType = RESOURCE_NAME_USCORESERVICEREQUESTPROFILE;
    ...
    USCoreServiceRequestProfilePriority priority?;
    USCoreServiceRequestProfileIntent intent;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.ServiceRequest.category constraint. This field must be an array containing at least one item."
        }
    }
    r4:CodeableConcept[] category;
    r4:CodeableConcept[] locationCode?;
    string patientInstruction?;
    USCoreServiceRequestProfileStatus status;
    r4:Element ...;
|};

# USCoreServiceRequestProfileIntent enum
public enum USCoreServiceRequestProfileIntent {
...
public enum USCoreServiceRequestProfileStatus {
...
public enum USCoreServiceRequestProfilePriority {
