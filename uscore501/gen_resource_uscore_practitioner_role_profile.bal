...
public type USCorePractitionerRoleProfile record {|
    *r4:DomainResource;
    ...
    BaseUSCorePractitionerRoleProfileMeta meta = {
        profile : [PROFILE_BASE_USCOREPRACTITIONERROLEPROFILE]
    };
...
public type BaseUSCorePractitionerRoleProfileMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitionerrole"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
