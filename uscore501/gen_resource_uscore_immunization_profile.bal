...
public type USCoreImmunizationProfile record {|
    *r4:DomainResource;
    ...
    BaseUSCoreImmunizationProfileMeta meta = {
        profile : [PROFILE_BASE_USCOREIMMUNIZATIONPROFILE]
    };
    r4:Annotation[] note?;
...
public type BaseUSCoreImmunizationProfileMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-immunization"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
