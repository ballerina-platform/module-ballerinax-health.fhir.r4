...
# + Laboratory - A code that classifies the general type of observation being made.
...
@r4:ResourceDefinition {
    resourceType: "USCoreLaboratoryResultObservationProfile",
...
@r4:DataTypeDefinition {
    name: "BaseUSCoreLaboratoryResultObservationProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
