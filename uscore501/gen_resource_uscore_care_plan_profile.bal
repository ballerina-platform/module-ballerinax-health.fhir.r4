...
@r4:ResourceDefinition {
    resourceType: "USCoreCarePlanProfile",
...
public type USCoreCarePlanProfile record {|
    *r4:DomainResource;
    ...
    BaseUSCoreCarePlanProfileMeta meta = {
        profile : [PROFILE_BASE_USCORECAREPLANPROFILE]
    };
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
...
@r4:DataTypeDefinition {
    name: "BaseUSCoreCarePlanProfileMeta",
    baseType: r4:Meta,
    elements: {},
    serializers: {
...
public type BaseUSCoreCarePlanProfileMeta record {|
    *r4:Meta;
    ...
    r4:uri 'source?;
    r4:canonical[] profile = ["http://hl7.org/fhir/us/core/StructureDefinition/us-core-careplan"];
    r4:Coding[] security?;
    r4:Coding[] tag?;
|};
