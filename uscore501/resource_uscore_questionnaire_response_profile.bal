...
# * extension Slicings
# 1) Extension: A signature attesting to the content
#       - min = 0
#       - max = *
#
# 2) Extension: E.g. Verbal, written, electronic
#       - min = 0
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "questionnaire" : {
            name: "questionnaire",
            dataType: USCoreQuestionnaireResponseProfileQuestionnaire,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreQuestionnaireResponseProfile record {|
    *r4:DomainResource;
    ...
    USCoreQuestionnaireResponseProfileQuestionnaire questionnaire;
    r4:Reference author?;
...
# + ordinalValue - A numeric value that allows the comparison (less than, greater than) or other numerical manipulation of a concept (e.g. Adding up components of a score). Scores are usually a whole number, but occasionally decimals are encountered in scores.
# + itemAnswerMedia - Media to render/make available as an accompaniment to a specific answer option
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type USCoreQuestionnaireResponseProfileItemAnswer record {|
    *r4:BackboneElement;
    ...
    r4:Extension ordinalValue?;
    r4:Extension itemAnswerMedia?;
    string id?;
