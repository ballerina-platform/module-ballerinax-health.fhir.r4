...
public const string PROFILE_BASE_USCORELOCATION = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-location";
public const RESOURCE_NAME_USCORELOCATION = "Location";
...
public type USCoreLocation record {|
    *r4:DomainResource;
