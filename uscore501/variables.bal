...
//Number of search params in USCORE_IG_SEARCH_PARAMS_1  = 98
final readonly & map<r4:FHIRSearchParameterDefinition[]> USCORE_IG_SEARCH_PARAMS_1 = {
    ...
    "USCorePatientGenderIdentity": [
        {
            ...
            'type: r4:TOKEN,
            base: ["Patient"],
            expression: "Patient.extension.where(url = 'http://hl7.org/fhir/StructureDefinition/patient-genderIdentity').extension.value.code"
        }
    ],
    ...
    "USCoreQuestionnaireresponseTag": [
        {
            name: "USCoreQuestionnaireresponseTag",
            'type: r4:TOKEN,
            base: ["QuestionnaireResponse"],
