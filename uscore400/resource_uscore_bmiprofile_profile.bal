...
public const string PROFILE_BASE_USCOREBMIPROFILEPROFILE = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi";
public const RESOURCE_NAME_USCOREBMIPROFILEPROFILE = "Observation";

# FHIR USCoreBMIProfileProfile resource record.
#
...
# * category Slicings
# 1) USCoreBMIProfileProfileCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "code" : {
            name: "code",
            dataType: USCoreBMIProfileProfileCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: USCoreBMIProfileProfileValue,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: USCoreBMIProfileProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: USCoreBMIProfileProfileReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: USCoreBMIProfileProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type USCoreBMIProfileProfile record {|
    *r4:DomainResource;

    RESOURCE_NAME_USCOREBMIPROFILEPROFILE resourceType = RESOURCE_NAME_USCOREBMIPROFILEPROFILE;

    r4:CodeableConcept dataAbsentReason?;
    r4:Annotation[] note?;
    r4:Reference[] partOf?;
    r4:Extension[] extension?;
    USCoreBMIProfileProfileCode code;
    ...
    USCoreBMIProfileProfileValue valueQuantity?;
    ...
    USCoreBMIProfileProfileComponent[] component?;
    r4:Resource[] contained?;
    USCoreBMIProfileProfileReferenceRange[] referenceRange?;
    ...
    r4:Reference device?;
    USCoreBMIProfileProfileStatus status;
    r4:Element ...;
|};

# FHIR USCoreBMIProfileProfileComponent datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type USCoreBMIProfileProfileComponent record {|
    *r4:BackboneElement;
...
# USCoreBMIProfileProfileValueComparator enum
public enum USCoreBMIProfileProfileValueComparator {
...
# FHIR USCoreBMIProfileProfileCodeCoding datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileCodeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type USCoreBMIProfileProfileCodeCoding record {|
    *r4:Coding;

    r4:uri system = "http://loinc.org";
    r4:code code = "39156-5";
|};

# FHIR USCoreBMIProfileProfileCategoryVSCat datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBMIProfileProfileCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type USCoreBMIProfileProfileCategoryVSCat record {|
    *r4:CodeableConcept;
    ...
    USCoreBMIProfileProfileCategoryCoding[] coding;
    r4:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR USCoreBMIProfileProfileReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBMIProfileProfileReferenceRange record {|
    *r4:BackboneElement;
...
# FHIR USCoreBMIProfileProfileValue datatype record.
#
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: USCoreBMIProfileProfileValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public type USCoreBMIProfileProfileValue record {|
    *r4:Quantity;

    USCoreBMIProfileProfileValueComparator comparator?;
    r4:Extension[] extension?;
    string unit;
    r4:code code = "kg/m2";
...
# USCoreBMIProfileProfileStatus enum
public enum USCoreBMIProfileProfileStatus {
...
# FHIR USCoreBMIProfileProfileCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: USCoreBMIProfileProfileCodeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type USCoreBMIProfileProfileCode record {|
    *r4:CodeableConcept;
    ...
    USCoreBMIProfileProfileCodeCoding[] coding;
|};

# FHIR USCoreBMIProfileProfileCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
@r4:DataTypeDefinition {
    name: "USCoreBMIProfileProfileCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type USCoreBMIProfileProfileCategoryCoding record {|
    *r4:Coding;
